...
ms.locfileid: "84268804"
---
## <a name="sign-in-to-azure"></a>Logowanie do platformy Azure

Zanim będzie można opublikować aplikację, należy zalogować się do platformy Azure. 

1. Jeśli jeszcze nie zalogowano się, wybierz ikonę platformy Azure na pasku działania, a następnie w obszarze **Azure: Functions** wybierz pozycję **Zaloguj się do platformy Azure...**. Jeśli jeszcze tego nie masz, możesz **[utworzyć bezpłatne konto platformy Azure](https://azure.microsoft.com/free/)**. Studenci mogą kliknąć tutaj, aby ** [utworzyć bezpłatne konto platformy Azure dla studentów](https://azure.microsoft.com/free/students/)**

    ![Odpowiedź hosta localhost funkcji wyświetlona w przeglądarce](./media/functions-sign-in-vs-code/functions-sign-into-azure.png)
