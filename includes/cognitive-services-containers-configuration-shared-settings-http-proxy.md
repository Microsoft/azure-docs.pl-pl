...
|HTTP_PROXY_CREDS|ciąg|Wszystkie poświadczenia potrzebne do uwierzytelnienia na serwerze proxy, na przykład `username:password` . Ta wartość **musi być w przypadku małych liter**. |
