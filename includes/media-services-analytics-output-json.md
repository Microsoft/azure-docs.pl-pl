...
| id |Identyfikator śledzonej wartości. Ta liczba może przypadkowo ulec zmianie, jeśli nie zostanie wykryta. Dana osoba powinna mieć ten sam identyfikator w całym wideo, ale nie może być gwarantowany ze względu na ograniczenia algorytmu wykrywania (zamknięcia itp.). |
