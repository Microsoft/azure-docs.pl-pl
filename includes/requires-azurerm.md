...
> 2. [Zainstaluj moduł AzureRM](/powershell/azure/azurerm/install-azurerm-ps) z sesji programu PowerShell 5,1.
> 3. [Pobierz i zainstaluj program PowerShell Core 6. x lub nowszy](/powershell/scripting/install/installing-powershell-core-on-windows).
> 4. [Zainstaluj element AZ module](/powershell/azure/install-az-ps) w sesji programu PowerShell Core.
