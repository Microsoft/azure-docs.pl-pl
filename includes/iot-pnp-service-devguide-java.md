...
ms.locfileid: "92521413"
---
Dostępne są również następujące zasoby:

- [Dokumentacja referencyjna języka Java SDK](/java/api/com.microsoft.azure.sdk.iot.service.devicetwin.devicetwindevice?preserve-view=true&view=azure-java-stable)
