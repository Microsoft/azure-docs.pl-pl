...
W Cloud Shell możesz użyć polecenia [`az webapp create`](/cli/azure/webapp#az_webapp_create) . W poniższym przykładzie zastąp ciąg `<app-name>` globalnie unikatową nazwą aplikacji (prawidłowe znaki to `a-z`, `0-9` i `-`). 
