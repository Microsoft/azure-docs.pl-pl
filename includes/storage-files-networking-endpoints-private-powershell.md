...
Utworzenie prywatnej strefy DNS platformy Azure umożliwia pierwotną nazwę konta magazynu, na przykład w `storageaccount.file.core.windows.net` celu rozpoznania prywatnego adresu IP w sieci wirtualnej. Chociaż jest to opcjonalne z punktu widzenia tworzenia prywatnego punktu końcowego, jest on jawnie wymagany do zainstalowania udziału plików platformy Azure bezpośrednio przy użyciu podmiotu użytkownika usługi AD lub dostęp za pośrednictwem interfejsu API REST.  
