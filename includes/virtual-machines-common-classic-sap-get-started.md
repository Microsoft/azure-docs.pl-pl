...
ms.locfileid: "67183164"
---
## <a name="planning-and-implementation"></a>Planowanie i implementacja
Title: SAP NetWeaver na platformie Virtual Machines Azure — przewodnik planowania i implementacji
...
[Pobierz ten przewodnik teraz](https://go.microsoft.com/fwlink/?LinkId=397963)

## <a name="deployment"></a>Wdrożenie
Title: SAP NetWeaver na platformie Azure Virtual Machines — Przewodnik wdrażania
...
[Pobierz ten przewodnik teraz](https://go.microsoft.com/fwlink/?LinkId=397964)

## <a name="sap-dbms-on-azure"></a>System SAP DBMS na platformie Azure
Title: System SAP DBMS w przewodniku wdrażania platformy Azure

Podsumowanie: W tym dokumencie opisano zagadnienia dotyczące planowania i wdrażania systemów DBMS, które powinny być uruchamiane w połączeniu z oprogramowaniem SAP. W pierwszej części wymieniono i przedstawiono zagadnienia ogólne. Kolejne części dokumentu dotyczą wdrożeń różnych systemów DBMS na platformie Azure obsługiwanych przez oprogramowanie SAP. W przypadku różnych prezentowanych systemów DBMS należą SQL Server, SAP ASE, Oracle, SAP MaxDB i IBM DB2 dla systemów Linux i Windows. W tych konkretnych częściach zostały omówione zagadnienia, które należy uwzględnić w przypadku uruchamiania systemów SAP na platformie Azure w połączeniu z tymi systemami DBMS. Tematy takie jak metody tworzenia kopii zapasowej i zapewniania wysokiej dostępności obsługiwane przez różne systemy DBMS na platformie Azure są przedstawione do użycia z aplikacjami SAP.

Zaktualizowano: grudzień 2015

[Pobierz ten przewodnik teraz](https://go.microsoft.com/fwlink/?LinkId=397965)

## <a name="sap-netweaver-on-azure"></a>Oprogramowanie SAP NetWeaver na platformie Azure
Title: SAP NetWeaver — Tworzenie rozwiązania do odzyskiwania po awarii opartego na platformie Azure

Podsumowanie: ten dokument zawiera wskazówki krok po kroku dotyczące tworzenia rozwiązania do odzyskiwania po awarii opartego na platformie Azure dla oprogramowania SAP NetWeaver. W opisanym rozwiązaniu przyjęto założenie, że środowisko SAP działa zwirtualizowane lokalnie na podstawie funkcji Hyper-V. W pierwszej części usługi Document Azure Site Recovery (ASR) są wprowadzane w swoich składnikach. W drugiej części dokumentu opisano specyficzne dla oprogramowania SAP NetWeaver oparte na Landscapes. Zostały omówione i opisane możliwości korzystania z usługi ASR z wystąpieniami aplikacji SAP NetWeaver i usługami SAP Central. Druga część polega na korzystaniu z usługi ASR dla usług SAP Central, które są chronione za pomocą konfiguracji klastra trybu failover systemu Windows Server.

Zaktualizowano: Wrzesień 2015

[Pobierz ten przewodnik teraz](https://go.microsoft.com/fwlink/?LinkID=521971)
