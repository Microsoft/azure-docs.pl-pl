...
:::image type="content" source="../articles/digital-twins/media/include-tutorial/copy-config.png" alt-text="Fragment z okna programu Visual Studio z okienkiem Eksplorator rozwiązań z wyróżnioną serviceConfig.js, a okienko właściwości z właściwością "Kopiuj do katalogu wyjściowego" ma wartość "Kopiuj, jeśli nowszy"" border="false":::
