...
1. Na stronie **Brama sieci wirtualnej** wybierz pozycję **+ Dodaj**. Spowoduje to otwarcie strony **Tworzenie bramy sieci wirtualnej**.
   ...
   :::image type="content" source="./media/vpn-gateway-add-gw-rm-portal-empty/add.png" alt-text="Strona bramy sieci wirtualnej":::
1. Na karcie **podstawowe** wprowadź wartości dla bramy sieci wirtualnej.

   :::image type="content" source="./media/vpn-gateway-add-gw-rm-portal-empty/gateway.png" alt-text="Pola bramy":::

   :::image type="content" source="./media/vpn-gateway-add-gw-rm-portal-empty/gateway-vnet.png" alt-text="Dodatkowe pola bramy":::
