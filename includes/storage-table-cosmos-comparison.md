...
| Cennik | Na podstawie użycia. | Dostępne zarówno w trybie dyspozycyjności, jak [i z](../articles/cosmos-db/serverless.md) [obsługą administracyjną](../articles/cosmos-db/set-throughput.md) . |
