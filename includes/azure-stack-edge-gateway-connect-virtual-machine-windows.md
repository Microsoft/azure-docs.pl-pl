...
1. Wprowadź adres IP maszyny wirtualnej i poświadczenia dostępu użyte w pliku parametrów szablonu maszyny wirtualnej.
    ...
    ![Łączenie za pośrednictwem protokołu RDP z maszyną wirtualną z systemem Windows](media/azure-stack-edge-gateway-connect-vm-windows/connect-vm-rdp-1.png)
1. Może być konieczne zatwierdzenie połączenia z niezaufanym komputerem. 
1. Zalogowano Cię na maszynie wirtualnej działającej na urządzeniu. 