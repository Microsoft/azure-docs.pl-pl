...
| Ustawienia skalowania automatycznego |100 na region na subskrypcję. | Analogicznie jak domyślny. |
| Profile skalowania automatycznego |20 profilów na ustawienie skalowania automatycznego. | Analogicznie jak domyślny. |
