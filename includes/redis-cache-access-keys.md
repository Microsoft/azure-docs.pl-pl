...
- Aby uzyskać nazwę hosta i porty, z okienka nawigacji po lewej stronie wybierz pozycję **Właściwości**. Nazwa hosta ma postać * \<nazwa DNS>. Redis.cache.Windows.NET*.
