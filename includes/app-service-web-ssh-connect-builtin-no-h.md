...
Aby otworzyć zdalną sesję SSH z komputera lokalnego, zobacz [Otwieranie sesji SSH z poziomu powłoki zdalnej](../articles/app-service/configure-linux-open-ssh-session.md#open-ssh-session-from-remote-shell).