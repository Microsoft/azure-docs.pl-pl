...
2. Na pasku narzędzi * \<nazwa konta>*  -  **kontenery** wybierz pozycję **kontener**.
3. W oknie dialogowym **Nowy kontener** wprowadź jako nazwę **adftutorial**, a następnie wybierz przycisk **OK**. Strona * \<nazwa konta>*  -  **kontenerów** jest aktualizowana w celu uwzględnienia **adftutorial** na liście kontenerów.
