...
ms.locfileid: "101102839"
---
- Jeśli nie znasz funkcji tożsamości zarządzanych dla zasobów platformy Azure, zobacz to [omówienie](../articles/active-directory/managed-identities-azure-resources/overview.md). 
