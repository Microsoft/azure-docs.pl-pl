...
ms.locfileid: "67183531"
---
## <a name="request-and-response-json"></a>Żądanie i odpowiedź w formacie JSON

Przykład sformatowanego przy użyciu notacji JSON pytania dla interfejsu API REST:
...
Pytanie zawiera właściwość powodującą zwrócenie trzech najważniejszych odpowiedzi. 

Odpowiedź jest zwracana w obiekcie JSON:
