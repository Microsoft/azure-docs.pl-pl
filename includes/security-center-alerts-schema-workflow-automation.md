...
|----|----|----|
|**AlertDisplayName**|Ciąg|Nazwa wyświetlana alertu.|
|**AlertType**|Ciąg|Typ alertu. Alerty tego samego typu powinny mieć taką samą wartość. To pole jest podkluczowym ciągiem reprezentującym typ alertu, a nie wystąpienia alertu. Wszystkie wystąpienia alertów z tej samej logiki wykrywania/analitycznej powinny mieć taką samą wartość dla typu alertu.|
|**CompromisedEntity**|Ciąg|Nazwa wyświetlana zasobu najbardziej powiązanego z tym alertem.|
...
|**ProductName**|Ciąg|Nazwa produktu, który opublikował ten alert (Azure Security Center, Azure ATP, Microsoft Defender ATP, O365 ATP, MCAS itd.).|
...
|**NazwaDostawcy**|Ciąg|Nazwa dostawcy, który wygeneruje alert.|
|||
