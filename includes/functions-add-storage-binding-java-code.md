...
---
Teraz można użyć nowego `msg` parametru do zapisu w powiązaniu danych wyjściowych z kodu funkcji. Dodaj następujący wiersz kodu przed odpowiedzią sukcesu, aby dodać wartość `name` do powiązania `msg` danych wyjściowych.
