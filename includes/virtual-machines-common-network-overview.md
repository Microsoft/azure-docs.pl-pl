...
- **[Przekazywanie portów](../articles/load-balancer/tutorial-load-balancer-port-forwarding-portal.md)** — definiuje sposób przepływu ruchu przychodzącego za pomocą adresu IP frontonu i dystrybuowania do adresu IP zaplecza wykorzystującego reguły NAT dla ruchu przychodzącego.
...
| Metoda | Opis |
| ------ | ----------- |
| Azure Portal | [W Azure Portal można zrównoważyć obciążenie ruchem wewnętrznym przy użyciu modułu równoważenia obciążenia](../articles/load-balancer/tutorial-load-balancer-standard-internal-portal.md). |
...
Aby uzyskać więcej informacji na temat modułu równoważenia obciążenia i zestawów skalowania maszyn wirtualnych, zobacz [sieci dla zestawów skalowania maszyn wirtualnych platformy Azure](https://docs.microsoft.com/azure/virtual-machine-scale-sets/virtual-machine-scale-sets-networking).
