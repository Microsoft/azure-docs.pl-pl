...
-->
Możesz użyć jednego z następujących narzędzi lub zestawów SDK, aby użyć działania kopiowania z potokiem. Wybierz link, aby uzyskać instrukcje krok po kroku:

- [Narzędzie do kopiowania danych](../articles/data-factory/quickstart-create-data-factory-copy-data-tool.md)
