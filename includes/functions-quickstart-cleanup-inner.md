...
1. W witrynie Azure Portal przejdź do strony **Grupa zasobów**. 
   ...
   Aby przejść do tej strony z pulpitu nawigacyjnego, wybierz pozycję **grupy zasobów**, a następnie wybierz grupę zasobów, która została użyta w tym artykule.
