...
+ [Za pomocą interfejsu wiersza polecenia platformy Azure.](https://docs.microsoft.com/cli/azure/functionapp/config/appsettings#az-functionapp-config-appsettings-set)
