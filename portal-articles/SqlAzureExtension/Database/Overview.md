---
title: Omówienie usługi SQL Database | Microsoft Docs
description: Zawartość pomocy dla omówienia usługi SQL Database w witrynie Azure Portal
...
- [Interfejs wiersza polecenia platformy Azure](/azure/sql-database/sql-database-cli-samples)
- [Azure PowerShell](/azure/sql-database/sql-database-powershell-samples)

## <a name="more"></a>Więcej

- [Aby uzyskać więcej informacji, zobacz dokumentację](/azure/sql-database/index)
