...
Cały dostęp do wpisów tajnych odbywa się za pośrednictwem Azure Key Vault. W tym przewodniku Szybki start utworzysz magazyn kluczy przy użyciu interfejsu [Azure Portal,](../general/quick-create-portal.md) [interfejsu](../general/quick-create-cli.md)wiersza polecenia platformy Azure [lub Azure PowerShell](../general/quick-create-powershell.md).
...
Klikając przycisk "Pokaż wartość tajne" w okienku po prawej stronie, można wyświetlić ukrytą wartość. 
...
> [!NOTE]
> Należy zauważyć, że usunięcie klucza tajnego, klucza, certyfikatu lub magazynu kluczy będzie możliwe do odzyskania przez konfigurowalny okres od 7 do 90 dni kalendarzowych. Jeśli nie określono konfiguracji, domyślny okres odzyskiwania zostanie ustawiony na 90 dni. Dzięki temu użytkownicy mają wystarczająco dużo czasu, aby zauważyć przypadkowe usunięcie tajnego pliku i zareagować na nie. Aby uzyskać więcej informacji na temat usuwania i odzyskiwania magazynów kluczy i obiektów magazynu kluczy, zobacz Azure Key Vault omówienie usuwania [nie soft-delete](../general/soft-delete-overview.md)
...
- Bezpieczny [dostęp do odczytu do Key Vault](../general/security-overview.md)
- Zobacz Use Key Vault with App Service Web App (Używanie aplikacji [Key Vault z App Service web app)](../general/tutorial-net-create-vault-azure-web-app.md)
