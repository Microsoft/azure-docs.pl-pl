...
- Użytkownik musi mieć przypisaną rolę Bult kontroli dostępu współdzielonego. trybu. [Dowiedz się więcej tutaj](https://docs.microsoft.com/azure/role-based-access-control/role-assignments-portal)
