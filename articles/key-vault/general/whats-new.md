---
title: Co nowego w Azure Key Vault | Microsoft Docs
...
ms.locfileid: "88588368"
---
# <a name="whats-new-for-azure-key-vault"></a>Co nowego w Azure Key Vault

> [!WARNING]
> **Lipiec 2020**: Istnieją dwie aktualizacje magazynu kluczy, które mogą wpływać na implementację usługi: [Magazyn kluczy nietrwałego usuwania](#soft-delete-on-by-default) i [zmiany certyfikatu usługi Azure TLS](#azure-tls-certificate-changes). Aby uzyskać szczegółowe informacje, zobacz poniżej.
...
- Usługi Azure Active Directory (Azure AD) zaczęły to przechodzenie od 7 lipca 2020.
...
### <a name="will-this-affect-me"></a>Czy będzie to miało wpływ na mnie?
...
- Różne systemy operacyjne i środowiska uruchomieniowe języka, które komunikują się z usługami platformy Azure, mogą wymagać dodatkowych kroków w celu poprawnego skompilowania łańcucha certyfikatów przy użyciu tych nowych katalogów głównych: 
    - **Linux**: wiele dystrybucji wymaga dodania urzędów certyfikacji wymienionych powyżej do/etc/SSL/certs. Aby uzyskać szczegółowe instrukcje, zapoznaj się z dokumentacją dystrybucji.
    - **Java**: Upewnij się, że magazyn kluczy Java zawiera wymienione powyżej urzędy certyfikacji.
    - **System Windows działający w odłączonych środowiskach**: systemy działające w środowiskach rozłączonych muszą mieć dodane elementy główne wymienione powyżej do magazynu zaufanych głównych urzędów certyfikacji, a następnie pośrednicy dodani do magazynu pośrednich urzędów certyfikacji.
