...
Jak zintegrować Key Vault z prywatnym łączem platformy Azure:
...
Stacje robocze uprzywilejowanego dostępu:https://docs.microsoft.com/windows-server/identity/securing-privileged-access/privileged-access-workstations 
...
- [Model szyfrowania i tabela zarządzania kluczami](https://docs.microsoft.com/azure/security/fundamentals/encryption-atrest#encryption-model-and-key-management-table)
...
Co to jest kontrola dostępu oparta na rolach (Azure RBAC)?
