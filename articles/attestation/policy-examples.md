...
## <a name="default-policy-for-an-sgx-enclave-in-text-format"></a>Zasady domyślne dla SGX enklawy w formacie tekstowym
...
## <a name="sample-custom-policy-for-an-sgx-enclave-in-text-format"></a>Przykładowe zasady niestandardowe dla SGX enklawy w formacie tekstowym
