...
## <a name="default-policy-for-an-sgx-enclave-with-policyformattext"></a>Zasady domyślne dla elementu SGX enklawy z PolicyFormat = text
...
## <a name="default-policy-for-vbs-enclave"></a>Zasady domyślne dla VBS enklawy

Brak zasad domyślnych dla VBS enklawy
