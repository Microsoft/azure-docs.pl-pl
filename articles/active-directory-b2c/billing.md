...
1. Wybierz pozycję **Utwórz zasób**, wprowadź `Active Directory B2C` wartość w polu **Wyszukaj w witrynie Marketplace** , a następnie wybierz pozycję **Azure Active Directory B2C**.
