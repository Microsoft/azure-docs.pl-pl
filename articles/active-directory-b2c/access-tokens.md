...
- `<application-ID-URI>` — Identyfikator URI identyfikatora aplikacji ustawiony w obszarze **Uwidacznianie bloku interfejsu API** aplikacji klienckiej.
- `<scope-name>` -Nazwa zakresu dodanego w obszarze **Uwidacznianie bloku interfejsu API** aplikacji klienckiej.
