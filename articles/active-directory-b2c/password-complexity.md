...
Jeśli używasz zasad [logowania opartej na nazwie użytkownika](https://github.com/azure-ad-b2c/samples/tree/master/policies/username-signup-or-signin) , zaktualizuj `AAD-UserWriteUsingLogonEmail` `AAD-UserWritePasswordUsingObjectId` Profile, i `LocalAccountWritePasswordUsingObjectId` techniczne przy użyciu zasad *DisableStrongPasswordymi* .
