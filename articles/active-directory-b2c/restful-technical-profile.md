...
1. W profilu technicznym interfejsu API REST:
    1. Dodaj transformację oświadczeń wejściowych z odwołaniem do transformacji `GenerateJson` oświadczeń.
    1. Ustaw opcję `SendClaimsIn` metadanych na`body`
    1. Ustaw opcję `ClaimUsedForRequestPayload` metadanych na nazwę żądania zawierającego ładunek JSON.
