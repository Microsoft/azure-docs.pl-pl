...
* Resetowanie hasła
* Użytkownicy nie mogą zarejestrować się w celu uzyskania konta lokalnego Azure AD B2C — aby utworzyć konto, administrator może użyć programu [MS interfejs API programu Graph](manage-user-accounts-graph-api.md).
