...
|department      |Ciąg|Nazwa działu, w którym pracuje użytkownik. Maksymalna długość 64.|Tak|Nie|Utrwalony, wyjściowy|
...
|legalCountry<sup>1</sup>  |Ciąg|Kraj do celów prawnych.|Nie|Nie|Utrwalony, wyjściowy|
