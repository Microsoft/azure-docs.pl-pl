...
W tym momencie dostawca tożsamości usługi Azure AD został skonfigurowany, ale nie jest jeszcze dostępny na żadnej stronie logowania. Aby dodać dostawcę tożsamości usługi Azure AD do przepływu użytkownika:
...
1. Na stronie rejestracji lub logowania wybierz pozycję **contoso Azure AD** , aby zalogować się przy użyciu konta Contoso usługi Azure AD.
