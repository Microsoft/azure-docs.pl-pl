...
## <a name="configure-wechat-as-an-identity-provider"></a>Konfigurowanie WeChat jako dostawcy tożsamości
...
Aby umożliwić użytkownikom logowanie się przy użyciu konta usługi WeChat, należy zdefiniować konto jako dostawcę oświadczeń, z którym Azure AD B2C może komunikować się za pośrednictwem punktu końcowego. Punkt końcowy zawiera zestaw oświadczeń, które są używane przez Azure AD B2C do sprawdzenia, czy określony użytkownik został uwierzytelniony.
