...
Po zmodyfikowaniu lub utworzeniu podróży użytkownika w sekcji jednostka **uzależniona** Określ, która Azure AD B2C będzie wykonywana dla tych zasad niestandardowych. W elemencie [RelyingParty](../articles/active-directory-b2c/relyingparty.md) Znajdź element **DefaultUserJourney** . Zaktualizuj  **DefaultUserJourney ReferenceId** w taki sposób, aby odpowiadał identyfikatorowi podróży użytkownika, w którym dodano **ClaimsProviderSelections**.
