...
[Schemat dziennika Analiza ruchu](https://docs.microsoft.com/azure/network-watcher/traffic-analytics-schema) zawiera następujące nowe pola: **SrcPublicIPs_s**, **DestPublicIPs_s** **NSGRule_s**. Nowe pola zawierają informacje o źródłowym i docelowym adresie IP oraz upraszczają zapytania.
