...
| properties | ile | Informacje o właściwościach podane na poziomie dokumentu w zestawie danych przestrzennych. |
...
Dobrze znany tekst może zostać odczytany przy `atlas.io.ogc.WKT.read` użyciu funkcji i zapisany przy użyciu `atlas.io.ogc.WKT.write` funkcji.

## <a name="examples-of-reading-and-writing-well-known-text-wkt"></a>Przykłady odczytywania i pisania dobrze znanego tekstu (WKT)

Poniższy kod przedstawia sposób odczytywania dobrze znanego ciągu `POINT(-122.34009 47.60995)` tekstowego i renderowania go na mapie za pomocą warstwy bąbelkowej.
