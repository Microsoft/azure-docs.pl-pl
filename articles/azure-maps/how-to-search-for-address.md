...
* Utwórz [odwrotne wyszukiwanie adresu](https://docs.microsoft.com/rest/api/maps/search/getsearchaddressreverse) , aby przetłumaczyć lokalizację współrzędnych na ulicę.
* Przetłumacz lokalizację współrzędnych na poznanie krzyżowe przez człowieka przy użyciu [adresu wyszukiwania odwrotnego interfejsu API](https://docs.microsoft.com/rest/api/maps/search/getsearchaddressreversecrossstreet).  Najczęściej jest to konieczne w przypadku śledzenia aplikacji, które odbierają kanał GPS z urządzenia lub zasobu, i chcą wiedzieć, gdzie znajduje się Współrzędna.
...
3. Kliknij pozycję **Wyślij** i sprawdź treść odpowiedzi.
    ...
    W następnym kroku użyjemy `countrySet` parametru, aby określić tylko kraje/regiony, dla których aplikacja wymaga pokrycia. Aby uzyskać pełną listę obsługiwanych krajów/regionów, zobacz [pokrycie wyszukiwania](https://docs.microsoft.com/azure/azure-maps/geocoding-coverage).
...
W tym przykładzie przeprowadzimy wyszukiwanie wsteczne przy użyciu kilku opcjonalnych parametrów, które są dostępne. Aby zapoznać się z pełną listą parametrów opcjonalnych, zobacz [wyszukiwanie wsteczne parametrów wyszukiwania](https://docs.microsoft.com/rest/api/maps/search/getsearchaddressreverse#uri-parameters).
...
>[!TIP]
>Aby uzyskać więcej informacji na temat tych parametrów, a także zapoznać się z innymi informacjami, zobacz [sekcję parametry wyszukiwania wstecznego](https://docs.microsoft.com/rest/api/maps/search/getsearchaddressreverse#uri-parameters).
...
> [Interfejs API REST Search Service Azure Maps](https://docs.microsoft.com/rest/api/maps/search)
