...
1. Przekaż pakiet rysowania do usługi Azure Maps Creator, aby uzyskać dostęp do `udid` przekazanego pakietu. Aby uzyskać instrukcje dotyczące sposobu przekazywania pakietu, zobacz [przekazywanie pakietu rysowania](tutorial-creator-indoor-maps.md#upload-a-drawing-package).
