...
description: Dowiedz się, które kategorie wyszukiwania są obsługiwane w Azure Maps. Wyświetl wszystkie obsługiwane kody kategorii i typy punktów, które reprezentuje każda z nich.
author: sataneja
ms.author: sataneja
ms.date: 05/14/2018
ms.topic: conceptual
...
ms.locfileid: "92896909"
---
# <a name="azure-maps-supported-categories"></a>Azure Maps obsługiwanych kategorii

Podczas [wyszukiwania kategorii](/rest/api/maps/search/getsearchpoicategory) w poszukiwaniu interesujących punktów należy użyć setek obsługiwanych kategorii. Poniżej znajduje się lista kodów kategorii dla obsługiwanych nazw kategorii. Kody kategorii są generowane dla kategorii najwyższego poziomu. Wszystkie podkategorie współdzielą ten sam kod kategorii. Ta lista kategorii może ulec zmianie z nowymi wersjami danych.

<br/>

| **Kod kategorii** | **Kategorie zgodne z kodem** |
| --- | --- |
| \_brama dostępu | dostęp do linii lotniczych, brama zabezpieczeń, dostęp do stacji, Brama dostępu |
| \_Wydział administracyjny | Prowincja, czwarta kolejność, Podział administracyjny, Podział administracyjny pierwszego rzędu, historyczny Podział administracyjny innej kolejności, stanowisko z podziałem administracyjnym z czwartej kolejności, miejsce podziału administracyjnego drugiego rzędu, zależna jednostka polityczna, zapełnione miejsce, siedziba działu administracyjnego trzeciego rzędu, miejsca, Podział administracyjny w drugiej kolejności Wydział administracyjny, pozostała miejscowość, region historyczny, witryna historyczna, zapełnione miejsce historyczne, rozliczenia Izraela, Podział administracyjny z czwartej kolejności, Podział administracyjny z piątą kolejnością, Podział administracyjny pierwszego zamówienia, oddział administracyjny w porządku, historyczny podmiot polityczny, historyczny Wydział administracyjny |
| Rejon firmy ADVENTURE \_ Sport \_ | Rejon firmy Adventure Sport |
...
| Rozrywka \_ Park | Rozrywka Zręcznościowe, rozrywka miejsce, rozrywka Park |
| \_dealery samochodowe | ATV/Snowmobile, łodzie, magistrala, motocykle, ciężarówka, samorekreacyjne pojazdy, samochód, samochodowy dealer |
| RACHUNK | Bank, banki, bankowe: |
| SEKWENCJE | sekwencje, plażach |
| \_punkt budynku | Kompilowanie (punkt) |
| Park BIZNESowy \_ | Parkowanie biznesowe, obszar branżowy |
| CAFE \_ pub | Internet kawiarni, herbata (kawiarni), Internet kawiarni, kawiarni, kawiarnia, microbrewery/piwo,, Pub, kawiarni/pub, kawiarni/pub |
| Ziemia KEMPINGowa \_ | samotworzenie, lokacja kempingowa, Ziemia kempingowa |
| \_pranie samochodu | pranie samochodu |
| \_dozownik gotówkowy | Automater, dozownik gotówkowy |
| KASYNOWE | kasynowe |
| KINOW | dysk — w kinowej, kinowej |
| Miasto \_ | klub, obszar administracyjny, miasto, środek |
| \_skojarzenie klubu | Klub sekwencje, klub kija hokejowego, Stowarzyszenie klubu |
...
| Instalacja WOJSKOWa \_ | Baza wojskowa, stacja ochrony wybrzeża, instalacja wojskowa, podstawa okrętowa |
