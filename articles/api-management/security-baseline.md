...
* [Informacje o zaleceniach dotyczących tożsamości i dostępu Azure Security Center](../security-center/recommendations-reference.md#recs-identityandaccess)
...
**Wskazówki**: Jeśli to możliwe, Użyj usługi Azure AD jako centralnego systemu uwierzytelniania i autoryzacji. Usługa Azure AD chroni dane przy użyciu silnego szyfrowania danych przechowywanych i przesyłanych. Usługa Azure AD również Sole, skróty i bezpieczne przechowywanie poświadczeń użytkownika.
...
* [Informacje o ochronie i szyfrowaniu danych przechowywanych w usłudze Azure API Management](#data-protection)
...
* [Jak utworzyć kopię zapasową certyfikatów Azure Key Vault](/powershell/module/azurerm.keyvault/backup-azurekeyvaultcertificate)
...
* [Jak przywrócić Azure Key Vault certyfikaty](/powershell/module/azurerm.keyvault/restore-azurekeyvaultcertificate)
