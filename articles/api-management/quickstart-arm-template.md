...
1. Po pomyślnym utworzeniu wystąpienia otrzymujesz powiadomienie:
    ...
    :::image type="content" source="media/quickstart-arm-template/deployment-notification.png" alt-text="Powiadomienie dotyczące wdrożenia":::
...
:::image type="content" source="media/quickstart-arm-template/service-instance-created.png" alt-text="Strona przeglądu usługi":::
...
1. Na stronie Grupa zasobów wybierz pozycję **Usuń grupę zasobów**.
    ...
    :::image type="content" source="media/quickstart-arm-template/delete-resource-group.png" alt-text="Usuwanie grupy zasobów":::
