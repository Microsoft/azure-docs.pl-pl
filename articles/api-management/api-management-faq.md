...
Teraz nowo dodany współautor może używać Azure PowerShell [poleceń cmdlet](/powershell/azure/overview). Oto jak zalogować się jako administrator:
