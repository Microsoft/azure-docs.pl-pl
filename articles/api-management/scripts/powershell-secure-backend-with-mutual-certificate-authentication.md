...
description: Dowiedz się, jak używać przykładowego Azure PowerShell do zabezpieczania zaplecza za pomocą wzajemnego uwierzytelniania certyfikatów.
