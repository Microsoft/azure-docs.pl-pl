...
description: Dowiedz się, jak używać przykładowego skryptu Azure PowerShell do zabezpieczenia zaplecza przy użyciu wzajemnego uwierzytelniania certyfikatów.
