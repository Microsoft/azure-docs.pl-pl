...
1. Wybierz **App Service** a następnie wybierz pozycję **Utwórz profil**.

   ![Publikowanie ze strony przeglądu projektu](./media/quickstart-dotnet-framework/publish-app-framework-vs2019.png)
