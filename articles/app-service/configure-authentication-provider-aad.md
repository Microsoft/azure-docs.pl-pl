...
* [Samouczek: kompleksowe uwierzytelnianie i autoryzacja użytkowników w usłudze Azure App Service](app-service-web-tutorial-auth-aad.md)
<!-- URLs. -->
