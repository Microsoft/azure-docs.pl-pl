...
description: Dowiedz się, jak zautomatyzować wdrażanie aplikacji App Service i zarządzanie nią za pomocą interfejsu wiersza polecenia platformy Azure. Ten przykład pokazuje, jak połączyć aplikację z SQL Database.
...
ms.locfileid: "97006382"
---
# <a name="connect-an-app-service-app-to-sql-database-using-cli"></a>Łączenie aplikacji App Service SQL Database przy użyciu interfejsu wiersza polecenia
...
| [`az sql db create`](/cli/azure/sql/db#az-sql-db-create) | Tworzy nową bazę danych. |
| [`az sql db show-connection-string`](/cli/azure/sql/db#az-sql-db-show-connection-string) | Generuje ciąg połączenia dla bazy danych. |
