...
description: Dowiedz się więcej na temat możliwości samoobsługowego rozwiązywania problemów w ramach usługi StorSimple Menedżer urządzeń.
services: storsimple
documentationcenter: ''
author: manuaery
manager: syadav
...
Można wyświetlić niektóre typowe problemy z wirtualną macierzą StorSimple i przejrzeć rozwiązania tych problemów bezpośrednio w bloku podsumowania usługi StorSimple Menedżer urządzeń.

#### <a name="to-diagnose-an-issue-with-your-virtual-array"></a>Aby zdiagnozować problem z tablicą wirtualną

1. Kliknij pozycję **Diagnozuj i rozwiąż problemy** w lewym okienku w bloku podsumowania usługi StorSimple Menedżer urządzeń, aby wyświetlić listę typowych problemów.
