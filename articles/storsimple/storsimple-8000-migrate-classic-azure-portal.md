...
| StorSimple urządzenie z jednej usługi StorSimple Menedżer urządzeń do innej usługi w innym regionie?      | Nie        | Tak            | Brak, proces ręczny |Tak samo jak powyżej.|
...
| Konto magazynu z jednego centrum danych platformy Azure na inne? | Nie |Tak  |Brak, proces ręczny  | Tak samo jak powyżej.|
