...
|-------------|--------------|----------|
|[Azure Data Lake Storage Gen 1](azure-data-lake-storage-gen1-output.md)|Azure Active Directory użytkownika </br> Tożsamość usługi zarządzanej|
