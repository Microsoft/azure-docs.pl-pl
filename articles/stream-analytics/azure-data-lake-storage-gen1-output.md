...
Maksymalny rozmiar komunikatu znajduje się w temacie [Data Lake Storage limitów](../azure-resource-manager/management/azure-subscription-service-limits.md#data-lake-store-limits). Aby zoptymalizować rozmiar partii, użyj do 4 MB na operację zapisu.
