...
2. Wybierz pozycję **Utwórz zasób** i wyszukaj **zadanie Stream Analytics**. Wybierz kafelek **zadanie Stream Analytics** i wybierz pozycję **Utwórz**.
