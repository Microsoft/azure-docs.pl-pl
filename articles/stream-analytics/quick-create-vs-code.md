...
1. W lewym górnym rogu Azure Portal wybierz pozycję **Utwórz zasób** > **Storage** > magazyn**konto magazynu**.
...
3. Nowy projekt zostanie dodany do obszaru roboczego. Projekt Stream Analytics składa się z trzech folderów **Inputs**: wejść **, Output**i **Functions**. Zawiera także skrypt zapytania **(*. asaql)**, plik **JobConfig. JSON** oraz plik konfiguracji **asaproj. JSON** .
