...
* Azure Active Directory Domain Services zarządzana domena włączona i skonfigurowana w dzierżawie usługi Azure AD.
    * W razie potrzeby Ukończ samouczek, aby [utworzyć i skonfigurować domenę Azure Active Directory Domain Servicesową][create-azure-ad-ds-instance].
