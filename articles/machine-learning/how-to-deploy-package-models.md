...
description: Pakowanie modelu. Modele można spakować jako obraz platformy Docker, który następnie można pobrać, lub można utworzyć pliku dockerfile i użyć go do utworzenia obrazu.
