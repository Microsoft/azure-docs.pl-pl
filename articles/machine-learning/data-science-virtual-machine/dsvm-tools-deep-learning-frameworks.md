...
> [!NOTE]
> Oba następujące obrazy maszyn wirtualnych są przestarzałe:
>
> * Obraz DSVM systemu Windows Server 2016
> * Obraz przedstawiający Ubuntu 16,04 DSVM 
>
> Te obrazy maszyn wirtualnych są dostępne tylko dla istniejących klientów korzystających z wdrożeń ARM. Te obrazy będą nadal otrzymywać krytyczne poprawki zabezpieczeń do daty wycofania, ale nie będą aktualizowane przy użyciu najnowszych narzędzi do nauki o danych.
> 
> Zapoznaj się ze [stroną przestarzałe obrazu DSVM](./reference-deprecation.md).
...
| ------------- | ------------- |
| Obsługiwane wersje | |
| Obsługiwane wersje DSVM      | Ubuntu 16,04 (przestarzałe)    |
...
| Obsługiwane wersje DSVM      | Windows Server 2019<br>Ubuntu 18.04<br> Windows 2016 (przestarzałe)<br> Ubuntu 16,04 (przestarzałe)  |
...
| Obsługiwane wersje DSVM      | Ubuntu 18.04<br> Ubuntu 16,04 (przestarzałe)   |
...
| Obsługiwane wersje DSVM      | Windows 2016 (przestarzałe)<br> Ubuntu 16,04 (przestarzałe)   |
...
| Kategoria | Wartość |
| ------------- | ------------- |
| Obsługiwane wersje | 1.2.0 (Ubuntu 16,04), 1.4.0 (Ubuntu 18,04, Windows 2019) |
| Obsługiwane wersje DSVM      | Windows Server 2019<br>Ubuntu 18.04<br> Ubuntu 16,04 (przestarzałe) |
