...
W tej sekcji pokazano `StringIndexer` , jak indeksować dane kategorii przy użyciu i kodować `OneHotEncoder` funkcje z danymi wejściowymi do modeli.
