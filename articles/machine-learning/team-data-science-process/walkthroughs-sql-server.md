---
title: Analiza na SQL Server z procesem nauki danych w językach R, Python i T-SQL
description: Przykłady, które przeprowadzą do analizy predykcyjnej za pomocą języka R, Python i T-SQL w SQL Server.
...
Te instruktaże wykorzystują SQL Server, SQL Server R Services i SQL Server usługi Python do wykonywania analiz predykcyjnych. Kod języka R i Python jest wdrażany w procedurach składowanych. Postępują zgodnie z krokami opisanymi w procesie nauki o danych zespołowych. Aby zapoznać się z omówieniem procesu nauki o danych zespołowych, zobacz [proces nauki o danych](overview.md). 
...
## <a name="predict-taxi-tips-using-python-and-sql-queries-with-sql-server"></a>Przewidywanie wskazówek dotyczących taksówki przy użyciu języka Python i zapytań SQL z SQL Server 

W instruktażu [Use SQL Server](sql-walkthrough.md) pokazano, jak tworzyć i wdrażać modele klasyfikacji i regresji uczenia maszynowego.  Dane to publicznie dostępny zestaw danych o wykorzystaniu NYC i taryfy.
