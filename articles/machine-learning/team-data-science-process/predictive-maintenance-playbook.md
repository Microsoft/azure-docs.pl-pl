...
| Identyfikator elementu zawartości | Czas | \<Feature Columns> | Etykieta |
| ---- | ---- | --- | --- |
| A123 |Dzień 1 | . . . | . |
| A123 |Dzień 2 | . . . | . |
| ...  |...   | . . . | . |
...
| 6 | [Konserwacja predykcyjna usługi Azure IoT](https://github.com/Azure/azure-iot-predictive-maintenance) | Azure IoT Suite komputerów — wstępnie skonfigurowane rozwiązanie. Szablon PdM konserwacji samolotów z IoT Suite. [Inny dokument](../../iot-accelerators/quickstart-predictive-maintenance-deploy.md) i [Przewodnik](../../iot-accelerators/iot-accelerators-predictive-walkthrough.md) dotyczący tego samego projektu. |
