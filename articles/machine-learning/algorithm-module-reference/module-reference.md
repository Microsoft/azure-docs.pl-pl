...
| Funkcja | Opis | Moduł |
| --- |--- | --- |
| Regresja | Przewidywanie wartości. | [Regresja wzmocnionego drzewa decyzyjnego](boosted-decision-tree-regression.md) <br/> [Regresja lasu decyzyjnego](decision-forest-regression.md) <br/> [Szybkie regresja quantile lasów](fast-forest-quantile-regression.md)  <br/> [Regresja liniowa](linear-regression.md)  <br/> [Regresja sieci neuronowej](neural-network-regression.md)  <br/> [Regresja Poissona](poisson-regression.md)  <br/>|
