...
-   **Korelacja Pearsona**  
    ...
    Statystyka korelacji Pearsona lub współczynnik korelacji Pearsona są również znane w modelach statystycznych `r` jako wartość. Dla każdej dwóch zmiennych zwraca wartość wskazującą siłę korelacji.
