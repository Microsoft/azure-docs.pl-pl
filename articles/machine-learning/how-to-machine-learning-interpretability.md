...
Używaj `pip install azureml-interpret` i `pip install azureml-interpret-contrib` do ogólnego użytku, a `pip install azureml-contrib-interpret` dla AutoML użyć do uzyskania pakietów do interpretacji.
