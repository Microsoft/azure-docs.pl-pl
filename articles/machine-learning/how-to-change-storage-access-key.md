...
Aby uzyskać więcej informacji na temat rejestrowania magazynów danych, zobacz [`Datastore`](https://docs.microsoft.com/python/api/azureml-core/azureml.core.datastore(class)?view=azure-ml-py&preserve-view=true) odwołanie do klasy.
