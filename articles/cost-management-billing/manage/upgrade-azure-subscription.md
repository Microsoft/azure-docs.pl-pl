...
Po uaktualnieniu bezpłatnego konta platformy Azure możesz zachować pozostałe środki przez pełne 30 dni od momentu zarejestrowania się. Przykład: W przypadku zarejestrowania się 1 listopada i wykonania uaktualnienia 5 listopada wszystkie niewykorzystane środki będą dostępne do 30 listopada. Masz również dostęp do bezpłatnych usług przez 12 miesięcy po uaktualnieniu.
...
Teraz, gdy już masz uaktualnione konto, zobacz [Zapobieganie nieoczekiwanym opłatom za pomocą funkcji rozliczeń i zarządzania kosztami platformy Azure.](getting-started.md)
