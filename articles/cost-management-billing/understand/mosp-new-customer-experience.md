...
**Brak zmian w zasobach platformy Azure** Ta aktualizacja nie ma wpływu na dostęp do zasobów platformy Azure ustawiony przy użyciu funkcji kontroli dostępu na podstawie ról platformy Azure (Azure RBAC).
