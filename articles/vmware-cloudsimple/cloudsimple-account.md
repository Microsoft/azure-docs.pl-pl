...
description: Dowiedz się więcej o zarządzaniu kontem CloudSimple, które jest tworzone wraz z usługą CloudSimple i jest skojarzone z subskrypcją platformy Azure.
author: sharaths-cs
ms.author: dikamath
ms.date: 04/10/2019
ms.topic: article
...
* [Wyświetl podsumowanie konta](account.md)
* [Wyświetl listę użytkowników](users.md)
