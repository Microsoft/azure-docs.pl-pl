...
description: Wyświetla Azure Policy wbudowanych definicji zasad dla Azure Portal. Te wbudowane definicje zasad zapewniają typowe podejścia do zarządzania zasobami platformy Azure.
ms.date: 04/21/2021
ms.topic: reference
...
ms.locfileid: "107875735"
---
# <a name="azure-policy-built-in-definitions-for-azure-portal"></a>Azure Policy wbudowane definicje dla Azure Portal

Ta strona jest indeksem [Azure Policy](../governance/policy/overview.md) wbudowanych definicji zasad dla Azure Portal. Aby uzyskać Azure Policy wbudowanych dla innych usług, [zobacz Azure Policy wbudowane definicje](../governance/policy/samples/built-in-policies.md).
