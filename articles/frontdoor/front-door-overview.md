...
* Zabezpieczenia aplikacji przy użyciu niestandardowych reguł **[zapory aplikacji sieci Web (WAF)](../web-application-firewall/overview.md)** i **[Azure DDoS Protection](../virtual-network/ddos-protection-overview.md)**.
