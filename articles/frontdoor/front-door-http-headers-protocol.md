...
| ------------- | ------------- |
| X-InternalError:  | Ten nagłówek będzie zawierać kod błędu, który obejmuje drzwi przed przetworzeniem żądania. Ten błąd wskazuje, że problem jest wewnętrzny dla usługi/infrastruktury czołowej. Zgłoś problem do obsługi.  |
...
## <a name="backend-to-front-door"></a>Zaplecze do przednich drzwi
