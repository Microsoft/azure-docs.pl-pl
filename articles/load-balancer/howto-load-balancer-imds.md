...
```
> [!NOTE]
> Parametr-noproxy został wprowadzony w programie PowerShell 6,0. Jeśli używasz starszej wersji programu PowerShell, Usuń parametr-noproxy w treści żądania i upewnij się, że nie używasz serwera proxy podczas pobierania informacji o IMDS. Dowiedz się więcej [tutaj](../virtual-machines/windows/instance-metadata-service.md?tabs=windows#proxies).
> 
