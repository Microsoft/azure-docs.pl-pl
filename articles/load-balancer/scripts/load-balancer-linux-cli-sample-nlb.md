---
title: Równoważenie obciążenia ruchem do maszyn wirtualnych w celu wysokiej wysokiej jakości — interfejs wiersza polecenia platformy Azure — Azure Load Balancer
