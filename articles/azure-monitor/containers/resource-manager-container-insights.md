...
## <a name="enable-for-new-azure-red-hat-openshift-v3-cluster"></a>Włącz dla nowego klastra usługi Azure Red Hat OpenShift v3
...
## <a name="enable-for-existing-azure-red-hat-openshift-v3-cluster"></a>Włącz dla istniejącego klastra usługi Azure Red Hat OpenShift v3
