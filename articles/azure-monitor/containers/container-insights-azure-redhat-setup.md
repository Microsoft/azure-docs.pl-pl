...
Usługa Container Insights obsługuje monitorowanie usługi Azure Red Hat OpenShift zgodnie z opisem w artykule dotyczącym [przeglądu](container-insights-overview.md) , z wyjątkiem następujących funkcji:
