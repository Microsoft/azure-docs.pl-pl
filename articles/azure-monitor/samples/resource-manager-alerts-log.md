...
## <a name="number-of-results-alert-rule"></a>Reguła alertu o liczbie wyników
Poniższy przykład tworzy [regułę alertu z liczbą wyników](../platform/alerts-unified-log.md#metric-measurement-alert-rules).
...
## <a name="metric-measurement-alert"></a>Alert dotyczący pomiaru metryki
Poniższy przykład tworzy [regułę alertu pomiaru metryki](../platform/alerts-unified-log.md#metric-measurement-alert-rules).
