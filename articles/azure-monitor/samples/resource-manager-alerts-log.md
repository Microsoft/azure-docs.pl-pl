...
ms.author: bwren
ms.date: 09/22/2020
ms.openlocfilehash: 74885156b3afe72f505dc45161b1f01dc6789875
ms.sourcegitcommit: 5a999764e98bd71653ad12918c09def7ecd92cf6
ms.translationtype: MT
ms.contentlocale: pl-PL
ms.lasthandoff: 02/16/2021
ms.locfileid: "100546095"
---
...
## <a name="number-of-results-template-up-to-version-2018-04-16"></a>Liczba szablonów wyników (do wersji 2018-04-16)
Poniższy przykład tworzy [regułę alertu z liczbą wyników](../platform/alerts-unified-log.md#count-of-the-results-table-rows).

### <a name="notes"></a>Uwagi

- Ten przykład zawiera [ładunek elementu webhook](../platform/alerts-log-webhook.md). Jeśli reguła alertu nie powinna wyzwalać elementu webhook, Usuń element **customWebhookPayload** .
...
## <a name="metric-measurement-template-up-to-version-2018-04-16"></a>Szablon pomiaru metryki (do wersji 2018-04-16)
Poniższy przykład tworzy [regułę alertu pomiaru metryki](../platform/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value).
...
## <a name="template-for-all-resource-types-from-version-2020-05-01-preview"></a>Szablon wszystkich typów zasobów (z wersji 2020-05-01-Preview)
Poniższy przykład tworzy regułę, która może być docelowa dla dowolnego zasobu.
...
* [Dowiedz się więcej o regułach alertów](../platform/alerts-overview.md).
