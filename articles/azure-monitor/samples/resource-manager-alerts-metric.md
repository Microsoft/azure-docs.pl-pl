...
W tym artykule przedstawiono przykłady użycia [szablonów Azure Resource Manager](../../azure-resource-manager/templates/template-syntax.md) do konfigurowania [reguł alertów dotyczących metryk](../platform/alerts-metric-near-real-time.md) w programie Azure monitor. Każdy przykład zawiera plik szablonu i plik parametrów z przykładowymi wartościami do udostępnienia szablonowi.
