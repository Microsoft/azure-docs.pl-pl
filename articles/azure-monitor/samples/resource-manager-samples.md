...
Na przykład użyj następujących poleceń, aby wdrożyć plik szablonu i parametrów do subskrypcji przy użyciu programu PowerShell lub interfejsu wiersza polecenia platformy Azure.
