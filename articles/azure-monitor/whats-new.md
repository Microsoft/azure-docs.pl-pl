...
- [Monitorowanie aplikacji Java w dowolnym środowisku](./app/java-in-process-agent.md) — nowy artykuł
...
- [Usuwanie Application Insights w programie Visual Studio](./app/remove-application-insights.md) — nowy artykuł
...
- [Konfigurowanie usługi Azure Red Hat OpenShift v4. x z Azure monitor for Containers](./insights/container-insights-azure-redhat4-setup.md) — nowy artykuł
...
- [Jak zatrzymać monitorowanie klastra Red Hat OpenShift v3 na platformie Azure](./insights/container-insights-optout-openshift-v3.md) — nowy artykuł
- [Jak zatrzymać monitorowanie hybrydowego klastra Kubernetes](./insights/container-insights-optout-hybrid.md) — nowy artykuł
...
- [Alerty z Azure monitor dla maszyn wirtualnych](./insights/vminsights-alerts.md) — nowy artykuł
