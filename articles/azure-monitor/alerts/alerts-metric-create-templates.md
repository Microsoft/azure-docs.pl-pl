---
title: Tworzenie nowszego alertu metryki za pomocą szablonu Azure Resource Manager
...
Informacje o schemacie i właściwościach reguły alertu [są dostępne tutaj](/rest/api/monitor/metricalerts/createorupdate).
