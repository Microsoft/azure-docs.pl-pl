...
Poniższy przykład tworzy [regułę alertu z liczbą wyników](../alerts/alerts-unified-log.md#count-of-the-results-table-rows).

### <a name="notes"></a>Uwagi

- Ten przykład zawiera [ładunek elementu webhook](../alerts/alerts-log-webhook.md). Jeśli reguła alertu nie powinna wyzwalać elementu webhook, Usuń element **customWebhookPayload** .
...
Poniższy przykład tworzy [regułę alertu pomiaru metryki](../alerts/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value).
...
* [Dowiedz się więcej o regułach alertów](./alerts-overview.md).