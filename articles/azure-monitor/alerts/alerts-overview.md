...
Można zmienić subskrypcje lub parametry filtru, aby zaktualizować stronę.
...
W celu uzyskania [odpowiednich pól można](../alerts/alerts-common-schema-definitions.md#essentials) wysyłać zapytania do alertów.
