...
Poniższy przykład dodaje kolekcję [zdarzeń systemu Windows](../agents/data-sources-windows-events.md) do istniejącego obszaru roboczego.
...
Poniższy przykład dodaje kolekcję [zdarzeń dziennika](../agents/data-sources-syslog.md) systemowego do istniejącego obszaru roboczego.
...
Poniższy przykład dodaje kolekcję [liczników wydajności systemu Windows](../agents/data-sources-performance-counters.md) do istniejącego obszaru roboczego.
...
Poniższy przykład dodaje kolekcję [liczników wydajności systemu Linux](../agents/data-sources-performance-counters.md) do istniejącego obszaru roboczego.
...
Poniższy przykład dodaje kolekcję [niestandardowych dzienników](../agents/data-sources-custom-logs.md) do istniejącego obszaru roboczego.
...
Poniższy przykład umożliwia dodanie kolekcji [dzienników usług IIS](../agents/data-sources-iis-logs.md) do istniejącego obszaru roboczego.
