...
- **[Klucze zarządzane przez klienta](../logs/customer-managed-keys.md)** — Szyfruj dane klastra przy użyciu kluczy dostarczanych i kontrolowanych przez klienta.
- **[Skrytka](../logs/customer-managed-keys.md#customer-lockbox-preview)** — klienci mogą kontrolować żądania dostępu inżynierów pomocy technicznej firmy Microsoft dotyczące danych.
...
- Komunikaty o błędach
  ...
  -  400 — KeyVaultProperties nie jest pusty, ale ma zły format. Zobacz [aktualizacja identyfikatora klucza](../logs/customer-managed-keys.md#update-cluster-with-key-identifier-details).
  -  400 — nie można zweryfikować klucza w Key Vault. Może być spowodowany brakiem uprawnień lub gdy klucz nie istnieje. Upewnij się, że [ustawisz Zasady kluczy i dostępu](../logs/customer-managed-keys.md#grant-key-vault-permissions) w Key Vault.
