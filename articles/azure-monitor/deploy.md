...
Zobacz [Tworzenie grup akcji i zarządzanie nimi w Azure Portal,](platform/action-groups.md) Aby uzyskać szczegółowe informacje na temat tworzenia grupy akcji oraz opis różnych akcji, które może uwzględnić.
