...
* Dowiedz się więcej o [metrykach opartych na dzienniku i wstępnie agregowanych](https://docs.microsoft.com/azure/azure-monitor/app/pre-aggregated-metrics-log-metrics).
* [Zapytania i definicje metryk opartych na dziennikach](https://docs.microsoft.com/azure/azure-monitor/platform/app-insights-metrics).