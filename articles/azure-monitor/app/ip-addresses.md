...
> [!NOTE]
> Te adresy są wymienione w notacji CIDR (Classless Inter-Domain Routing). Oznacza to, że wpis podobny `51.144.56.112/28` do 16 adresów IP rozpoczyna się od `51.144.56.112` i kończy się `51.144.56.127`na.
