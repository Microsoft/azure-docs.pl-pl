...
Można wysyłać zapytania do listy adresów IP używanych przez grupy akcji za pomocą [polecenia programu PowerShell Get-AzNetworkServiceTag](https://docs.microsoft.com/powershell/module/az.network/Get-AzNetworkServiceTag).
