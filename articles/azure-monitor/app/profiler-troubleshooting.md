...
* Upewnij się, że serwery proxy lub zapora nie zablokowali dostępu do programu https://gateway.azureserviceprofiler.net .
...
1. Ustawienie **zawsze włączone** . **On**
