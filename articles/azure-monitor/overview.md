...
- Skorelowanie problemów z infrastrukturą przy użyciu [Azure monitor dla maszyn wirtualnych](vm/vminsights-overview.md) i [Azure monitor dla kontenerów](containers/container-insights-overview.md).
