...
| Monitorowanie | Opis |
|:---|:---|
| Monitor jednostkowy | Mierzy pewne aspekty zasobu lub aplikacji. Może to spowodować sprawdzenie licznika wydajności w celu określenia wydajności zasobu lub jego dostępności. |
| Monitor zagregowany | Grupuje wiele monitorów, aby zapewnić pojedynczy zagregowany stan kondycji. Monitor zagregowany może zawierać co najmniej jeden monitor jednostkowy i inne monitory zagregowane. |
...
| Monitorowanie | Enabled (Włączony) | Generowanie alertów | Ostrzeżenie | Krytyczne | Częstotliwość oceny | Lookback | Typ oceny | Minimalny przykład | Maksymalna liczba próbek |
|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|
...
Poniższa zasada zbierania danych przykładowych przedstawia przykład przesłonięcia konfigurowania monitorowania.
...
- Przeczytaj więcej na temat [reguł zbierania danych](../platform/data-collection-rule-overview.md).