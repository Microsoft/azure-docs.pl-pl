...
ms.locfileid: "84803941"
---
# <a name="format-of-azure-monitor-resource-logs-archived-to-a-storage-account"></a>Format dzienników zasobów Azure Monitor archiwizowanych na koncie magazynu

> [!NOTE]
> W przypadku wysyłania [dzienników zasobów zasobów platformy Azure lub metryk do konta magazynu przy użyciu ustawień diagnostycznych zasobów](./../../azure-monitor/platform/archive-diagnostic-logs.md) lub [dzienników aktywności do konta magazynu przy użyciu profilów dzienników](./../../azure-monitor/platform/archive-activity-log.md), format danych w ramach konta magazynu został zmieniony na linie JSON na lis. 1, 2018. Poniższe instrukcje opisują wpływ i sposobu aktualizowania narzędzi do obsługi nowego formatu. 
>
> 
...
* Format obiektu BLOB zmienia się dla wszystkich ustawień diagnostycznych jednocześnie w ramach wszystkich subskrypcji. Pierwszy PT1H.jsw pliku wyemitowanym przez 1 listopada będzie używać tego nowego formatu. Nazwy obiektów blob i kontenerów pozostają takie same.
