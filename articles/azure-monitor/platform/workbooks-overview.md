...
* [Schematy](workbooks-chart-visualizations.md)
...
Kliknięcie innych przycisków **edycji** po prawej stronie spowoduje wyświetlenie wielu podstawowych składników, które składają się na skoroszyty, takie jak [pola tekstowe](workbooks-text-visualizations.md)oparte na promocji, [elementy interfejsu użytkownika](workbooks-parameters.md) i inne [typy wykresów/wizualizacji](#visualizations). 
