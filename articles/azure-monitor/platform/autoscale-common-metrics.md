...
- [Metryki hosta dla maszyn wirtualnych z systemem Windows i Linux opartych na Menedżer zasobów](./metrics-supported.md#microsoftcomputevirtualmachines)
- [Metryki hostów dla systemów Windows i Linux opartych na Menedżer zasobówach VM Scale Sets](./metrics-supported.md#microsoftcomputevirtualmachinescalesets)
