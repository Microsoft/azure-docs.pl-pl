...
Więcej przykładów przypisań ról za pomocą tego polecenia można znaleźć w [dokumentacji **AZ DT Create** Reference](/cli/azure/ext/azure-iot/dt?view=azure-cli-latest&preserve-view=true#ext_azure_iot_az_dt_create).
