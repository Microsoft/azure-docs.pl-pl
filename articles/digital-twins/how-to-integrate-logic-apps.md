...
Usługa Azure Digital bliźniaczych reprezentacji nie ma obecnie certyfikowanego (wstępnie utworzonego) łącznika dla Logic Apps. Zamiast tego bieżący proces używania Logic Apps z usługą Azure Digital bliźniaczych reprezentacji polega na utworzeniu [**niestandardowego łącznika Logic Apps**](../logic-apps/custom-connector-overview.md)przy użyciu [niestandardowego pliku struktury Swagger usługi Azure Digital bliźniaczych reprezentacji](https://github.com/Azure-Samples/digital-twins-custom-swaggers/blob/main/LogicApps/preview/2020-05-31-preview/digitaltwins.json) , który został zmodyfikowany w celu współdziałania z programem Logic Apps.
...
Najpierw pobierz niestandardową strukturę Swagger usługi Azure Digital bliźniaczych reprezentacji, która została zmodyfikowana w celu współpracy z Logic Apps. Pobierz *digitaltwins.js* z [tego linku](https://github.com/Azure-Samples/digital-twins-custom-swaggers/blob/main/LogicApps/preview/2020-05-31-preview/digitaltwins.json).

Następnie na stronie Przegląd łącznika w Azure Portal kliknij przycisk *Edytuj*.
...
* **Łączniki niestandardowe**
    ...
    - Plik: będzie to plik niestandardowego pliku struktury Swagger pobrany wcześniej. Kliknij przycisk *Importuj*, Znajdź plik na maszynie i kliknij przycisk *Otwórz*.
* **Informacje ogólne**
    - Ikona, kolor tła ikony, opis: Wypełnij wszystkie wartości, które chcesz.
