---
title: Konwertowanie modeli zgodnych ze standardami branżowymi
...
| Miasta inteligentne | [ETSI NGSI-LD](https://www.etsi.org/deliver/etsi_gr/CIM/001_099/008/01.01.01_60/gr_CIM008v010101p.pdf)<br>[Dokumentacja inteligentnych aplikacji (SAREF)](https://saref.etsi.org/)<br>[Fiware](https://www.fiware.org/)<br>[Otwarte & Agile — inteligentne miasta (OASC)](https://oascities.org/) |
| Siatka energii | [Model CIM](https://cimug.ucaiug.org/) / [IEC 61968](https://en.wikipedia.org/wiki/IEC_61968)<br>[Modele ADRM](http://www.adrm.com/) dla produktów energetycznych i handlowych |
| Motoryzacja | [Specyfikacja sygnału pojazdu](https://github.com/GENIVI/vehicle_signal_specification/tree/master/spec) |
