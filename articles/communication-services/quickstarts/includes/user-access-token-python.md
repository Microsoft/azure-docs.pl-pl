...
Mimo że w katalogu aplikacji, Zainstaluj zestaw SDK tożsamości usług Azure Communication Services dla języka Python za pomocą `pip install` polecenia.
