---
title: Dokumentacja referencyjna dotycząca usługi Azure Communications Services
titleSuffix: An Azure Communication Services concept document
description: Zapoznaj się z dokumentacją dotyczącą usług komunikacyjnych.
author: mikben
manager: jken
...
ms.locfileid: "103495729"
---
# <a name="reference-documentation-overview"></a>Przegląd dokumentacji referencyjnej

[!INCLUDE [Public Preview Notice](../includes/public-preview-include.md)]


W poniższej tabeli przedstawiono szczegółowe informacje o dostępnych pakietach usług komunikacyjnych wraz z odpowiednią dokumentacją referencyjną:
...
| Rozmów        | [npm](https://www.npmjs.com/package/@azure/communication-calling)         | -      | -      | -     | [GitHub](https://github.com/Azure/Communication/releases) ([docs](/objectivec/communication-services/calling/))     | [Maven](https://search.maven.org/artifact/com.azure.android/azure-communication-calling/)            | -                              |
