...
Na potrzeby tego przykładu zostanie podpisywany wniosek o utworzenie nowej tożsamości przy użyciu interfejsu API uwierzytelniania usług komunikacyjnych (wersja `2020-07-20-preview2` )
