...
1. Aby sprawdzić pomyślne uwierzytelnianie Kerberos, użyj `klist` polecenia. W przeciwnym razie użyj `kinit` do uruchomienia uwierzytelniania Kerberos.
