...
:::image type="content" source="./media/apache-storm-develop-java-topology/word-count-topology1.png" alt-text="Diagram przedstawiający układ elementy Spout i piorunów" border="false":::
