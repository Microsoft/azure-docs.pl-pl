...
Fragmenty kodu dla tej dodatkowej funkcji zestawu SDK można znaleźć w dokumentacji usługi [HDINSIGHT SDK dla języka Python](https://docs.microsoft.com/python/api/overview/azure/hdinsight).
