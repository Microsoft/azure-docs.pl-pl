...
|[Zestaw SDK dla języka Python](https://docs.microsoft.com/python/api/overview/azure/hdinsight)||||X|
|[Zestaw SDK Java](https://docs.microsoft.com/java/api/overview/azure/hdinsight)||||X|
