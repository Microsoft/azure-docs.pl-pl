...
| Opcja | Dokumenty |
|---|---|
| Zestaw Azure Toolkit for IntelliJ | [Błąd debugowania zadań platformy Spark z użyciem Azure Toolkit for IntelliJ (wersja zapoznawcza)](apache-spark-intellij-tool-failure-debug.md) |
