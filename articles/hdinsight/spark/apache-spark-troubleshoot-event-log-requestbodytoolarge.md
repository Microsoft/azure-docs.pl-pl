...
* Zwiększ rozmiar bloku do 100 MB. W interfejsie użytkownika Ambari Zmodyfikuj właściwość `fs.azure.write.request.size` konfiguracji systemu plików HDFS (lub `Custom core-site` utwórz ją w sekcji). Ustaw właściwość na większą wartość, na przykład: 33554432. Zapisz zaktualizowaną konfigurację i ponownie uruchom składniki.
