...
* [Klasa AzureSession języka C#](https://docs.microsoft.com/dotnet/api/microsoft.azure.remoterendering.azuresession)
...
* [Klasa C++ AzureSession](https://docs.microsoft.com/cpp/api/remote-rendering/azuresession)
