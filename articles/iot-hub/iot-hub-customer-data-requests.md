...
Pełna Dokumentacja interfejsów API usługi Azure IoT Hub Service znajduje się w [interfejsie API usługi IoT Hub Service](https://docs.microsoft.com/rest/api/iothub/service/configuration).
