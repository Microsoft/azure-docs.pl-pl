...
Jeśli jeszcze tego nie zrobiono, Pobierz przykłady w języku C# usługi Azure https://github.com/Azure-Samples/azure-iot-samples-csharp/archive/master.zip IoT z programu i Wyodrębnij archiwum zip.
