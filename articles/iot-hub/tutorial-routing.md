...
description: Samouczek — Konfigurowanie routingu komunikatów dla platformy Azure IoT Hub przy użyciu interfejsu wiersza polecenia platformy Azure i Azure Portal
author: robinsh
manager: philmea
ms.service: iot-hub
services: iot-hub
