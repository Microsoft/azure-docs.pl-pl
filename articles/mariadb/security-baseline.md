...
description: Linia bazowa zabezpieczeń Azure Database for MariaDB zawiera wskazówki i zasoby dotyczące procedur związanych z wdrażaniem zaleceń dotyczących zabezpieczeń określonych w teście zabezpieczeń platformy Azure.
author: msmbaldwin
ms.service: mariadb
ms.topic: conceptual
ms.date: 03/29/2021
...
Ta linia bazowa zabezpieczeń stosuje wskazówki z programu [Azure Security test w wersji 1,0](../security/benchmarks/overview-v1.md) do Azure Database for MariaDB. Test porównawczy zabezpieczeń platformy Azure zawiera zalecenia dotyczące sposobu zabezpieczania rozwiązań w chmurze na platformie Azure. Zawartość jest pogrupowana według **kontroli zabezpieczeń** zdefiniowanych przez program Azure Security test i powiązane wskazówki dotyczące Azure Database for MariaDB. Nie zostały wykluczone żadne **kontrolki** , które mają zastosowanie do Azure Database for MariaDB lub dla których odpowiedzialnością jest firma Microsoft.

Aby dowiedzieć się, jak Azure Database for MariaDB całkowicie mapować do testu porównawczego zabezpieczeń platformy Azure, zobacz [pełny Azure Database for MariaDB pliku mapowania linii bazowej zabezpieczeń](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Offer%20Security%20Baselines).
...
- [Jak skonfigurować link prywatny dla Azure Database for MariaDB](howto-configure-privatelink-portal.md)

- [Tworzenie punktów końcowych usługi sieci wirtualnej i reguł sieci wirtualnej w programie Azure Database for MariaDB Server oraz zarządzanie nimi](howto-manage-vnet-portal.md)

- [Jak skonfigurować reguły zapory Azure Database for MariaDB](concepts-firewall-rules.md)
...
**Azure Policy wbudowane definicje — Microsoft. DBforMariaDB**:
...
- [Jak skonfigurować zaawansowaną ochronę przed zagrożeniami dla Azure Database for MariaDB](howto-database-threat-protection-portal.md)
...
Azure Database for MariaDB używa znacznika usługi "Microsoft. SQL".

- [Aby uzyskać więcej informacji na temat używania tagów usługi](../virtual-network/service-tags-overview.md)

- [Opis użycia tagu usługi dla Azure Database for MariaDB](https://docs.microsoft.com/azure/mariadb/concepts-data-access-security-vnet#terminology-and-description)
...
- [Przykłady Azure Policy dla sieci](../governance/policy/samples/built-in-policies.md)
...
- [Jak skonfigurować i uzyskać dostęp do dzienników serwera dla Azure Database for MariaDB](concepts-server-logs.md)

- [Jak skonfigurować i uzyskać dostęp do dzienników inspekcji dla Azure Database for MariaDB](howto-configure-audit-logs-portal.md)
...
- [Jak skonfigurować ustawienia diagnostyczne dziennika aktywności platformy Azure](/azure/azure-monitor/platform/diagnostic-settings-legacy)
...
- [Jak włączyć zaawansowaną ochronę przed zagrożeniami dla MariaDB](howto-database-threat-protection-portal.md)

- [Jak skonfigurować i uzyskać dostęp do dzienników serwera dla MariDB](concepts-server-logs.md)

- [Jak skonfigurować i uzyskać dostęp do dzienników inspekcji dla MariaDB](howto-configure-audit-logs-portal.md)
...
- [Informacje o rolach wbudowanych platformy Azure dla subskrypcji platformy Azure](../role-based-access-control/built-in-roles.md)
...
- [Jak utworzyć dodatkowe konta dla MariaDB](howto-create-users.md)
...
- [Informacje o interfejsie API REST Azure Database for MariaDB](/rest/api/mariadb/)
...
Ponadto można użyć usługi Azure Active Directory (Azure AD) Privileged Identity Management (PIM) do generowania dzienników i alertów w przypadku wystąpienia podejrzanych lub niebezpiecznych działań w środowisku. Użyj funkcji wykrywania ryzyka usługi Azure AD, aby wyświetlać alerty i raporty na temat ryzykownego zachowania użytkowników.

- [Jak skonfigurować zaawansowaną ochronę przed zagrożeniami dla MariaDB](howto-database-threat-protection-portal.md)
...
- [Jak zaktualizować hasło administratora dla usługi MariaDB](https://docs.microsoft.com/azure/mariadb/howto-create-manage-server-portal#update-admin-password)
...
**Wskazówki**: Zapoznaj się z dziennikami usługi Azure Active Directory (Azure AD), aby ułatwić odnajdywanie starych kont, które mogą obejmować role administracyjne MariaDB. Ponadto za pomocą przeglądów dostępu do tożsamości platformy Azure można efektywnie zarządzać członkostwem w grupach, uzyskiwać dostęp do aplikacji firmowych, które mogą być używane do uzyskiwania dostępu do MariaDB i przypisań ról. Dostęp użytkowników powinien być regularnie przeglądany, na przykład co 90 dni, aby upewnić się, że tylko Ci użytkownicy mają stały dostęp.
...
**Wskazówki**: Włączanie ustawień diagnostycznych dla MariaDB i Azure Active Directory (Azure AD), wysyłanie wszystkich dzienników do log Analytics obszaru roboczego. Skonfiguruj żądane alerty (takie jak nieudane próby uwierzytelniania) w obszarze roboczym Log Analytics.

- [Jak skonfigurować i uzyskać dostęp do dzienników serwera dla MariaDB](concepts-server-logs.md)
...
- [Jak skonfigurować link prywatny dla Azure Database for MariaDB](concepts-data-access-security-private-link.md)

- [Jak skonfigurować punkty końcowe usługi dla Azure Database for MariaDB](howto-manage-vnet-portal.md)

- [Jak skonfigurować reguły zapory dla Azure Database for MariaDB](concepts-firewall-rules.md)
...
- [Jak wyeliminować eksfiltracji danych dla Azure Database for MariaDB](concepts-data-access-security-private-link.md)
...
- [Jak skonfigurować szyfrowanie podczas przesyłania dla MariaDB](howto-configure-ssl.md)
...
**Wskazówki**: Użyj kontroli dostępu opartej na rolach (Azure RBAC) na platformie Azure, aby zarządzać dostępem do usługi Azure Database dla płaszczyzny zarządzania MariaDB (Azure Portal/Azure Resource Manager). Aby uzyskać dostęp do płaszczyzny danych (w samej bazie danych), należy użyć zapytań SQL do tworzenia użytkowników i konfigurowania uprawnień użytkownika.

- [Jak skonfigurować usługę Azure RBAC](../role-based-access-control/role-assignments-portal.md)

- [Jak skonfigurować dostęp użytkowników przy użyciu programu SQL dla MariaDB](howto-create-users.md)
...
**Wskazówki**: serwer Azure Database for MariaDB obecnie nie obsługuje uwierzytelniania Azure Active Directory (Azure AD) w celu uzyskania dostępu do baz danych. Podczas tworzenia serwera Azure Database for MariaDB podajesz poświadczenia dla użytkownika administratora. Ten administrator może służyć do tworzenia dodatkowych użytkowników MariaDB.

W przypadku usługi Azure Virtual Machines lub aplikacji sieci Web działających na Azure App Service używanym do uzyskiwania dostępu do serwera Azure Database for MariaDB Użyj tożsamości zarządzanych w połączeniu z usługą Azure Key Vault do przechowywania i pobierania poświadczeń dla Azure Database for MariaDB serwera. Upewnij się, że Key Vault usuwanie trwałe jest włączone.
...
- [Informacje o kopiach zapasowych dla MariaDB](concepts-backup.md)

- [Opis konfiguracji początkowej MariaDB](tutorial-design-database-using-portal.md)
...
- [Informacje na temat tworzenia kopii zapasowych i przywracania w programie Azure Database for MariaDB](https://docs.microsoft.com/azure/mariadb/concepts-backup#restore)
...
- [Informacje na temat tworzenia kopii zapasowych i przywracania w programie Azure Database for MariaDB](concepts-backup.md)
