...
description: Ten przewodnik Szybki Start przeprowadzi Cię przez proces używania Azure Portal, aby szybko utworzyć przykładowy serwer Azure Database for MySQL w ciągu około pięciu minut.
author: ajlam
ms.author: andrela
ms.service: mysql
ms.custom: mvc
