...
|[Azure Cloud Shell](https://docs.microsoft.com/azure/mysql/quickstart-create-mysql-server-database-using-azure-cli#connect-to-azure-database-for-mysql-server-using-mysql-command-line-client)|W tym artykule pokazano, jak uruchomić **mysql.exe** w programie [Azure Cloud Shell](https://docs.microsoft.com/azure/cloud-shell/overview) , aby nawiązać połączenie z serwerem, a następnie uruchomić instrukcje w celu wykonywania zapytań, wstawiania, aktualizowania i usuwania danych w bazie danych.|
