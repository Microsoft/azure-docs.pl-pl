...
> [!NOTE]
> Dzienniki dostępu do tabel są wyprowadzane wyłącznie dla programu MySQL 5,7.<br>W przypadku programu `sql_text_s` Dziennik zostanie obcięty, jeśli przekracza 2048 znaków.
