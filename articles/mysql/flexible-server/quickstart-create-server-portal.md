...
Tworzysz elastyczny serwer ze zdefiniowanym zestawem [zasobów obliczeniowych i magazynu](./concepts-compute-storage.md). Serwer jest tworzony w ramach [grupy zasobów Azure](https://docs.microsoft.com/azure/azure-resource-manager/management/overview).
