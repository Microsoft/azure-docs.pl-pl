...
>[Tworzenie aplikacji PHP w systemie Linux przy użyciu programu MySQL](../../app-service/containers/tutorial-php-mysql-app.md)<br/>
>[Tworzenie aplikacji sprężynowej opartej na języku Java za pomocą programu MySQL](https://docs.microsoft.com/azure/developer/java/spring-framework/spring-app-service-e2e?tabs=bash)<br/>
