...
Zainstaluj język PHP na własnym serwerze lub utwórz [aplikację internetową](https://docs.microsoft.com/azure/app-service/overview), która zawiera język PHP.  Aby dowiedzieć się, jak utworzyć reguły zapory, zobacz temat [Tworzenie i zarządzanie regułami zapory](./how-to-manage-firewall-portal.md) .
