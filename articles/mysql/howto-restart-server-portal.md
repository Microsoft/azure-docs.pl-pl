...
---
# <a name="restart-azure-database-for-mysql-server-using-azure-portal"></a>Ponowne uruchamianie serwera usługi Azure Database for MySQL za pomocą witryny Azure Portal
