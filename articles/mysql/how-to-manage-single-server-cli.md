...
Możesz łatwo skalować warstwę cenową, zasoby obliczeniowe i magazyn przy użyciu poniższego polecenia. Można wyświetlić wszystkie operacje serwera, które można wykonać [AZ MySQL Server Overview](/cli/azure/mysql/server?view=azure-cli-latest)
