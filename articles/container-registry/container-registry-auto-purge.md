...
* `--concurrency` -Określa, że zadania przeczyszczania x są przetwarzane współbieżnie. Jeśli ten parametr nie zostanie podany, zostanie użyta wartość domyślna.
