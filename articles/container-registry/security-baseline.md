...
- [Zezwalaj na dostęp według tagu usługi](./container-registry-firewall-access-rules.md#allow-access-by-service-tag)
...
- [Konto administratora Azure Container Registry](./container-registry-authentication.md#admin-account)
...
- [Logowanie indywidualne do rejestru kontenerów](./container-registry-authentication.md#admin-account)
...
- [Klucze zarządzane przez klienta w Azure Container Registry](./container-registry-customer-managed-keys.md)
...
- [Integracja usługi Azure Container Registry z usługą Security Center (wersja zapoznawcza)](../security-center/defender-for-container-registries-introduction.md)
...
- [Na przykład Sterowanie wykonywaniem skryptu programu PowerShell w środowiskach systemu Windows](/powershell/module/microsoft.powershell.security/set-executionpolicy?preserve-view=true&view=powershell-7)
...
- [Jak przywrócić klucze Azure Key Vault na platformie Azure](/powershell/module/az.keyvault/restore-azkeyvaultkey?preserve-view=true&view=azps-4.8.0)
