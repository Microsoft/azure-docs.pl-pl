...
Ta strona jest indeksem [Azure Policy](../governance/policy/overview.md) wbudowanych definicji zasad dla Azure Container Registry. Aby uzyskać dodatkowe Azure Policy wbudowane dla innych usług, zobacz [Azure Policy wbudowane definicje](../governance/policy/samples/built-in-policies.md).
...
- Zapoznaj się ze wskazówkami dotyczącymi [przypisywania zasad i przeglądu zgodności](container-registry-azure-policy.md).
