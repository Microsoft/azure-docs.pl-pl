...
Aby uzyskać więcej informacji na temat alertów Azure Monitor, zobacz [Omówienie alertów na platformie Azure](../azure-monitor/alerts/alerts-overview.md).
