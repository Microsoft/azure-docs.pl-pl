...
1. Jeśli w magazynie nie ma więcej elementów, wybierz pozycję **Usuń**.
    ...
    ![Wybierz pozycję Zatrzymaj tworzenie kopii zapasowej w celu usunięcia magazynu](./media/tutorial-backup-vm-at-scale/deleting-the-vault.png)
