---
title: Skrypt programu PowerShell — cofanie usuwania usuniętego udziału plików
...
Ten skrypt ułatwia Cofnięcie usunięcia udziału plików, jeśli został przypadkowo usunięty. Funkcja usuwania nietrwałego zabezpieczeń dla udziałów plików umożliwia anulowanie usuwania udziału plików w okresie przechowywania w 14 dni, co pozwala na odzyskiwanie wszystkich zawartości udziałów plików, migawek i punktów odzyskiwania. Aby dowiedzieć się więcej na temat usuwania nietrwałego, przejdź do tego [linku](../soft-delete-azure-file-share.md).
...
## <a name="how-to-use-the-script-in-different-scenarios"></a>Jak używać skryptu w różnych scenariuszach

### <a name="prerequisites"></a>Wymagania wstępne

1. Przed uruchomieniem skryptu Zainstaluj najnowsze Azure PowerShell AZ modułów z [tego linku](https://docs.microsoft.com//powershell/azure/install-az-ps?view=azps-3.3.0) .
2. Należy pamiętać o następujących szczegółach, jak należy przekazać je jako wartości dla różnych parametrów skryptu:
    ...
    * **-ResourceGroupName** — Grupa zasobów konta magazynu obsługującego udział plików.
    * **-StorageAccountName** — nazwa konta magazynu obsługującego udział plików.
    * **-FileShareName** — nazwa udziału plików, który ma zostać cofnięty usunięcie

### <a name="execution-steps"></a>Kroki wykonywania

1. Zapisz skrypt powyżej na swojej maszynie, podając wybraną nazwę. W tym przykładzie Zapisano go jako *Undelete. ps1*
2. Uruchom skrypt zgodnie z scenariuszem, który odpowiada Twoim wymaganiom.

#### <a name="scenario-1"></a>Scenariusz 1

Nie istnieje wiele usuniętych wersji o tej samej nazwie co udział plików, który próbujesz usunąć.

Poniższy przykład cofa usunięcie *share1* udziału plików znajdującego się na koncie magazynu *afsshare*.
...
Dane wyjściowe powinny wyświetlać komunikat`Completed:Restore File Share`

#### <a name="scenario-2"></a>Scenariusz 2

Istnieje wiele usuniętych wersji o takiej samej nazwie, jak nazwa udziału, który próbujesz usunąć.

Poniższy przykład cofa usunięcie wersji udziału plików *share1*

##### <a name="step-1"></a>Krok 1

Wykonaj skrypt w następujący sposób, podając nazwę udziału plików.
...
Wybierz wersję z danych wyjściowych kroku 1, która ma zostać cofnięta, i przekaż ją jako wartość parametru **-DeletedShareVersion** .

Poniższy przykład cofa usunięcie wersji *01D5D7F77ACC7864* udziału plików *share1* .
