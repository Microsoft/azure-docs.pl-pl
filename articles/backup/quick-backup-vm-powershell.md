...
Aby uruchomić kopię zapasową na żądanie, należy użyć [kopii zapasowej-AzRecoveryServicesBackupItem](/powershell/module/az.recoveryservices/get-azrecoveryservicesbackupitem).
