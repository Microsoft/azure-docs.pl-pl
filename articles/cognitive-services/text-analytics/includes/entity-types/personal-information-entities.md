...
|------------|-------------|--------------------------------------|------------------------|---|
| Person (Osoba)     | Brak         | Nazwy osób.  | `2019-10-01`  | Zwracany także przez `domain=phi` . |
| Persontype | Brak         | Typy zadań lub role przechowywane przez osobę. | `2020-02-01` | |
| PhoneNumber | Brak | Numery telefonów (tylko numery telefonów USA i UE). | `2019-10-01` | Zwrócono również z`domain=phi` |
...
| E-mail | Brak | Adresy e-mail. | `2019-10-01` | Zwracany także przez `domain=phi` .   |
| Adres URL | Brak | Adresy URL do witryn sieci Web. | `2019-10-01` | Zwracany także przez `domain=phi` . |
| Adres IP | Brak | Adresy IP sieci. | `2019-10-01` | |
| DateTime | Brak | Daty i godziny dnia. | `2019-10-01` |  | 
| DateTime | Date | Daty kalendarzowe. | `2019-10-01` | Zwracany także przez `domain=phi` . |
| Liczba | Brak | Liczby i ilości liczbowe. | `2019-10-01` |  |
| Liczba | Wiek | Ważności. | `2019-10-01` | | |
| Międzynarodowa Klasyfikacja Chorób (ICD-10-CM) | Brak | Jednostki odnoszące się do międzynarodowej klasyfikacji chorób, dziewiątej poprawki.   | `2020-04-01` | |
| Międzynarodowa Klasyfikacja Chorób (ICD-10-CM) | Brak | Jednostki odnoszące się do międzynarodowej klasyfikacji chorób, dziesiątej poprawki.    | `2020-04-01` | |
