...
Możesz również użyć operacji Analizuj, aby wykryć dane OSOBowe, rozpoznać połączone jednostki i wyodrębnianie kluczowych fraz. Zobacz [przykład analizy](https://github.com/Azure/azure-sdk-for-net/blob/master/sdk/textanalytics/Azure.AI.TextAnalytics/samples/Sample_AnalyzeOperation.md) w witrynie GitHub.
