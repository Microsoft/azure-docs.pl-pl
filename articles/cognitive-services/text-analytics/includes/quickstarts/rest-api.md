...
ms.locfileid: "102444285"
---
# <a name="version-31-preview"></a>[Wersja 3,1 Preview](#tab/version-3-1)

[Dokumentacja referencyjna v 3.1](https://westus2.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-1-preview-3/)
...
> [!NOTE]
> Poniższy przykład obejmuje żądanie funkcji wyszukiwania opinii analiza tonacji przy użyciu `opinionMining=true` parametru, który zawiera szczegółowe informacje o opiniach związanych z aspektami (takimi jak atrybuty produktów lub usług) w tekście.
