...
Aby skorzystać z samouczka, potrzebny jest klucz subskrypcji interfejsu API sprawdzania pisowni Bing. Jeśli go nie masz, będziesz potrzebować:
...
Utwórz formularz HTML z polem tekstowym. Obsłuż `onsubmit` zdarzenie i wywołaj funkcję bingSpellCheck, przekazując zawartość pola tekstowego i klucz interfejsu API sprawdzanie pisowni Bing.
