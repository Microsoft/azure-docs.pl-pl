...
> [!TIP]
> W przypadku [`docker pull`](https://docs.docker.com/engine/reference/commandline/pull/)korzystania z programu należy zwrócić uwagę na wielkość liter w rejestrze kontenerów, repozytorium, nazwę obrazu kontenera i odpowiedni tag — w miarę **uwzględniania wielkości**liter.

## <a name="anomaly-detector"></a>Narzędzie do wykrywania anomalii

Obraz kontenera [wykrywania anomalii][ad-containers] znajduje się w rejestrze `containerpreview.azurecr.io` kontenerów. Znajduje się w `microsoft` repozytorium i ma nazwę `cognitive-services-anomaly-detector`. W pełni kwalifikowana nazwa obrazu kontenera to, `containerpreview.azurecr.io/microsoft/cognitive-services-anomaly-detector`.
...
Obraz kontenera [Przetwarzanie obrazów][cv-containers] można znaleźć w rejestrze `containerpreview.azurecr.io` kontenerów. Znajduje się w `microsoft` repozytorium i ma nazwę `cognitive-services-read`. W pełni kwalifikowana nazwa obrazu kontenera to, `containerpreview.azurecr.io/microsoft/cognitive-services-read`.
...
Obraz kontenera [kroju][fa-containers] można znaleźć w rejestrze `containerpreview.azurecr.io` kontenerów. Znajduje się w `microsoft` repozytorium i ma nazwę `cognitive-services-face`. W pełni kwalifikowana nazwa obrazu kontenera to, `containerpreview.azurecr.io/microsoft/cognitive-services-face`.
...
Obraz kontenera [aparatu rozpoznawania formularzy][fr-containers] można znaleźć w rejestrze `containerpreview.azurecr.io` kontenerów. Znajduje się w `microsoft` repozytorium i ma nazwę `cognitive-services-form-recognizer`. W pełni kwalifikowana nazwa obrazu kontenera to, `containerpreview.azurecr.io/microsoft/cognitive-services-form-recognizer`.
...
Obraz kontenera [Custom Speech-to-Text][sp-cstt] można znaleźć w rejestrze `containerpreview.azurecr.io` kontenerów. Znajduje się w `microsoft` repozytorium i ma nazwę `cognitive-services-custom-speech-to-text`. W pełni kwalifikowana nazwa obrazu kontenera to, `containerpreview.azurecr.io/microsoft/cognitive-services-custom-speech-to-text`.
...
Niestandardowy obraz kontenera [zamiany tekstu na mowę][sp-ctts] można znaleźć w rejestrze `containerpreview.azurecr.io` kontenerów. Znajduje się w `microsoft` repozytorium i ma nazwę `cognitive-services-custom-text-to-speech`. W pełni kwalifikowana nazwa obrazu kontenera to, `containerpreview.azurecr.io/microsoft/cognitive-services-custom-text-to-speech`.
...
Obraz kontenera [zamiany mowy na tekst][sp-stt] można znaleźć w rejestrze `containerpreview.azurecr.io` kontenerów. Znajduje się w `microsoft` repozytorium i ma nazwę `cognitive-services-speech-to-text`. W pełni kwalifikowana nazwa obrazu kontenera to, `containerpreview.azurecr.io/microsoft/cognitive-services-speech-to-text`.
...
Obraz kontenera [zamiany tekstu na mowę][sp-tts] można znaleźć w rejestrze `containerpreview.azurecr.io` kontenerów. Znajduje się w `microsoft` repozytorium i ma nazwę `cognitive-services-text-to-speech`. W pełni kwalifikowana nazwa obrazu kontenera to, `containerpreview.azurecr.io/microsoft/cognitive-services-text-to-speech`.

Ten obraz kontenera ma dostępne następujące znaczniki:

| Tagi obrazu                                  | Uwagi                                                                      |
|---------------------------------------------|:---------------------------------------------------------------------------|
| `latest`                                    | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-JessaRUS` i głosem.        |
| `1.3.0-amd64-ar-eg-hoda-preview`            | Obraz kontenera z `ar-EG` ustawieniami regionalnymi `ar-EG-Hoda` i głosem.            |
| `1.3.0-amd64-ar-sa-naayf-preview`           | Obraz kontenera z `ar-SA` ustawieniami regionalnymi `ar-SA-Naayf` i głosem.           |
| `1.3.0-amd64-bg-bg-ivan-preview`            | Obraz kontenera z `bg-BG` ustawieniami regionalnymi `bg-BG-Ivan` i głosem.            |
| `1.3.0-amd64-ca-es-herenarus-preview`       | Obraz kontenera z `ca-ES` ustawieniami regionalnymi `ca-ES-HerenaRUS` i głosem.       |
| `1.3.0-amd64-cs-cz-jakub-preview`           | Obraz kontenera z `cs-CZ` ustawieniami regionalnymi `cs-CZ-Jakub` i głosem.           |
| `1.3.0-amd64-da-dk-hellerus-preview`        | Obraz kontenera z `da-DK` ustawieniami regionalnymi `da-DK-HelleRUS` i głosem.        |
| `1.3.0-amd64-de-at-michael-preview`         | Obraz kontenera z `de-AT` ustawieniami regionalnymi `de-AT-Michael` i głosem.         |
| `1.3.0-amd64-de-ch-karsten-preview`         | Obraz kontenera z `de-CH` ustawieniami regionalnymi `de-CH-Karsten` i głosem.         |
| `1.3.0-amd64-de-de-hedda-preview`           | Obraz kontenera z `de-DE` ustawieniami regionalnymi `de-DE-Hedda` i głosem.           |
| `1.3.0-amd64-de-de-heddarus-preview`        | Obraz kontenera z `de-DE` ustawieniami regionalnymi `de-DE-Hedda` i głosem.           |
| `1.3.0-amd64-de-de-heddarus-preview`        | Obraz kontenera z `de-DE` ustawieniami regionalnymi `de-DE-HeddaRUS` i głosem.        |
| `1.3.0-amd64-de-de-stefan-apollo-preview`   | Obraz kontenera z `de-DE` ustawieniami regionalnymi `de-DE-Stefan-Apollo` i głosem.   |
| `1.3.0-amd64-el-gr-stefanos-preview`        | Obraz kontenera z `el-GR` ustawieniami regionalnymi `el-GR-Stefanos` i głosem.        |
| `1.3.0-amd64-en-au-catherine-preview`       | Obraz kontenera z `en-AU` ustawieniami regionalnymi `en-AU-Catherine` i głosem.       |
| `1.3.0-amd64-en-au-hayleyrus-preview`       | Obraz kontenera z `en-AU` ustawieniami regionalnymi `en-AU-HayleyRUS` i głosem.       |
| `1.3.0-amd64-en-ca-heatherrus-preview`      | Obraz kontenera z `en-CA` ustawieniami regionalnymi `en-CA-HeatherRUS` i głosem.      |
| `1.3.0-amd64-en-ca-linda-preview`           | Obraz kontenera z `en-CA` ustawieniami regionalnymi `en-CA-Linda` i głosem.           |
| `1.3.0-amd64-en-gb-george-apollo-preview`   | Obraz kontenera z `en-GB` ustawieniami regionalnymi `en-GB-George-Apollo` i głosem.   |
| `1.3.0-amd64-en-gb-hazelrus-preview`        | Obraz kontenera z `en-GB` ustawieniami regionalnymi `en-GB-HazelRUS` i głosem.        |
| `1.3.0-amd64-en-gb-susan-apollo-preview`    | Obraz kontenera z `en-GB` ustawieniami regionalnymi `en-GB-Susan-Apollo` i głosem.    |
| `1.3.0-amd64-en-ie-sean-preview`            | Obraz kontenera z `en-IE` ustawieniami regionalnymi `en-IE-Sean` i głosem.            |
| `1.3.0-amd64-en-in-heera-apollo-preview`    | Obraz kontenera z `en-IN` ustawieniami regionalnymi `en-IN-Heera-Apollo` i głosem.    |
| `1.3.0-amd64-en-in-priyarus-preview`        | Obraz kontenera z `en-IN` ustawieniami regionalnymi `en-IN-PriyaRUS` i głosem.        |
| `1.3.0-amd64-en-in-ravi-apollo-preview`     | Obraz kontenera z `en-IN` ustawieniami regionalnymi `en-IN-Ravi-Apollo` i głosem.     |
| `1.3.0-amd64-en-us-benjaminrus-preview`     | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-BenjaminRUS` i głosem.     |
| `1.3.0-amd64-en-us-guy24krus-preview`       | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-Guy24kRUS` i głosem.       |
| `1.3.0-amd64-en-us-jessa24krus-preview`     | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-Jessa24kRUS` i głosem.     |
| `1.3.0-amd64-en-us-jessarus-preview`        | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-JessaRUS` i głosem.        |
| `1.3.0-amd64-en-us-zirarus-preview`         | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-ZiraRUS` i głosem.         |
| `1.3.0-amd64-es-es-helenarus-preview`       | Obraz kontenera z `es-ES` ustawieniami regionalnymi `es-ES-HelenaRUS` i głosem.       |
| `1.3.0-amd64-es-es-laura-apollo-preview`    | Obraz kontenera z `es-ES` ustawieniami regionalnymi `es-ES-Laura-Apollo` i głosem.    |
| `1.3.0-amd64-es-es-pablo-apollo-preview`    | Obraz kontenera z `es-ES` ustawieniami regionalnymi `es-ES-Pablo-Apollo` i głosem.    |
| `1.3.0-amd64-es-mx-hildarus-preview`        | Obraz kontenera z `es-MX` ustawieniami regionalnymi `es-MX-HildaRUS` i głosem.        |
| `1.3.0-amd64-es-mx-raul-apollo-preview`     | Obraz kontenera z `es-MX` ustawieniami regionalnymi `es-MX-Raul-Apollo` i głosem.     |
| `1.3.0-amd64-fi-fi-heidirus-preview`        | Obraz kontenera z `fi-FI` ustawieniami regionalnymi `fi-FI-HeidiRUS` i głosem.        |
| `1.3.0-amd64-fr-ca-caroline-preview`        | Obraz kontenera z `fr-CA` ustawieniami regionalnymi `fr-CA-Caroline` i głosem.        |
| `1.3.0-amd64-fr-ca-harmonierus-preview`     | Obraz kontenera z `fr-CA` ustawieniami regionalnymi `fr-CA-HarmonieRUS` i głosem.     |
| `1.3.0-amd64-fr-ch-guillaume-preview`       | Obraz kontenera z `fr-CH` ustawieniami regionalnymi `fr-CH-Guillaume` i głosem.       |
| `1.3.0-amd64-fr-fr-hortenserus-preview`     | Obraz kontenera z `fr-FR` ustawieniami regionalnymi `fr-FR-HortenseRUS` i głosem.     |
| `1.3.0-amd64-fr-fr-julie-apollo-preview`    | Obraz kontenera z `fr-FR` ustawieniami regionalnymi `fr-FR-Julie-Apollo` i głosem.    |
| `1.3.0-amd64-fr-fr-paul-apollo-preview`     | Obraz kontenera z `fr-FR` ustawieniami regionalnymi `fr-FR-Paul-Apollo` i głosem.     |
| `1.3.0-amd64-he-il-asaf-preview`            | Obraz kontenera z `he-IL` ustawieniami regionalnymi `he-IL-Asaf` i głosem.            |
| `1.3.0-amd64-hi-in-hemant-preview`          | Obraz kontenera z `hi-IN` ustawieniami regionalnymi `hi-IN-Hemant` i głosem.          |
| `1.3.0-amd64-hi-in-kalpana-apollo-preview`  | Obraz kontenera z `hi-IN` ustawieniami regionalnymi `hi-IN-Kalpana-Apollo` i głosem.  |
| `1.3.0-amd64-hi-in-kalpana-apollo-preview`  | Obraz kontenera z `hi-IN` ustawieniami regionalnymi `hi-IN-Kalpana` i głosem.         |
| `1.3.0-amd64-hi-in-kalpana-preview`         | Obraz kontenera z `hi-IN` ustawieniami regionalnymi `hi-IN-Kalpana` i głosem.         |
| `1.3.0-amd64-hr-hr-matej-preview`           | Obraz kontenera z `hr-HR` ustawieniami regionalnymi `hr-HR-Matej` i głosem.           |
| `1.3.0-amd64-hu-hu-szabolcs-preview`        | Obraz kontenera z `hu-HU` ustawieniami regionalnymi `hu-HU-Szabolcs` i głosem.        |
| `1.3.0-amd64-id-id-andika-preview`          | Obraz kontenera z `id-ID` ustawieniami regionalnymi `id-ID-Andika` i głosem.          |
| `1.3.0-amd64-it-it-cosimo-apollo-preview`   | Obraz kontenera z `it-IT` ustawieniami regionalnymi `it-IT-Cosimo-Apollo` i głosem.   |
| `1.3.0-amd64-it-it-luciarus-preview`        | Obraz kontenera z `it-IT` ustawieniami regionalnymi `it-IT-LuciaRUS` i głosem.        |
| `1.3.0-amd64-ja-jp-ayumi-apollo-preview`    | Obraz kontenera z `ja-JP` ustawieniami regionalnymi `ja-JP-Ayumi-Apollo` i głosem.    |
| `1.3.0-amd64-ja-jp-harukarus-preview`       | Obraz kontenera z `ja-JP` ustawieniami regionalnymi `ja-JP-HarukaRUS` i głosem.       |
| `1.3.0-amd64-ja-jp-ichiro-apollo-preview`   | Obraz kontenera z `ja-JP` ustawieniami regionalnymi `ja-JP-Ichiro-Apollo` i głosem.   |
| `1.3.0-amd64-ko-kr-heamirus-preview`        | Obraz kontenera z `ko-KR` ustawieniami regionalnymi `ko-KR-HeamiRUS` i głosem.        |
| `1.3.0-amd64-ms-my-rizwan-preview`          | Obraz kontenera z `ms-MY` ustawieniami regionalnymi `ms-MY-Rizwan` i głosem.          |
| `1.3.0-amd64-nb-no-huldarus-preview`        | Obraz kontenera z `nb-NO` ustawieniami regionalnymi `nb-NO-HuldaRUS` i głosem.        |
| `1.3.0-amd64-nl-nl-hannarus-preview`        | Obraz kontenera z `nl-NL` ustawieniami regionalnymi `nl-NL-HannaRUS` i głosem.        |
| `1.3.0-amd64-pl-pl-paulinarus-preview`      | Obraz kontenera z `pl-PL` ustawieniami regionalnymi `pl-PL-PaulinaRUS` i głosem.      |
| `1.3.0-amd64-pt-br-daniel-apollo-preview`   | Obraz kontenera z `pt-BR` ustawieniami regionalnymi `pt-BR-Daniel-Apollo` i głosem.   |
| `1.3.0-amd64-pt-br-heloisarus-preview`      | Obraz kontenera z `pt-BR` ustawieniami regionalnymi `pt-BR-HeloisaRUS` i głosem.      |
| `1.3.0-amd64-pt-pt-heliarus-preview`        | Obraz kontenera z `pt-PT` ustawieniami regionalnymi `pt-PT-HeliaRUS` i głosem.        |
| `1.3.0-amd64-ro-ro-andrei-preview`          | Obraz kontenera z `ro-RO` ustawieniami regionalnymi `ro-RO-Andrei` i głosem.          |
| `1.3.0-amd64-ru-ru-ekaterinarus-preview`    | Obraz kontenera z `ru-RU` ustawieniami regionalnymi `ru-RU-EkaterinaRUS` i głosem.    |
| `1.3.0-amd64-ru-ru-irina-apollo-preview`    | Obraz kontenera z `ru-RU` ustawieniami regionalnymi `ru-RU-Irina-Apollo` i głosem.    |
| `1.3.0-amd64-ru-ru-pavel-apollo-preview`    | Obraz kontenera z `ru-RU` ustawieniami regionalnymi `ru-RU-Pavel-Apollo` i głosem.    |
| `1.3.0-amd64-sk-sk-filip-preview`           | Obraz kontenera z `sk-SK` ustawieniami regionalnymi `sk-SK-Filip` i głosem.           |
| `1.3.0-amd64-sl-si-lado-preview`            | Obraz kontenera z `sl-SI` ustawieniami regionalnymi `sl-SI-Lado` i głosem.            |
| `1.3.0-amd64-sv-se-hedvigrus-preview`       | Obraz kontenera z `sv-SE` ustawieniami regionalnymi `sv-SE-HedvigRUS` i głosem.       |
| `1.3.0-amd64-ta-in-valluvar-preview`        | Obraz kontenera z `ta-IN` ustawieniami regionalnymi `ta-IN-Valluvar` i głosem.        |
| `1.3.0-amd64-te-in-chitra-preview`          | Obraz kontenera z `te-IN` ustawieniami regionalnymi `te-IN-Chitra` i głosem.          |
| `1.3.0-amd64-th-th-pattara-preview`         | Obraz kontenera z `th-TH` ustawieniami regionalnymi `th-TH-Pattara` i głosem.         |
| `1.3.0-amd64-tr-tr-sedarus-preview`         | Obraz kontenera z `tr-TR` ustawieniami regionalnymi `tr-TR-SedaRUS` i głosem.         |
| `1.3.0-amd64-vi-vn-an-preview`              | Obraz kontenera z `vi-VN` ustawieniami regionalnymi `vi-VN-An` i głosem.              |
| `1.3.0-amd64-zh-cn-huihuirus-preview`       | Obraz kontenera z `zh-CN` ustawieniami regionalnymi `zh-CN-HuihuiRUS` i głosem.       |
| `1.3.0-amd64-zh-cn-kangkang-apollo-preview` | Obraz kontenera z `zh-CN` ustawieniami regionalnymi `zh-CN-Kangkang-Apollo` i głosem. |
| `1.3.0-amd64-zh-cn-yaoyao-apollo-preview`   | Obraz kontenera z `zh-CN` ustawieniami regionalnymi `zh-CN-Yaoyao-Apollo` i głosem.   |
| `1.3.0-amd64-zh-hk-danny-apollo-preview`    | Obraz kontenera z `zh-HK` ustawieniami regionalnymi `zh-HK-Danny-Apollo` i głosem.    |
| `1.3.0-amd64-zh-hk-tracy-apollo-preview`    | Obraz kontenera z `zh-HK` ustawieniami regionalnymi `zh-HK-Tracy-Apollo` i głosem.    |
| `1.3.0-amd64-zh-hk-tracyrus-preview`        | Obraz kontenera z `zh-HK` ustawieniami regionalnymi `zh-HK-TracyRUS` i głosem.        |
| `1.3.0-amd64-zh-tw-hanhanrus-preview`       | Obraz kontenera z `zh-TW` ustawieniami regionalnymi `zh-TW-HanHanRUS` i głosem.       |
| `1.3.0-amd64-zh-tw-yating-apollo-preview`   | Obraz kontenera z `zh-TW` ustawieniami regionalnymi `zh-TW-Yating-Apollo` i głosem.   |
| `1.3.0-amd64-zh-tw-zhiwei-apollo-preview`   | Obraz kontenera z `zh-TW` ustawieniami regionalnymi `zh-TW-Zhiwei-Apollo` i głosem.   |
| `1.2.0-amd64-de-de-heddarus-preview`        | Obraz kontenera z `de-DE` ustawieniami regionalnymi `de-DE-Hedda` i głosem.           |
| `1.2.0-amd64-de-de-heddarus-preview`        | Obraz kontenera z `de-DE` ustawieniami regionalnymi `de-DE-HeddaRUS` i głosem.        |
| `1.2.0-amd64-de-de-stefan-apollo-preview`   | Obraz kontenera z `de-DE` ustawieniami regionalnymi `de-DE-Stefan-Apollo` i głosem.   |
| `1.2.0-amd64-en-au-catherine-preview`       | Obraz kontenera z `en-AU` ustawieniami regionalnymi `en-AU-Catherine` i głosem.       |
| `1.2.0-amd64-en-au-hayleyrus-preview`       | Obraz kontenera z `en-AU` ustawieniami regionalnymi `en-AU-HayleyRUS` i głosem.       |
| `1.2.0-amd64-en-gb-george-apollo-preview`   | Obraz kontenera z `en-GB` ustawieniami regionalnymi `en-GB-George-Apollo` i głosem.   |
| `1.2.0-amd64-en-gb-hazelrus-preview`        | Obraz kontenera z `en-GB` ustawieniami regionalnymi `en-GB-HazelRUS` i głosem.        |
| `1.2.0-amd64-en-gb-susan-apollo-preview`    | Obraz kontenera z `en-GB` ustawieniami regionalnymi `en-GB-Susan-Apollo` i głosem.    |
| `1.2.0-amd64-en-in-heera-apollo-preview`    | Obraz kontenera z `en-IN` ustawieniami regionalnymi `en-IN-Heera-Apollo` i głosem.    |
| `1.2.0-amd64-en-in-priyarus-preview`        | Obraz kontenera z `en-IN` ustawieniami regionalnymi `en-IN-PriyaRUS` i głosem.        |
| `1.2.0-amd64-en-in-ravi-apollo-preview`     | Obraz kontenera z `en-IN` ustawieniami regionalnymi `en-IN-Ravi-Apollo` i głosem.     |
| `1.2.0-amd64-en-us-benjaminrus-preview`     | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-BenjaminRUS` i głosem.     |
| `1.2.0-amd64-en-us-guy24krus-preview`       | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-Guy24kRUS` i głosem.       |
| `1.2.0-amd64-en-us-jessa24krus-preview`     | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-Jessa24kRUS` i głosem.     |
| `1.2.0-amd64-en-us-jessarus-preview`        | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-JessaRUS` i głosem.        |
| `1.2.0-amd64-en-us-zirarus-preview`         | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-ZiraRUS` i głosem.         |
| `1.2.0-amd64-es-es-helenarus-preview`       | Obraz kontenera z `es-ES` ustawieniami regionalnymi `es-ES-HelenaRUS` i głosem.       |
| `1.2.0-amd64-es-es-laura-apollo-preview`    | Obraz kontenera z `es-ES` ustawieniami regionalnymi `es-ES-Laura-Apollo` i głosem.    |
| `1.2.0-amd64-es-es-pablo-apollo-preview`    | Obraz kontenera z `es-ES` ustawieniami regionalnymi `es-ES-Pablo-Apollo` i głosem.    |
| `1.2.0-amd64-es-mx-hildarus-preview`        | Obraz kontenera z `es-MX` ustawieniami regionalnymi `es-MX-HildaRUS` i głosem.        |
| `1.2.0-amd64-es-mx-raul-apollo-preview`     | Obraz kontenera z `es-MX` ustawieniami regionalnymi `es-MX-Raul-Apollo` i głosem.     |
| `1.2.0-amd64-fr-ca-caroline-preview`        | Obraz kontenera z `fr-CA` ustawieniami regionalnymi `fr-CA-Caroline` i głosem.        |
| `1.2.0-amd64-fr-ca-harmonierus-preview`     | Obraz kontenera z `fr-CA` ustawieniami regionalnymi `fr-CA-HarmonieRUS` i głosem.     |
| `1.2.0-amd64-fr-fr-hortenserus-preview`     | Obraz kontenera z `fr-FR` ustawieniami regionalnymi `fr-FR-HortenseRUS` i głosem.     |
| `1.2.0-amd64-fr-fr-julie-apollo-preview`    | Obraz kontenera z `fr-FR` ustawieniami regionalnymi `fr-FR-Julie-Apollo` i głosem.    |
| `1.2.0-amd64-fr-fr-paul-apollo-preview`     | Obraz kontenera z `fr-FR` ustawieniami regionalnymi `fr-FR-Paul-Apollo` i głosem.     |
| `1.2.0-amd64-it-it-cosimo-apollo-preview`   | Obraz kontenera z `it-IT` ustawieniami regionalnymi `it-IT-Cosimo-Apollo` i głosem.   |
| `1.2.0-amd64-it-it-luciarus-preview`        | Obraz kontenera z `it-IT` ustawieniami regionalnymi `it-IT-LuciaRUS` i głosem.        |
| `1.2.0-amd64-ja-jp-ayumi-apollo-preview`    | Obraz kontenera z `ja-JP` ustawieniami regionalnymi `ja-JP-Ayumi-Apollo` i głosem.    |
| `1.2.0-amd64-ja-jp-harukarus-preview`       | Obraz kontenera z `ja-JP` ustawieniami regionalnymi `ja-JP-HarukaRUS` i głosem.       |
| `1.2.0-amd64-ja-jp-ichiro-apollo-preview`   | Obraz kontenera z `ja-JP` ustawieniami regionalnymi `ja-JP-Ichiro-Apollo` i głosem.   |
| `1.2.0-amd64-ko-kr-heamirus-preview`        | Obraz kontenera z `ko-KR` ustawieniami regionalnymi `ko-KR-HeamiRUS` i głosem.        |
| `1.2.0-amd64-pt-br-daniel-apollo-preview`   | Obraz kontenera z `pt-BR` ustawieniami regionalnymi `pt-BR-Daniel-Apollo` i głosem.   |
| `1.2.0-amd64-pt-br-heloisarus-preview`      | Obraz kontenera z `pt-BR` ustawieniami regionalnymi `pt-BR-HeloisaRUS` i głosem.      |
| `1.2.0-amd64-zh-cn-huihuirus-preview`       | Obraz kontenera z `zh-CN` ustawieniami regionalnymi `zh-CN-HuihuiRUS` i głosem.       |
| `1.2.0-amd64-zh-cn-kangkang-apollo-preview` | Obraz kontenera z `zh-CN` ustawieniami regionalnymi `zh-CN-Kangkang-Apollo` i głosem. |
| `1.2.0-amd64-zh-cn-yaoyao-apollo-preview`   | Obraz kontenera z `zh-CN` ustawieniami regionalnymi `zh-CN-Yaoyao-Apollo` i głosem.   |
| `1.1.0-amd64-de-de-hedda-preview`           | Obraz kontenera z `de-DE` ustawieniami regionalnymi `de-DE-Hedda` i głosem.           |
| `1.1.0-amd64-de-de-heddarus-preview`        | Obraz kontenera z `de-DE` ustawieniami regionalnymi `de-DE-Hedda` i głosem.           |
| `1.1.0-amd64-de-de-heddarus-preview`        | Obraz kontenera z `de-DE` ustawieniami regionalnymi `de-DE-HeddaRUS` i głosem.        |
| `1.1.0-amd64-de-de-stefan-apollo-preview`   | Obraz kontenera z `de-DE` ustawieniami regionalnymi `de-DE-Stefan-Apollo` i głosem.   |
| `1.1.0-amd64-en-au-catherine-preview`       | Obraz kontenera z `en-AU` ustawieniami regionalnymi `en-AU-Catherine` i głosem.       |
| `1.1.0-amd64-en-au-hayleyrus-preview`       | Obraz kontenera z `en-AU` ustawieniami regionalnymi `en-AU-HayleyRUS` i głosem.       |
| `1.1.0-amd64-en-gb-george-apollo-preview`   | Obraz kontenera z `en-GB` ustawieniami regionalnymi `en-GB-George-Apollo` i głosem.   |
| `1.1.0-amd64-en-gb-hazelrus-preview`        | Obraz kontenera z `en-GB` ustawieniami regionalnymi `en-GB-HazelRUS` i głosem.        |
| `1.1.0-amd64-en-gb-susan-apollo-preview`    | Obraz kontenera z `en-GB` ustawieniami regionalnymi `en-GB-Susan-Apollo` i głosem.    |
| `1.1.0-amd64-en-in-heera-apollo-preview`    | Obraz kontenera z `en-IN` ustawieniami regionalnymi `en-IN-Heera-Apollo` i głosem.    |
| `1.1.0-amd64-en-in-priyarus-preview`        | Obraz kontenera z `en-IN` ustawieniami regionalnymi `en-IN-PriyaRUS` i głosem.        |
| `1.1.0-amd64-en-in-ravi-apollo-preview`     | Obraz kontenera z `en-IN` ustawieniami regionalnymi `en-IN-Ravi-Apollo` i głosem.     |
| `1.1.0-amd64-en-us-benjaminrus-preview`     | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-BenjaminRUS` i głosem.     |
| `1.1.0-amd64-en-us-guy24krus-preview`       | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-Guy24kRUS` i głosem.       |
| `1.1.0-amd64-en-us-jessa24krus-preview`     | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-Jessa24kRUS` i głosem.     |
| `1.1.0-amd64-en-us-jessarus-preview`        | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-JessaRUS` i głosem.        |
| `1.1.0-amd64-en-us-zirarus-preview`         | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-ZiraRUS` i głosem.         |
| `1.1.0-amd64-es-es-helenarus-preview`       | Obraz kontenera z `es-ES` ustawieniami regionalnymi `es-ES-HelenaRUS` i głosem.       |
| `1.1.0-amd64-es-es-laura-apollo-preview`    | Obraz kontenera z `es-ES` ustawieniami regionalnymi `es-ES-Laura-Apollo` i głosem.    |
| `1.1.0-amd64-es-es-pablo-apollo-preview`    | Obraz kontenera z `es-ES` ustawieniami regionalnymi `es-ES-Pablo-Apollo` i głosem.    |
| `1.1.0-amd64-es-mx-hildarus-preview`        | Obraz kontenera z `es-MX` ustawieniami regionalnymi `es-MX-HildaRUS` i głosem.        |
| `1.1.0-amd64-es-mx-raul-apollo-preview`     | Obraz kontenera z `es-MX` ustawieniami regionalnymi `es-MX-Raul-Apollo` i głosem.     |
| `1.1.0-amd64-fr-ca-caroline-preview`        | Obraz kontenera z `fr-CA` ustawieniami regionalnymi `fr-CA-Caroline` i głosem.        |
| `1.1.0-amd64-fr-ca-harmonierus-preview`     | Obraz kontenera z `fr-CA` ustawieniami regionalnymi `fr-CA-HarmonieRUS` i głosem.     |
| `1.1.0-amd64-fr-fr-hortenserus-preview`     | Obraz kontenera z `fr-FR` ustawieniami regionalnymi `fr-FR-HortenseRUS` i głosem.     |
| `1.1.0-amd64-fr-fr-julie-apollo-preview`    | Obraz kontenera z `fr-FR` ustawieniami regionalnymi `fr-FR-Julie-Apollo` i głosem.    |
| `1.1.0-amd64-fr-fr-paul-apollo-preview`     | Obraz kontenera z `fr-FR` ustawieniami regionalnymi `fr-FR-Paul-Apollo` i głosem.     |
| `1.1.0-amd64-it-it-cosimo-apollo-preview`   | Obraz kontenera z `it-IT` ustawieniami regionalnymi `it-IT-Cosimo-Apollo` i głosem.   |
| `1.1.0-amd64-it-it-luciarus-preview`        | Obraz kontenera z `it-IT` ustawieniami regionalnymi `it-IT-LuciaRUS` i głosem.        |
| `1.1.0-amd64-ja-jp-ayumi-apollo-preview`    | Obraz kontenera z `ja-JP` ustawieniami regionalnymi `ja-JP-Ayumi-Apollo` i głosem.    |
| `1.1.0-amd64-ja-jp-harukarus-preview`       | Obraz kontenera z `ja-JP` ustawieniami regionalnymi `ja-JP-HarukaRUS` i głosem.       |
| `1.1.0-amd64-ja-jp-ichiro-apollo-preview`   | Obraz kontenera z `ja-JP` ustawieniami regionalnymi `ja-JP-Ichiro-Apollo` i głosem.   |
| `1.1.0-amd64-ko-kr-heamirus-preview`        | Obraz kontenera z `ko-KR` ustawieniami regionalnymi `ko-KR-HeamiRUS` i głosem.        |
| `1.1.0-amd64-pt-br-daniel-apollo-preview`   | Obraz kontenera z `pt-BR` ustawieniami regionalnymi `pt-BR-Daniel-Apollo` i głosem.   |
| `1.1.0-amd64-pt-br-heloisarus-preview`      | Obraz kontenera z `pt-BR` ustawieniami regionalnymi `pt-BR-HeloisaRUS` i głosem.      |
| `1.1.0-amd64-zh-cn-huihuirus-preview`       | Obraz kontenera z `zh-CN` ustawieniami regionalnymi `zh-CN-HuihuiRUS` i głosem.       |
| `1.1.0-amd64-zh-cn-kangkang-apollo-preview` | Obraz kontenera z `zh-CN` ustawieniami regionalnymi `zh-CN-Kangkang-Apollo` i głosem. |
| `1.1.0-amd64-zh-cn-yaoyao-apollo-preview`   | Obraz kontenera z `zh-CN` ustawieniami regionalnymi `zh-CN-Yaoyao-Apollo` i głosem.   |
| `1.0.0-amd64-en-us-benjaminrus-preview`     | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-BenjaminRUS` i głosem.     |
| `1.0.0-amd64-en-us-guy24krus-preview`       | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-Guy24kRUS` i głosem.       |
| `1.0.0-amd64-en-us-jessa24krus-preview`     | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-Jessa24kRUS` i głosem.     |
| `1.0.0-amd64-en-us-jessarus-preview`        | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-JessaRUS` i głosem.        |
| `1.0.0-amd64-en-us-zirarus-preview`         | Obraz kontenera z `en-US` ustawieniami regionalnymi `en-US-ZiraRUS` i głosem.         |
| `1.0.0-amd64-zh-cn-huihuirus-preview`       | Obraz kontenera z `zh-CN` ustawieniami regionalnymi `zh-CN-HuihuiRUS` i głosem.       |
| `1.0.0-amd64-zh-cn-kangkang-apollo-preview` | Obraz kontenera z `zh-CN` ustawieniami regionalnymi `zh-CN-Kangkang-Apollo` i głosem. |
| `1.0.0-amd64-zh-cn-yaoyao-apollo-preview`   | Obraz kontenera z `zh-CN` ustawieniami regionalnymi `zh-CN-Yaoyao-Apollo` i głosem.   |
