...
Wersja *Wirginia dla instytucji rządowych USA* jest obsługiwana w programie v 2.4.0 i można ją znaleźć w temacie `containerpreview.azurecr.io/microsoft/fairfax/cognitive-services-speech-to-text` .
