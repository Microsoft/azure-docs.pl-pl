...
Globalny punkt końcowy usługi Translator jest ustawiany jako `endpoint` . Element `path` ustawia trasę `dictionary/lookup` i określa, że chcemy korzystać z wersji 3 interfejsu API.
