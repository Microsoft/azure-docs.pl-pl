...
Użyj [interfejsu API uczenia](https://docs.microsoft.com/rest/api/cognitiveservices/qnamaker4.0/runtime/train) , aby wysłać poprawną odpowiedź do QNA Maker, po wybraniu go przez użytkownika.
