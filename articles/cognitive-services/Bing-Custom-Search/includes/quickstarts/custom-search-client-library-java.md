...
[Dokumentacja](/java/api/overview/azure/cognitiveservices/client/bingcustomsearch)  |  referencyjna [Kod](https://github.com/Azure/azure-sdk-for-net/tree/master/sdk/cognitiveservices/Search.BingCustomSearch)  |  źródłowy biblioteki [Artefakt (Maven)](https://search.maven.org/artifact/com.microsoft.azure.cognitiveservices/azure-cognitiveservices-customsearch/)  |  [Przykłady](https://github.com/Azure-Samples/cognitive-services-java-sdk-samples)
...
Po otrzymaniu klucza z zasobu [Utwórz zmienną środowiskową](../../../cognitive-services-apis-create-account.md#configure-an-environment-variable-for-authentication) dla klucza o nazwie `AZURE_BING_CUSTOM_SEARCH_API_KEY` .
...
Klient wyszukiwanie niestandardowe Bing jest obiektem [BingCustomSearchAPI](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustomsearchapi) , który jest tworzony przy użyciu metody [Authenticate ()](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustomsearchmanager.authenticate) obiektu [BingCustomSearchManager](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustomsearchmanager) . Żądanie wyszukiwania można wysłać przy użyciu metody [BingCustomInstances. Search ()](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustominstances.search#com_microsoft_azure_cognitiveservices_search_customsearch_BingCustomInstances_search__) klienta.

Odpowiedź interfejsu API to obiekt [SearchResponse](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.models.searchresponse) zawierający informacje o zapytaniu wyszukiwania i wynikach wyszukiwania.
...
Główna Metoda powinna zawierać obiekt [BingCustomSearchManager](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustomsearchapi) , który pobiera klucz i wywołuje jego `authenticate()` .
...
Użyj funkcji [BingCustomInstances. Search ()](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustominstances.search#com_microsoft_azure_cognitiveservices_search_customsearch_BingCustomInstances_search__) klienta, aby wysłać zapytanie wyszukiwania do wystąpienia niestandardowego. Ustaw wartość `withCustomConfig` na identyfikator konfiguracji niestandardowej lub wartość domyślną `1` . Po otrzymaniu odpowiedzi z interfejsu API Sprawdź, czy nie znaleziono żadnych wyników wyszukiwania. Jeśli tak, Pobierz pierwszy wynik wyszukiwania przez wywołanie `webPages().value().get()` funkcji odpowiedzi i wydrukowanie nazwy wyniku oraz adresu URL.
