...
* [Omówienie sieci wirtualnych platformy Azure](https://docs.microsoft.com/azure/virtual-network/virtual-networks-overview)
...
* [Grupy zabezpieczeń aplikacji](https://docs.microsoft.com/azure/virtual-network/security-overview#application-security-groups)
...
Za pomocą planów platformy Azure można również uprościć wdrożenia platformy Azure na dużą skalę przez pakowanie kluczowych artefaktów środowiska, takich jak szablony Azure Resource Manager, kontrola dostępu oparta na rolach (RBAC) i zasady, w ramach jednej definicji planu. Łatwo stosuj plan do nowych subskrypcji i środowisk, a następnie dostosuj kontrolę i zarządzanie przy użyciu wersji.
...
* [Korzystanie z ustawień diagnostycznych w usłudze Azure Cognitive Services](https://docs.microsoft.com/azure/cognitive-services/diagnostic-logging)
...
* [Informacje o interfejsie API REST usługi Azure Cognitive Services](https://docs.microsoft.com/rest/api/cognitiveservices/)
...
Obecnie tylko interfejs API przetwarzania obrazów, interfejs API rozpoznawania twarzy, interfejs API analizy tekstu, czytniki immersyjny, aparat rozpoznawania nietypowego wykrywania i wszystkie usługi Bing, z wyjątkiem wyszukiwanie niestandardowe Bing obsługa uwierzytelniania przy użyciu usługi Azure AD.
...
* [Opis Transport Layer Security platformy Azure Cognitive Services](https://docs.microsoft.com/azure/cognitive-services/cognitive-services-security)
...
**Wskazówki**: usługa Azure Active Directory (Azure AD) Kontrola dostępu oparta na ROLACH (RBAC) umożliwia kontrolowanie dostępu do płaszczyzny kontroli Cognitive Services platformy Azure (tj. Azure Portal).
...
* [Lista usług, które szyfrują informacje w spoczynku](https://docs.microsoft.com/azure/cognitive-services/encryption/cognitive-services-encryption-keys-portal)
