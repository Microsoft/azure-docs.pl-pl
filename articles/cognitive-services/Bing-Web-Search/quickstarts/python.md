...
Aby uzyskać pełną listę opcji i parametrów, zobacz [interfejs API wyszukiwania w sieci Web Bing wersji 7](/rest/api/cognitiveservices-bingsearch/bing-web-api-v7-reference).
