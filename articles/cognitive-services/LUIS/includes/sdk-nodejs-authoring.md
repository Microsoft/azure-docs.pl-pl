...
Utwórz nowy plik tekstowy w preferowanym edytorze lub środowisku IDE o `luis_authoring_quickstart.js`nazwie. Następnie Dodaj następujące zależności.
