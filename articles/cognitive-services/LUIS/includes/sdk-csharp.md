...
* Przykład wyrażenia długości — [Dodawanie](//dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.examplesextensions.addasync?view=azure-dotnet), [usuwanie według identyfikatora](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.examplesextensions.deleteasync?view=azure-dotnet)
...
Wywołaj [przykłady. addasync](//dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring.examplesextensions.addasync?view=azure-dotnet) z identyfikatorem aplikacji, identyfikatorem wersji i przykładem.
