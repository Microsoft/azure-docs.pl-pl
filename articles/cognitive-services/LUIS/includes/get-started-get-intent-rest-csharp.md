...
1. Utwórz nową aplikację konsolową przeznaczoną dla języka C#, z nazwą projektu i folderu `predict-with-rest`.

    ```console
    dotnet new console -lang C# -n predict-with-rest
    ```

1. Przejdź do `predict-with-rest` katalogu, który został właśnie utworzony, i zainstaluj wymagane zależności przy użyciu następujących poleceń:
...
1. Zastąp `YOUR-KEY` wartości `YOUR-ENDPOINT` i własnymi kluczami prognoz i punktem końcowym.
