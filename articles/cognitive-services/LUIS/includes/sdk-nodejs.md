...
[Przykłady wywołań. Dodaj](/javascript/api/@azure/cognitiveservices-luis-authoring/examples?view=azure-node-lates) przy użyciu identyfikatora aplikacji, identyfikatora wersji i przykładu.
