...
1. W oknie podręcznym wybierz pozycję **gotowe** na stronie **Potwierdzanie wzorców** . Nie musisz definiować podjednostek ani funkcji jednostek. Wystarczy tylko wyświetlić listę jednostek, których dotyczy dana maszyna.
