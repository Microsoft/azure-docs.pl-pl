...
:::image type="content" source="media/sign-in/resource-selection.png" alt-text="Ekran częściowy — zrzut ekranu LUIS Portal z listami rozwijanymi wyboru zasobów.":::
