---
title: 'Szybki Start: Tworzenie zasobu Cognitive Services platformy Azure przy użyciu szablonów usługi ARM | Microsoft Docs'
description: Wprowadzenie do wdrażania zasobu Cognitive Services przy użyciu szablonu Azure Resource Manager.
...
Ten artykuł służy do tworzenia i wdrażania zasobów Cognitive Services przy użyciu szablonu Azure Resource Manager (szablon ARM). Ten zasób usługi wiele usług umożliwia:
