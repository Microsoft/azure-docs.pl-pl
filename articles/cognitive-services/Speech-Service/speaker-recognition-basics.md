---
title: Podstawowe informacje dotyczące rozpoznawanie osoby mówiącej — usługa mowy
titleSuffix: Azure Cognitive Services
description: Dowiedz się, jak za pomocą zestawu Speech SDK odpowiedzieć na pytanie "kto mówi". W tym artykule omówiono typowe wzorce projektowe umożliwiające pracę z weryfikacją i identyfikacją osoby mówiącej.
...
ms.locfileid: "84632317"
---
# <a name="learn-the-basics-of-speaker-recognition"></a>Poznaj podstawy rozpoznawanie osoby mówiącej

W tym artykule przedstawiono podstawowe wzorce projektowe dla rozpoznawanie osoby mówiącej przy użyciu zestawu Speech SDK, w tym:
...
* Szczegółowe informacje na temat klas i funkcji można znaleźć w [dokumentacji](https://docs.microsoft.com/rest/api/speakerrecognition/) dotyczącej rozpoznawanie osoby mówiącej.

* Zobacz przykłady [języków C#](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/csharp/dotnet/speaker-recognition) i [C++](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/cpp/windows/speaker-recognition) w witrynie GitHub.
