...
| `ar-PS` | Arabski (stan Palestyny)       | Nie                                                |
...
| `ko-KR` | Koreański (Korea Południowa) | Kobiety | `ko-KR-SunHiNeural` | Ogólne |
...
| `ko-KR` | Koreański (Korea Południowa) | Kobiety | `ko-KR-HeamiRUS` |
