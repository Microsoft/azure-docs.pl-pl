---
title: 'Szybki Start: Konfiguracja platformy SDK dla języka C# (Xamarin) — usługa mowy'
titleSuffix: Azure Cognitive Services
description: Skorzystaj z tego przewodnika, aby skonfigurować platformę dla środowiska C# dla platformy Xamarin z zestawem SDK usługi Speech Service.
...
Zestaw Speech SDK jest teraz zainstalowany. Możesz teraz usunąć lub ponownie użyć projektu "HelloWorld" utworzonego w poprzednich krokach.
