---
title: 'Szybki Start: interfejs API REST usługi Metric Advisor'
...
Rozpocznij pracę z interfejsem API REST usługi Metric Advisor. Wykonaj następujące kroki, aby zainstalować pakiet i wypróbować przykładowy kod dla podstawowych zadań.
