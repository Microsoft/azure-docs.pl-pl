---
title: 'Szybki Start: Wyodrębnianie wydrukowanych tekstu — REST, Java'
...
> [!NOTE]
> W przypadku wyodrębniania tekstu w języku angielskim należy rozważyć użycie nowej [operacji odczytu](../concept-recognizing-text.md). Dostępny jest [Przewodnik Szybki Start dla języka Java](./java-hand-text.md) . 
