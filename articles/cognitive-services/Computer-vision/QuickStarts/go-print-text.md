...
> [!NOTE]
> W przypadku wyodrębniania tekstu w języku angielskim należy rozważyć użycie nowej [operacji odczytu](../concept-recognizing-text.md). Dostępny jest [Przewodnik Szybki Start](../quickstarts-sdk/client-library.md?pivots=programming-language-go%253fpivots%253dprogramming-language-go#call-the-read-api) .
