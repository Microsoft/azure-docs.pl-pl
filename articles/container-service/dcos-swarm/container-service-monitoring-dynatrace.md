...
1. Uzyskaj dostęp do interfejsu użytkownika DC/OS za pośrednictwem programu `http://localhost:80/` . Po uruchomieniu interfejsu użytkownika DC/OS przejdź do karty **Universe** , a następnie wyszukaj ciąg **dynaTrace**.
