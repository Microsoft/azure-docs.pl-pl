...
Uzyskaj dostęp do interfejsu użytkownika DC/ `http://localhost:80/` OS za pośrednictwem jednego z nich w interfejsie użytkownika DC/OS przejdź do "Universe", który znajduje się w lewym dolnym rogu, a następnie wyszukaj ciąg "narzędzia Sysdig".
