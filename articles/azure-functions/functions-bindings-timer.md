...
`hh:mm:ss` Jest `hh` to ciąg, który `TimeSpan` jest mniejszy niż 24. Gdy dwie pierwsze cyfry mają wartość 24 lub większą, format to `dd:hh:mm`. Oto kilka przykładów:
