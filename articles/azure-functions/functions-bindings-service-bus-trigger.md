...
W poniższym przykładzie pokazano powiązanie wyzwalacza Service Bus w *function.js* pliku oraz [Funkcja programu PowerShell](functions-reference-powershell.md) , która używa powiązania. 
