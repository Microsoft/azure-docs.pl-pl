...
::: zone-end
::: zone pivot="programming-language-other"
Gdy `HttpExample` punkt końcowy zostanie wyświetlony w danych wyjściowych, przejdź do `http://localhost:7071/api/HttpExample` . W przeglądarce powinien zostać wyświetlony komunikat "Hello World".
::: zone-end
