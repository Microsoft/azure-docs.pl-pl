---
title: Rozwiązywanie problemów z usługą Python ModuleNotFoundError w Azure Functions
description: Dowiedz się, jak rozwiązywać problemy z błędami modułu Azure Functions nie znaleziono w funkcjach języka Python.
author: Hazhzeng
ms.topic: article
ms.date: 05/12/2020
ms.author: hazeng
...
Ten artykuł pomaga w rozwiązywaniu problemów związanych z modułami w aplikacji funkcji języka Python. Te błędy zwykle powodują następujący komunikat o błędzie Azure Functions:
...
Jeśli nie możesz rozwiązać problemu związanego z modułem, zgłoś ten raport do zespołu ds. funkcji:
