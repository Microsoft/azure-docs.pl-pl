...
|`x5t` | String | Taka sama (w użyciu i wartość) jako `kid` . Jest to jednak starsze zgłoszenie wyemitowane tylko w wersji 1.0 w `id_tokens` celu zapewnienia zgodności. |
