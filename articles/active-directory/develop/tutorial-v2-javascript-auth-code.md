...
Postępuj zgodnie z instrukcjami, aby [zarejestrować nową aplikację jednostronicową](https://docs.microsoft.com/azure/active-directory/develop/scenario-spa-app-registration).
