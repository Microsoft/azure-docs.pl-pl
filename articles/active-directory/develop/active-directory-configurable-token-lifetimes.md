...
Są to polecenia cmdlet w [module Azure Active Directory PowerShell dla programu Graph Preview](/powershell/module/azuread/?view=azureadps-2.0-preview&preserve-view=true#service-principals).
