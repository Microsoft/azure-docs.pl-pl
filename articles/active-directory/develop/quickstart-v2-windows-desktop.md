...
>
>     Aby znaleźć wartości **identyfikatora katalogu (dzierżawy)** i **obsługiwanych typów kont**, przejdź do strony **Przegląd** aplikacji w Azure Portal.
>
