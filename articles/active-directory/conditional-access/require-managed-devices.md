...
:::image type="content" source="./media/require-managed-devices/47.png" alt-text="Zrzut ekranu przedstawiający okienko urządzenia na platformie Azure A D. Włączanie i wyłączanie elementów jest wyróżniony." border="false":::
...
:::image type="content" source="./media/require-managed-devices/10.png" alt-text="Zrzut ekranu przedstawiający okienko urządzenia na platformie Azure A D. Włączanie i wyłączanie elementów jest wyróżniony." border="false":::
...
:::image type="content" source="./media/require-managed-devices/45.png" alt-text="Zrzut ekranu przedstawiający okienko urządzenia na platformie Azure A D. Włączanie i wyłączanie elementów jest wyróżniony." border="false":::
...
:::image type="content" source="./media/require-managed-devices/11.png" alt-text="Zrzut ekranu przedstawiający okienko urządzenia na platformie Azure A D. Włączanie i wyłączanie elementów jest wyróżniony." border="false":::
...
:::image type="content" source="./media/require-managed-devices/46.png" alt-text="Zrzut ekranu przedstawiający okienko urządzenia na platformie Azure A D. Włączanie i wyłączanie elementów jest wyróżniony." border="false":::
