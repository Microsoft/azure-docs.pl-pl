...
1. W sekcji **Zarządzanie** kliknij pozycję **warunki użytkowania** .
   ...
   :::image type="content" source="./media/require-tou/04.png" alt-text="Zrzut ekranu przedstawiający Azure Portal. Widoczne jest okienko definiujące zasady o nazwie Wymagaj T O U dla Isabella." border="false":::

1. W menu u góry kliknij pozycję **nowe warunki** .

   :::image type="content" source="./media/require-tou/05.png" alt-text="Zrzut ekranu przedstawiający Azure Portal. Widoczne jest okienko definiujące zasady o nazwie Wymagaj T O U dla Isabella." border="false":::

1. Na stronie **nowe warunki użytkowania** :

   :::image type="content" source="./media/require-tou/112.png" alt-text="Zrzut ekranu przedstawiający Azure Portal. Widoczne jest okienko definiujące zasady o nazwie Wymagaj T O U dla Isabella." border="false":::
...
:::image type="content" source="./media/require-tou/1234.png" alt-text="Zrzut ekranu przedstawiający Azure Portal. Widoczne jest okienko definiujące zasady o nazwie Wymagaj T O U dla Isabella." border="false":::
...
1. W sekcji **przypisanie** kliknij pozycję **Użytkownicy i grupy** .
   ...
   :::image type="content" source="./media/require-tou/06.png" alt-text="Zrzut ekranu przedstawiający Azure Portal. Widoczne jest okienko definiujące zasady o nazwie Wymagaj T O U dla Isabella." border="false":::

1. Na stronie **Użytkownicy i grupy** :

   :::image type="content" source="./media/require-tou/24.png" alt-text="Zrzut ekranu przedstawiający Azure Portal. Widoczne jest okienko definiujące zasady o nazwie Wymagaj T O U dla Isabella." border="false":::
...
1. Kliknij pozycję **aplikacje w chmurze** .
   ...
   :::image type="content" source="./media/require-tou/08.png" alt-text="Zrzut ekranu przedstawiający Azure Portal. Widoczne jest okienko definiujące zasady o nazwie Wymagaj T O U dla Isabella." border="false":::
...
1. Aby wybrać aplikację w chmurze:
   ...
   :::image type="content" source="./media/require-tou/16.png" alt-text="Zrzut ekranu przedstawiający Azure Portal. Widoczne jest okienko definiujące zasady o nazwie Wymagaj T O U dla Isabella." border="false":::
...
:::image type="content" source="./media/require-tou/57.png" alt-text="Zrzut ekranu przedstawiający Azure Portal. Widoczne jest okienko definiujące zasady o nazwie Wymagaj T O U dla Isabella." border="false":::
...
- Aby usunąć zasady, wybierz zasady, a następnie kliknij przycisk **Usuń** na pasku narzędzi Szybki dostęp.
    ...
    :::image type="content" source="./media/require-tou/33.png" alt-text="Zrzut ekranu przedstawiający Azure Portal. Widoczne jest okienko definiujące zasady o nazwie Wymagaj T O U dla Isabella." border="false":::

- Aby usunąć warunki użytkowania, zaznacz je, a następnie kliknij pozycję **Usuń warunki** na pasku narzędzi u góry.

    :::image type="content" source="./media/require-tou/29.png" alt-text="Zrzut ekranu przedstawiający Azure Portal. Widoczne jest okienko definiujące zasady o nazwie Wymagaj T O U dla Isabella." border="false":::
