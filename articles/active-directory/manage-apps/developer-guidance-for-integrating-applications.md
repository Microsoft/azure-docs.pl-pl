...
Aby uzyskać więcej informacji na temat zgody użytkowników i środowiska zgody na platformie Azure, zobacz [Integrowanie aplikacji z Azure Active Directory](../develop/quickstart-v1-integrate-apps-with-azure-ad.md).
