---
title: Rozwiązywanie problemów z logowaniem jednokrotnym na podstawie hasła w usłudze Azure AD
description: Jak rozwiązywać problemy z aplikacją usługi Azure AD, która została skonfigurowana pod kątem logowania jednokrotnego opartego na hasłach.
author: kenwith
manager: celestedg
