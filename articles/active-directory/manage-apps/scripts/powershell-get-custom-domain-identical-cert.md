...
ms.locfileid: "105044111"
---
# <a name="get-all-application-proxy-apps-that-are-published-with-the-identical-certificate"></a>Pobierz wszystkie aplikacje serwera proxy aplikacji, które są publikowane przy użyciu identycznego certyfikatu
