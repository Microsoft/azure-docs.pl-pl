...
* Aplikacje sieci Web korzystające z dostępu opartego na formularzach lub [nagłówkach](./application-proxy-configure-single-sign-on-with-headers.md)
