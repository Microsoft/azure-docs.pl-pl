...
- Lista aplikacji, które obejmują:
  ...
  - Czy zostaną zmigrowane, zaniechane lub połączone z [Azure AD Connect](/azure/active-directory/hybrid/whatis-azure-ad-connect).
