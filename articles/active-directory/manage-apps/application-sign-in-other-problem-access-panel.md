...
3. Uruchom, `(Get-MgUserAppRoleAssignment -UserId "<user-id>" -PageSize 999).Count` Aby określić liczbę przypisań ról aplikacji aktualnie przyznanych przez użytkownika.
