---
title: Zrozumienie tokenów użytkowników w współpracy B2B — Azure AD
description: Informacje o tokenie użytkownika dotyczące Azure Active Directory współpracy B2B
...
## <a name="microsoft-account-guest-token"></a>konto Microsoft token gościa
```
