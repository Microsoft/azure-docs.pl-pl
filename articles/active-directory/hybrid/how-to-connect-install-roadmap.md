...
* Wprowadzenie do korzystania z programu Azure AD Connect Health dla usług AD FS
    ...
    * [Zobacz instrukcje instalacji](how-to-connect-health-agent-install.md#install-the-agent-for-ad-fs).
...
* Wprowadzenie do korzystania z programu Azure AD Connect Health dla usług AD DS
    ...
    * [Zobacz instrukcje instalacji](how-to-connect-health-agent-install.md#install-the-agent-for-azure-ad-ds).
