...
>[!NOTE]
>Aby dowiedzieć się więcej o certyfikatach używanych przez AD FS, zobacz [Opis certyfikatów używanych przez AD FS](https://technet.microsoft.com/library/cc730660.aspx).
