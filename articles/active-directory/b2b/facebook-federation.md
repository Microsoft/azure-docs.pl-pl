...
> - Wprowadź **adres URL witryny** `https://login.microsoftonline.com` .
...
- [Zapraszanie użytkowników zewnętrznych do współpracy](add-users-administrator.md)
