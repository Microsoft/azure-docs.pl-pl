...
1. W tym samym kreatorze **edycji reguł dotyczących roszczeń** wybierz pozycję **Dodaj regułę**. W obszarze **Typ reguły**dla dowolnego węża wybierz opcję **Wyślij atrybuty LDAP jako oświadczenia**. Wybierz pozycję **Dalej**.
1. W obszarze **Konfigurowanie reguły roszczeń**określ następujące wartości: 
