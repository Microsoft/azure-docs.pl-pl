...
- Aby uruchomić przykłady skryptów interfejsu wiersza polecenia, można korzystać z trzech opcji:
    ...
    - [Zainstaluj najnowszą wersję interfejsu wiersza polecenia platformy Azure,](/cli/azure/install-azure-cli) Jeśli wolisz korzystać z lokalnej konsoli interfejsu wiersza polecenia i zalogować się do platformy Azure przy użyciu polecenia `az login`
