...
* [Tworzenie i Konfigurowanie wystąpienia usługi Azure AD DS](https://docs.microsoft.com/azure/active-directory-domain-services/tutorial-create-instance) 

* [Konfigurowanie sieci wirtualnej dla wystąpienia usługi Azure AD DS](https://docs.microsoft.com/azure/active-directory-domain-services/tutorial-configure-networking) 

* [Konfigurowanie Secure LDAP dla domeny zarządzanej AD DS platformy Azure](https://docs.microsoft.com/azure/active-directory-domain-services/tutorial-configure-ldaps) 

* [Utwórz zaufanie lasu wychodzącego do domeny lokalnej na platformie Azure AD DS](https://docs.microsoft.com/azure/active-directory-domain-services/tutorial-create-forest-trust)
