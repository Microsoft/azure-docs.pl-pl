...
[SincroPool Apps](https://www.sincropool.com/), [SmartDB](https://hibiki.dreamarts.co.jp/smartdb/trial/), [float](../saas-apps/float-tutorial.md), [LMS365](https://lms.365.systems/), [IWT — pakiet zaopatrzenia](../saas-apps/iwt-procurement-suite-tutorial.md), [Lunni](https://lunni.fi/), [EasySSO for JIRA](../saas-apps/easysso-for-jira-tutorial.md), [Virtual Training Academy](https://vta.c3p.ca/app/en/openid?authenticate_with=microsoft) [](https://hexaware.com/partnerships-and-alliances/digital-transformation-using-microsoft-azure/), [pulpit nawigacyjny Meraki](../saas-apps/meraki-dashboard-tutorial.md), [](../saas-apps/fortes-change-cloud-tutorial.md) [](https://review.docs.microsoft.com/azure/active-directory/saas-apps/trend-micro-tutorial) [Microsoft 365 przeprowadzki](https://app.mover.io/login), [współpracownik,](https://speakerengage.com/login.php) [uczciwie](../saas-apps/honestly-tutorial.md), [Ally](../saas-apps/ally-tutorial.md), [DutyFlow](https://app.dutyflow.nl/) [, AlertMedia,](../saas-apps/alertmedia-tutorial.md) [gr8e](../saas-apps/gr8-people-tutorial.md) [](../saas-apps/nitro-productivity-suite-tutorial.md), [pendo,](../saas-apps/pendo-tutorial.md) [HighGround](../saas-apps/highground-tutorial.md), Timetabling, SynchroNet, Litmus, GroupTalk, Frontify, MongoDB, [](https://recorder.grouptalk.com/) [](../saas-apps/synchronet-click-tutorial.md)TickitLMS, Coco, [](../saas-apps/mongodb-cloud-tutorial.md) [](../saas-apps/harmony-tutorial.md) [](../saas-apps/timetabling-solutions-tutorial.md) [](https://www.made-in-office.com/en/) [](../saas-apps/litmus-tutorial.md) [](../saas-apps/frontify-tutorial.md) [](../saas-apps/tickitlms-learn-tutorial.md)
...
Przyjemnością się z tym, że udostępnimy teraz odświeżone środowisko [Azure AD Identity Protection](../identity-protection/overview-identity-protection.md)   w [portalu Microsoft Azure Government](https://portal.azure.us/). Aby uzyskać więcej informacji, zobacz [wpis w blogu dotyczący anonsu](https://techcommunity.microsoft.com/t5/public-sector-blog/identity-protection-refresh-in-microsoft-azure-government/ba-p/1223667).
...
[IamIP platformę patentową](../saas-apps/iamip-patent-platform-tutorial.md), [chmurę doświadczenia](../saas-apps/experience-cloud-tutorial.md), [ns1 Logowanie jednokrotne na platformie Azure](../saas-apps/ns1-sso-azure-tutorial.md), [usługę zabezpieczeń poczty e-mail Barracuda](https://ess.barracudanetworks.com/sso/azure), [raportowanie ABA](https://myaba.co.uk/client-access/signin/auth/msad), [na wypadek kryzysu — portal online](../saas-apps/in-case-of-crisis-online-portal-tutorial.md), [BIC projektowanie chmurowe](../saas-apps/bic-cloud-design-tutorial.md), program [pszczelarstwa usługi Azure AD Data Connector](../saas-apps/beekeeper-azure-ad-data-connector-tutorial.md), [oceny promów](https://www.kornferry.com/solutions/kf-digital/kf-assess), [Verkada](../saas-apps/verkada-command-tutorial.md), [Splashtop](../saas-apps/splashtop-tutorial.md), [Syxsense](../saas-apps/syxsense-tutorial.md), [EAB](../saas-apps/eab-navigate-tutorial.md), [New Relic (Limited Release)](../saas-apps/new-relic-limited-release-tutorial.md), [Thulium](https://admin.thulium.com/login/instance), [kierownik biletów](../saas-apps/ticketmanager-tutorial.md), selektor [szablonów dla zespołów](https://links.officeatwork.com/templatechooser-download-teams), [pszczoły](https://www.beesy.me/index.php/site/login), [system pomocy technicznej](../saas-apps/health-support-system-tutorial.md), [mural](https://app.mural.co/signup), [Hive](../saas-apps/hive-tutorial.md), LavaDo [,](../saas-apps/wedo-tutorial.md) [Wakelet](https://wakelet.com/login), [Firmex VDR](../saas-apps/firmex-vdr-tutorial.md), [ThingLink dla nauczycieli i szkół](https://www.thinglink.com/), [Coda](../saas-apps/coda-tutorial.md), [NearpodApp](https://nearpod.com/signup/?oc=Microsoft&utm_campaign=Microsoft&utm_medium=site&utm_source=product) [, WeDo,](https://appsource.microsoft.com/product/web-apps/lavaloon.lavado_standard?tab=Overview) [InvitePeople,](https://invitepeople.com/login) [reprinters Desk, artykuł Galaxy](../saas-apps/reprints-desk-article-galaxy-tutorial.md), [TeamViewer](../saas-apps/teamviewer-tutorial.md)
...
Moje konto — ten, który zatrzymał się w przypadku wszystkich potrzeb związanych z zarządzaniem kontem użytkownika końcowego, jest teraz ogólnie dostępny. Użytkownicy końcowi mogą uzyskiwać dostęp do tej nowej witryny za pośrednictwem adresu URL lub w nagłówku nowego środowiska moje aplikacje. Dowiedz się więcej na temat wszystkich funkcji samoobsługowych oferowanych przez nowe środowisko w [portalu mojego konta](../user-help/my-account-portal-overview.md).
...
Nowe środowisko użytkownika końcowego moje konto będzie aktualizować jego adres URL `https://myaccount.microsoft.com` w ciągu następnego miesiąca. Znajdź więcej informacji na temat środowiska oraz wszystkie możliwości samoobsługowego konta, które oferuje użytkownikom końcowym w [pomocy portalu mojego konta](../user-help/my-account-portal-overview.md).
...
Aby uzyskać więcej informacji na temat sposobu konfigurowania inicjowania obsługi przychodzącej SAP SuccessFactors w usłudze Azure AD, zobacz samouczek [Konfigurowanie funkcji automatycznej APROWIZACJI SAP SuccessFactors](../saas-apps/sap-successfactors-inbound-provisioning-tutorial.md) .
...
Aby dowiedzieć się więcej na temat nowego środowiska Rejestracje aplikacji, zobacz [rejestracje aplikacji w przewodniku szkolenia Azure Portal](../develop/quickstart-register-app.md).
...
Aby uzyskać więcej informacji, zobacz [Konfigurowanie zasad wygasania dla grup pakietu Office 365](../enterprise-users/groups-lifecycle.md).
...
Aby uzyskać więcej informacji, zobacz [zbiorcze Dodawanie członków](../enterprise-users/groups-bulk-import-members.md), [zbiorcze usuwanie](../enterprise-users/groups-bulk-remove-members.md)członków, [listy członków pobierania zbiorczego](../enterprise-users/groups-bulk-download-members.md)i [listę grup pobierania zbiorczego](../enterprise-users/groups-bulk-download.md).
...
Role niestandardowe (dostępne w ramach subskrypcji usługi Azure AD P1 lub P2) mogą teraz pomóc zapewnić szczegółowy dostęp, umożliwiając tworzenie definicji ról z określonymi uprawnieniami, a następnie przypisywanie tych ról do określonych zasobów. Obecnie można tworzyć role niestandardowe przy użyciu uprawnień do zarządzania rejestracjami aplikacji, a następnie przypisywania roli do określonej aplikacji. Aby uzyskać więcej informacji na temat ról niestandardowych, zobacz [Niestandardowe role administratorów w Azure Active Directory (wersja zapoznawcza)](../roles/custom-overview.md).
...
Aby uzyskać więcej informacji, zobacz [jak to działa: Samoobsługowe resetowanie hasła w usłudze Azure AD](../authentication/concept-sspr-howitworks.md). Aby uzyskać więcej informacji na temat środowiska użytkownika, zobacz [Resetowanie własnego hasła służbowego — Omówienie](../user-help/active-directory-passwords-reset-register.md).
...
Aby uzyskać więcej informacji, zobacz [Zarządzanie dynamicznymi regułami członkostwa](../enterprise-users/groups-dynamic-membership.md).
...
Aby uzyskać więcej informacji na temat udoskonalonego środowiska informacji o zabezpieczeniach, zapoznaj się z [dokumentacją administratora](../authentication/concept-registration-mfa-sspr-combined.md) i [dokumentacją użytkownika](../user-help/security-info-setup-signin.md).
...
[Ungerboeck Software](../saas-apps/ungerboeck-software-tutorial.md), [jasnozielony wzorzec omnichannel Center contacting](../saas-apps/bright-pattern-omnichannel-contact-center-tutorial.md), [sprytne Nelly](../saas-apps/clever-nelly-tutorial.md), [AcquireIO](../saas-apps/acquireio-tutorial.md), [Looop](https://www.looop.co/schedule-a-demo/), [](../saas-apps/productboard-tutorial.md) [](../saas-apps/wandera-tutorial.md) [](https://twinesocial.com/) [](../saas-apps/hyperanna-tutorial.md) [](../saas-apps/kallidus-tutorial.md) [](https://www.flipsnack.com/accounts/sign-in-sso.html) [](../saas-apps/abstract-tutorial.md) [](../saas-apps/ascentis-tutorial.md) [](../saas-apps/hype-tutorial.md) [ &trade; productboard, MS Azure SSO Access for Ethidex](../saas-apps/ms-azure-sso-access-for-ethidex-compliance-office-tutorial.md), pogłoskami narosłymi, abstract,, Flipsnack, Wandera, TwineSocial, Kallidus, HyperAnna, [PharmID WasteWitness](https://pharmid.com/), [i2B Connect](https://www.i2b-online.com/sign-up-to-use-i2b-connect-here-sso-access/), [JFrog Artifactory](../saas-apps/jfrog-artifactory-tutorial.md)
...
Aby uzyskać więcej informacji, zobacz [wymuszanie zasad nazewnictwa dla grup pakietu Office 365](../enterprise-users/groups-naming-policy.md).
...
[SAP Fiori](../saas-apps/sap-fiori-tutorial.md), [HRworks logowania](../saas-apps/hrworks-single-sign-on-tutorial.md)jednokrotnego, [Percolate](../saas-apps/percolate-tutorial.md), [MobiControl](../saas-apps/mobicontrol-tutorial.md), [Citrix](../saas-apps/citrix-netscaler-tutorial.md), [Shibumi](../saas-apps/shibumi-tutorial.md), [kanaper](../saas-apps/benchling-tutorial.md), [MileIQ](https://mileiq.onelink.me/991934284/7e980085), [PageDNA](../saas-apps/pagedna-tutorial.md), [EduBrite](../saas-apps/edubrite-lms-tutorial.md), [RStudio](../saas-apps/rstudio-connect-tutorial.md), AMMS, e [](../saas-apps/amms-tutorial.md), e [](https://indiggolead.com/) [](../saas-apps/surveymonkey-enterprise-tutorial.md) [, Alibaba](../saas-apps/greenorbit-tutorial.md) [Cloud (oparta na rolach — Logowanie jednokrotne)](../saas-apps/alibaba-cloud-service-role-based-sso-tutorial.md), [Certent Management](../saas-apps/certent-equity-management-tutorial.md) [, Sectigo](../saas-apps/sectigo-certificate-manager-tutorial.md) [](../saas-apps/mitel-connect-tutorial.md) [](../saas-apps/workgrid-tutorial.md) [](../saas-apps/mondaycom-tutorial.md)
...
[Rozwiązania Zscaler](../saas-apps/zscaler-provisioning-tutorial.md), [rozwiązania Zscaler beta](../saas-apps/zscaler-beta-provisioning-tutorial.md), [rozwiązania Zscaler One](../saas-apps/zscaler-one-provisioning-tutorial.md), [rozwiązania Zscaler dwa](../saas-apps/zscaler-two-provisioning-tutorial.md), [rozwiązania Zscaler trzy](../saas-apps/zscaler-three-provisioning-tutorial.md), [rozwiązania Zscaler ZSCloud](../saas-apps/zscaler-zscloud-provisioning-tutorial.md), [Atlassian Cloud](../saas-apps/atlassian-cloud-provisioning-tutorial.md)
...
Więcej informacji o konfiguracji wymagań dotyczących złożoności haseł znajduje się [w temacie Konfigurowanie wymagań dotyczących złożoności haseł w Azure Active Directory B2C](../../active-directory-b2c/password-complexity.md).
...
Aby uzyskać więcej informacji na temat ulepszeń, zobacz [co to jest Azure Active Directory Identity Protection (odświeżone)?](../identity-protection/overview-identity-protection.md) Aby dowiedzieć się więcej i podzielić się swoimi pomysłami, zapoznaj się z instrukcjami w ramach produktu.
...
|Wynik|Zawiera wyniki dzienników inspekcji. Wcześniej było to wyliczone, ale teraz pokazywane są rzeczywiste wartości.|<ul><li>0</li><li>1</li></ul>|<ul><li>Success</li><li>Niepowodzenie</li></ul>|
...
|conditionalAccessStatus|Zapewnia wynik stanu zasad dostępu warunkowego podczas logowania. Wcześniej było to wyliczone, ale teraz pokazywane są rzeczywiste wartości.|<ul><li>0</li><li>1</li><li>2</li><li>3</li></ul>|<ul><li>Success</li><li>Niepowodzenie</li><li>Nie zastosowano</li><li>Disabled</li></ul>|
|appliedConditionalAccessPolicies: wynik|Zapewnia wynik poszczególnych stanów zasad dostępu warunkowego podczas logowania. Wcześniej było to wyliczone, ale teraz pokazywane są rzeczywiste wartości.|<ul><li>0</li><li>1</li><li>2</li><li>3</li></ul>|<ul><li>Success</li><li>Niepowodzenie</li><li>Nie zastosowano</li><li>Disabled</li></ul>|
...
Aby uzyskać więcej informacji o rolach i uprawnieniach, zobacz [Przypisywanie ról administratorów w Azure Active Directory](../roles/permissions-reference.md)
...
Aby rozpocząć korzystanie z tego samego kliknięcia, przejdź do   >  strony **Konfiguracja logowania jednokrotnego** w Azure Portal stronie konfiguracji usługi SSO dla aplikacji. Aby uzyskać więcej informacji, zobacz [SaaS Application Integration with Azure Active Directory](../saas-apps/tutorial-list.md)
...
Aby uzyskać więcej informacji o używaniu niestandardowych właściwości rozszerzenia dla reguł członkostwa dynamicznego, zobacz [Właściwości rozszerzenia i niestandardowe właściwości rozszerzenia](../enterprise-users/groups-dynamic-membership.md#extension-properties-and-custom-extension-properties) .
...
Aby uzyskać więcej informacji, zobacz [jak włączyć resetowanie haseł w systemach Windows 7, 8 i 8,1](../authentication/howto-sspr-windows.md)
...
[Hornbill](../saas-apps/hornbill-tutorial.md), [bridgeline Unbound](../saas-apps/bridgelineunbound-tutorial.md), [sosy Labs — testowanie dla urządzeń przenośnych i sieci Web](../saas-apps/saucelabs-mobileandwebtesting-tutorial.md), [Łączniki meta Networks](../saas-apps/metanetworksconnector-tutorial.md), [jak to zrobisz](../saas-apps/waywedo-tutorial.md), [Spotinst](../saas-apps/spotinst-tutorial.md), [premaster (Inlogik)](../saas-apps/promaster-tutorial.md) [](../saas-apps/eluminate-tutorial.md), [](../saas-apps/dovetale-tutorial.md) [SchoolBooking,](../saas-apps/safeconnect-tutorial.md) [4me](../saas-apps/4me-tutorial.md) [,](../saas-apps/zenqms-tutorial.md) [Dokumentacja](../saas-apps/dossier-tutorial.md), [N2F](../saas-apps/n2f-expensereports-tutorial.md) [](../saas-apps/comm100livechat-tutorial.md)
...
Aby zapoznać się z przykładem niektórych nowych projektów poczty e-mail i więcej informacji, zobacz [powiadomienia e-mail w usłudze Azure AD PIM](../privileged-identity-management/pim-email-notifications.md).
...
[Centra innowacji](../saas-apps/innovationhub-tutorial.md), [Leapsome](../saas-apps/leapsome-tutorial.md), [niektóre administratora logowania jednokrotnego](../saas-apps/certainadminsso-tutorial.md), PSUC, [IPass SmartConnect](../saas-apps/ipasssmartconnect-tutorial.md), [](../saas-apps/smartlpa-tutorial.md) [](../saas-apps/kanbanize-tutorial.md) [zrzut ekranu przedstawiający-O-Matic](../saas-apps/screencast-tutorial.md), PowerSchool ujednoliconej klasy, [eli](../saas-apps/elionboarding-tutorial.md), [Bomgar, NimbleX](../saas-apps/bomgarremotesupport-tutorial.md), [Insight4GRC,](../saas-apps/nimblex-tutorial.md) [](../saas-apps/imagineerwebvision-tutorial.md) [](../saas-apps/insight4grc-tutorial.md) [](../saas-apps/securejoinnow-tutorial.md) [](../saas-apps/skillsbase-tutorial.md)
...
Aby uzyskać listę wszystkich aplikacji, które obsługują Inicjowanie obsługi użytkowników w galerii usługi Azure AD, zobacz [SaaS Application Integration with Azure Active Directory](../saas-apps/tutorial-list.md).
...
Aby uzyskać więcej informacji na temat ochrony hasłem w usłudze Azure AD, zobacz [eliminowanie nieprawidłowych haseł w organizacji](../authentication/concept-password-ban-bad.md).
...
Aby uzyskać listę wszystkich aplikacji, które obsługują Inicjowanie obsługi użytkowników w galerii usługi Azure AD, zobacz [https://aka.ms/appstutorial](../saas-apps/tutorial-list.md) .
...
Aby uzyskać więcej informacji na temat aplikacji, zobacz [SaaS Application Integration with Azure Active Directory](../saas-apps/tutorial-list.md).

Aby uzyskać więcej informacji na temat tworzenia listy aplikacji w galerii aplikacji usługi Azure AD, zobacz [Wyświetlanie listy aplikacji w galerii aplikacji Azure Active Directory](../develop/v2-howto-app-gallery-listing.md).
...
- [Jak debugować Logowanie jednokrotne oparte na protokole SAML do aplikacji w Azure Active Directory](../manage-apps/debug-saml-sso-issues.md)
...
Aby uzyskać więcej informacji, zobacz [raport dotyczący ryzykownych adresów IP](../hybrid/how-to-connect-health-adfs.md).
...
Na stronie aplikacje przedsiębiorstwa Administratorzy mogą przekazać plik metadanych SAML, aby skonfigurować logowanie oparte na protokole SAML dla galerii usługi Azure AD i aplikacji spoza galerii.
...
- [Konfigurowanie zasad przeglądarki Managed Browser](/mem/intune/apps/manage-microsoft-edge)
...
Aby uzyskać więcej informacji, zobacz [dynamiczne reguły członkostwa dla grup w Azure Active Directory](../enterprise-users/groups-dynamic-membership.md)
...
- Naprawiono usterkę polegającą na tym, że podczas uruchamiania na kontrolerze domeny jest rejestrowane niewłaściwe hasło przy użyciu kreatora programu Azure AD Connect, aby zmienić konfigurację
...
[IBM OpenPages](../saas-apps/ibmopenpages-tutorial.md), [OneTrust Management Software](../saas-apps/onetrust-tutorial.md), [Dealpath](../saas-apps/dealpath-tutorial.md), [IriusRisk federacyjnego Directory i [wierność zalety](../saas-apps/fidelitynetbenefits-tutorial.md).
...
[Accredible](../saas-apps/accredible-tutorial.md), Adobe Experience Manager, [Digital](../saas-apps/efidigitalstorefront-tutorial.md)websklepie, [Communifire](../saas-apps/communifire-tutorial.md) CybSafe, [FactSet](../saas-apps/factset-tutorial.md), [Image działa](../saas-apps/imageworks-tutorial.md), [mobi](../saas-apps/mobi-tutorial.md), [MobileIron Azure AD Integration](../saas-apps/mobileiron-tutorial.md), [Reflektive](../saas-apps/reflektive-tutorial.md), [SAML SSO dla Bamboo, rezolucja GmbH](../saas-apps/bamboo-tutorial.md), [Logowanie jednokrotne SAML dla BitBucket, rezolucja GmbH](../saas-apps/bitbucket-tutorial.md), [Vodeclic](../saas-apps/vodeclic-tutorial.md), WebHR, Zenegy Azure AD Integration.
