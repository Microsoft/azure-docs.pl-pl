...
- [Utwórz nową grupę przy użyciu Azure Active Directory](active-directory-groups-create-azure-portal.md) lub [Utwórz nową grupę i zarządzaj nią za pomocą poleceń cmdlet programu PowerShell](../enterprise-users/groups-settings-v2-cmdlets.md)
