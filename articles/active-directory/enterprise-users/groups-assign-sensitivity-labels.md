...
Należy również zsynchronizować etykiety czułości z usługą Azure AD. Aby uzyskać instrukcje, zobacz [jak włączyć etykiety czułości dla kontenerów i zsynchronizować etykiety](/microsoft-365/compliance/sensitivity-labels-teams-groups-sites?view=o365-worldwide#how-to-enable-sensitivity-labels-for-containers-and-synchronize-labels).
