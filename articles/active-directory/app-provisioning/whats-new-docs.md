...
- [Inicjowanie obsługi aplikacji w stanie kwarantanny](application-provisioning-quarantine-status.md)
- [Dostosowywanie mapowania atrybutów aprowizacji użytkowników dla aplikacji SaaS w Azure Active Directory](customize-application-attributes.md)
- [Tworzenie punktu końcowego Standard scim i Konfigurowanie aprowizacji użytkowników przy użyciu usługi Azure AD](use-scim-to-provision-users-and-groups.md)
- [Dokumentacja atrybutów rozwiązania Workday](workday-attribute-reference.md)
...
### <a name="updated-articles"></a>Zaktualizowane artykuły
- [Konfigurowanie aprowizacji przy użyciu Microsoft Graph interfejsów API](/graph/application-provisioning-configure-api)
- [Znane problemy i rozwiązania z standard scim 2,0 zgodności protokołów aprowizacji użytkowników usługi Azure AD](application-provisioning-config-problem-scim-compatibility.md)
