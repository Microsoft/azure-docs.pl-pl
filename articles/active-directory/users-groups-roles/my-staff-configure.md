...
- [Administrator pomocy technicznej](directory-assign-admin-roles.md#helpdesk-administrator)
- [Administrator użytkowników](directory-assign-admin-roles.md#user-administrator)
