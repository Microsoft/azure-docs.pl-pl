...
10. Kliknij przycisk **Uruchom zapytanie**.
    ...
    ![Uruchamianie zapytania](./media/tutorial-log-analytics-wizard/run-workbook-query.png)
...
4. W sekcji **dostęp warunkowy** kliknij pozycję **szczegółowe informacje i raportowanie dostępu warunkowego**.
    ...
    ![Szablon dostępu warunkowego](./media/tutorial-log-analytics-wizard/conditional-access-template.png)

5. Na pasku narzędzi kliknij przycisk **Edytuj**.

    ![Szablon dostępu warunkowego](./media/tutorial-log-analytics-wizard/edit-workbook-template.png)
...
8. Kliknij przycisk **Uruchom zapytanie**.
    ...
    ![Uruchamianie zapytania](./media/tutorial-log-analytics-wizard/run-workbook-insights-query.png)
