...
- **Działanie** 
    ...
    - **Dzienniki inspekcji** — umożliwia śledzenie przy użyciu dzienników dla wszystkich zmian wykonywanych przez różne funkcje w ramach usługi Azure AD. Działania umieszczane w dziennikach inspekcji to na przykład zmiany wprowadzone w dowolnych zasobach usługi Azure AD, takie jak dodawanie lub usuwanie użytkowników, aplikacji, grup, ról i zasad.
