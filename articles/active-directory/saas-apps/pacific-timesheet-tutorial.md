...
2. Konfigurowanie logowania jednokrotnego dla **[grafiku pacyficznego](#configure-pacific-timesheet-single-sign-on)** — w celu skonfigurowania ustawień logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-pacific-timesheet-single-sign-on"></a>Konfigurowanie logowania jednokrotnego dla grafiku pacyficznego
...
Po kliknięciu kafelka grafiku pacyficznego w panelu dostępu należy automatycznie zalogować się do grafiku w Pacyfiku, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
