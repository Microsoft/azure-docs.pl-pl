...
2. **[Skonfiguruj logowanie](#configure-peakon-single-sign-on)** jednokrotne w usłudze Peakon, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
Po kliknięciu kafelka Peakon w panelu dostępu należy automatycznie zalogować się do Peakon, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
