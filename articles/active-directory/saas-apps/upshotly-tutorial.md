...
## <a name="configure-and-test-azure-ad-single-sign-on-for-upshotly"></a>Skonfiguruj i przetestuj Logowanie jednokrotne usługi Azure AD w celu odstrzału
...
Aby skonfigurować i przetestować Logowanie jednokrotne usługi Azure AD z odciskiem, wykonaj następujące bloki konstrukcyjne:
...
1. **[Skonfiguruj wbudowane Logowanie jednokrotne](#configure-upshotly-sso)** — w celu skonfigurowania ustawień logowania jednokrotnego na stronie aplikacji.
    * **[Utwórz z odstrzelonym użytkownikiem testowym](#create-upshotly-test-user)** , aby dysponować odpowiednikiem B. Simon, który jest połączony z reprezentacją użytkownika w usłudze Azure AD.
...
1. W [Azure Portal](https://portal.azure.com/)na **stronie z wbudowaną integracją aplikacji Znajdź** sekcję **Zarządzanie** i wybierz pozycję **Logowanie jednokrotne**.
...
1. W innym oknie przeglądarki sieci Web Zaloguj się do witryny firmowej jako administrator.
...
Po kliknięciu kafelka z odstrzałem w panelu dostępu należy automatycznie zalogować się do programu, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
...
- [Spróbuj ponownie za pomocą usługi Azure AD](https://aad.portal.azure.com/)