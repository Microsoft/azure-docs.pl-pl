...
> * [Logowanie](./blogin-tutorial.md) jednokrotne do blogu (zalecane)
...
3. Określ, które dane mają być [mapowane między usługą Azure AD i blogiem](../app-provisioning/customize-application-attributes.md). 
