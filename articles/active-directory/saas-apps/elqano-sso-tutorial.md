...
Po kliknięciu kafelka rejestracji jednokrotnej Elqano w panelu dostępu należy automatycznie zalogować się do logowania jednokrotnego Elqano, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Jak chronić Logowanie jednokrotne w usłudze Elqano przy użyciu zaawansowanej widoczności i kontrolek](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)