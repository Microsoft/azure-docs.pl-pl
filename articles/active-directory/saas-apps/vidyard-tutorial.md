...
2. **[Skonfiguruj logowanie](#configure-vidyard-single-sign-on)** jednokrotne w usłudze Vidyard, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
5. Kliknij pozycję **Ustaw dodatkowe adresy URL** i wykonaj następujące kroki, jeśli chcesz skonfigurować aplikację w trybie inicjowania programu **SP** :
    ...
    ![Vidyard domenę i adresy URL Logowanie jednokrotne](common/metadata-upload-additional-signon.png)
...
Po kliknięciu kafelka Vidyard w panelu dostępu należy automatycznie zalogować się do Vidyard, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
