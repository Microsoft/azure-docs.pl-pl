...
Po kliknięciu kafelka usługi Cisco Cloud w panelu dostępu należy automatycznie zalogować się do chmury Cisco, dla której skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
