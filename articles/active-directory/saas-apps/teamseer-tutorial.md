...
2. **[Skonfiguruj logowanie](#configure-teamseer-single-sign-on)** jednokrotne w usłudze TeamSeer, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-teamseer-single-sign-on"></a>Konfigurowanie logowania jednokrotnego TeamSeer
...
1. Kliknij przycisk **Setup (Konfiguracja**).
    ...
    ![Konfiguracja](./media/teamseer-tutorial/ic789635.png "Konfigurowanie")
...
Po kliknięciu kafelka TeamSeer w panelu dostępu należy automatycznie zalogować się do TeamSeer, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
