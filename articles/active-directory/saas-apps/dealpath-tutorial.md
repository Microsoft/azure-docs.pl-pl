---
title: 'Samouczek: integracja Azure Active Directory z usługą Dealpath | Microsoft Docs'
...
Po kliknięciu kafelka Dealpath w panelu dostępu powinno nastąpić automatyczne zalogowanie do aplikacji Dealpath, dla której skonfigurowano logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
