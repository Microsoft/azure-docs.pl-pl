...
2. **[Skonfiguruj jedno Logowanie jednokrotne](#configure-zoho-one-single-sign-on)** w usłudze Zoho, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
4. Jeśli chcesz skonfigurować aplikację w trybie inicjalizacji **dostawcy tożsamości** , w sekcji **Podstawowa konfiguracja SAML** wykonaj następujące czynności:
    ...
    ![Zoho jedną domenę i adresy URL Logowanie jednokrotne](common/idp-relay.png)
...
5. Jeśli chcesz skonfigurować aplikację w trybie zainicjowania programu **SP** , wykonaj następujące czynności:
    ...
    ![Zoho jedną domenę i adresy URL Logowanie jednokrotne](common/both-signonurl.png)
    ...
    > [!NOTE] 
    > Poprzednia wartość **adresu URL logowania** nie jest prawdziwa. Wartość jest aktualizowana przy użyciu rzeczywistego adresu URL logowania w sekcji **Konfigurowanie Zoho jednej rejestracji jednokrotnej** , która została omówiona w dalszej części tego samouczka. 
...
### <a name="configure-zoho-one-single-sign-on"></a>Konfigurowanie rejestracji jednokrotnej w Zoho
...
4. Po zapisaniu konfiguracji uwierzytelniania SAML skopiuj wartość **identyfikatora SAML** i Dołącz ją z **adresem URL odpowiedzi** `<saml-identifier>`zamiast, podobnie `https://accounts.zoho.com/samlresponse/one.zoho.com` jak i wklej wygenerowaną wartość w polu tekstowym **adres URL odpowiedzi** w sekcji **Podstawowa konfiguracja SAML** .
