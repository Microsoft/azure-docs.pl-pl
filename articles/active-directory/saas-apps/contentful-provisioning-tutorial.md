...
> * [Logowanie](https://docs.microsoft.com/azure/active-directory/saas-apps/contentful-tutorial) jednokrotne do zawartości (zalecane)
...
3. Określ dane, które mają być [mapowane między usługą Azure AD i zawartością](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
