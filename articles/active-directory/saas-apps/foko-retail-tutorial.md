...
Po kliknięciu kafelka detalicznego Foko w panelu dostępu należy automatycznie zalogować się do sieci sprzedaży Foko, dla której skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
