...
Po kliknięciu kafelka rejestracji studenta JISC głosujących w panelu dostępu należy automatycznie zalogować się do rejestracji JISC student głosujących, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
