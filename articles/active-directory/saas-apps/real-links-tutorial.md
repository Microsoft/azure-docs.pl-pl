...
2. **[Skonfiguruj rzeczywiste linki logowanie](#configure-real-links-single-sign-on)** jednokrotne — aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-real-links-single-sign-on"></a>Skonfiguruj rzeczywiste linki Logowanie jednokrotne
