...
2. **[Skonfiguruj logowanie](#configure-patentsquare-single-sign-on)** jednokrotne w usłudze PatentSQUARE, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-patentsquare-single-sign-on"></a>Konfigurowanie logowania jednokrotnego PatentSQUARE
