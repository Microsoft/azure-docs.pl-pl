...
* Możesz kontrolować w usłudze Azure AD, kto ma dostęp do aplikacji Workable.
* Możesz zezwolić swoim użytkownikom na automatyczne logowanie do aplikacji Workable (logowanie jednokrotne) przy użyciu kont usługi Azure AD.
...
Aby skonfigurować integrację usługi Azure AD z aplikacją Workable, potrzebne są następujące elementy:

* Subskrypcja usługi Azure AD. Jeśli nie masz środowiska usługi Azure AD, możesz skorzystać z miesięcznej wersji próbnej [tutaj](https://azure.microsoft.com/pricing/free-trial/)
* Subskrypcja aplikacji Workable z obsługą logowania jednokrotnego

## <a name="scenario-description"></a>Opis scenariusza

W tym samouczku skonfigurujesz i przetestujesz logowanie jednokrotne usługi Azure AD w środowisku testowym.

* Aplikacja Workable obsługuje logowanie jednokrotne inicjowane za pomocą **SP oraz IDP**
* Aplikacja Workable obsługuje aprowizowanie użytkowników typu **Just In Time**

## <a name="adding-workable-from-the-gallery"></a>Dodawanie aplikacji Workable z galerii

Aby skonfigurować integrację aplikacji Workable z usługą Azure AD, musisz dodać aplikację Workable z galerii do swojej listy zarządzanych aplikacji SaaS.
...
2. **[Konfigurowanie logowania jednokrotnego w aplikacji Workable](#configure-workable-single-sign-on)** — aby skonfigurować ustawienia logowania jednokrotnego po stronie aplikacji.
3. **[Tworzenie użytkownika testowego usługi Azure AD](#create-an-azure-ad-test-user)** — aby przetestować logowanie jednokrotne usługi Azure AD z użytkownikiem Britta Simon.
4. **[Przypisywanie użytkownika testowego usługi Azure AD](#assign-the-azure-ad-test-user)** — aby umożliwić użytkownikowi Britta Simon korzystanie z logowania jednokrotnego usługi Azure AD.
5. **[Tworzenie użytkownika testowego aplikacji Workable](#create-workable-test-user)** — aby mieć w aplikacji Workable odpowiednik użytkownika Britta Simon połączony z reprezentacją użytkownika w usłudze Azure AD.
...
4. Jeśli chcesz skonfigurować aplikację w trybie inicjalizacji **dostawcy tożsamości** , w sekcji **Podstawowa konfiguracja SAML** wykonaj następujące czynności:
    ...
    ![Zrzut ekranu przedstawia podstawową konfigurację języka SAML, w której można wprowadzić odpowiedź U R L.](common/both-replyurl.png)
...
7. W sekcji **Skonfiguruj aplikację Workable** skopiuj odpowiednie adresy URL zgodnie z wymaganiami.
...
Aby włączyć logowanie jednokrotne w aplikacji Workable, skontaktuj się z dedykowanym menedżerem ds. kont aplikacji Workable i podaj mu poniższe informacje.
...
W tej sekcji w aplikacji Workable jest tworzony użytkownik o nazwie Britta Simon. Aplikacja Workable obsługuje aprowizację użytkowników just in time, która jest domyślnie włączona. W tej sekcji nie musisz niczego robić. Jeśli użytkownik jeszcze nie istnieje w aplikacji Workable, zostanie utworzony po uwierzytelnieniu.

### <a name="test-single-sign-on"></a>Testowanie logowania jednokrotnego

W tej sekcji przetestujesz konfigurację logowania jednokrotnego usługi Azure AD przy użyciu panelu dostępu.

Po kliknięciu kafelka Workable w panelu dostępu powinno nastąpić automatyczne zalogowanie do aplikacji Workable, dla której skonfigurowano logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
