...
2. **[Skonfiguruj logowanie](#configure-planmyleave-single-sign-on)** jednokrotne w usłudze PlanMyLeave, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-planmyleave-single-sign-on"></a>Konfigurowanie logowania jednokrotnego PlanMyLeave
...
2. Przejdź do pozycji **Konfiguracja systemu**. Następnie w sekcji **Zarządzanie zabezpieczeniami** kliknij pozycję **firmy ustawienia protokołu SAML** .
    ...
    ![Konfigurowanie logowania jednokrotnego po stronie aplikacji](./media/planmyleave-tutorial/tutorial_planmyleave_002.png) 

3. W sekcji **Ustawienia SAML** kliknij ikonę Edytor.

    ![Konfigurowanie logowania jednokrotnego po stronie aplikacji](./media/planmyleave-tutorial/tutorial_planmyleave_003.png)
...
Po kliknięciu kafelka PlanMyLeave w panelu dostępu należy automatycznie zalogować się do PlanMyLeave, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
