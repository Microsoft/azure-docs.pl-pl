...
Dodaj szkolenie dotyczące uczenia zabezpieczeń programu Webroot z galerii aplikacji usługi Azure AD, aby rozpocząć zarządzanie aprowizacjim do szkolenia w zakresie zabezpieczeń Webroot. Więcej informacji o dodawaniu aplikacji z galerii znajdziesz [tutaj](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app). 
