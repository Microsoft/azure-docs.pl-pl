...
## <a name="configure-and-test-azure-ad-single-sign-on-for-appneta-performance-monitor"></a>Skonfiguruj i przetestuj Logowanie jednokrotne usługi Azure AD dla monitora wydajności AppNeta
...
Aby skonfigurować i przetestować Logowanie jednokrotne usługi Azure AD za pomocą monitora wydajności AppNeta, wykonaj następujące bloki konstrukcyjne:
...
1. W [Azure Portal](https://portal.azure.com/)na stronie integracja aplikacji **AppNeta Performance Monitor** Znajdź sekcję **Zarządzanie** i wybierz pozycję **Logowanie jednokrotne**.
...
- [Wypróbuj Monitor wydajności AppNeta z usługą Azure AD](https://aad.portal.azure.com/)
