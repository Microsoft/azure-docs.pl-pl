...
4. Jeśli chcesz skonfigurować aplikację w trybie inicjalizacji **dostawcy tożsamości** , w sekcji **Podstawowa konfiguracja SAML** wykonaj następujące czynności:
    ...
    ![Infor retails — informacje o rejestracji jednokrotnej w adresach URL i domenach zarządzania informacjami](common/idp-intiated.png)
...
5. Kliknij pozycję **Ustaw dodatkowe adresy URL** i wykonaj następujące kroki, jeśli chcesz skonfigurować aplikację w trybie inicjowania programu **SP** :
    ...
    ![Infor retails — informacje o rejestracji jednokrotnej w adresach URL i domenach zarządzania informacjami](common/metadata-upload-additional-signon.png)
...
Po kliknięciu kafelka infor retails (zarządzanie informacjami) w panelu dostępu należy automatycznie zalogować się do usługi infor Retail — zarządzanie informacjami, dla której skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
