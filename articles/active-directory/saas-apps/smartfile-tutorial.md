---
title: 'Samouczek: integracja Azure Active Directory z usługą SmartFile | Microsoft Docs'
...
ms.locfileid: "92522091"
---
# <a name="tutorial-azure-active-directory-integration-with-smartfile"></a>Samouczek: integracja Azure Active Directory z usługą SmartFile
...
W tej sekcji utworzysz w aplikacji SmartFile użytkownika o nazwie Britta Simon. Aby dodać użytkowników na platformie SmartFile, Pracuj z [zespołem pomocy technicznej SmartFile](https://support.lumanox.com/hc/sections/360003453152-SAML-Authentication) . Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.

### <a name="test-single-sign-on"></a>Testowanie logowania jednokrotnego 

W tej sekcji przetestujesz konfigurację logowania jednokrotnego usługi Azure AD przy użyciu panelu dostępu.

Po kliknięciu kafelka SmartFile na panelu dostępu powinno nastąpić automatyczne zalogowanie do aplikacji SmartFile, dla której skonfigurowano logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
