...
Po kliknięciu kafelka AuditBoard w panelu dostępu powinno nastąpić automatyczne zalogowanie do oprogramowania AuditBoard, dla którego skonfigurowano logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
