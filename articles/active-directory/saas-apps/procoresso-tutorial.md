...
2. **[Skonfiguruj jednordzeniowe logowanie](#configure-procore-sso-single-sign-on)** jednokrotne — w celu skonfigurowania ustawień logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-procore-sso-single-sign-on"></a>Skonfiguruj jednordzeniowe Logowanie jednokrotne
