...
Aby logowanie jednokrotne działało, należy ustanowić relację linku między użytkownikiem usługi Azure AD i powiązanym użytkownikiem w łączu Springer.
...
5. **[Utwórz użytkownika testowego linku Springer](#create-springer-link-test-user)** , aby uzyskać odpowiednik Britta Simon w łączu Springer, który jest połączony z reprezentacją użytkownika w usłudze Azure AD.
...
4. Jeśli chcesz skonfigurować aplikację w trybie inicjalizacji **dostawcy tożsamości** , w sekcji **Podstawowa konfiguracja SAML** wykonaj następujące czynności:
    ...
    ![Informacje dotyczące logowania jednokrotnego w domenie i adresach URL Springer](common/idp-relay.png)
...
5. Jeśli chcesz skonfigurować aplikację w trybie zainicjowania programu **SP** , wykonaj następujące czynności:
    ...
    ![Informacje dotyczące logowania jednokrotnego w domenie i adresach URL Springer](common/both-signonurl.png)
...
Aby skonfigurować Logowanie jednokrotne na stronie **linku Springer** , musisz wysłać skopiowany **adres URL metadanych federacji aplikacji** oraz odpowiednie skopiowane adresy URL z Azure Portal do [zespołu pomocy technicznej linku Springer](mailto:identity@springernature.com). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w linku Springer. Współpracuj z [zespołem pomocy technicznej linku Springer](mailto:identity@springernature.com) , aby dodać użytkowników z platformy linku Springer. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.
