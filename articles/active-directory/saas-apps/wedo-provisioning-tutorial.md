...
3. Określ, które dane mają być [mapowane między usługą Azure AD i WeDo](../app-provisioning/customize-application-attributes.md). 
...
9. Przejrzyj atrybuty użytkownika, które są synchronizowane z usługi Azure AD, do WEDO w sekcji **Mapowanie atrybutów** . Atrybuty wybrane jako **pasujące** właściwości są używane do dopasowania kont użytkowników w programie WeDo for Updates. Jeśli zdecydujesz się zmienić [pasujący atrybut docelowy](../app-provisioning/customize-application-attributes.md), należy się upewnić, że interfejs API WeDo obsługuje filtrowanie użytkowników na podstawie tego atrybutu. Wybierz przycisk **Zapisz** , aby zatwierdzić zmiany.
