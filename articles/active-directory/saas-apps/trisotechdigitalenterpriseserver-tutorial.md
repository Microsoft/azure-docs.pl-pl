...
2. Skonfiguruj Logowanie jednokrotne w usłudze **[Trisotech Digital Enterprise Server](#configure-trisotech-digital-enterprise-server-single-sign-on)** , aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-trisotech-digital-enterprise-server-single-sign-on"></a>Konfigurowanie logowania jednokrotnego w usłudze Trisotech Digital Enterprise Server
