...
2. **[Skonfiguruj logowanie](#configure-confirmit-horizons-single-sign-on)** jednokrotne w usłudze Confirmit Horizons — aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
4. Jeśli chcesz skonfigurować aplikację w trybie inicjalizacji **dostawcy tożsamości** , w sekcji **Podstawowa konfiguracja SAML** wykonaj następujące czynności:
    ...
    ![Confirmit Horizons domeny i adresy URL Logowanie jednokrotne](common/idp-intiated.png)
...
### <a name="configure-confirmit-horizons-single-sign-on"></a>Konfigurowanie logowania jednokrotnego w usłudze Confirmit Horizons
...
Po kliknięciu kafelka Confirmit Horizons w panelu dostępu należy automatycznie zalogować się do Horizons Confirmit, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
