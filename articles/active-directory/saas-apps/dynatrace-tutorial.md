...
1. W sekcji **certyfikat podpisywania SAML** wybierz przycisk **Edytuj** , aby otworzyć okno dialogowe **certyfikat podpisywania SAML** . Wykonaj poniższe czynności:
...
Aby skonfigurować Logowanie jednokrotne na stronie **dynaTrace** , musisz wysłać pobrany plik **XML metadanych Federacji** oraz odpowiednie skopiowane adresy URL z Azure Portal do [dynaTrace](https://www.dynatrace.com/support/help/shortlink/users-sso-hub). Aby skonfigurować połączenie SSO protokołu SAML na obu stronach, można wykonać instrukcje w witrynie sieci Web dynaTrace.
...
Po kliknięciu kafelka dynaTrace w panelu dostępu należy automatycznie zalogować się do dynaTrace, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
