...
2. **[Skonfiguruj logowanie](#configure-yardione-single-sign-on)** jednokrotne w usłudze YardiOne, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-yardione-single-sign-on"></a>Konfigurowanie logowania jednokrotnego YardiOne
