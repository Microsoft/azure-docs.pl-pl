...
1. Na stronie **administrator** przejdź do karty **informacje SAML** , a następnie wykonaj następujące czynności:
    ...
    ![Konfiguracja](./media/zylo-tutorial/saml-configuration-zylo.png)
