...
## <a name="configure-and-test-azure-ad-single-sign-on-for-e-days"></a>Skonfiguruj i przetestuj Logowanie jednokrotne usługi Azure AD dla dni elektronicznych
...
Aby skonfigurować i przetestować Logowanie jednokrotne usługi Azure AD za pomocą dni elektronicznych, wykonaj następujące bloki konstrukcyjne:
...
1. W [Azure Portal](https://portal.azure.com/)na stronie integracja aplikacji **E-Days** Znajdź sekcję **Zarządzanie** i wybierz pozycję **Logowanie jednokrotne**.
...
Po kliknięciu kafelka E-Days w panelu dostępu należy automatycznie zalogować się do dni roboczych, dla których skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Wypróbuj usługę Azure AD za pomocą dni E](https://aad.portal.azure.com/)
