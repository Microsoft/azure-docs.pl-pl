...
3. Określ, które dane mają być [mapowane między usługą Azure AD i Templafy OpenID Connect Connect](../app-provisioning/customize-application-attributes.md). 
