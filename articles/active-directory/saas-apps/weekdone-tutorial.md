...
2. **[Skonfiguruj logowanie](#configure-weekdone-single-sign-on)** jednokrotne w usłudze Weekdone, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
4. Jeśli chcesz skonfigurować aplikację w trybie inicjalizacji **dostawcy tożsamości** , w sekcji **Podstawowa konfiguracja SAML** wykonaj następujące czynności:
    ...
    ![Weekdone domenę i adresy URL Logowanie jednokrotne](common/idp-intiated.png)
...
5. Kliknij pozycję **Ustaw dodatkowe adresy URL** i wykonaj następujące kroki, jeśli chcesz skonfigurować aplikację w trybie inicjowania programu **SP** :
    ...
    ![Weekdone domenę i adresy URL Logowanie jednokrotne](common/metadata-upload-additional-signon.png)
...
### <a name="configure-weekdone-single-sign-on"></a>Konfigurowanie logowania jednokrotnego Weekdone
...
Po kliknięciu kafelka Weekdone w panelu dostępu należy automatycznie zalogować się do Weekdone, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
