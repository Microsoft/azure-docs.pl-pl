...
* Możesz korzystać z aplikacji Microsoft my Apps. Kliknięcie kafelka osoby w obszarze Moje aplikacje spowoduje przekierowanie do adresu URL logowania do osoby. Aby uzyskać więcej informacji o moich aplikacjach, zobacz [wprowadzenie do aplikacji Moje aplikacje](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
