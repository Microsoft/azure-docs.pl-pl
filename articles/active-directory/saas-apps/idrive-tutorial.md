---
title: 'Samouczek: integracja Azure Active Directory z usługą IDrive | Microsoft Docs'
...
W tej sekcji w aplikacji IDrive utworzysz użytkownika o nazwie Britta Simon. Aby dodać użytkowników na platformie IDrive, Pracuj z [zespołem pomocy technicznej iDrive](https://www.idrive.com/support) . Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.

### <a name="test-single-sign-on"></a>Testowanie logowania jednokrotnego 

W tej sekcji przetestujesz konfigurację logowania jednokrotnego usługi Azure AD przy użyciu panelu dostępu.

Po kliknięciu kafelka IDrive w panelu dostępu powinno nastąpić automatyczne zalogowanie do aplikacji IDrive, dla której skonfigurowano logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
