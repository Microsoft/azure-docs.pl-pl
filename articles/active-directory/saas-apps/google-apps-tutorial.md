...
Aby skonfigurować i przetestować Logowanie jednokrotne usługi Azure AD za pomocą łącznika Google Cloud (G Suite), wykonaj następujące bloki konstrukcyjne:
...
1. W [Azure Portal](https://portal.azure.com/)na stronie integracja aplikacji **łącznika Google Cloud (G Suite)** Znajdź sekcję **Zarządzanie** i wybierz pozycję **Logowanie jednokrotne**.
