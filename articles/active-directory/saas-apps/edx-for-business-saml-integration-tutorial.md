...
- [Jak chronić integrację z usługą edX dla firmowego protokołu SAML dzięki zaawansowanemu wglądowi i kontrolkom](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
