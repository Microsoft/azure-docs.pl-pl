...
2. **[Skonfiguruj logowanie](#configure-spaceiq-single-sign-on)** jednokrotne w usłudze SpaceIQ, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-spaceiq-single-sign-on"></a>Konfigurowanie logowania jednokrotnego SpaceIQ
