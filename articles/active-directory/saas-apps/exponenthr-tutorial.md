...
Aby skonfigurować Logowanie jednokrotne na stronie **ExponentHR** , musisz wysłać **adres URL metadanych federacji aplikacji** do [zespołu pomocy technicznej ExponentHR](mailto:support@exponenthr.com). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.

### <a name="create-exponenthr-test-user"></a>Utwórz użytkownika testowego ExponentHR

W tej sekcji utworzysz użytkownika o nazwie B. Simon w ExponentHR. Aby dodać użytkowników na platformie ExponentHR, Pracuj z [zespołem pomocy technicznej ExponentHR](mailto:support@exponenthr.com) . Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.

## <a name="test-sso"></a>Testuj Logowanie jednokrotne 

W tej sekcji przetestujesz konfigurację logowania jednokrotnego usługi Azure AD przy użyciu panelu dostępu.

Po kliknięciu kafelka ExponentHR w panelu dostępu należy automatycznie zalogować się do ExponentHR, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
