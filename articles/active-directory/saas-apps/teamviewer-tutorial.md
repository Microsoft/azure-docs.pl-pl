...
* Program TeamViewer obsługuje logowanie jednokrotne zainicjowane przez usługę **SP**

## <a name="adding-teamviewer-from-the-gallery"></a>Dodawanie programu TeamViewer z galerii
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-teamviewer"></a>Skonfiguruj i przetestuj Logowanie jednokrotne usługi Azure AD dla programu TeamViewer
...
Aby skonfigurować i przetestować Logowanie jednokrotne usługi Azure AD za pomocą programu TeamViewer, wykonaj następujące bloki konstrukcyjne:
...
1. **[Skonfiguruj Logowanie jednokrotne programu TeamViewer](#configure-teamviewer-sso)** — w celu skonfigurowania ustawień logowania jednokrotnego na stronie aplikacji.
    * **[Utwórz użytkownika testowego programu TeamViewer](#create-teamviewer-test-user)** , aby dysponować odpowiednikiem B. Simon w programie TeamViewer, który jest połączony z reprezentacją użytkownika w usłudze Azure AD.
...
1. W [Azure Portal](https://portal.azure.com/)na stronie integracja aplikacji programu **TeamViewer** Znajdź sekcję **Zarządzanie** i wybierz pozycję **Logowanie jednokrotne**.
...
Po kliknięciu kafelka programu TeamViewer w panelu dostępu należy automatycznie zalogować się do programu TeamViewer, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
...
- [Wypróbuj program TeamViewer z usługą Azure AD](https://aad.portal.azure.com/)