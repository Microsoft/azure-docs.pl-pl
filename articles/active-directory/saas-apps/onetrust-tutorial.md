...
2. Skonfiguruj Logowanie jednokrotne w **[oprogramowaniu OneTrust do zarządzania prywatnością](#configure-onetrust-privacy-management-software-single-sign-on)** , aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-onetrust-privacy-management-software-single-sign-on"></a>Konfigurowanie logowania jednokrotnego w ramach oprogramowania do zarządzania prywatnością OneTrust
