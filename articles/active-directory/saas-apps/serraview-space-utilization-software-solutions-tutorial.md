...
Po kliknięciu kafelka rozwiązania oprogramowania Serraview do wykorzystania miejsca w panelu dostępu należy automatycznie zalogować się do Serraview rozwiązań oprogramowania do użycia miejsca, dla których skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
