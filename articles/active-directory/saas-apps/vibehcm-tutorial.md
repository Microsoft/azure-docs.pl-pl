---
title: 'Samouczek: integracja Azure Active Directory z usługą Vibe HCM | Microsoft Docs'
...
2. **[Skonfiguruj logowanie](#configure-vibe-hcm-single-sign-on)** jednokrotne w usłudze Vibe HCM — aby skonfigurować pojedyncze ustawienia Sign-On po stronie aplikacji.
...
4. Jeśli chcesz skonfigurować aplikację w trybie inicjalizacji **dostawcy tożsamości** , w sekcji **Podstawowa konfiguracja SAML** użytkownik nie musi wykonywać żadnych kroków, ponieważ aplikacja jest już wstępnie zintegrowana z platformą Azure.
    ...
    ![Zrzut ekranu przedstawia podstawową konfigurację języka SAML przy użyciu linku Przekaż plik metadanych.](common/preintegrated.png)
...
### <a name="configure-vibe-hcm-single-sign-on"></a>Konfigurowanie Vibe HCM pojedynczego Sign-On

Aby skonfigurować Logowanie jednokrotne na stronie **Vibe HCM** , musisz wysłać **adres URL metadanych federacji aplikacji** do [zespołu pomocy technicznej Vibe HCM](mailto:support@vibehcm.com). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w Vibe HCM. Współpracuj z [zespołem pomocy technicznej Vibe HCM](mailto:support@vibehcm.com) , aby dodać użytkowników na platformie Vibe HCM. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.

### <a name="test-single-sign-on"></a>Testowanie logowania jednokrotnego 

W tej sekcji przetestujesz konfigurację logowania jednokrotnego usługi Azure AD przy użyciu panelu dostępu.

Po kliknięciu kafelka Vibe HCM w panelu dostępu należy automatycznie zalogować się do HCM Vibe, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
