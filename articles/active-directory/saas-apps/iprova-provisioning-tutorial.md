...
> * [Logowanie](./iprova-tutorial.md) jednokrotne do iProva (zalecane)
...
3. Określ, które dane mają być [mapowane między usługą Azure AD i iProva](../app-provisioning/customize-application-attributes.md). 
