...
3. Możesz użyć panelu programu Microsoft Access. Po kliknięciu kafelka Starmind w panelu dostępu zostanie on przekierowany do adresu URL logowania Starmind. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
