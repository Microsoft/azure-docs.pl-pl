...
Po kliknięciu kafelka nowy Relic (według organizacji) w panelu dostępu należy automatycznie zalogować się do nowego Relic (według organizacji), dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
