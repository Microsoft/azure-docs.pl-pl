...
* Hostowane Logowanie jednokrotne w usłudze MyCirqa **SP**
...
Po kliknięciu kafelka Logowanie jednokrotne MyCirqa w panelu dostępu należy automatycznie zalogować się do hostowanego logowania jednokrotnego MyCirqa, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
