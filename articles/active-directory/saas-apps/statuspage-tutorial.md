...
2. **[Skonfiguruj logowanie](#configure-statuspage-single-sign-on)** jednokrotne w usłudze StatusPage, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
4. Na stronie **Konfigurowanie logowania jednokrotnego za pomocą protokołu SAML** wykonaj następujące kroki:
    ...
    > [!NOTE]
    > Skontaktuj się z zespołem pomocy [SupportTeam@statuspage.io](mailto:SupportTeam@statuspage.io)technicznej StatusPage pod adresem, aby zażądać metadanych niezbędnych do skonfigurowania logowania jednokrotnego. 
    >
...
### <a name="configure-statuspage-single-sign-on"></a>Konfigurowanie logowania jednokrotnego StatusPage
