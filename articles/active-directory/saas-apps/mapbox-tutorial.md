...
## <a name="configure-and-test-azure-ad-sso-for-mapbox"></a>Skonfiguruj i przetestuj Logowanie jednokrotne usługi Azure AD dla MapBox
...
Aby skonfigurować i przetestować Logowanie jednokrotne usługi Azure AD za pomocą MapBox, wykonaj następujące czynności:
...
1. W Azure Portal na stronie integracja aplikacji **MapBox** Znajdź sekcję **Zarządzanie** i wybierz pozycję **Logowanie jednokrotne**.
...
* Kliknij pozycję Testuj tę aplikację w Azure Portal i należy automatycznie zalogować się do MapBox, dla którego skonfigurowano Logowanie jednokrotne

* Możesz korzystać z aplikacji Microsoft my Apps. Po kliknięciu kafelka MapBox w obszarze Moje aplikacje należy automatycznie zalogować się do MapBox, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji o moich aplikacjach, zobacz [wprowadzenie do aplikacji Moje aplikacje](../user-help/my-apps-portal-end-user-access.md).
