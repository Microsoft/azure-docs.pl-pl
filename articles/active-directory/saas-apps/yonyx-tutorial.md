...
2. Konfigurowanie logowania jednokrotnego ( **[Yonyx Interactive przewodników](#configure-yonyx-interactive-guides-single-sign-on)** ) na potrzeby konfigurowania ustawień logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-yonyx-interactive-guides-single-sign-on"></a>Konfigurowanie logowania jednokrotnego (Yonyx Interactive przewodników)
...
Po kliknięciu kafelka interaktywne przewodniki Yonyx w panelu dostępu należy automatycznie zalogować się do przewodników interaktywnych Yonyx, dla których skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
