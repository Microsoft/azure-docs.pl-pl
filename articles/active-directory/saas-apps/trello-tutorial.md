...
> [!NOTE]
> Należy uzyskać dostęp do ** \<informacji\> korporacyjnych** od Trello. Jeśli nie masz wartości informacji o użytkowniku, skontaktuj się z [zespołem pomocy technicznej Trello](mailto:support@trello.com) , aby uzyskać dostęp do swojego przedsiębiorstwa.
