...
2. **[Skonfiguruj funkcję logowania](#configure-lockpath-keylight-single-sign-on)** jednokrotnego w usłudze LockPath, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-lockpath-keylight-single-sign-on"></a>Konfigurowanie logowania jednokrotnego LockPath
...
1. Na stronie **Edytowanie ustawień SAML** wykonaj następujące czynności:
    ...
    g. Ustaw **aktywną** **obsługę administracyjną użytkowników** .
...
Po kliknięciu kafelka LockPath sygnalizatora w panelu dostępu należy automatycznie zalogować się do LockPath, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
