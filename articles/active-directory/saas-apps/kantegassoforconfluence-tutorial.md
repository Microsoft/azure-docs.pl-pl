...
2. **[Skonfiguruj logowanie JEDNOkrotne w usłudze Kantega dla usługi Confluence Single](#configure-kantega-sso-for-confluence-single-sign-on)** — aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-kantega-sso-for-confluence-single-sign-on"></a>Konfigurowanie logowania jednokrotnego w usłudze Kantega do usługi Confluence Single-on
