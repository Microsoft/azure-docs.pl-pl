...
2. **[Skonfiguruj logowanie](#configure-sequr-single-sign-on)** jednokrotne w usłudze Sequr, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-sequr-single-sign-on"></a>Konfigurowanie logowania jednokrotnego Sequr
