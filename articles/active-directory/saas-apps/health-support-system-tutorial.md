...
Po kliknięciu kafelka system obsługi kondycji w panelu dostępu należy automatycznie zalogować się do systemu pomocy technicznej, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
...
- [Jak chronić system obsługi kondycji za pomocą zaawansowanej widoczności i kontroli](/cloud-app-security/proxy-intro-aad)