---
title: 'Samouczek: integracja Azure Active Directory z programem Pavaso Digital Close | Microsoft Docs'
...
Aby skonfigurować logowanie jednokrotne po stronie aplikacji **Pavaso Digital Close** , należy wysłać pobrany **kod XML metadanych federacji** i odpowiednie adresy URL skopiowane z witryny Azure Portal [zespołowi pomocy technicznej aplikacji Pavaso Digital Close](mailto:support@pavaso.com). Ustawią oni to ustawienie tak, aby połączenie logowania jednokrotnego SAML było ustawione właściwie po obu stronach.
...
W tej sekcji w aplikacji Pavaso Digital Close utworzysz użytkownika o nazwie Britta Simon. Współpracuj z [zespołem pomocy technicznej Pavaso Digital Close](mailto:support@pavaso.com) , aby dodać użytkowników z platformy Digital Close Pavaso. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.

### <a name="test-single-sign-on"></a>Testowanie logowania jednokrotnego 

W tej sekcji przetestujesz konfigurację logowania jednokrotnego usługi Azure AD przy użyciu panelu dostępu.

Po kliknięciu kafelka Pavaso Digital Close w panelu dostępu powinno nastąpić automatyczne zalogowanie do aplikacji Pavaso Digital Close, dla której skonfigurowano logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
