...
## <a name="configure-and-test-azure-ad-single-sign-on-for-icims"></a>Skonfiguruj i przetestuj Logowanie jednokrotne w usłudze Azure AD dla ICIMS
...
Aby skonfigurować i przetestować Logowanie jednokrotne usługi Azure AD za pomocą ICIMS, wykonaj następujące bloki konstrukcyjne:
...
1. W [Azure Portal](https://portal.azure.com/)na stronie integracja aplikacji **ICIMS** Znajdź sekcję **Zarządzanie** i wybierz pozycję **Logowanie jednokrotne**.
...
Po kliknięciu kafelka ICIMS w panelu dostępu powinno nastąpić automatyczne zalogowanie do aplikacji ICIMS, dla której skonfigurowano logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](../user-help/my-apps-portal-end-user-access.md).
...
- [Wypróbuj ICIMS z usługą Azure AD](https://aad.portal.azure.com/)
