...
Z tego samouczka dowiesz się, jak zintegrować aplikację Ceridian Dayforce HCM z usługą Azure Active Directory (Azure AD).
Zintegrowanie aplikacji Ceridian Dayforce HCM z usługą Azure AD zapewnia następujące korzyści:

* Możesz kontrolować w usłudze Azure AD, kto ma dostęp do aplikacji Ceridian Dayforce HCM.
* Możesz zezwolić swoim użytkownikom na automatyczne logowanie do aplikacji Ceridian Dayforce HCM (logowanie jednokrotne) przy użyciu kont usługi Azure AD.
...
Aby skonfigurować integrację usługi Azure AD z aplikacją Ceridian Dayforce HCM, potrzebne są następujące elementy:

* Subskrypcja usługi Azure AD. Jeśli nie masz środowiska usługi Azure AD, możesz skorzystać z miesięcznej wersji próbnej [tutaj](https://azure.microsoft.com/pricing/free-trial/)
* Subskrypcja aplikacji Ceridian Dayforce HCM z obsługą logowania jednokrotnego
...
## <a name="adding-ceridian-dayforce-hcm-from-the-gallery"></a>Dodawanie aplikacji Ceridian Dayforce HCM z galerii
...
4. W polu wyszukiwania wpisz **Ceridian Dayforce HCM**, wybierz pozycję **Ceridian Dayforce HCM** z panelu wyników, a następnie kliknij przycisk **Dodaj**, aby dodać aplikację.

     ![Aplikacja Ceridian Dayforce HCM na liście wyników](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Konfigurowanie i testowanie logowania jednokrotnego usługi Azure AD

W tej sekcji skonfigurujesz i przetestujesz logowanie jednokrotne usługi Azure AD z aplikacją Ceridian Dayforce HCM, korzystając z danych testowego użytkownika **Britta Simon**.
Aby logowanie jednokrotne działało, należy ustanowić relację połączenia między użytkownikiem usługi Azure AD i powiązanym użytkownikiem aplikacji Ceridian Dayforce HCM.

Aby skonfigurować i przetestować logowanie jednokrotne usługi Azure AD przy użyciu aplikacji Ceridian Dayforce HCM, należy wykonać poniższe bloki konstrukcyjne:

1. **[Konfigurowanie logowania jednokrotnego usługi Azure AD](#configure-azure-ad-single-sign-on)** — aby umożliwić użytkownikom korzystanie z tej funkcji.
2. **[Konfigurowanie logowania jednokrotnego w aplikacji Ceridian Dayforce HCM](#configure-ceridian-dayforce-hcm-single-sign-on)** — aby skonfigurować ustawienia logowania jednokrotnego po stronie aplikacji.
3. **[Tworzenie użytkownika testowego usługi Azure AD](#create-an-azure-ad-test-user)** — aby przetestować logowanie jednokrotne usługi Azure AD z użytkownikiem Britta Simon.
4. **[Przypisywanie użytkownika testowego usługi Azure AD](#assign-the-azure-ad-test-user)** — aby umożliwić użytkownikowi Britta Simon korzystanie z logowania jednokrotnego usługi Azure AD.
5. **[Tworzenie użytkownika testowego aplikacji Ceridian Dayforce HCM](#create-ceridian-dayforce-hcm-test-user)** — aby mieć w aplikacji Ceridian Dayforce HCM odpowiednik użytkownika Britta Simon połączony z reprezentacją użytkownika w usłudze Azure AD.
...
Aby skonfigurować logowanie jednokrotne usługi Azure AD w aplikacji Ceridian Dayforce HCM, wykonaj następujące kroki:

1. W witrynie [Azure Portal](https://portal.azure.com/) na stronie integracji aplikacji **Ceridian Dayforce HCM** wybierz pozycję **Logowanie jednokrotne**.
...
### <a name="configure-ceridian-dayforce-hcm-single-sign-on"></a>Konfigurowanie logowania jednokrotnego aplikacji Ceridian Dayforce HCM
...
W tej sekcji włączysz dla użytkownika Britta Simon możliwość korzystania z logowania jednokrotnego platformy Azure, udzielając dostępu do aplikacji Ceridian Dayforce HCM.

1. W witrynie Azure Portal wybierz pozycję **Aplikacje dla przedsiębiorstw**, wybierz pozycję **Wszystkie aplikacje**, a następnie pozycję **Ceridian Dayforce HCM**.

    ![Blok Aplikacje dla przedsiębiorstw](common/enterprise-applications.png)

2. Na liście aplikacji wybierz pozycję **Ceridian Dayforce HCM**.

    ![Link aplikacji Ceridian Dayforce HCM na liście aplikacji](common/all-applications.png)
...
W tej sekcji utworzysz użytkownika o nazwie Britta Simon w aplikacji Ceridian Dayforce HCM. We współpracy z  [zespołem pomocy technicznej aplikacji Ceridian Dayforce HCM](https://www.ceridian.com/support) dodaj użytkowników na platformie Ceridian Dayforce HCM. Użytkownicy muszą być utworzeni i aktywowani przed rozpoczęciem korzystania z logowania jednokrotnego.

### <a name="test-single-sign-on"></a>Testowanie logowania jednokrotnego 

W tej sekcji przetestujesz konfigurację logowania jednokrotnego usługi Azure AD przy użyciu panelu dostępu.

Po kliknięciu kafelka Ceridian Dayforce HCM w panelu dostępu powinno nastąpić automatyczne zalogowanie do aplikacji Ceridian Dayforce HCM, dla której skonfigurowano logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
