...
Po kliknięciu kafelka pomocy technicznej Jitbit w panelu dostępu należy automatycznie zalogować się do pomocy technicznej Jitbit, dla której skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
