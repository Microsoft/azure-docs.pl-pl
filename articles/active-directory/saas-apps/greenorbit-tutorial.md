...
2. **[Skonfiguruj logowanie](#configure-greenorbit-single-sign-on)** jednokrotne w usłudze GreenOrbit, aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
### <a name="configure-greenorbit-single-sign-on"></a>Konfigurowanie logowania jednokrotnego GreenOrbit
