...
Po wybraniu kafelka porządkowania Predictix w panelu dostępu należy automatycznie zalogować się do wystąpienia porządkowania Predictix, dla którego skonfigurowano Logowanie jednokrotne. Aby uzyskać więcej informacji, zobacz [dostęp i używanie aplikacji w portalu Moje aplikacje](../user-help/my-apps-portal-end-user-access.md).
