...
> * [Logowanie](./coda-tutorial.md) jednokrotne do formatu CODA (zalecane)
...
3. Określ, które dane mają być [mapowane między usługą Azure AD i Coda](../app-provisioning/customize-application-attributes.md).
