...
* Usługa Oracle Fusion ERP obsługuje logowanie jednokrotne inicjowane przez **dostawcę usług**

## <a name="adding-oracle-fusion-erp-from-the-gallery"></a>Dodawanie aplikacji Oracle Fusion ERP z galerii
...
Aby skonfigurować i przetestować Logowanie jednokrotne usługi Azure AD za pomocą programu Oracle Fusion ERP, wykonaj następujące bloki konstrukcyjne:

1. **[Skonfiguruj Logowanie jednokrotne usługi Azure AD](#configure-azure-ad-sso)** , aby umożliwić użytkownikom korzystanie z tej funkcji.
    1. **[Utwórz użytkownika testowego usługi Azure AD](#create-an-azure-ad-test-user)** — aby przetestować Logowanie jednokrotne w usłudze Azure AD za pomocą usługi B. Simon.
    1. **[Przypisz użytkownika testowego usługi Azure AD](#assign-the-azure-ad-test-user)** — aby umożliwić usłudze B. Simon korzystanie z logowania jednokrotnego w usłudze Azure AD.
1. **[Skonfiguruj Logowanie jednokrotne w usłudze Oracle Fusion](#configure-oracle-fusion-erp-sso)** — aby skonfigurować ustawienia logowania jednokrotnego na stronie aplikacji.
...
1. W [Azure Portal](https://portal.azure.com/)na stronie integracja aplikacji **ERP Oracle Fusion** Znajdź sekcję **Zarządzanie** i wybierz pozycję **Logowanie jednokrotne**.
...
Po kliknięciu kafelka Oracle Fusion ERP w panelu dostępu powinno nastąpić automatyczne zalogowanie do aplikacji Oracle Fusion ERP, dla której skonfigurowano logowanie jednokrotne. Aby uzyskać więcej informacji na temat panelu dostępu, zobacz [wprowadzenie do panelu dostępu](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Wypróbuj program Oracle Fusion ERP z usługą Azure AD](https://aad.portal.azure.com/)
