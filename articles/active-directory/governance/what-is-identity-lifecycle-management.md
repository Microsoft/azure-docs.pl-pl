...
- [Zarządzanie dostępem użytkowników zewnętrznych w usłudze Azure AD upoważnienia](/azure/active-directory/governance/entitlement-management-external-users.md)
