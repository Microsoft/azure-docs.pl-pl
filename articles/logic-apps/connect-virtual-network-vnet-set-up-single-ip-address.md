...
1. W kolekcji Dodaj regułę zezwalającą na ruch do systemu docelowego.
   ...
   **Właściwości reguły sieci**
   ...
   | **Protokol** | <*połączenia — protokoły*> | Protokoły połączeń do użycia. Na przykład jeśli korzystasz z reguł sieciowej grupy zabezpieczeń, wybierz zarówno **TCP** , jak i **UDP**, a nie tylko **TCP**. |
   ...
   | **Adresy docelowe** | <*Destination-IP-Address*> | Adres IP systemu docelowego, do którego ma nastąpić ruch |
