...
* [Lista definicji Azure Policy dla Logic Apps](./policy-samples.md)
...
* [Jak włączyć ochronę przed usuwaniem i Przeczyszczaniem w programie Key Vault](../storage/blobs/soft-delete-overview.md?tabs=azure-portal)
