...
Poniżej przedstawiono limity dla aplikacji logiki, która rozpoczyna się od wyzwalacza żądania i umożliwia [Azure Active Directory otwierania uwierzytelniania](/azure/active-directory/develop/) (Azure AD OAuth) do autoryzacji wywołań przychodzących do wyzwalacza żądania:
...
> Ten tag działa w regionach, w których jest dostępna usługa Logic Apps.
> W przypadku łączników zarządzanych należy nadal korzystać z adresów IP.
