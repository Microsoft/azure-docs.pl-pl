...
description: Dowiedz się więcej o platformie Azure VPN Gateway obsługuje Border Gateway Protocol, standardowy protokół routingu używany do wymiany informacji o routingu i dostępie.
