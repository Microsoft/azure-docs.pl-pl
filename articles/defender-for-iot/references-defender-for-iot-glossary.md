...
| **Potwierdzenie zdarzenia alertu** | Poinstruuj usługę Defender for IoT, aby ukryć alert dla wykrytego zdarzenia. Alert zostanie wyzwolony ponownie, jeśli zdarzenie zostanie wykryte ponownie. | **[](#glossary-a) <br /> Alert <br /> [Informacje o zdarzeniu](#l) <br /> <br /> alertu [Wycisz zdarzenie alertu](#m)** |
...
| **Interfejs API** | Umożliwia zewnętrznym systemom dostęp do danych wykrytych przez usługę Defender for IoT i wykonywanie akcji przy użyciu zewnętrznego interfejsu API REST za pośrednictwem połączeń SSL. | **[Tokeny dostępu](#glossary-a)** |
...
| **Powiadomienia systemowe** | Powiadomienia z przeklasyfikowania lokalnej konsoli zarządzania:<br /><br />— Stan połączenia czujnika.<br /><br />-Błędy zdalnej kopii zapasowej. | **[](#n) <br /> Powiadomienia <br /> [Alert](#glossary-a)** |
