---
title: Skalowanie hostów sesji Azure Automation Windows Virtual Desktop (klasyczny) — Azure
description: Jak automatycznie skalować hosty sesji pulpitu wirtualnego systemu Windows (klasycznego) przy użyciu Azure Automation.
author: Heidilohr
ms.topic: how-to
ms.date: 03/30/2020
ms.author: helohr
...
Po znalezieniu dzierżawy z pulami hosta, które mają być skalowane, postępuj zgodnie z instrukcjami w temacie [Create a Azure Automation Account Uruchom jako](#create-an-azure-automation-run-as-account) , aby zebrać identyfikator aplikacji **AzureRunAsConnection** i użyj nazwy dzierżawy pulpitu wirtualnego systemu Windows uzyskanych z poprzedniego polecenia cmdlet w poniższym poleceniu cmdlet, aby utworzyć przypisanie roli:
...
5. Uruchom następujący skrypt programu PowerShell, aby utworzyć aplikację logiki platformy Azure i harmonogram wykonywania dla puli hostów
