...
> ![Zrzut ekranu poleceń cmdlet programu PowerShell Get-RDSRemoteApp z nazwami i FriendlyName wyróżniony, aby edytować niestandardową Właściwość R D P.](../media/singlecustomrdpproperty.png)
...
> [!div class="mx-imgBorder"]
> ![Zrzut ekranu poleceń cmdlet programu PowerShell Set-RDSRemoteApp z nazwami i FriendlyName wyróżniony, aby edytować niestandardową Właściwość R D P.](../media/multiplecustomrdpproperty.png)
...
> [!div class="mx-imgBorder"]
> ![Zrzut ekranu przedstawiający polecenie cmdlet programu PowerShell Get-RDSRemoteApp z wyróżnioną nazwą i przyjaznymi nazwami.](../media/resetcustomrdpproperty.png)
