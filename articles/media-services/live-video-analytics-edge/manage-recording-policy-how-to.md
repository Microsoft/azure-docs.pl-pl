...
* Określa, że po upływie okresu ważności obiektów BLOB przez 30 dni są one przenoszone z [warstwy dostępu gorąca do chłodna](https://docs.microsoft.com/azure/storage/blobs/storage-blob-storage-tiers?tabs=azure-portal).
...
* Aktualizacje zasad zarządzania cyklem życia nie są natychmiastowe. Aby uzyskać więcej informacji, zobacz [sekcję często zadawanych pytań](https://docs.microsoft.com/azure/storage/blobs/storage-lifecycle-management-concepts?tabs=azure-portal#faq) .
