---
title: Kontrakt danych rozszerzenia HTTP — Azure
description: Ten artykuł zawiera informacje na temat korzystania z protokołu HTTP w celu wysyłania komunikatów między modułami analizy wideo na żywo a modułem AI lub OKS.
ms.topic: overview
ms.date: 09/14/2020
...
ms.locfileid: "88691867"
---
# <a name="http-extension-data-contract"></a>Kontrakt danych rozszerzenia HTTP

Ten artykuł zawiera informacje na temat korzystania z protokołu HTTP w celu wysyłania komunikatów między modułami analizy wideo na żywo a modułem AI lub OKS.
...
![Hierarchia klas](./media/http-data-contract/class-hierarchy.png)
