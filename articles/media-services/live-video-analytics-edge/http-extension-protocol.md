...
Jeśli moduł zwróci odpowiedź z typem zawartości jako "Application/JSON", ale schemat JSON nie postępuje zgodnie ze schematem metadanych wnioskowania opisanym poniżej, ładunek wiadomości zostanie przekazany przez potok, ale współdziałanie zostanie zredukowane. Zapoznaj się z [tym](./inference-metadata-schema.md) artykułem, aby zapoznać się ze szczegółowymi informacjami dotyczącymi schematu metadanych wnioskowania.
