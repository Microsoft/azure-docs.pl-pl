...
* [Python 3](https://www.python.org/downloads/) (3.6.9 lub nowszy), [PIP 3](https://pip.pypa.io/en/stable/installing/) i opcjonalnie [venv](https://docs.python.org/3/library/venv.html).
