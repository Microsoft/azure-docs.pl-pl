...
description: Dowiedz się więcej na temat kolekcji Poster zawierającej pogrupowane żądania HTTP, które wywołują Azure Media Services interfejsy API REST.
