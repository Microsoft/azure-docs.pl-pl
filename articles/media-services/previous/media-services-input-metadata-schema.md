...
W tym artykule omówiono elementy i typy schematu XML, na których bazuje dane wejściowe metada&lt;(&gt;asset_id _metadata. xml).  Aby uzyskać informacje o pliku zawierającym metadane dotyczące wyjściowego elementu zawartości, zobacz [metadane wyjściowe](media-services-output-metadata-schema.md).  
...
| Nazwa | Opis |
| --- | --- |
| **AssetFile**<br /><br /> minOccurs = "1" maxOccurs = "niepowiązane" |Pojedynczy element podrzędny. Aby uzyskać więcej informacji, zobacz [AssetFile element](media-services-input-metadata-schema.md#AssetFile). |
...
| Nazwa | Typ | Opis |
| --- | --- | --- |
| **Nazwa**<br /><br /> Wymagany |**XS: ciąg** |Nazwa pliku zasobu. |
| **Rozmiar**<br /><br /> Wymagany |**XS: Long** |Rozmiar pliku zasobów w bajtach. |
| **Czas trwania**<br /><br /> Wymagany |**XS: czas trwania** |Czas trwania odtwarzania zawartości. Przykład: duration = "PT25M 37.757 S". |
| **NumberOfStreams**<br /><br /> Wymagany |**XS: int** |Liczba strumieni w pliku zasobów. |
| **FormatNames**<br /><br /> Wymagany |**XS: ciąg** |Nazwy formatów. |
| **FormatVerboseNames**<br /><br /> Wymagany |**XS: ciąg** |Sformatuj pełne nazwy. |
| **Rozpoczęcia** |**XS: czas trwania** |Godzina rozpoczęcia zawartości. Przykład: StartTime = "PT 2.669 S". |
...
| **Metadane**<br /><br /> minOccurs = "0" maxOccurs = "niepowiązane" |[Datadatatype](media-services-input-metadata-schema.md#MetadataType) |Metadane pliku zasobów reprezentowane jako ciągi key\value. Przykład:<br /><br /> **&lt;Metadata Key = "Language" value = "aparatu"/&gt;** |

## <a name="tracktype"></a><a name="TrackType"></a>Ścieżka śledzenia
Zapoznaj się z przykładem XML na końcu tego artykułu: [przykład XML](media-services-input-metadata-schema.md#xml).  

### <a name="attributes"></a>Atrybuty
| Nazwa | Typ | Opis |
| --- | --- | --- |
| **#C1**<br /><br /> Wymagany |**XS: int** |Indeks tej ścieżki audio lub wideo liczony od zera.<br /><br /> Nie musi to być TrackID używany w pliku MP4. |
...
| **Ujemną**<br /><br /> Wymagany |**XS: ciąg** |Podstawa czasu. Przykład: podstawa = "1/48000" |
| **NumberOfFrames** |**XS: int** |Liczba ramek (obecnych dla ścieżek wideo). |
| **Rozpoczęcia** |**XS: czas trwania** |Godzina rozpoczęcia śledzenia. Przykład: StartTime = "PT 2.669 S" |
...
| **Metadane**<br /><br /> minOccurs = "0" maxOccurs = "niepowiązane" |[Datadatatype](media-services-input-metadata-schema.md#MetadataType) |Ogólne ciągi klucz/wartość, których można użyć do przechowywania różnych informacji. Na przykład klucz = "język", i wartość = "aparatu". |

## <a name="audiotracktype-inherits-from-tracktype"></a><a name="AudioTrackType"></a>AudioTrackType (dziedziczy z metody tracktype)
...
| **SamplingRate**<br /><br /> Wymagany |**XS: int** |Częstotliwość próbkowania audio w próbkach/s lub Hz. |
...
## <a name="videotracktype-inherits-from-tracktype"></a><a name="VideoTrackType"></a>VideoTrackType (dziedziczy z metody tracktype)
...
| **Proporcj**<br /><br /> Wymagany |**XS: int** |Zakodowana wysokość wideo w pikselach. |
| **DisplayAspectRatioNumerator**<br /><br /> Wymagany |**XS: Double** |Licznik współczynnik proporcji wyświetlania wideo. |
| **DisplayAspectRatioDenominator**<br /><br /> Wymagany |**XS: Double** |Mianownik współczynnika proporcji wyświetlania wideo. |
| **DisplayAspectRatioDenominator**<br /><br /> Wymagany |**XS: Double** |Przykładowy współczynnik proporcji filmu wideo. |
...
| **Szybkości**<br /><br /> Wymagany |**XS: decimal** |Mierzona szybkość klatek wideo w formacie. 3F. |
...
## <a name="metadatatype"></a><a name="MetadataType"></a>Datadatatype
...
| Nazwa | Typ | Opis |
| --- | --- | --- |
| **głównych**<br /><br /> Wymagany |**XS: ciąg** |Klucz w parze klucz/wartość. |
| **value**<br /><br /> Wymagany |**XS: ciąg** |Wartość w parze klucz/wartość. |
...
| **PmtPid**<br /><br /> Wymagany |**XS: int** |Tabele mapy programu (PMTs) zawierają informacje o programach.  Aby uzyskać więcej informacji, zobacz [PMt](https://en.wikipedia.org/wiki/MPEG_transport_stream#PMT). |
| **PcrPid**<br /><br /> Wymagany |**XS: int** |Używany przez dekoder. Aby uzyskać więcej informacji, zobacz [PCR](https://en.wikipedia.org/wiki/MPEG_transport_stream#PCR) |
...
| Nazwa | Typ | Opis |
| --- | --- | --- |
| **Wartooć**<br /><br /> Wymagany |**XS: int** |Ustaw ten atrybut na 1, aby wskazać, że jest to prezentacja domyślna. |
| **Dub**<br /><br /> Wymagany |**XS: int** |Ustaw ten atrybut na 1, aby wskazać, że jest to prezentacja dubbed. |
...
| **Muzycznych**<br /><br /> Wymagany |**XS: int** |Ustaw ten atrybut na 1, aby wskazać, że ta ścieżka zawiera teksty. |
| **Karaoke**<br /><br /> Wymagany |**XS: int** |Ustaw ten atrybut na 1, aby wskazać, że reprezentuje śledzenie karaoke (muzyka w tle, bez vocals). |
| **Wymuszone**<br /><br /> Wymagany |**XS: int** |Ustaw ten atrybut na 1, aby wskazać, że jest to wymuszona prezentacja. |
| **HearingImpaired**<br /><br /> Wymagany |**XS: int** |Ustaw ten atrybut na 1, aby wskazać, że ta ścieżka jest dla osób słabo słyszących. |
| **VisualImpaired**<br /><br /> Wymagany |**XS: int** |Ustaw ten atrybut na 1, aby wskazać, że ta ścieżka jest dla wizualizacji. |
| **CleanEffects**<br /><br /> Wymagany |**XS: int** |Ustaw ten atrybut na 1, aby wskazać, że ta ścieżka ma czyste efekty. |
| **AttachedPic**<br /><br /> Wymagany |**XS: int** |Ustaw ten atrybut na 1, aby wskazać, że ta ścieżka zawiera obrazy. |
...
| Nazwa | Typ | Opis |
| --- | --- | --- |
| **Program**<br /><br /> minOccurs = "0" maxOccurs = "niepowiązane" |[ProgramType](media-services-input-metadata-schema.md#ProgramType) |W przypadku plików zasobów w formacie MPEG-TS program zawiera informacje o programach w pliku zasobów. |
...
| Nazwa | Typ | Opis |
| --- | --- | --- |
| **VideoTrack**<br /><br /> minOccurs = "0" maxOccurs = "niepowiązane" |[VideoTrackType (dziedziczy z metody tracktype)](media-services-input-metadata-schema.md#VideoTrackType) |Zawiera informacje o ścieżkach wideo w pliku zasobów. |
...
| Nazwa | Typ | Opis |
| --- | --- | --- |
| **AudioTrack**<br /><br /> minOccurs = "0" maxOccurs = "niepowiązane" |[AudioTrackType (dziedziczy z metody tracktype)](media-services-input-metadata-schema.md#AudioTrackType) |Zawiera informacje o ścieżkach audio w pliku zasobów. |
