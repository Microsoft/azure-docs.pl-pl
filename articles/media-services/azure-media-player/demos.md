...
| Funkcje |
| VOD do wstawiania w usłudze AD — ogromne | [Dynamiczny](https://amp.azure.net/libs/amp/latest/samples/dynamic_vast_ads_vod.html) | Brak | Wstaw wstępnie rozbudowane i gotowe reklamy do VOD zasobów. |
| Szybkość odtwarzania | [Dynamiczny](https://amp.azure.net/libs/amp/latest/samples/dynamic_playback_speed.html)| Brak | Umożliwia podglądom sterowanie szybkością oglądania wideo. |
...
| Podpisy Live CEA 708 | [Dynamiczny](https://amp.azure.net/libs/amp/latest/samples/dynamic_live_captions.html) | Brak | Odtwarzanie przy użyciu podpisów przychodzących CEA 708 na żywo z podpisami wyrównanymi do lewej. |
...
| DD + | [Dynamiczny](https://amp.azure.net/libs/amp/latest/samples/dynamic_dolbyDigitalPlus.html) | Brak | Odtwarzanie zawartości przy użyciu DD + audio. |
| Opcje |
...
| Rejestruj zdarzenia | [Dynamiczny](https://amp.azure.net/libs/amp/latest/samples/dynamic_registerEvents.html) | Brak | Odtwarzanie przy użyciu detektorów zdarzeń. |
| Rejestrowanie | [Dynamiczny](https://amp.azure.net/libs/amp/latest/samples/dynamic_logging.html) | [Statyczny](https://amp.azure.net/libs/amp/latest/samples/videotag_logging.html) | Włączenie pełnego rejestrowania w konsoli programu. |
| Diagnostyka | [Dynamiczny](https://amp.azure.net/libs/amp/latest/samples/dynamic_diagnostics.html) | Brak | Pobieranie danych diagnostycznych. Ten przykład działa tylko na niektóre techniczne. |
| AES |
...
| Programowo wybierz |
| Wybieranie ścieżki tekstowej | [Dynamiczny](https://amp.azure.net/libs/amp/latest/samples/dynamic_selectTextTrack.html) | Brak | Wybieranie ścieżki WebVTT z listy Śledzenie. |
| Wybierz szybkość transmisji bitów | [Dynamiczny](https://amp.azure.net/libs/amp/latest/samples/dynamic_selectBitrate.html) | Brak | Wybieranie szybkości transmisji bitów z listy szybkości transmisji bitów. Ten przykład działa tylko na niektóre techniczne. |
| Wybieranie strumienia audio | [Dynamiczny](https://amp.azure.net/libs/amp/latest/samples/dynamic_selectAudioStream.html) | Brak | Wybieranie strumienia audio z listy dostępnych strumieni audio. Ten przykład działa tylko na niektóre techniczne. |
