...
Zaleca się zapoznanie się z niestandardowymi transformacjemi, odczytując [sposób kodowania przy użyciu niestandardowej transformacji](encode-custom-preset-rest-how-to.md).
