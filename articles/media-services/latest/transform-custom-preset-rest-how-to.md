...
- [Skonfiguruj funkcję publikowania dla Azure Media Services wywołań interfejsu API REST](setup-postman-rest-how-to.md).<br/>Pamiętaj, aby postępować zgodnie z ostatnim krokiem w temacie [pobieranie tokenu usługi Azure AD](setup-postman-rest-how-to.md#get-azure-ad-token). 
