...
Zaleca się zapoznanie się z niestandardowymi transformacjemi, odczytując [sposób kodowania przy użyciu niestandardowej transformacji](transform-custom-preset-rest-how-to.md).
...
[Generuj miniatury przy użyciu platformy .NET](transform-generate-thumbnails-dotnet-how-to.md)