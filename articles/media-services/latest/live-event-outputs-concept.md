...
Aby uzyskać więcej informacji, zobacz [Stany wydarzeń na żywo i rozliczenia](live-event-states-billing-concept.md).
...
* Podczas tworzenia zdarzenia można włączyć transkrypcje na żywo. Domyślnie transkrypcja dynamiczna jest wyłączona. Aby uzyskać więcej informacji na temat transkrypcji na żywo, Przeczytaj [dynamiczną transkrypcję](live-event-live-transcription-how-to.md).
...
Aby uzyskać szczegółowe informacje na temat danych wyjściowych na żywo, zobacz [Korzystanie z funkcji DVR w chmurze](live-event-cloud-dvr-time-how-to.md).
