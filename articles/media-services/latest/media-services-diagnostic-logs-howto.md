...
- Przejrzyj  [Media Services monitora](monitoring/monitor-media-services.md).
...
* [Azure Monitor dzienników diagnostycznych](../../azure-monitor/essentials/platform-logs-overview.md)
