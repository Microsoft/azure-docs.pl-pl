...
Jeśli nie wiesz, jak uzyskać identyfikator dzierżawy i Identyfikator subskrypcji, zobacz [jak znaleźć identyfikator dzierżawy](setup-azure-tenant-how-to.md) i [Znajdź swój identyfikator dzierżawy](setup-azure-tenant-how-to.md).
...
[Jak utworzyć element zawartości](asset-create-asset-how-to.md)
