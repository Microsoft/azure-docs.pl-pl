...
* [Zasady kluczy zawartości](drm-content-key-policy-concept.md) usługi AMS przy użyciu interfejsu API usługi AMS v3, Azure Portal lub [Azure Media Services Explorer (AMSE)](https://github.com/Azure/Azure-Media-Services-Explorer)
...
Zapoznaj się z artykułem [Projektowanie systemu ochrony zawartości z wieloma drmmi przy użyciu funkcji kontroli dostępu](./architecture-design-multi-drm-system.md) , aby uzyskać więcej szczegółowych informacji o podsystemie.
...
Konfiguracja zasad dotyczących [kluczy zawartości](drm-content-key-policy-concept.md) i [zasad przesyłania STRUMIENIOWEGO](stream-streaming-policy-concept.md) dla technologii DRM i AES-128.  Zmień wartość `ContentKeyPolicyRestriction` w obszarze zasady klucza zawartości.
