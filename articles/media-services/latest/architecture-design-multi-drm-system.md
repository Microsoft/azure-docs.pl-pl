...
![Podsystem DRM z CENC](./media/architecture-design-multi-drm-system/media-services-generic-drm-subsystem-with-cenc.png)
...
* Dodaj uprawnienia do aplikacji w usłudze Azure AD na karcie **Konfiguracja** aplikacji. Dla każdej aplikacji, w wersji lokalnej i wdrożonej wymagane są uprawnienia.
    ...
    ![Uprawnienia](./media/architecture-design-multi-drm-system/media-services-perms-to-other-apps.png)
...
![Niestandardowe konto domeny dzierżawy usługi Azure AD jeden](./media/architecture-design-multi-drm-system/media-services-ad-tenant-domain1.png)
...
![Niestandardowe konto domeny dzierżawy usługi Azure AD dwa](./media/architecture-design-multi-drm-system/media-services-ad-tenant-domain2.png)

**Konto Microsoft**: strona logowania konto Microsoft dla użytkowników.

![Niestandardowe konto domeny dzierżawy usługi Azure AD trzy](./media/architecture-design-multi-drm-system/media-services-ad-tenant-domain3.png)
...
![Korzystanie z EME dla oprogramowania PlayReady](./media/architecture-design-multi-drm-system/media-services-eme-for-playready1.png)
...
![Wtyczki odtwarzacza dla oprogramowania PlayReady](./media/architecture-design-multi-drm-system/media-services-eme-for-playready2.png)
...
![Użyj EME dla Widevine](./media/architecture-design-multi-drm-system/media-services-eme-for-widevine1.png)

Widevine nie uniemożliwia przechwycenia ekranu chronionego wideo.

![Wtyczki odtwarzacza dla Widevine](./media/architecture-design-multi-drm-system/media-services-eme-for-widevine2.png)
...
![Nieuprawnieni użytkownicy](./media/architecture-design-multi-drm-system/media-services-unentitledusers.png)
...
![Niestandardowa usługa STS z kluczem symetrycznym](./media/architecture-design-multi-drm-system/media-services-running-sts1.png)
...
![Niestandardowa usługa STS z kluczem asymetrycznym](./media/architecture-design-multi-drm-system/media-services-running-sts2.png)
