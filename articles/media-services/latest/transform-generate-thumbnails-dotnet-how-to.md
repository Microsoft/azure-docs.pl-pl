...
Zaleca się zapoznanie się z niestandardowymi transformacjami przez zapoznanie się [z kodowaniem przy użyciu niestandardowego przekształcenia — .NET](transform-custom-presets-how-to.md).
