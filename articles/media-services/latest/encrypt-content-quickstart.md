...
Przekaż i przetwórz zawartość zgodnie z opisem w artykule [Zarządzanie zasobami w Azure Portal](manage-assets-quickstart.md)
...
[Zarządzanie elementami zawartości](manage-assets-quickstart.md)
