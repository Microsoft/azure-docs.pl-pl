---
title: Media Services języku Python Basic — Przewodnik Szybki Start
description: W tym przewodniku szybki start przedstawiono, jak wykonać podstawowe kodowanie przy użyciu języka Python i Azure Media Services.
...
ms.locfileid: "102185457"
---
# <a name="media-services-basic-encoding-with-python"></a>Media Services podstawowe kodowanie przy użyciu języka Python

[!INCLUDE [media services api v3 logo](./includes/v3-hr.md)]

## <a name="introduction"></a>Wprowadzenie

W tym przewodniku szybki start przedstawiono, jak wykonać podstawowe kodowanie przy użyciu języka Python i Azure Media Services. Używa interfejsu API usługi Media Service v3 2020-05-01.

## <a name="prerequisites"></a>Wymagania wstępne

- Jeśli nie masz subskrypcji platformy Azure, przed rozpoczęciem utwórz [bezpłatne konto](https://azure.microsoft.com/free/?WT.mc_id=A261C142F).
- Utwórz grupę zasobów, która ma być używana w tym przewodniku Szybki Start.
- Utwórz konto Media Services v3.
- Pobierz klucz konta magazynu.
- Utwórz nazwę główną usługi i klucz.

## <a name="get-the-sample"></a>Pobieranie przykładu

Utwórz rozwidlenie i Sklonuj próbkę znajdującą się w [repozytorium przykładów języka Python](https://github.com/Azure-Samples/media-services-v3-python). W tym przewodniku szybki start pracujemy z przykładem BasicEncoding.

## <a name="create-the-env-file"></a>Utwórz plik ENV

Pobierz wartości z konta, aby utworzyć plik *. env* . To prawo, Zapisz go bez nazwy, tylko rozszerzenie.  Użyj *przykład. env* jako szablonu, a następnie Zapisz plik *. env* w folderze BasicEncoder w sklonowanym lokalnym.

## <a name="try-the-code"></a>Wypróbuj kod

Poniższy kod jest dokładnie komentarzem.  Użyj całego skryptu lub użyj jego części do własnego skryptu.

W tym przykładzie liczba losowa jest generowana do nazywania elementów, aby można było zidentyfikować je jako grupę utworzoną razem podczas uruchamiania skryptu.  Liczba losowa jest opcjonalna i może zostać usunięta po zakończeniu testowania skryptu.

Nie używamy adresu URL sygnatury dostępu współdzielonego dla wejściowego zasobu w tym przykładzie.
...
Po zakończeniu korzystania z przewodnika Szybki Start Usuń zasoby utworzone w grupie zasobów.

## <a name="next-steps"></a>Następne kroki

Zapoznaj się z [Media Services Python SDK](https://docs.microsoft.com/python/api/azure-mgmt-media/?view=azure-python)