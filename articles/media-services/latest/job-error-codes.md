...
Poniższy dokument REST zawiera szczegółowe wyjaśnienia dotyczące [kodów błędów zadań](https://docs.microsoft.com/rest/api/media/jobs/get#joberrorcode).
