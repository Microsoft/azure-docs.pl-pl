...
- [Skalowanie przesyłania strumieniowego przy użyciu sieci CDN](stream-scale-streaming-cdn-concept.md)
...
[Zarządzanie punktami końcowymi przesyłania strumieniowego](stream-manage-streaming-endpoints-how-to.md)
