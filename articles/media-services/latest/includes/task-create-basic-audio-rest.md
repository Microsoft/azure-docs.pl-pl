...
ms.locfileid: "95996910"
---
<!--Create a basic audio transform REST-->

Następujące polecenie REST platformy Azure tworzy podstawową transformację audio. Zastąp wartości `subscriptionID` , `resourceGroup` i wartościami, dla `accountName` których obecnie pracujesz. Nadaj nazwę przekształceniu według ustawienia `transformName` .
