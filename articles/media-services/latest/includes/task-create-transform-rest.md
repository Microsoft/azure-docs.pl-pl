...
ms.locfileid: "94918211"
---
<!--Create a basic transform REST-->

Następujące polecenie REST platformy Azure tworzy podstawowy zasób audio. Zastąp wartości `subscriptionID` , `resourceGroup` i wartościami, dla `accountName` których obecnie pracujesz. Nadaj nazwę przekształcenia, ustawiając `transformName` tutaj.

Zmień na `@odata.type` jedno z [dostępnych ustawień wstępnych](https://docs.microsoft.com/rest/api/media/transforms/createorupdate#definitions), na przykład `#Microsoft.Media.AudioAnalyzerPreset` .
