...
ms.locfileid: "101705468"
---
<!--Create a thumbnail sprites REST-->

Następujące polecenie REST platformy Azure tworzy przekształcenie Sprite z miniaturą. Zastąp wartości `subscriptionID` , `resourceGroup` i wartościami, dla `accountName` których obecnie pracujesz. 

Nadaj nazwę przekształceniu według ustawienia `transformName` .
