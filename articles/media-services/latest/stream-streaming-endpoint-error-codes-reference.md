...
ms.locfileid: "106282141"
---
# <a name="streaming-endpoint-origin-errors"></a>Błędy punktu końcowego przesyłania strumieniowego (źródło)

W tym temacie opisano błędy, które mogą pojawić się w [usłudze Azure Media Services Streaming Endpoint Service](stream-streaming-endpoint-concept.md).
