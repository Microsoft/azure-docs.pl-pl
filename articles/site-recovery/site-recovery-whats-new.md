...
--- | --- | --- | --- | --- | ---
[Pakiet zbiorczy 54](https://support.microsoft.com/topic/update-rollup-54-for-azure-site-recovery-50873c7c-272c-4a7a-b9bb-8cd59c230533)  | 9.41.5888.1 | 5.1.6620.0 | 9.41.5888.1 | 5.1.6620.0  | 2.0.9202.0
[Pakiet zbiorczy 53](https://support.microsoft.com/topic/update-rollup-53-for-azure-site-recovery-060268ef-5835-bb49-7cbc-e8c1e6c6e12a)  | 9.40.5850.1 | 5.1.6537.0 | 9.40.5850.1 | 5.1.6537.0  | 2.0.9202.0
[Pakiet zbiorczy 52](https://support.microsoft.com/help/4597409/)  | 9.39.5796.1 | 5.1.6458.0 | 9.39.5796.1 | 5.1.6458.0  | 2.0.9196.0
[Pakiet zbiorczy 51](https://support.microsoft.com/help/4590304)  | 9.38.5761.1 | 5.1.6400.0 | 9.38.5761.1 | 5.1.6400.0  | 2.0.9193.0
[Pakiet zbiorczy 50](https://support.microsoft.com/help/4582666/) | 9.37.5724.1 | 5.1.6347.0 | 9.37.5724.1 | 5.1.6347.0  | 2.0.9192.0
...
## <a name="updates-february-2021"></a>Aktualizacje (luty 2021)

### <a name="update-rollup-54"></a>Pakiet zbiorczy aktualizacji 54

[Pakiet zbiorczy aktualizacji 54](https://support.microsoft.com/topic/update-rollup-54-for-azure-site-recovery-50873c7c-272c-4a7a-b9bb-8cd59c230533) udostępnia następujące aktualizacje:
...
**Odzyskiwanie po awarii maszyny wirtualnej platformy Azure** | Odzyskiwanie po awarii strefy do strefy przy użyciu Azure Site Recovery znajduje się teraz w 4 więcej regionach — Europa Północna, Wschodnie stany USA, środkowe stany USA i zachodnie stany USA 2.<br/>
**Maszyna wirtualna VMware/odzyskiwanie po awarii na platformie Azure** | Aktualizacja obejmuje obsługę portalu do wybierania grup rozmieszczeń zbliżeniowe dla oprogramowania VMware/Machines po włączeniu replikacji.<br/><br/> Ochrona maszyn VMware z rozmiarem dysku danych do 32 TB jest teraz obsługiwane.
**Odzyskiwanie po awarii funkcji Hyper-V do platformy Azure** | Aktualizacja obejmuje obsługę portalu do wybierania grup rozmieszczeń zbliżeniowe dla maszyn funkcji Hyper-V po włączeniu replikacji.


## <a name="updates-january-2021"></a>Aktualizacje (styczeń 2021)

### <a name="update-rollup-53"></a>Pakiet zbiorczy aktualizacji 53

[Pakiet zbiorczy aktualizacji 53](https://support.microsoft.com/topic/update-rollup-53-for-azure-site-recovery-060268ef-5835-bb49-7cbc-e8c1e6c6e12a) udostępnia następujące aktualizacje:

**Aktualizowanie** | **Szczegóły**
--- | ---
**Dostawcy i agenci** | Aktualizacje Site Recovery agentów i dostawców zgodnie z opisem w zestawie zbiorczym.
**Rozwiązywanie poprawek/ulepszeń** | Szereg poprawek i ulepszeń, które opisano szczegółowo w pakiecie zbiorczym. 
**Odzyskiwanie po awarii maszyny wirtualnej platformy Azure** | Replikacja tagów jest teraz obsługiwana. Wszystkie Tagi dodane do maszyn wirtualnych, dysków i kart sieciowych platformy Azure w regionie źródłowym są replikowane do maszyn w regionie docelowym.<br/><br/> Maszyny wirtualne platformy Azure z systemem Debian 10 są teraz obsługiwane na potrzeby replikacji.
**Maszyna wirtualna VMware/odzyskiwanie po awarii na platformie Azure** | Aktualizacja obejmuje ulepszenia rejestrowania w przypadku replikacji maszyn wirtualnych VMware na platformę Azure i udoskonalone komunikaty o błędach.<br/><br/> Na potrzeby replikacji obsługiwane są maszyny wirtualne VMware i maszyny fizyczne z systemem Debian 10.


## <a name="updates-november-2020"></a>Aktualizacje (listopad 2020)

### <a name="update-rollup-52"></a>Pakiet zbiorczy aktualizacji 52

[Pakiet zbiorczy aktualizacji 52](https://support.microsoft.com/help/4597409/update-rollup-52-for-azure-site-recovery) udostępnia następujące aktualizacje:

**Aktualizowanie** | **Szczegóły**
--- | ---
**Dostawcy i agenci** | Aktualizacje Site Recovery agentów i dostawców zgodnie z opisem w zestawie zbiorczym.
**Rozwiązywanie poprawek/ulepszeń** | Szereg poprawek i ulepszeń, które są szczegółowo opisane w pakiecie zbiorczym, w tym o nowej obsłudze systemu Linux dla usługi mobilności.
**Odzyskiwanie po awarii maszyny wirtualnej platformy Azure** | Teraz obsługiwane w przypadku maszyn wirtualnych z systemem RHEL 8,3 i Oracle Linux 7,9
**Maszyna wirtualna VMware/odzyskiwanie po awarii na platformie Azure** | Teraz obsługiwane w przypadku maszyn wirtualnych z systemem RHEL 8,3, Oracle Linux 7,9/8.3.

## <a name="updates-october-2020"></a>Aktualizacje (październik 2020)

### <a name="update-rollup-51"></a>Pakiet zbiorczy aktualizacji 51

[Pakiet zbiorczy aktualizacji 51](https://support.microsoft.com/help/4590304/update-rollup-51-for-azure-site-recovery) udostępnia następujące aktualizacje:
...
## <a name="updates-september-2020"></a>Aktualizacje (2020 września)

### <a name="update-rollup-50"></a>Pakiet zbiorczy aktualizacji 50

[Pakiet zbiorczy aktualizacji 50](https://support.microsoft.com/help/4582666/update-rollup-50-for-azure-site-recovery) udostępnia następujące aktualizacje:
