...
[Azure Resource Manager szablon](update-mgmt-enable-template.md) jest dostępny, aby ułatwić wdrożenie Update Management na nowym lub istniejącym koncie usługi Automation i log Analytics obszarze roboczym w ramach subskrypcji.
...
Dostępny jest [szablon Menedżer zasobów](update-mgmt-enable-template.md) platformy Azure ułatwiający wdrożenie Update Management na nowym lub istniejącym koncie usługi Automation i Azure Monitor Log Analytics obszarze roboczym w ramach subskrypcji. Nie konfiguruje zakresu maszyn, które powinny być zarządzane, jest to wykonywane w osobnym kroku po użyciu szablonu.
...
* Aby uzyskać szczegółowe informacje na temat pracy z Update Management, zobacz [Zarządzanie aktualizacjami dla maszyn wirtualnych](update-mgmt-manage-updates-for-vm.md).
