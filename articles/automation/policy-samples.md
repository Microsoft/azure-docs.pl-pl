...
ms.locfileid: "83648381"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-automation"></a>Azure Policy wbudowane definicje zasad dla Azure Automation

Ta strona jest indeksem [Azure Policy](../governance/policy/overview.md) wbudowanych definicji zasad dla Azure Automation. Aby uzyskać dodatkowe Azure Policy wbudowane dla innych usług, zobacz [Azure Policy wbudowane definicje](../governance/policy/samples/built-in-policies.md).
