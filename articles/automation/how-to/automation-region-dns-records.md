...
>[!NOTE]
>Rejestracja hybrydowego procesu roboczego elementu Runbook systemu Linux kończy się niepowodzeniem z nowymi rekordami, chyba że jest w wersji 1.6.10.2 lub nowszej. Musisz uaktualnić program do nowszej wersji [agenta log Analytics dla systemu Linux](../../azure-monitor/platform/agent-linux.md) , aby komputer otrzymał zaktualizowaną wersję roli proces roboczy i korzystał z tych nowych rekordów. Istniejące maszyny będą nadal działać bez żadnych problemów.  
...
| Środkowe stany USA |`https://<accountId>.webhook.cus.azure-automation.net`<br>`https://<accountId>.agentsvc.cus.azure-automation.net`<br>`https://<accountId>.jrds.cus.azure-automation.net` |
| Południowo-środkowe stany USA |`https://<accountId>.webhook.scus.azure-automation.net`<br>`https://<accountId>.agentsvc.scus.azure-automation.net`<br>`https://<accountId>.jrds.scus.azure-automation.net` |
...
| Wschodnie stany USA |`https://<accountId>.webhook.eus.azure-automation.net`<br>`https://<accountId>.agentsvc.eus.azure-automation.net`<br>`https://<accountId>.jrds.eus.azure-automation.net` |
...
| Europa Zachodnia |`https://<accountId>.webhook.we.azure-automation.net`<br>`https://<accountId>.agentsvc.we.azure-automation.net`<br>`https://<accountId>.jrds.we.azure-automation.net` |
