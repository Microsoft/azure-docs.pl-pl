...
Użyj funkcji z poniższej tabeli, aby uzyskać dostęp do certyfikatów w elemencie Runbook języka Python 2 i 3. Elementy Runbook języka Python 3 są obecnie dostępne w wersji zapoznawczej.
...
Poniższy przykład pokazuje, jak uzyskać dostęp do certyfikatów w elementach Runbook języka Python 3 (wersja zapoznawcza).
