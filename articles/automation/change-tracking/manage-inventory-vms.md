...
5. Aby rozpocząć włączanie komputera, wybierz pozycję **Włącz**.
   ...
   ![Widok opcji dołączania](./media/manage-inventory-vms/inventory-onboarding-options.png)
   ...
   ![Wyświetlanie spisu](./media/manage-inventory-vms/inventory-onboarded.png)
...
![Wyświetlanie grup maszyn na stronie spisu](./media/manage-inventory-vms/inventory-machine-groups.png)
...
![Wyświetl stronę grupy maszyn](./media/manage-inventory-vms/machine-group-page.png)
...
![Utwórz nową grupę maszyn](./media/manage-inventory-vms/create-new-group.png)
...
* Aby uzyskać szczegółowe informacje na temat pracy z funkcją, zobacz [zarządzanie Change Tracking i spisem](manage-change-tracking.md).
* Aby dowiedzieć się więcej o śledzeniu zmian oprogramowania, zobacz [śledzenie zmian oprogramowania w środowisku przy użyciu Change Tracking](overview.md).
