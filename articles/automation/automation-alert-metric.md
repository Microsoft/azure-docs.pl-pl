...
W tym artykule dowiesz się, jak utworzyć [alert dotyczący metryki](../azure-monitor/platform/alerts-metric-overview.md) na podstawie stanu ukończenia elementu Runbook.
...
1. W obszarze **Grupa akcji**wybierz pozycję **Określ grupę akcji**. Grupa akcji to grupa akcji, których można użyć w więcej niż jednym alercie. Mogą one obejmować, ale nie są ograniczone do powiadomień e-mail, elementów Runbook, elementy webhook i wiele innych. Aby dowiedzieć się więcej na temat grup akcji i kroków tworzenia tych, które wysyłają powiadomienia e-mail, zobacz [Tworzenie grup akcji i zarządzanie nimi](../azure-monitor/platform/action-groups.md).
