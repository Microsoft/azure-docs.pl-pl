...
description: Ten artykuł zawiera przykładowy skrypt programu PowerShell, który ustawia dozwolone rozmiary maszyn wirtualnych (VM) w Azure Lab Services.
ms.devlang: azurecli
ms.topic: sample
ms.date: 08/11/2020
