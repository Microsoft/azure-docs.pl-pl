...
Na koniec w sklepie Analytics jest wysyłana kwerenda przy użyciu **Power BI** , aby wyróżnić wgląd w zachowanie dzierżawy i korzystanie z aplikacji biletów Wingtip. Uruchamiasz zapytania, które:
