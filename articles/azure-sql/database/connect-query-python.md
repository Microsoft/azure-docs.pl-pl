...
ms.locfileid: "84054413"
---
# <a name="quickstart-use-python-to-query-a-microsoft-azure-sql-database"></a>Szybki Start: używanie języka Python do wykonywania zapytań w bazie danych SQL Microsoft Azure
