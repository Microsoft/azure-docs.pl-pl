---
title: Migrowanie do nowych zadań Elastic Database (wersja zapoznawcza)
...
- Zadania z wieloma wyzwalaczami z różnymi harmonogramami są rozdzielone na wiele zadań ze schematem nazewnictwa: " \<jobName\> ( \<scheduleName\> )".
