...
- Dowiedz się [, jak monitorować problemy z wydajnością za pomocą Azure SQL Analytics](https://docs.microsoft.com/azure/log-analytics/log-analytics-azure-sql).
