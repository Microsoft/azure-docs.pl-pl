---
title: Wbudowane definicje zasad dla Azure SQL Database
description: Wyświetla Azure Policy wbudowane definicje zasad dla Azure SQL Database i SQL Managed Instance. Te wbudowane definicje zasad zapewniają typowe podejścia do zarządzania zasobami platformy Azure.
ms.date: 04/14/2021
ms.topic: reference
author: stevestein
ms.author: sstein
...
ms.locfileid: "107498099"
---
# <a name="azure-policy-built-in-definitions-for-azure-sql-database--sql-managed-instance"></a>Azure Policy wbudowane definicje dla Azure SQL Database & SQL Managed Instance
...
- Azure Policy ma zastosowanie do Azure SQL Database nie jest wymuszane w przypadku korzystania z języka T-SQL lub programu SSMS. 
