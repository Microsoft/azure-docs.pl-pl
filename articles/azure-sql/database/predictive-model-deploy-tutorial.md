...
W [drugiej części](predictive-model-build-compare-tutorial.md)pokazano, jak utworzyć i szkolić wiele modeli uczenia maszynowego w języku R, a następnie wybrać największą precyzję.

## <a name="prerequisites"></a>Wymagania wstępne

* W trzeciej części tej serii samouczków przyjęto założenie, że wykonano [**część jeden**](predictive-model-prepare-data-tutorial.md) i [**drugą część**](predictive-model-build-compare-tutorial.md).
...
Teraz można użyć procedury składowanej, `predict_rentalcount_new` aby przewidzieć liczbę czynszów z nowych danych.
