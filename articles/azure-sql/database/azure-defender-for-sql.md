...
## <a name="1-enable-azure-defender"></a>1. Włącz usługę Azure Defender
...
## <a name="2-start-tracking-vulnerabilities-and-investigating-threat-alerts"></a>2. Rozpocznij śledzenie luk w zabezpieczeniach i badanie alertów dotyczących zagrożeń
...
## <a name="3-manage-azure-defender-settings"></a>3. Zarządzanie ustawieniami usługi Azure Defender
...
## <a name="4-manage-azure-defender-settings-for-a-database"></a>4. Zarządzanie ustawieniami usługi Azure Defender dla bazy danych
