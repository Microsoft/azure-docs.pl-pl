...
|----------|--------------------------------|------------|
|`avg_instance_cpu_percent`|Użycie procesora CPU przez proces SQL skojarzony z elastyczną pulą, mierzony przez podstawowy system operacyjny. Dostępne w widoku [sys.dm_db_resource_stats](https://docs.microsoft.com/sql/relational-databases/system-dynamic-management-views/sys-dm-db-resource-stats-azure-sql-database) w każdej bazie danych, a w widoku [sys.elastic_pool_resource_stats](https://docs.microsoft.com/sql/relational-databases/system-catalog-views/sys-elastic-pool-resource-stats-azure-sql-database) w `master` bazie danych. Ta Metryka jest również emitowana do Azure Monitor, gdzie ma [nazwę](https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported#microsoftsqlserverselasticpools) `sqlserver_process_core_percent` , i może być wyświetlana w Azure Portal. Ta wartość jest taka sama dla każdej bazy danych w tej samej puli elastycznej.|Poniżej 70%. Można zaakceptować sporadyczne krótkie skoki do 90%.|
...
- Aby zapoznać się z wprowadzeniem do pul elastycznych, zobacz [Pule elastyczne ułatwiają zarządzanie wieloma bazami danych w Azure SQL Database i skalowanie](https://docs.microsoft.com/azure/sql-database/sql-database-elastic-pool)ich.
