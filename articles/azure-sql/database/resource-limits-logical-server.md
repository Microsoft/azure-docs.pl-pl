...
Całkowite użycie procesora i pamięci według obciążeń użytkowników i procesów wewnętrznych jest raportowane w widokach [sys. dm_db_resource_stats](https://docs.microsoft.com/sql/relational-databases/system-dynamic-management-views/sys-dm-db-resource-stats-azure-sql-database) i [sys. resource_stats](https://docs.microsoft.com/sql/relational-databases/system-catalog-views/sys-resource-stats-azure-sql-database) , w `avg_instance_cpu_percent` i w `avg_instance_memory_percent` kolumnach. Te dane są również raportowane za pośrednictwem `sqlserver_process_core_percent` `sqlserver_process_memory_percent` metryk i Azure monitor dla [pojedynczych baz danych](https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported#microsoftsqlserversdatabases) i [pul elastycznych](https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported#microsoftsqlserverselasticpools) na poziomie puli.
