...
> [!NOTE]
> **Ta zawartość jest specyficzna dla Azure SQL Database.** Azure SQL Database jest oparta na najnowszej stabilnej wersji aparatu bazy danych Microsoft SQL Server, dlatego większość zawartości jest podobna, ale opcje rozwiązywania problemów i narzędzia mogą się różnić. Aby uzyskać więcej informacji na temat blokowania w SQL Server, zobacz [Omówienie i rozwiązywanie problemów z blokowaniem SQL Server](/troubleshoot/sql/performance/understand-resolve-blocking).
