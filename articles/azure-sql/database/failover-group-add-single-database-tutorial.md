...
1. Na ostrzeżeniu wybierz pozycję **tak** , aby powiadomić, że sesje TDS zostaną rozłączone.
   ...
   ![Praca awaryjna grupy trybu failover zawierającej bazę danych w usłudze SQL Database](./media/failover-group-add-single-database-tutorial/failover-sql-db.png)
