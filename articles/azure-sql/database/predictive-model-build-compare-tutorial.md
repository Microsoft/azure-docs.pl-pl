...
* W drugiej części tego samouczka założono, że została wykonana [**część pierwszej**](predictive-model-prepare-data-tutorial.md) i jej wymagania wstępne.

## <a name="train-two-models"></a>Uczenie dwóch modeli

Aby znaleźć najlepszy model dla danych o wypożyczeniu narciarskim, Utwórz dwa różne modele (regresja liniowa i drzewo decyzyjne) i sprawdź, który z nich jest bardziej dokładny. Będziesz używać ramki danych `rentaldata` utworzonej w pierwszej części tej serii.
...
![Porównywanie dwóch modeli](./media/predictive-model-build-compare-tutorial/compare-models.png)
...
> [Samouczek: Wdrażanie modelu predykcyjnego w języku R z Azure SQL Database Machine Learning Services (wersja zapoznawcza)](predictive-model-deploy-tutorial.md)
