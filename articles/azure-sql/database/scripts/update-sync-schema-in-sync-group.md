...
Dodatkowe przykłady skryptów programu PowerShell w usłudze SQL Database można znaleźć w [skryptach programu PowerShell w Azure SQL Database](../powershell-script-content-guide.md).
...
- Konfigurowanie synchronizacji danych
    ...
    - Z programem PowerShell
        ...
        -  [Używanie programu PowerShell do synchronizowania bazy danych w Azure SQL Database i bazy danych w wystąpieniu SQL Server](sql-data-sync-sync-data-between-azure-onprem.md)
