...
description: Dowiedz się więcej na temat nowych funkcji i ulepszeń Azure SQL Database & usługi i dokumentacji wystąpienia zarządzanego SQL
...
| [Replikacja transakcyjna](../managed-instance/replication-transactional-overview.md) | Replikowanie zmian z tabel do innych baz danych umieszczonych w wystąpieniach zarządzanych SQL, bazach danych SQL lub wystąpieniach SQL Server lub aktualizowanie tabel w przypadku zmiany niektórych wierszy w innych wystąpieniach zarządzanych SQL lub wystąpieniu SQL Server. Aby uzyskać więcej informacji, zobacz [Konfigurowanie replikacji w wystąpieniu zarządzanym usługi Azure SQL](../managed-instance/replication-between-two-instances-configure-tutorial.md). |
...
- Skonfiguruj zachowanie wystąpienia zarządzanego SQL przy użyciu [globalnych flag śledzenia](https://azure.microsoft.com/updates/global-trace-flags-are-now-available-in-azure-sql-database-managed-instance/).
...
Rola RBAC współautor wystąpienia zarządzanego SQL w przypadku zastosowania do grupy zasobów (RG) nie jest stosowana do wystąpienia zarządzanego SQL i nie ma żadnego wpływu.

**Obejście**: Skonfiguruj rolę współautor wystąpienia zarządzanego SQL dla użytkowników na poziomie subskrypcji.
...
W tym przykładzie pokazano, że w pewnych okolicznościach, ze względu na określoną dystrybucję plików, wystąpienie zarządzane SQL może osiągnąć limit 35-TB zarezerwowane dla dołączonego dysku platformy Azure Premium, gdy użytkownik może nie oczekiwać.
...
Moduły CLR umieszczone w wystąpieniu zarządzanym SQL i połączone serwery lub zapytania rozproszone, które odwołują się do bieżącego wystąpienia czasami nie mogą rozpoznać adresu IP wystąpienia lokalnego. Ten błąd jest przejściowym problemem.
