...
Dowiedz się więcej o [interfejsie API interfejsu wiersza polecenia platformy Azure o pojedynczej bazie danych](single-database-manage.md#azure-cli).
