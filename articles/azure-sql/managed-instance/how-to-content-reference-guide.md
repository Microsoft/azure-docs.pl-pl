...
- [Monitoruj przestrzeń OLTP w pamięci](../in-memory-oltp-monitor-space.md)
...
- [Inicjowanie ręcznego przełączania użytkownika na wystąpienie zarządzane SQL](user-initiated-failover.md)
