...
- Wymaga zainstalowanej najnowszej wersji programu [SSMS](https://docs.microsoft.com/sql/ssms/sql-server-management-studio-ssms) .
...
3. Uruchom następujący skrypt SQL, który używa wstępnie skonfigurowanego konta magazynu i klucza sygnatury dostępu współdzielonego, aby [utworzyć poświadczenie](https://docs.microsoft.com/sql/t-sql/statements/create-credential-transact-sql) w wystąpieniu zarządzanym.
...
- Aby uzyskać informacje na temat rozwiązywania problemów z kopią zapasową w adresie URL, zobacz [SQL Server Tworzenie i rozwiązywanie problemów z usługą Backup](https://docs.microsoft.com/sql/relational-databases/backup-restore/sql-server-backup-to-url-best-practices-and-troubleshooting)
