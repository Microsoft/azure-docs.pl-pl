---
title: 'Wystąpienie zarządzane Oracle do SQL: Przewodnik migracji'
...
- Aby dowiedzieć się więcej na temat wystąpienia zarządzanego usługi Azure SQL, zobacz: 
  - [Omówienie wystąpienia zarządzanego usługi Azure SQL](../../database/sql-database-paas-overview.md)
