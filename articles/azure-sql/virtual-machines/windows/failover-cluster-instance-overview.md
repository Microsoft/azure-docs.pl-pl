...
Aby rozpocząć, zobacz [SQL Server wystąpienia klastra trybu failover z bezpośrednie miejsca do magazynowania](failover-cluster-instance-azure-shared-disks-manually-configure.md). 
