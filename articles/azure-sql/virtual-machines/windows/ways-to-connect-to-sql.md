...
ms.locfileid: "84041952"
---
# <a name="connect-to-a-sql-server-virtual-machine-on-azure"></a>Nawiązywanie połączenia z maszyną wirtualną programu SQL Server na platformie Azure
...
Jeśli wolisz korzystać z pełnego przewodnika po aprowizacji i łączności, zobacz [Inicjowanie obsługi administracyjnej SQL Server maszyny wirtualnej na platformie Azure](create-sql-vm-portal.md).
