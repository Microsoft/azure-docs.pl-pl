---
title: Format telemetrii wydawcy programu Microsoft OPC
description: Ten artykuł zawiera omówienie pliku ustawień konfiguracji
author: jehona-m
ms.author: jemorina
...
ms.locfileid: "104787555"
---
# <a name="opc-publisher-telemetry-format"></a>Format telemetrii wydawcy OPC

Wydawca OPC w wersji 2,6 i nowszej obsługują standardowy format JSON OPC UA PubSub, jak określono w [części 14 specyfikacji OPC UA](https://opcfoundation.org/developer-tools/specifications-unified-architecture/part-14-pubsub/) i wygląda następująco:
```
{
  "MessageId": "18",
  "MessageType": "ua-data",
...
Ponadto wszystkie wersje programu OPC Publisher obsługują niestandardowy, prosty format telemetrii JSON, który jest zgodny z [Azure Time Series Insights](https://azure.microsoft.com/services/time-series-insights/) i wygląda następująco:
```
[
   {
...
## <a name="opc-publisher-telemetry-configuration-file-format"></a>Format pliku konfiguracji telemetrii wydawcy OPC
```
