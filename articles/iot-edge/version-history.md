...
* **IoT Edge 1,2 (wersja zapoznawcza)** zawiera dodatkową zawartość dla funkcji i możliwości dostępnych w najnowszej wersji zapoznawczej: [1,2 — RC1](https://github.com/Azure/azure-iotedge/releases/tag/1.2-rc1)
