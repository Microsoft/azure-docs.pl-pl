...
Możesz skonfigurować usługę Azure DNS do rozpoznawania nazw hostów w domenie publicznej. Na przykład jeśli zakupiono nazwę domeny *contoso. xyz* z rejestratora nazw domen, można skonfigurować Azure DNS, aby hostować domenę *contoso. xyz* i rozpoznać *`www.contoso.xyz`* adres IP serwera sieci Web lub aplikacji sieci Web.
