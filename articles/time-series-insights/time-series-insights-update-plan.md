...
- Przeczytaj więcej na temat pozyskiwania [danych](./concepts-ingestion-overview.md).
- Zapoznaj się z artykułem dotyczącym [magazynu danych](./concepts-storage.md)
- Dowiedz się więcej na temat [modelowania danych](./concepts-model-overview.md) w wersji zapoznawczej Time Series Insights.
