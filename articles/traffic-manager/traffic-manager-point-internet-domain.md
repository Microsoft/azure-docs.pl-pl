...
* [Traffic Manager — wyłączanie, Włączanie lub usuwanie profilu](./traffic-manager-manage-profiles.md)
* [Traffic Manager — wyłączanie lub włączanie punktu końcowego](./traffic-manager-manage-endpoints.md)