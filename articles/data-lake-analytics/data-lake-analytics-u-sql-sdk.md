...
- Ustaw zmienną środowiskową **SCOPE_CPP_SDK** .
    ...
    Jeśli uzyskasz Microsoft Visual C++ i Windows SDK przez zainstalowanie narzędzi Data Lake Tools for Visual Studio, upewnij się, że masz następujący folder:
