...
- [Narzędzia](../private-link/create-private-endpoint-powershell.md)
...
Nmap (Maper sieci) to narzędzie bezpłatne i typu "open source" służące do przeprowadzania inspekcji sieci i zabezpieczeń. Aby uzyskać więcej informacji i link do pobierania, https://nmap.orgodwiedź stronę. Za pomocą tego narzędzia można upewnić się, że prywatny punkt końcowy nasłuchuje połączeń na porcie 1433.
