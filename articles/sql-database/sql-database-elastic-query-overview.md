...
Wykonywanie zdalnych wywołań procedur składowanych lub funkcji zdalnych przy użyciu programu [\_Sp Execute \_Remote](https://msdn.microsoft.com/library/mt703714).
