...
Można skonfigurować i uzyskać informacje o regułach alertów przy użyciu następujących interfejsów:

* [Azure Portal](../monitoring-and-diagnostics/insights-alerts-portal.md)
* [PowerShell](../azure-monitor/platform/alerts-classic-portal.md)
* [Interfejs wiersza polecenia](../azure-monitor/platform/alerts-classic-portal.md)
...
> [!IMPORTANT]
> Metryki alertów są dostępne tylko dla wystąpienia zarządzanego. Metryki alertów dla poszczególnych baz danych w wystąpieniu zarządzanym są niedostępne. Dane telemetryczne diagnostyki baz danych są dostępne w postaci [dzienników diagnostycznych](sql-database-metrics-diag-logging.md#diagnostic-telemetry-for-export-for-azure-sql-database). Alerty w dziennikach diagnostycznych mogą być skonfigurowane z poziomu produktu [analitycznego SQL](../azure-monitor/insights/azure-sql.md) przy użyciu [skryptów alertów dziennika](../azure-monitor/insights/azure-sql.md#creating-alerts-for-managed-instances) dla wystąpienia zarządzanego.
...
1. W [witrynie Azure Portal](https://portal.azure.com/)Znajdź wystąpienie zarządzane SQL, które chcesz monitorować, a następnie wybierz je.

2. Wybierz element menu **metryki** w sekcji monitorowanie.

   ![Monitorowanie](media/sql-database-managed-instance-alerts/mi-alerting-menu-annotated.png)
...
6. W okienku utwórz regułę alertu kliknij pozycję **nazwa warunku** (w przykładzie pokazano miejsce do magazynowania)
   ...
   ![Zdefiniuj warunek](media/sql-database-managed-instance-alerts/mi-create-metrics-alert-smaller-annotated.png)
