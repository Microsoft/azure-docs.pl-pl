...
- Domyślne sortowanie dla wszystkich baz danych utworzonych na serwerze `SQL_LATIN1_GENERAL_CP1_CI_AS`SQL Database to, gdzie `LATIN1_GENERAL` jest angielski (Stany Zjednoczone), `CP1` jest stroną kodową 1252, `CI` bez uwzględniania wielkości liter i `AS` jest uwzględniana w akcentie.
