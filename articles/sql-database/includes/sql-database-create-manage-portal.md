...
- [Tworzenie pojedynczej bazy danych](../sql-database-single-database-get-started.md)
- [Tworzenie puli elastycznej](../sql-database-elastic-pool.md#creating-a-new-sql-database-elastic-pool-using-the-azure-portal)
- [Tworzenie wystąpienia zarządzanego](../sql-database-managed-instance-get-started.md)
- [Tworzenie maszyny wirtualnej SQL](../../virtual-machines/windows/sql/quickstart-sql-vm-create-portal.md)