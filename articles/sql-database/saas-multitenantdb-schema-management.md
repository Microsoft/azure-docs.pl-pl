...
6. W programie SSMS Otwórz plik *... \\Moduły uczenia zarządzania\\ \\DeployReferenceData. SQL*.
...
- **SP\_Add\_Target\_Group** tworzy nazwę grupy docelowej *DemoServerGroup*i dodaje docelowe elementy członkowskie do grupy.

- **członek\_grupy\_Dodaj\_grupę\_docelową dodatku SP** dodaje następujące elementy:
...
2. W programie SSMS Otwórz pozycję *... \\Moduły uczenia zarządzania\\ \\OnlineReindex. SQL*.
