...
Następujące polecenie sqlpackage importuje bazę danych **AdventureWorks2017** z magazynu lokalnego na serwer Azure SQL Database. Tworzy nową bazę danych o nazwie **myMigratedDatabase** z warstwą usługi **Premium** i celem usługi **P6** . Zmień te wartości zgodnie z potrzebami w danym środowisku.
