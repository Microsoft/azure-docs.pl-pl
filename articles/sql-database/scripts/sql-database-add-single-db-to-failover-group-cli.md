...
Ten przykładowy skrypt interfejsu wiersza polecenia platformy Azure tworzy pojedynczą bazę danych, tworzy grupę trybu failover, dodaje do niej bazę danych i testuje tryb failover.
