...
|**Właściwości**|**Always Encrypted**|**Niewidoczne szyfrowanie danych**|
|---|---|---|
...
|---|---|
|**Podstawowy**|Aplikacje z kilku użytkownikami i bazą danych, która nie ma wysokich wymagań dotyczących współbieżności, skalowania i wydajności. |
