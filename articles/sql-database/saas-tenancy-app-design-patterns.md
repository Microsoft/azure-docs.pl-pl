...
- **Izolacja dzierżawy:** &nbsp; izolacja i wydajność danych (czy obciążenie jednej dzierżawy ma wpływ na innych).
...
- **Szerszym:** &nbsp; łatwość obsługi dostosowań schematu, które są specyficzne dla dzierżawy lub klasy dzierżawcy.
