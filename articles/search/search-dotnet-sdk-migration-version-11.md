...
+ [Dokumentacja interfejsu API dla biblioteki klienta](/dotnet/api/overview/azure/search.documents-readme?view=azure-dotnet)
...
+ [ Dokumentacja interfejsu APIAzure.Search.Document](/dotnet/api/overview/azure/search.documents-readme?view=azure-dotnet)