...
ms.locfileid: "82838619"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-cognitive-search"></a>Azure Policy wbudowane definicje zasad dla platformy Azure Wyszukiwanie poznawcze

Ta strona jest indeksem [Azure Policy](../governance/policy/overview.md) wbudowanych definicji zasad dla wyszukiwanie poznawcze platformy Azure. Aby uzyskać dodatkowe Azure Policy wbudowane dla innych usług, zobacz [Azure Policy wbudowane definicje](../governance/policy/samples/built-in-policies.md).

Nazwa każdej wbudowanej definicji zasad łączy się z definicją zasad w tym Azure Portal. Użyj linku w kolumnie **GitHub** , aby wyświetlić źródło w [Azure Policy repozytorium GitHub](https://github.com/Azure/azure-policy).
