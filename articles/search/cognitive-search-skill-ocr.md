...
ms.locfileid: "88935334"
---
# <a name="ocr-cognitive-skill"></a>Umiejętność OCR

Umiejętność **optycznego rozpoznawania znaków (OCR)** rozpoznaje drukowany i odręczny tekst w plikach obrazu. Ta umiejętność używa modeli uczenia maszynowego zapewnianych przez [Przetwarzanie obrazów](../cognitive-services/computer-vision/home.md) API [v 3.0](https://westcentralus.dev.cognitive.microsoft.com/docs/services/computer-vision-v3-ga/operations/5d986960601faab4bf452005) w Cognitive Services. Umiejętność **OCR** jest mapowana na następujące funkcje:
