...
description: Wyświetla Azure Policy wbudowane definicje zasad dla Azure Cognitive Search. Te wbudowane definicje zasad zapewniają typowe podejścia do zarządzania zasobami platformy Azure.
ms.date: 04/14/2021
ms.topic: reference
author: HeidiSteen
ms.author: heidist
...
Ta strona jest indeksem [Azure Policy](../governance/policy/overview.md) wbudowanych definicji zasad dla Azure Cognitive Search. Aby uzyskać Azure Policy wbudowanych funkcji dla innych usług, [Azure Policy wbudowane definicje](../governance/policy/samples/built-in-policies.md).
