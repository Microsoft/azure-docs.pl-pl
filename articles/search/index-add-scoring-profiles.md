...
```  
 ...
 To zapytanie wyszukuje termin "Inn" i przekazuje w bieżącej lokalizacji. Zwróć uwagę, że to zapytanie zawiera inne parametry, takie jak `scoringParameter` . Parametry zapytania są opisane w [dokumentach wyszukiwania &#40;&#41;interfejsu API REST platformy Azure wyszukiwanie poznawcze ](https://docs.microsoft.com/rest/api/searchservice/Search-Documents).  
