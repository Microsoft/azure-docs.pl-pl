...
Po zdefiniowaniu analizatora, tokenizatora, filtr tokenu lub filtr char nie można go modyfikować. Nowe ustawienia można dodać do istniejącego indeksu tylko wtedy, gdy `allowIndexDowntime` flaga ma wartość true w żądaniu aktualizacji indeksu:
...
|Type|Typ analizatorze z listy obsługiwanych analizatorów. Zobacz kolumnę **analyzer_type** w tabeli [analizatory](#AnalyzerTable) poniżej.|  
...
| ---- | ----------- |  
|Nazwa|Musi zawierać tylko litery, cyfry, spacje, kreski i znaki podkreślenia, może zaczynać się i kończyć tylko znakami alfanumerycznymi i mieć ograniczone do 128 znaków.|  
|Type|Musi mieć wartość "#Microsoft. Azure. Search. CustomAnalyzer".|  
...
|Tokenizatora|Wymagane. Ustaw jeden z wstępnie zdefiniowanych tokenizatory wymienionych w poniższej tabeli [tokenizatory](#Tokenizers) lub Custom tokenizatora określony w definicji indeksu.|  
...
| ---- | ----------- | 
|Nazwa|Musi zawierać tylko litery, cyfry, spacje, kreski i znaki podkreślenia, może zaczynać się i kończyć tylko znakami alfanumerycznymi i mieć ograniczone do 128 znaków.|  
|Type|Typ filtru char z listy obsługiwanych filtrów char. Zobacz **char_filter_type** kolumny w tabeli [filtry znaków](#char-filters-reference) poniżej.|  
...
| ---- | ----------- | 
|Nazwa|Musi zawierać tylko litery, cyfry, spacje, kreski i znaki podkreślenia, może zaczynać się i kończyć tylko znakami alfanumerycznymi i mieć ograniczone do 128 znaków.|  
|Type|Nazwa tokenizatora z listy obsługiwanych tokenizatory. Zobacz **tokenizer_type** kolumny w poniższej tabeli [tokenizatory](#Tokenizers) .|  
...
| ---- | ----------- |  
|Nazwa|Musi zawierać tylko litery, cyfry, spacje, kreski i znaki podkreślenia, może zaczynać się i kończyć tylko znakami alfanumerycznymi i mieć ograniczone do 128 znaków.|  
|Type|Nazwa filtru tokenu z listy obsługiwanych filtrów tokenu. Zapoznaj się z kolumną **token_filter_type** w tabeli [filtry tokenu](#TokenFilters) poniżej.|  
