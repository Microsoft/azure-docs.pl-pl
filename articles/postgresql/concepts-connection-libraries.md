...
|--------------|----------------------------------------------------------------|-------------------------------------|--------------------------------------------------------------------|
| Python | [psycopg](http://initd.org/psycopg/) | Baza danych API 2,0 — zgodna | [Pobierz](http://initd.org/psycopg/download/) |
...
| Node.js | [Pakiet npm PG](https://www.npmjs.com/package/pg) | Czysty klient nieblokujący języka JavaScript | [Zainstaluj](https://www.npmjs.com/package/pg) |
| Java | [JDBC](https://jdbc.postgresql.org/) | Sterownik JDBC typu 4 | [Przesłać](https://jdbc.postgresql.org/download.html)  |
| Ruby | [PG rozwiązania Gem](https://deveiate.org/code/pg/) | Interfejs Ruby | [Pobierz](https://rubygems.org/downloads/pg-0.20.0.gem) |
| Przejdź | [PQ pakietu](https://godoc.org/github.com/lib/pq) | Czysty sterownik Postgres | [Zainstaluj](https://github.com/lib/pq/blob/master/README.md) |
| C\#/.NET | [Npgsql](https://www.npgsql.org/) | ADO.NET Dostawca danych | [Pobierz](https://www.microsoft.com/net/) |
...
| C++ | [libpqxx](http://pqxx.org/) | Interfejs języka C++ w nowym stylu | [Pobierz](http://pqxx.org/download/software/) |
...
[Środowisko Python](./connect-python.md) | [Node. js](./connect-nodejs.md) | [Java języka JavaScript](./connect-java.md) | [Ruby](./connect-ruby.md) |  | [(C#)](./connect-csharp.md) | [Go](./connect-go.md) [PHP](./connect-php.md)
