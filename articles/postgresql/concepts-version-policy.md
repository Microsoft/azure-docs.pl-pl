...
## <a name="retired-postgresql-engine-versions-not-supported-in-azure-postgresql"></a>Wycofane wersje aparatu PostgreSQL nie są obsługiwane w usłudze Azure PostgreSQL
...
- Jeśli dowolny problem z pomocą techniczną, który może się pojawić, odnosi się do bazy danych PostgreSQL, firma Microsoft nie będzie mogła dostarczać pomocy technicznej. W takich przypadkach trzeba będzie uaktualnić bazę danych, aby umożliwić nam zapewnienie pomocy technicznej.
...
- W przypadku poważnej luki w zabezpieczeniach bazy danych zidentyfikowanej w wycofanej wersji bazy danych platforma Azure może zdecydować się na automatyczne uaktualnienie bazy danych do nowszej wersji.
