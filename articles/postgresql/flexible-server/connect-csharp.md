---
title: 'Szybki Start: Łączenie przy użyciu języka C#-Azure Database for PostgreSQL-elastyczny serwer'
description: Ten przewodnik Szybki Start zawiera przykładowy kod języka C# (.NET), którego można używać do nawiązywania połączeń i wysyłania zapytań dotyczących danych z serwera Azure Database for PostgreSQL-elastycznym.
author: mksuni
ms.author: sumuth
...
- Utwórz Azure Database for PostgreSQL elastyczny serwer przy użyciu [Azure Portal](./quickstart-create-server-portal.md) <br/> lub [interfejs wiersza polecenia platformy Azure](./quickstart-create-server-cli.md) , jeśli go nie masz.
- Użyj pustej bazy danych *Postgres* dostępnej na serwerze lub Utwórz [nową bazę danych](./quickstart-create-server-portal.md#connect-to-the-postgresql-database-using-psql).
