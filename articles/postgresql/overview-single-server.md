...
Usługa Single Server to skarga ze wszystkimi wiodącymi w branży certyfikatami, takimi jak FedRAMP, HIPAA, PCI DSS. Odwiedź [Centrum zaufania Azure](), aby uzyskać informacje o zabezpieczeniach platformy Azure.
