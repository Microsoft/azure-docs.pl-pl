...
Załóżmy na przykład, że jest uruchamiana Grupa serwerów z jednym skalem (Citus) z 16 koordynatorem rdzeń wirtualny i trzema węzłami roboczymi rdzeń wirtualny. Załóżmy również, że planujesz wdrożenie w następnym miesiącu grupy serwerów dodatkowej Citus z rdzeń wirtualny koordynatorem 32 i dwoma węzłami roboczymi rdzeń wirtualny. Załóżmy również, że te zasoby są potrzebne przez co najmniej jeden rok.
