...
Pobieraj, Kompiluj i uruchamiaj jeden z plików. zip dla konkretnej tablicy i narzędzia (IAR, IDE lub PC) wybranego z [modułu zabezpieczeń dla zasobu usługi Azure RTO](hhtps://github.com/azure-rtos/azure-iot-preview/releases)w serwisie GitHub.
...
Log Analytics pozyskiwanie w IoT Hub jest wyłączone domyślnie Azure Security Center rozwiązania IoT. Aby umożliwić korzystanie z modułu zabezpieczeń dla usługi Azure RTO, wykonaj następujące czynności: 
...
> [Konfigurowanie modułu zabezpieczeń dla usługi Azure RTO](how-to-azure-rtos-security-module.md)
