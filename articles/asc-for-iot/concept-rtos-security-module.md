---
title: Ogólne wyjaśnienie podstaw modułu zabezpieczeń usługi Azure IoT — Azure RTO
description: Poznaj podstawowe informacje na temat koncepcji i przepływu pracy modułu Azure RTO IoT Security.
...
Moduł zabezpieczeń dla usługi Azure RTO jest dostępny bezpłatnie do pobrania dla urządzeń IoT. Azure Security Center dla usługi IoT w chmurze jest dostępna w ramach 30-dniowej wersji próbnej dla każdej subskrypcji platformy Azure. [Pobierz moduł zabezpieczeń teraz](https://github.com/azure-rtos/azure-iot-preview/releases) i zacznijmy. 
