...
[Przewodnik Szybki Start dotyczący zestawu Speech SDK](https://docs.microsoft.com/azure/cognitive-services/speech-service) zawiera przykłady użycia macierzy mikrofonu w języku urządzenia Kinect w różnych językach programowania.
...
* [Architektura Windows audio](https://docs.microsoft.com/windows-hardware/drivers/audio/windows-audio-architecture)
* [Dokumentacja systemu Windows. Media. Capture](https://docs.microsoft.com/uwp/api/Windows.Media.Capture)
* [Samouczek przechwytywania kamery internetowej](https://docs.microsoft.com/windows/uwp/audio-video-camera/basic-photo-video-and-audio-capture-with-mediacapture)
* [Informacje o audio USB](https://docs.microsoft.com/windows-hardware/drivers/audio/usb-2-0-audio-drivers)
...
>[Zestaw SDK usługi Speech Services](https://docs.microsoft.com/azure/cognitive-services/speech-service/)
