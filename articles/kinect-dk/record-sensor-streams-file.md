...
1. Otwórz wiersz polecenia i podaj ścieżkę do [usługi Azure urządzenia Kinect Recorder](azure-kinect-recorder.md), która znajduje się w katalogu zainstalowane narzędzia jako `k4arecorder.exe` . Na przykład: `C:\Program Files\Azure Kinect SDK\tools\k4arecorder.exe`.
2. Rekord 5 sekund.
...
> [Tworzenie pierwszej aplikacji usługi Azure urządzenia Kinect](build-first-app.md)
