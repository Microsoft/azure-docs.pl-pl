...
Aby rejestrować żądania na koncie usługi Azure Storage w celu ocenienia sposobu ich autoryzacji, możesz użyć usługi Azure Storage w Azure Monitor (wersja zapoznawcza). Aby uzyskać więcej informacji, zobacz [monitorowanie usługi Azure Storage](../common/monitor-storage.md).
