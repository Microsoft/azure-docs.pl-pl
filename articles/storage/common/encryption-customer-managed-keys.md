...
Użycie Azure Key Vault wiąże się z powiązanymi kosztami. Aby uzyskać więcej informacji, zobacz [Cennik usługi Key Vault](https://azure.microsoft.com/pricing/details/key-vault/).
