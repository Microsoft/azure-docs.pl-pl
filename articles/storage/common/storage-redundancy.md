...
Wszystkie dane dla wszystkich typów kont magazynu i [wszystkie warstwy (w tym archiwum)](../blobs/storage-blob-storage-tiers.md) są kopiowane zgodnie z opcją nadmiarowości dla konta magazynu. Są kopiowane obiekty, w tym blokowych obiektów blob, dołączanie obiektów blob, stronicowych obiektów blob, kolejek, tabel i plików.
