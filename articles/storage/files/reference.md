...
| ----------------------- | -------- |
| [Interfejs API REST usługi plików](/rest/api/storageservices/file-service-rest-api) | [Pojęcia dotyczące usługi plików](/rest/api/storageservices/file-service-concepts) |
