...
2. W Menedżerze pakietów NuGet Znajdź pakiet **Azure. Storage. blob** i Zainstaluj wersję **12.5.0-dev. 20200422.2** w projekcie. Możesz również uruchomić polecenie```Install-Package Azure.Storage.Blobs -Version12.5.0-dev.20200422.2```
