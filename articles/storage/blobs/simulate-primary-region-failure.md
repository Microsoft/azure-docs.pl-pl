...
description: Symulacja błędu podczas odczytywania danych z regionu podstawowego, gdy konto magazynu jest skonfigurowane pod kątem strefy geograficznej do odczytu nadmiarowego (RA-GZRS). Po wystąpieniu błędu odczytywanie danych z regionu pomocniczego.
services: storage
author: tamram
ms.service: storage
ms.subservice: blobs
