...
2. Zainstaluj `12.5.0-preview.6` wersję biblioteki klienta usługi Azure Blob Storage dla pakietu .NET przy użyciu `dotnet add package` polecenia. 
...
Ten przykład wysyła zapytanie do interfejsu API przyspieszenia zapytania, a następnie przesyła strumieniowo wyniki.
