...
Poniżej przedstawiono niektóre zapytania, które można wprowadzić na pasku **przeszukiwania dzienników** , aby ułatwić monitorowanie magazynu obiektów BLOB. Te zapytania działają w [nowym języku](../../azure-monitor/log-query/log-query-overview.md).
