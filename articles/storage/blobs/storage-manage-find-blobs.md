...
description: Dowiedz się, jak używać tagów indeksu obiektów BLOB do kategoryzowania, zarządzania i wykonywania zapytań w celu odnajdywania obiektów BLOB.
...
## <a name="blob-index-tags-and-data-management"></a>Znaczniki indeksu obiektów blob i Zarządzanie danymi
...
Wywołania przy użyciu [tożsamości usługi AAD](../common/storage-auth-aad.md) mogą mieć przyznane następujące uprawnienia do działania w tagach indeksu obiektów BLOB. 
...
Dodatkowe uprawnienia oddzielone od źródłowych danych obiektów BLOB są wymagane do obsługi tagów. Rola współautor danych obiektu blob magazynu będzie mieć przyznane wszystkie trzy z tych uprawnień. Czytnik danych obiektów blob magazynu uzyska uprawnienia tylko znajdowanie obiektów BLOB według tagów i pobieranie tagów obiektów BLOB.
...
> [!IMPORTANT]
> Zobacz sekcję warunki w tym artykule. Aby zarejestrować się w wersji zapoznawczej, zobacz sekcję rejestrowanie subskrypcji w tym artykule. Musisz zarejestrować swoją subskrypcję, aby można było używać indeksu obiektów BLOB na kontach magazynu.
