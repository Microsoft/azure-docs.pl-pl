...
Wybierz pozycję **wyświetl > Terminal** , aby otworzyć okno konsoli w programie Visual Studio Code. Uruchom następujące polecenie Menedżera pakietów Node. js (npm) w oknie terminalu, aby utworzyć plik [Package. JSON](https://docs.npmjs.com/files/package.json) .
...
Aby uruchomić kod w debugerze Visual Studio Code, Skonfiguruj plik *Launch. JSON* dla przeglądarki.
...
Po uaktualnieniu Zapisz plik *Launch. JSON* . Ta konfiguracja informuje Visual Studio Code, która przeglądarka ma być otwarta i który adres URL do załadowania.
...
Aby otworzyć *plik index. html* w przeglądarce z dołączonym debugerem Visual Studio Code, wybierz pozycję **Uruchom > Rozpocznij debugowanie** lub naciśnij klawisz F5 w Visual Studio Code.
