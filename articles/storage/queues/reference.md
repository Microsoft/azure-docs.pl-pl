...
|  Wersja  | Dokumentacja referencyjna | Pakiet | Szybki start |
| :-------: | ----------------------- | ------- | ---------- |
| 12. x | [Biblioteka klienta usługi Azure Storage Queue dla języka Java](https://azuresdkdocs.blob.core.windows.net/$web/java/azure-storage-queue/12.0.0/index.html) | [Pakiet (Maven)](https://mvnrepository.com/artifact/com.azure/azure-storage-queue) | [Szybki Start: V12 biblioteki klienta usługi Azure queue storage dla języka Java](/azure/storage/queues/storage-quickstart-queues-java) |
