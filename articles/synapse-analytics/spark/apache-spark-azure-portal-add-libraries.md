---
title: Dodawanie bibliotek do Apache Spark i zarządzanie nimi
...
## <a name="add-or-update-python-libraries"></a>Dodawanie lub aktualizowanie bibliotek języka Python
