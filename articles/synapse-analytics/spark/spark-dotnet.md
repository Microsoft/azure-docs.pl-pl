...
Możesz zainstalować wybrane pakiety NuGet w notesie przy użyciu `#r` symbolu przed nazwą pakietu NuGet. Na poniższym diagramie przedstawiono przykład:
