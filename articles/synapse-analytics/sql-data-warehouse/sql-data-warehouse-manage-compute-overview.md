...
description: Dowiedz się więcej o możliwościach skalowania wydajności dla dedykowanej puli SQL (dawniej SQL DW) w usłudze Azure Synapse Analytics. Skalowanie w poziomie przez dostosowanie jednostek dwu lub obniżenie kosztów przez wstrzymanie dedykowanej puli SQL (dawniej SQL DW).
