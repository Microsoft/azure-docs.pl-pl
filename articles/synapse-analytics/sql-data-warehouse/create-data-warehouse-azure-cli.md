...
Użyj polecenia [az synapse sql pool create,](/cli/azure/synapse/sql/pool#az_synapse_sql_pool_create) aby utworzyć pulę SQL:
...
Aby uzyskać więcej informacji na temat opcji parametrów, zobacz [az synapse sql pool](/cli/azure/synapse/sql/pool).

Pule SQL można wyświetlić za pomocą [polecenia az synapse sql pool list:](/cli/azure/synapse/sql/pool#az_synapse_sql_pool_list)

```azurecli
az synapse sql pool list --resource-group myResourceGroup --workspace-name testsynapseworkspace
```

Użyj polecenia [az synapse sql pool update,](/cli/azure/synapse/sql/pool#az_synapse_sql_pool_update) aby zaktualizować istniejącą pulę:
...
Użyj polecenia [az synapse sql pool pause,](/cli/azure/synapse/sql/pool#az_synapse_sql_pool_pause) aby wstrzymać pulę:
...
Użyj polecenia [az synapse sql pool resume,](/cli/azure/synapse/sql/pool#az_synapse_sql_pool_resume) aby uruchomić wstrzymaną pulę:
...
Aby usunąć istniejącą pulę SQL, użyj [polecenia az synapse sql pool delete:](/cli/azure/synapse/sql/pool#az_synapse_sql_pool_delete)
