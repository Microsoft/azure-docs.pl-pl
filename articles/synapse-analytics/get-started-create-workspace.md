...
W przeciwieństwie do dedykowanych pul SQL rozliczenia na żądanie SQL są oparte na ilości danych skanowanych w celu uruchomienia zapytania, a nie liczby zasobów używanych do wykonywania zapytania.
