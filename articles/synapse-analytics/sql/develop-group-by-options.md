...
Klauzula [Group by](/sql/t-sql/queries/select-group-by-transact-sql?view=azure-sqldw-latest&preserve-view=true) T-SQL agreguje dane do zestawu podsumowującego wierszy.
...
Na poniższej ilustracji przedstawiono wyniki [CREATE TABLE jako wybrane](/sql/t-sql/statements/create-table-as-select-azure-sql-data-warehouse?view=azure-sqldw-latest&preserve-view=true):
