...
Zapoznaj się z artykułem [rozwiązywania problemów](../sql-data-warehouse/sql-data-warehouse-troubleshoot.md?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json) , aby uzyskać informacje o typowych problemach. Jeśli pracujesz z dedykowaną pulą SQL, a nie bezserwerową pulą SQL, zapoznaj się z [najlepszymi rozwiązaniami dotyczącymi dedykowanych pul SQL](best-practices-dedicated-sql-pool.md) , aby uzyskać szczegółowe wskazówki.
