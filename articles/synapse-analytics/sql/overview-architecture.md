...
W Synapse SQL aparat zapytań rozproszonych działa w węźle kontrolnym w celu optymalizacji i koordynowania zapytań równoległych. Po przesłaniu zapytania T-SQL do puli SQL, węzeł kontrolny przekształca go w zapytania, które są wykonywane równolegle do każdej dystrybucji.
