---
title: Widoki systemowe obsługiwane w programie SQL Synapse
description: Linki do dokumentacji dotyczącej widoków systemu obsługiwanych w programie SQL Synapse.
author: filippopovic
...
> [!NOTE]
> Synapse bezserwerowa Pula SQL obsługuje tylko widoki wykazu SQL Server.  

## <a name="dedicated-sql-pool-and-serverless-sql-pool-catalog-views"></a>Dedykowana Pula SQL i nieserwerowe widoki wykazu puli SQL
...
* [sys.pdw_materialized_view_column_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-column-distribution-properties-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (wersja zapoznawcza)
* [sys.pdw_materialized_view_distribution_properties](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-distribution-properties-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (wersja zapoznawcza)
* [sys.pdw_materialized_view_mappings](/sql/relational-databases/system-catalog-views/sys-pdw-materialized-view-mappings-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (wersja zapoznawcza)
...
* [sys.workload_management_workload_classifier_details](/sql/relational-databases/system-catalog-views/sys-workload-management-workload-classifier-details-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (wersja zapoznawcza)
* [sys.workload_management_workload_classifiers](/sql/relational-databases/system-catalog-views/sys-workload-management-workload-classifiers-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest) (wersja zapoznawcza)

## <a name="dedicated-sql-pool-dynamic-management-views-dmvs"></a>Dedykowane widoki dynamicznego zarządzania puli SQL (widoków DMV)
...
## <a name="sql-server-dmvs-applicable-to-dedicated-sql-pool"></a>SQL Server widoków DMV mające zastosowanie do dedykowanej puli SQL

Poniższe widoków DMV mają zastosowanie do dedykowanej puli SQL, ale muszą być wykonywane przez połączenie z bazą danych **Master** .
...
## <a name="sql-server-catalog-views"></a>Widoki wykazu SQL Server
...
* [sys. zestawy](/sql/relational-databases/system-catalog-views/sys-assemblies-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys. grupy plików](/sql/relational-databases/system-catalog-views/sys-filegroups-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys. procedury](/sql/relational-databases/system-catalog-views/sys-procedures-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys. schematy](/sql/relational-databases/system-catalog-views/schemas-catalog-views-sys-schemas?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys. statystyki](/sql/relational-databases/system-catalog-views/sys-stats-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys. synonimy](/sql/relational-databases/system-catalog-views/sys-synonyms-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys.syskolumny](/sql/relational-databases/system-compatibility-views/sys-syscolumns-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
* [ Bazy danychsys.sys](/sql/relational-databases/system-compatibility-views/sys-sysdatabases-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
* [ Językisys.sys](/sql/relational-databases/system-compatibility-views/sys-syslanguages-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
* [sys.sysobiektów](/sql/relational-databases/system-compatibility-views/sys-sysobjects-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
* [ Odwołaniasys.sys](/sql/relational-databases/system-compatibility-views/sys-sysreferences-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys.sysużytkowników](/sql/relational-databases/system-compatibility-views/sys-sysusers-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [sys. widoki](/sql/relational-databases/system-catalog-views/sys-views-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)

## <a name="sql-server-dmvs-available-in-dedicated-sql-pool"></a>SQL Server widoków DMV dostępne w dedykowanej puli SQL

Pula SQL uwidacznia wiele SQL Server dynamicznych widoków zarządzania (widoków DMV). Te widoki, które są zgłaszane w dedykowanej puli SQL, zgłaszają stan baz danych SQL działających w ramach dystrybucji.

Usługi SQL Pool i system platform Analytics (Parallel Data Warehouse) używają tych samych widoków systemowych. Każdy DMV ma kolumnę o nazwie pdw_node_id, która jest identyfikatorem węzła obliczeniowego.

> [!NOTE]
> Aby użyć tych widoków, Wstaw "pdw_nodes_" do nazwy, jak pokazano w poniższej tabeli:

| Nazwa DMV w dedykowanej puli SQL | SQL Server artykułu Transact-SQL|
|:--- |:--- |
...
## <a name="sql-server-2016-polybase-dmvs-available-in-dedicated-sql-pool"></a>SQL Server widoków DMV 2016, dostępne w dedykowanej puli SQL
...
## <a name="sql-server-information_schema-views"></a>Widoki INFORMATION_SCHEMA SQL Server
...
* [WEJŚCIOWE](/sql/relational-databases/system-information-schema-views/parameters-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
* [PROCEDURY](/sql/relational-databases/system-information-schema-views/routines-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
* [SCHEMATU](/sql/relational-databases/system-information-schema-views/schemata-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
* [TABELĘ](/sql/relational-databases/system-information-schema-views/tables-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)
...
* [Widoki](/sql/relational-databases/system-information-schema-views/views-transact-sql?toc=/azure/synapse-analytics/toc.json&bc=/azure/synapse-analytics/breadcrumb/toc.json&view=azure-sqldw-latest)

## <a name="next-steps"></a>Następne kroki

Aby uzyskać więcej informacji, zobacz [instrukcje języka t-SQL w programie Synapse SQL](../sql-data-warehouse/sql-data-warehouse-reference-tsql-language-elements.md)i [w języku t-SQL w Synapse SQL](../sql-data-warehouse/sql-data-warehouse-reference-tsql-statements.md).
