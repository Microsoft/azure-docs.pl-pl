...
![Synapse Studio Management Hub lista pul platformy Spark.](media/quickstart-create-apache-spark-pool/create-spark-pool-studio-23.png)
...
1. Na następnej karcie (Ustawienia dodatkowe) pozostaw wszystkie ustawienia domyślne, a następnie naciśnij pozycję **Recenzja + Utwórz** (nie dodamy żadnych tagów).
 ![Nowy formularz puli Apache Spark Synapse Studio.](media/quickstart-create-apache-spark-pool/create-spark-pool-studio-25.png)
...
1. Na karcie **Recenzja + tworzenie** upewnij się, że szczegóły są poprawne na podstawie wprowadzonych wcześniej elementów, a następnie naciśnij pozycję **Utwórz**. 
 ![Nowy formularz puli Apache Spark Synapse Studio.](media/quickstart-create-apache-spark-pool/create-spark-pool-studio-26.png)

1. Pula Apache Spark rozpocznie proces aprowizacji.
![Nowy formularz puli Apache Spark Synapse Studio.](media/quickstart-create-apache-spark-pool/create-spark-pool-studio-27.png)

1. Po zakończeniu aprowizacji Nowa pula Apache Spark zostanie wyświetlona na liście.
![Nowy formularz puli Apache Spark Synapse Studio.](media/quickstart-create-apache-spark-pool/create-spark-pool-studio-28.png)
...
1. Potwierdź usunięcie i naciśnij przycisk **Usuń** .
 ![Okno dialogowe potwierdzenia usuwania wybranej puli Apache Spark.](media/quickstart-create-apache-spark-pool/create-spark-pool-studio-30.png)
