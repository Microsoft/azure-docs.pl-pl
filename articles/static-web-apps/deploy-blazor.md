...
- **Interfejs API**: aplikacja C# Azure Functions, która implementuje punkt końcowy interfejsu API, który zapewnia informacje o pogodzie dla aplikacji statycznej. [`WeatherForecastFunction`](https://github.com/staticwebev/blazor-starter/blob/main/Api/WeatherForecastFunction.cs)Zwraca tablicę `WeatherForecast` obiektów.
