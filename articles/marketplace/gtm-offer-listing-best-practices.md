---
title: Usługi w ramach usług "przejdź do rynku" — Lista najlepszych rozwiązań dotyczących oferty | Portal Azure Marketplace
description: Usługi dotyczące platformy "przejdź do platformy" — w tej sekcji opisano najlepsze rozwiązania dotyczące oferty
author: qianw211
...
Tabele w tej sekcji zawierają sugestie dotyczące tworzenia i angażowania ofert w portalu Marketplace. Aby napisać i skonfigurować materiały marketingowe, przejdź do [Centrum partnerskiego](https://partner.microsoft.com/dashboard/commercial-marketplace/analytics/marketplaceinsights). 
...
| Ustawienie witryny sklepu | Najlepsze rozwiązania |
|:--- |:--- |  
| Branże: AppSource aplikacje i usługi doradcze | Wybierz pozycję branże, jeśli Twoja oferta dotyczy potrzeb specyficznych dla branż: <ul><li> Wywołaj specyficzne dla branży funkcje w opisie oferty.</li> </ul> **Uwaga**: Maksymalna liczba opcji jest różna w zależności od typu oferty i jest wskazana w [centrum partnerskim](https://partner.microsoft.com/dashboard/commercial-marketplace/analytics/marketplaceinsights). |
| Kategorie | Wybierz kategorie, które są dostosowane do oferty:<br> <ul> <li> Starannie wybieraj kategorie, ponieważ klienci używają ich do wyszukiwania odpowiednich aplikacji. </li> <li> Pamiętaj, aby dowiedzieć się, w jaki sposób oferta obsługuje wymagania specyficzne dla kategorii w opisie oferty. </li> </ul> **Uwaga**: Maksymalna liczba opcji jest różna w zależności od typu oferty i jest wskazana w [centrum partnerskim](https://partner.microsoft.com/dashboard/commercial-marketplace/analytics/marketplaceinsights). |
| Produkty działające z aplikacją (3 maks.): tylko aplikacje AppSource | Utwórz listę dodatkowych produktów i technologii, które są używane lub rozszerzane przez rozwiązanie. Na przykład platforma Azure IoT Hub lub Azure Machine Learning. |
| Słowa kluczowe wyszukiwania (3 maks.) | Słowa kluczowe wyszukiwania mogą pomóc użytkownikom biznesowym w znalezieniu oferty podczas wyszukiwania <ul> <li> w portalu Azure Marketplace </li> <li> na AppSource </li> <li> używanie aparatów wyszukiwania </li> </ul> Aby Twoje aukcje pojawiły się w tych wyszukiwaniach, musisz: <ul> <li> Zidentyfikuj trzy pierwsze słowa kluczowe wyszukiwania dla swojej oferty; </li> <li> Uwzględnij słowa kluczowe wyszukiwania w podsumowaniu oferty i opisie. </li> <li> Tutaj umieść listę słów kluczowych wyszukiwania. </li> </ul> |

### <a name="category"></a>Kategoria

Portal Azure Marketplace i Microsoft AppSource są sklepami, które obsługują różne i unikatowe wymagania klientów. Wybierz odpowiednie witryny i kategorie dla każdej oferty przeznaczonej dla klientów według ról. 

Możesz wybrać maksymalnie dwie kategorie i dwie podkategorie dla oferty. Kategorie i podkategorie wymienione poniżej są dostępne w obu firmach.  Upewnij się, że wybór kategorii jest wyrównany do zamierzonych odbiorców, opis oferty i propozycja oferty.
...
| Zrzuty ekranu&nbsp;&times;&nbsp;(1280 720) | Dodaj maksymalnie pięć zrzutów ekranu:<br>Uwzględnij słowa kluczowe wyszukiwania w nazwach plików. |
...
Dodając parametry do adresu URL AppSource, możesz sprawdzić efektywność kampanii na pulpicie nawigacyjnym analizy w [centrum partnerskim](https://partner.microsoft.com/dashboard/commercial-marketplace/analytics/marketplaceinsights).
