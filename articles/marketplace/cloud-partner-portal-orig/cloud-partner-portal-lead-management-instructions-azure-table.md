...
1. Aby zapisać zmiany, wybierz opcję **Zapisz**. Microsoft Flow automatycznie przetestuje go pod kątem błędów. Jeśli nie ma żadnych błędów, przepływ zostanie uruchomiony po jego zapisaniu.
