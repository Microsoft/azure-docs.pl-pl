...
|Power Apps | Musi kwalifikować się do korzystania z zaawansowanych korzyści w [programie PowerShell Apps](https://aka.ms/PowerAppsPartner) . |
||

Dodatkowe zasoby i pomoc techniczna:

* Dział pomocy [technicznej w chmurze firmy Microsoft](https://aka.ms/CEDnominate): Uzupełnij formularz nominacji partnera dla przewodnika z obsługą techniczną w chmurze, aby nawiązać połączenie z specjalistą ds. programu w chmurze, który może ideach Microsoft Partner Network korzyści i służy jako przewodnik po osiągnięciu kompetencji.  
...
Aukcja oferty usług konsultingowych na Microsoft AppSource i Azure Marketplace obejmuje następujące etapy:

1. **Lista** — Rozpocznij tworzenie wersji roboczej nowej oferty, logując się do konta [Centrum partnerskiego](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/partnership) . Z listy rozwijanej wybierz pozycję **Nowa oferta**, a następnie wybierz pozycję **usługi konsultingowe**. Wprowadź artefakt swojej aukcji i opublikuj go.
2. **Walidacja** — Twoje żądanie jest przeglądane w celu upewnienia się, że spełniasz kryteria kwalifikacyjne. Następnie wyślemy instrukcje dotyczące tworzenia oferty usług konsultingowych.
...
* **Krótka** — wprowadzenie do rozwiązania lub usługi konsultingowej w celu narysowania zainteresowania klienta przy użyciu struktur, pokazów i przykładów klientów.
* **Implementacja** — Pełna instalacja, która skutkuje w pełni działającym rozwiązaniem. Zalecamy ograniczenie tego rozwiązania do rozwiązań, które mogą być implementowane przez dwa tygodnie lub mniej.
* **Weryfikacja koncepcji** — wdrożenie z ograniczoną zakresem w celu ustalenia, czy rozwiązanie spełnia wymagania klientów.
...
> [!NOTE]
> Typ usługi *krótkiej* musi być podany *w polu osoba*. Pozostałe cztery usługi doradcze można udostępnić na jeden z dwóch sposobów:
