...
Dokumentacja tej wersji interfejsu API nie jest już dostępna. Jeśli uważasz, że musisz uzyskać do niego dostęp, skontaktuj się z firmą saas-api-v1@microsoft.com .

W przypadku wszystkich nowych osiągnięć przejdź do [wersji 2 interfejsu API](./pc-saas-fulfillment-api-v2.md) , nawet jeśli korzystasz już z wersji 1. Ta wersja będzie całkowicie przestarzała w przyszłości.
