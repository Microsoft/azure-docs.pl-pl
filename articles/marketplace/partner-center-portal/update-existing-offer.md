---
title: Aktualizowanie istniejącej oferty — Microsoft Commercial Marketplace
description: Jak wprowadzać aktualizacje do istniejącej komercyjnej oferty lub planu witryny Marketplace, synchronizować prywatnych odbiorców oraz usuwać oferty.
...
ms.locfileid: "100097261"
---
# <a name="update-existing-offers-in-the-commercial-marketplace"></a>Aktualizowanie istniejących ofert w portalu komercyjnym

W tym artykule wyjaśniono, jak wprowadzać aktualizacje do istniejących ofert i planów, a także jak usunąć ofertę z komercyjnej witryny Marketplace. Oferty można wyświetlić na karcie **Przegląd** w [portalu komercyjnej witryny Marketplace](https://partner.microsoft.com/dashboard/commercial-marketplace/offers) w centrum partnerskim.

## <a name="update-a-published-offer"></a>Aktualizowanie opublikowanej oferty
...
## <a name="update-a-plan-for-an-existing-offer"></a>Aktualizowanie planu dla istniejącej oferty
...
## <a name="compare-changes-to-your-offer"></a>Porównaj zmiany z ofertą

Przed opublikowaniem aktualizacji oferty na żywo lub w [wersji zapoznawczej](#compare-changes-to-a-preview-offer) można przeprowadzić inspekcję zapisanych zmian na stronie **porównywania** . Możesz uzyskać dostęp do strony **PORÓWNAJ** w prawym górnym rogu dowolnej strony oferty, na przykład na stronie **Właściwości** lub **listy oferty** . Na stronie **PORÓWNAJ** są wyświetlane bezpośrednie wersje zapisywanych zmian tej oferty oraz opublikowana oferta w portalu Marketplace.
...
Możesz usunąć oferty ofert i plany z komercyjnej witryny Marketplace firmy Microsoft, co uniemożliwi nowym klientom Znajdowanie i kupowanie. Wszyscy klienci, którzy wcześniej uzyskali ofertę lub plan, nadal mogą z niego korzystać i mogą pobrać je ponownie w razie konieczności. Nie będą jednak otrzymywać aktualizacji, jeśli zdecydujesz się ponownie opublikować ofertę lub plan w późniejszym czasie.

- Aby zrezygnować z sprzedaży oferty po jej opublikowaniu, wybierz pozycję **Zatrzymaj sprzedawanie** na stronie **przeglądu oferty** . W ciągu kilku godzin potwierdzenia oferta nie będzie już widoczna na komercyjnym rynku.

- Aby zrezygnować z sprzedaży planu, wybierz pozycję **Zatrzymaj sprzedawanie** na stronie **Przegląd planu** . Opcja zatrzymania sprzedaży planu jest dostępna tylko wtedy, gdy w ofercie znajduje się więcej niż jeden plan. Możesz zrezygnować z sprzedaży jednego planu bez wpływu na inne plany w ramach oferty.
     >[!NOTE]
     > Po potwierdzeniu, że chcesz zrezygnować z sprzedaży planu, należy ponownie opublikować ofertę zmiany, która zaczęła obowiązywać.

Po zatrzymaniu sprzedaży oferty lub planu nadal będzie on widoczny w centrum partnerskim ze stanem **niedostępnym** . Jeśli zdecydujesz się na wystawianie lub ponowne sprzedawanie tej oferty lub planu, postępuj zgodnie z instrukcjami, aby [zaktualizować opublikowaną ofertę](#update-a-published-offer). Nie zapomnij, że konieczne będzie **opublikowanie** oferty lub ponowne zaplanowanie po wprowadzeniu jakichkolwiek zmian.
...
- [Sprawdź stan publikowania oferty komercyjnej witryny Marketplace](../review-publish-offer.md)
