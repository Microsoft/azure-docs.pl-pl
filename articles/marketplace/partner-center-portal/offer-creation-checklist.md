...
| [Planowanie strony cen i dostępności](#plan-pricing-and-availability-page)  | Dostępne tylko w przypadku wybrania sprzedaży oferty przez firmę Microsoft.  Gromadzi informacje o cechach biznesowej (modelu cen), odbiorcach i dostępności dla każdego planu (wersji) oferty.  |
...
| Potencjalni klienci — łączenie z systemem CRM | Wymagane, jeśli sprzedajesz przez firmę Microsoft lub jeśli lista zawiera oferty "kontakt ze mną". Wartość domyślna: brak połączonego systemu CRM. Opcje programu CRM: Azure Table, Azure Blob, Dynamics CRM Online, HTTPs "punkt końcowy, Marketo, Salesforce.  |
|
...
| Adres URL zasad ochrony prywatności  | Wymagane |
| Adres URL materiałów marketingowych programu CSP  | Opcjonalne |
| Przydatne linki tytuł + adres URL  | Opcjonalne |
...
| Logo Sklepu (mały, średni, duży)  | Wymagane jest duże logo (od 216 x 216 do 350 x 350 px). Centrum partnerskie będzie używać tego do tworzenia małych (48 x 48 pikseli) i średniego (90 x 90 px) logo. Opcjonalnie można zastąpić je innymi obrazami później. Logo musi być w formacie PNG. |
...
## <a name="plan-pricing-and-availability-page"></a>Planowanie strony cen i dostępności
...
| Nazwa pola | Uwagi |
| ---------------- | -----------|
| Uwagi dotyczące certyfikacji  | Opcjonalne |
|
