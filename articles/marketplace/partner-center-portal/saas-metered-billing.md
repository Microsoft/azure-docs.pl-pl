...
* Zapoznaj się ze wszystkimi wymaganiami oferty dotyczącymi [sprzedaży za pomocą oferty firmy Microsoft](./create-new-saas-offer.md#sell-through-microsoft) , jak opisano w temacie [Tworzenie oferty SaaS](./create-new-saas-offer.md).
...
Następnie oferta SaaS może być zintegrowana z [interfejsami API usługi pomiaru Marketplace](./marketplace-metering-service-apis.md) , aby poinformować firmę Microsoft o zdarzeniach rozliczanych.
...
Przykładowo firma Contoso jest wydawcą z usługą SaaS o nazwie contoso Notification Services (CNS). CNS pozwala klientom wysyłać powiadomienia za pośrednictwem poczty e-mail lub tekstu. Firma Contoso jest zarejestrowana jako Wydawca w centrum partnerskim do komercyjnego programu Marketplace do publikowania ofert SaaS oferowanych klientom platformy Azure.  Istnieją dwa plany skojarzone z CNS, podane poniżej:
...
Podobnie jak w przypadku cen ryczałtowych, ceny za wymiar rozliczeń można ustawić na obsługiwany kraj lub region. Wydawca musi używać funkcji importowania i eksportowania danych cenowych w centrum partnerskim.

1. Najpierw Zdefiniuj żądane wymiary i Oznacz, które rynki są obsługiwane. 
1. Następnie wyeksportuj te dane do pliku.
...
[![Wymiary usługi pomiaru Marketplace](./media/metering-service-dimentions.png "Kliknij, aby wyświetlić widok powiększony")](./media/metering-service-dimentions.png)
