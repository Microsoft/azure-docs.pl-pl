...
<br>Przykład: test oferty 1&#8482;

Wybierz przycisk **Utwórz**.  Dla tej oferty została utworzona strona **przeglądu oferty** .  
...
Test jest doskonałym sposobem na pokazanie oferty potencjalnym klientom, dając im możliwość "Wypróbuj przed zakupem", co spowodowało zwiększenie konwersji i generowanie wysoce wykwalifikowanych klientów. Aby dowiedzieć się więcej, zobacz [Zezwalanie klientom na testowanie oferty](./test-drive.md).
...
- [Testowanie najlepszych](https://docs.microsoft.com/azure/marketplace/cloud-partner-portal/test-drive/marketing-and-best-practices)- [Test Drive technical best practices](https://github.com/Azure/AzureTestDrive/wiki/Test-Drive-Best-Practices) rozwiązań w zakresie marketingu
- [Przegląd dysku testowego (pobieranie plików PDF)](https://assetsprod.microsoft.com/mpn/azure-marketplace-appsource-test-drives.pdf)
...
Możliwość skonfigurowania bezpłatnej wersji próbnej jest dostępna dla każdego planu oferty. Przejdź do cennika i dostępności dla każdej oferty i zaznacz pole wyboru, aby zezwolić na miesięczną wersję próbną.
...
Jeśli już ustawisz ceny dla planu w Stany Zjednoczone dolarów (USD) i dodasz kolejną lokalizację na rynku, cena nowego rynku zostanie obliczona zgodnie z bieżącymi stawkami za wymianę. Przed opublikowaniem zapoznaj się z cenami poszczególnych rynków. Cennik można przejrzeć przy użyciu linku "Eksport cen (xlsx)" po zapisaniu zmian.
