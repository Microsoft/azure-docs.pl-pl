---
title: Uzyskiwanie identyfikatora URI sygnatury dostępu współdzielonego dla obrazu maszyny wirtualnej | Portal Azure Marketplace
description: W tym artykule wyjaśniono, jak uzyskać identyfikator URI sygnatury dostępu współdzielonego (SAS) dla każdego wirtualnego dysku twardego (VHD).
author: anbene
