...
ms.locfileid: "88812873"
---
# <a name="azure-marketplace-listing-guidelines"></a>Wskazówki dotyczące wyświetlania w portalu Azure Marketplace

W tym artykule wyjaśniono wymagania i wskazówki dotyczące wyświetlania nowych ofert i usług w witrynie Azure Marketplace. Wszystkie oferty muszą spełniać wymagania wymienione w sekcji [wymagania dotyczące aukcji wszystkie oferty](#listing-requirements-for-all-offers) . Użyj linków po prawej stronie, aby przejść do wymagań i list kontrolnych dla określonych typów list.
...
| 7 | Artefakty marketingowe | Logo są wyświetlane poprawnie. | <ul><li>Logo: mały (48 x 48 pikseli, opcjonalnie), średni (90 x 90 px, opcjonalnie) i duży (od 216 x 216 do 350 x 350 px, wymagane).</li><li>Zrzut ekranu (maks. 5): wymaga. Obraz PNG o rozdzielczości 1280x720 pikseli. |
...
| 2 | Plany | Partner wybiera nowe plany.| Tytuł odzwierciedla styl tytułu, który jest już dostępny w opisie. Unikaj używania długich tytułów.  |
| 3 | Artefakty portalu Marketplace | Logo są wyświetlane poprawnie. |<ul><li>Logo: mały (48 x 48 pikseli, opcjonalnie), średni (90 x 90 px, opcjonalnie) i duży (od 216 x 216 do 350 x 350 px, wymagane).</li><li>Zrzut ekranu (maks. 5): wymaga. Obraz PNG o rozdzielczości 1280 x 720 pikseli.|
