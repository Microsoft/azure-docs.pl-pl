...
>- Nie wszystkie usługi platformy Azure są zgodne z przyznanymi użyciem klientów. Usługi Azure Kubernetes Services (AKS) i VM Scale Sets mają znane problemy powodujące raportowanie użycia.
