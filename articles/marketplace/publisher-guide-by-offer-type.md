...
| [**Aplikacje SaaS**](./partner-center-portal/create-new-saas-offer.md) | Użyj typu oferty aplikacji SaaS, aby umożliwić klientowi kupowanie rozwiązań technicznych opartych na SaaS, w ramach subskrypcji. |
