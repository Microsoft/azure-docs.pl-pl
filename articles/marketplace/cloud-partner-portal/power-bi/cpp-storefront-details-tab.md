...
|   Pole               |   Opis                                                                           |
|-----------------------|-----------------------------------------------------------------------------------------|
| **Podsumowanie oferty\***     | Krótki cel aplikacji przy użyciu maksymalnie 100 znaków.                             |
...
| *Dokumenty*                          | Dodaj maksymalnie trzy dokumenty, które mają być wyświetlane na AppSource, w sekcji **Dowiedz się więcej** .  |
...
| **Image (Obraz)**                            | Przekaż zrzut ekranu PNG. Jego rozdzielczość musi wynosić 1280 x 720 pikseli.  | 
|   |   |

Logo, które chcesz przekazać [Cloud Partner Portal](https://cloudpartner.azure.com) do Portal Cloud partner *nie*powinno:
...
|------------------------|--------------------------------------            |
|  **Brak**              | Nie Zbieraj żadnych potencjalnych klientów. Jest to domyślne ustawienie opcji.  |
