...
| **Wydawca\*** | Unikatowy identyfikator organizacji w [AppSource](https://appsource.microsoft.com). Wszystkie oferty powinny być skojarzone z IDENTYFIKATORem wydawcy. Tej wartości nie można zmienić po zapisaniu oferty.                         |
