...
* Sprawdź, czy na komputerze zainstalowano lokalnie i AZ Azure PowerShell module. Aby uzyskać więcej informacji, zobacz [Instalowanie i konfigurowanie programu Azure PowerShell](/powershell/azure/).
