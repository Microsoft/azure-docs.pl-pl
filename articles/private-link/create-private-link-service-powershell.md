...
* Aby zatwierdzić połączenie, użyj [Zatwierdź-AzPrivateEndpointConnection](/powershell/module/az.network/approve-azprivateendpointconnnection) .
