---
title: Omówienie usługi Azure Security test w wersji 1
description: Azure Security test — Omówienie wersji 1
author: msmbaldwin
manager: rkarlin
ms.service: security
ms.topic: conceptual
...
ms.locfileid: "90059315"
---
# <a name="overview-of-the-azure-security-benchmark-v1"></a>Omówienie testu porównawczego zabezpieczeń platformy Azure (wersja 1)

> [!NOTE]
> Najbardziej aktualnym wzorcem zabezpieczeń platformy Azure jest dostępny [tutaj](overview.md).
...
- [Reagowanie na zdarzenia](security-control-incident-response.md)
