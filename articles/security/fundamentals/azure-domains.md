---
title: Lista odwołań do domen platformy Azure
description: Lista referencyjna domen platformy Azure (niepełna)
services: security
author: memildin
manager: rkarlin
ms.assetid: ''
...
ms.locfileid: "87433207"
---
# <a name="reference-list-of-azure-domains-not-comprehensive"></a>Lista referencyjna domen platformy Azure (niepełna)

Ta strona jest częściową listą używanych domen platformy Azure. Niektóre z nich to punkty końcowe interfejsu API REST.
...
|[Azure Blob Storage](https://docs.microsoft.com/azure/storage/blobs/)|*.blob.core.windows.net|
|[Azure Cloud Services](https://docs.microsoft.com/azure/cloud-services/cloud-services-choose-me) i [Azure Virtual Machines](https://docs.microsoft.com/azure/virtual-machines/)|*. cloudapp.net|
|[usług Azure Cloud Services](https://docs.microsoft.com/azure/cloud-services/cloud-services-choose-me)|*. cloudapp.azure.com|
|[Azure Container Registry](https://azure.microsoft.com/services/container-registry/)|*. azurecr.io|
|Azure Container Service (ACS) (przestarzałe)|*. azurecontainer.io|
|[Azure Content Delivery Network (CDN)](https://azure.microsoft.com/services/cdn/)|*. vo.msecnd.net|
|[Azure Files](https://docs.microsoft.com/azure/storage/files/storage-files-introduction)|*. file.core.windows.net|
|[Azure Front Door](https://azure.microsoft.com/services/frontdoor/)|*. azurefd.net|
|Usługi zarządzania platformy Azure|*. management.core.windows.net|
...
|[Azure Stack Edge](https://azure.microsoft.com/products/azure-stack/edge/) i [Azure IoT Edge](https://azure.microsoft.com/services/iot-edge/)|*.azureedge.net|
|[Table Storage platformy Azure](https://docs.microsoft.com/azure/storage/tables/table-storage-overview)|*. table.core.windows.net|
