...
**Wskazówki** : Aby zalogować się do i skonfigurować żądania skrytka klienta, użyj stacji roboczej z dostępem uprzywilejowanym (dostępem uprzywilejowanym) z włączoną usługą Azure Multi-Factor Authentication (MFA).
