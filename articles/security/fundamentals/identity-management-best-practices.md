...
Za pomocą [RBAC](../../role-based-access-control/overview.md) można przypisywać uprawnienia użytkownikom, grupom i aplikacjom w określonym zakresie. Zakresem przypisania roli może być subskrypcja, grupa zasobów lub pojedynczy zasób.
...
**Szczegóły** : Przyznaj zespoły zabezpieczeń rolę [czytnika zabezpieczeń](../../role-based-access-control/built-in-roles.md#security-reader) RBAC. W zależności od zakresu obowiązków można użyć głównej grupy zarządzania lub grupy zarządzania segmentacją:
