...
* Zapewnij uwierzytelnianie wieloskładnikowe (za pomocą usługi [Azure Multi-Factor Authentication](/azure/active-directory/authentication/multi-factor-authentication)) lub uwierzytelnianie przy użyciu kart inteligentnych dla administratorów logujących się przy użyciu bramy usług pulpitu zdalnego.
* Skonfiguruj [ograniczenia źródłowych adresów IP](https://azure.microsoft.com/blog/2013/08/27/confirming-dynamic-ip-address-restrictions-in-windows-azure-web-sites/) lub [sieciowe grupy zabezpieczeń](/azure/virtual-network/security-overview) na platformie Azure, aby zminimalizować liczbę punktów końcowych uprawnionych do zarządzania.
