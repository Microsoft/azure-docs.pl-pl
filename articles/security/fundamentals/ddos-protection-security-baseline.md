...
Ta linia bazowa zabezpieczeń stosuje wskazówki dotyczące [wersji Azure DDoS Protection 1,0 usługi Azure Security test](../benchmarks/overview-v1.md) w warstwie Standardowa. Test porównawczy zabezpieczeń platformy Azure zawiera zalecenia dotyczące sposobu zabezpieczania rozwiązań w chmurze na platformie Azure. Zawartość jest pogrupowana według **kontroli zabezpieczeń** zdefiniowanych przez program Azure Security test i powiązane wskazówki dotyczące Azure DDoS Protection Standard. Nie ma zastosowania w przypadku **urządzeń** z Azure DDoS Protection Standard lub dla których odpowiedzialnością jest firma Microsoft.

Aby dowiedzieć się, jak usługa Azure DDoS Protection standard w całości jest mapowana na test porównawczy zabezpieczeń platformy Azure, zapoznaj się z [pełnym Azure DDoS Protection pliku mapowania linii bazowej zabezpieczeń Standard](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Offer%20Security%20Baselines).

## <a name="logging-and-monitoring"></a>Rejestrowanie i monitorowanie

*Aby uzyskać więcej informacji, zobacz temat [Azure Security test: rejestrowanie i monitorowanie](../benchmarks/security-control-logging-monitoring.md).*
...
- [Informacje na temat uzyskiwania dostępu do telemetrii, dzienników i analizy ataków dla usługi DDoS Protection Standard](/azure/ddos-protection/telemetry-monitoring-alerting#configure-alerts-for-ddos-protection-metrics)
...
*Aby uzyskać więcej informacji, zobacz informacje o [teście zabezpieczeń Azure: Identity i Access Control](../benchmarks/security-control-identity-access-control.md).*
...
Ponadto Azure Active Directory (Azure AD) ma wbudowane role, które muszą być jawnie przypisane i są queryable. Za pomocą modułu Azure AD PowerShell można wykonywać zapytania ad hoc w celu odnajdywania kont należących do grup administracyjnych.
...
**Wskazówki**: Włączanie Azure Active Directory (Azure AD) Multi-Factor Authentication i postępuj zgodnie z zaleceniami związanymi z zarządzaniem tożsamościami i dostępem Azure Security Center.

- [Jak włączyć Multi-Factor Authentication Azure Active Directory](../../active-directory/authentication/howto-mfa-getstarted.md)
...
**Wskazówki**: Użyj bezpiecznej, zarządzanej na platformie Azure stacji roboczej z Azure Active Directory Multi-Factor Authentication włączona, aby zalogować się i skonfigurować żądania skrytka klienta platformy Azure.

- [Wdrażanie bezpiecznej, zarządzanej na platformie Azure stacji roboczej](/security/compass/overview)
...
**Wskazówki**: Użyj nazw lokalizacji Azure Active Directory (Azure AD), aby zezwolić na dostęp do Azure Portal tylko dla określonych logicznych grup zakresów lub krajów/regionów adresów IP.
...
*Aby uzyskać więcej informacji, zobacz [Test porównawczy platformy Azure: ochrona danych](../benchmarks/security-control-data-protection.md).*
...
- [Zarządzanie usługą Azure RBAC w Azure DDoS Protection](/azure/virtual-network/manage-ddos-protection)
...
*Aby uzyskać więcej informacji, zobacz temat [Azure Security test: Inventory and Asset Management](../benchmarks/security-control-inventory-asset-management.md).*
...
*Aby uzyskać więcej informacji, zobacz temat [Azure Security test: bezpieczna konfiguracja](../benchmarks/security-control-secure-configuration.md).*
...
*Aby uzyskać więcej informacji, zobacz temat [Azure Security test: Obrona złośliwego oprogramowania](../benchmarks/security-control-malware-defense.md).*
...
*Aby uzyskać więcej informacji, zobacz [Test porównawczy platformy Azure: reagowanie na zdarzenia](../benchmarks/security-control-incident-response.md).*
...
*Aby uzyskać więcej informacji, zobacz test [porównawczy zabezpieczeń platformy Azure: testy penetracji i czerwone ćwiczenia zespołu](../benchmarks/security-control-penetration-tests-red-team-exercises.md).*
