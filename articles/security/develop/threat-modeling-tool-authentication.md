...
| **Materiały źródłowe**              | [SQL Server — wybierz tryb uwierzytelniania](https://msdn.microsoft.com/library/ms144284.aspx) |
...
| **Materiały źródłowe**              | [Nawiązywanie połączenia z SQL Database przy użyciu uwierzytelniania Azure Active Directory](https://azure.microsoft.com/documentation/articles/sql-database-aad-authentication/) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Zasady haseł SQL Server](https://technet.microsoft.com/library/ms161959(v=sql.110).aspx) |
...
| **Materiały źródłowe**              | [Najlepsze rozwiązania w zakresie zabezpieczeń z zawartymi bazami danych](https://msdn.microsoft.com/library/ff929055.aspx) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Co to jest usługa Azure Multi-Factor Authentication?](https://azure.microsoft.com/documentation/articles/multi-factor-authentication/) |
...
| **Materiały źródłowe**              | [Scenariusze zabezpieczeń klastra Service Fabric](https://azure.microsoft.com/documentation/articles/service-fabric-cluster-security) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Środowisko — Azure |
| **Materiały źródłowe**              | [Scenariusze zabezpieczeń klastra — zalecenia dotyczące zabezpieczeń](https://azure.microsoft.com/documentation/articles/service-fabric-cluster-security/#security-recommendations) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Środowisko — Azure |
| **Materiały źródłowe**              | [Certyfikaty X. 509 i Service Fabric](https://azure.microsoft.com/documentation/articles/service-fabric-cluster-security/#x509-certificates-and-service-fabric) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [IdentityServer3 — Big Picture](https://identityserver.github.io/Documentation/docsv2/overview/bigPicture.html) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Wdrożenie serwera tożsamości — buforowanie](https://identityserver.github.io/Documentation/docsv2/advanced/deployment.html) |
...
| **Atrybuty**              | Brak |
| **Materiały źródłowe**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx) |
...
| **Materiały źródłowe**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx), [wzmacnianie](https://community.microfocus.com/t5/UFT-Discussions/UFT-API-Test-with-WCF-wsHttpBinding/m-p/600927) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Nowoczesne uwierzytelnianie z Azure Active Directory aplikacji sieci Web](https://blogs.msdn.microsoft.com/microsoft_press/2016/01/04/new-book-modern-authentication-with-azure-active-directory-for-web-applications/) [przy użyciu Redis jako pamięci podręcznej tokenów ADAL](https://blogs.msdn.microsoft.com/mrochon/2016/09/19/using-redis-as-adal-token-cache/)  |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Nowoczesne uwierzytelnianie za pomocą Azure Active Directory dla aplikacji sieci Web](https://blogs.msdn.microsoft.com/microsoft_press/2016/01/04/new-book-modern-authentication-with-azure-active-directory-for-web-applications/) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [ADAL](https://azure.microsoft.com/documentation/articles/active-directory-authentication-libraries/) |
...
| **Materiały źródłowe**              | [Tokeny zabezpieczające IoT Hub platformy Azure](https://azure.microsoft.com/documentation/articles/iot-hub-sas-tokens/) |
...
| **Materiały źródłowe**              | [Zarządzanie dostępem anonimowym do odczytu do kontenerów i obiektów BLOB](https://azure.microsoft.com/documentation/articles/storage-manage-access-to-resources/), [sygnatury dostępu współdzielonego, część 1: Omówienie modelu SAS](https://azure.microsoft.com/documentation/articles/storage-dotnet-shared-access-signature-part-1/) |
