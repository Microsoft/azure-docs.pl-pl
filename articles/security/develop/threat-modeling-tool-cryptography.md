...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Wybieranie algorytmu szyfrowania](https://technet.microsoft.com/library/ms345262(v=sql.130).aspx) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Zidentyfikuj źródło pakietów z podpisami cyfrowymi](https://msdn.microsoft.com/library/ms141174.aspx), [zagrożeniem i lukami w zabezpieczeniach (usługi integracji)](https://msdn.microsoft.com/library/bb522559.aspx) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Dodaj SYGNATURę (Transact-SQL)](https://msdn.microsoft.com/library/ms181700) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [SQL Server rozszerzalne zarządzanie kluczami (EKM)](https://msdn.microsoft.com/library/bb895340), [rozszerzalne zarządzanie kluczami za pomocą Azure Key Vault (SQL Server)](https://msdn.microsoft.com/library/dn198405) |
...
| **Materiały źródłowe**              | [Always Encrypted (aparat bazy danych)](https://msdn.microsoft.com/library/mt163865) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Serwer tożsamości — klucze, sygnatury i Kryptografia](https://identityserver.github.io/Documentation/docsv2/configuration/crypto.html) |
