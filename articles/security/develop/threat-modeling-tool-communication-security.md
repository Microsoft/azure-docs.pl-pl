...
| **Materiały źródłowe**              |[Przeniesienie danych między środowiskiem lokalnym i Azure Data Factory](https://azure.microsoft.com/documentation/articles/data-factory-move-data-between-onprem-and-cloud/#create-gateway), [brama zarządzania danymi](https://azure.microsoft.com/documentation/articles/data-factory-data-management-gateway/) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [IdentityServer3 — klucze, podpisy i Kryptografia](https://identityserver.github.io/Documentation/docsv2/configuration/crypto.html), [IdentityServer3-Deployment](https://identityserver.github.io/Documentation/docsv2/advanced/deployment.html) |
...
| **Materiały źródłowe**              | [Włącz protokół HTTPS dla aplikacji w Azure App Service](../../app-service/configure-ssl-bindings.md) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | EnvironmentType — Azure |
| **Materiały źródłowe**              | [Wymuszanie protokołu HTTPS na Azure App Service](../../app-service/configure-ssl-bindings.md#enforce-https) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [OWASP HTTP Strict Transport Security Ściągawka arkusz](https://cheatsheetseries.owasp.org/cheatsheets/HTTP_Strict_Transport_Security_Cheat_Sheet.html) |
...
| **Materiały źródłowe**              | [Najlepsze rozwiązania dotyczące pisania bezpiecznych parametrów połączenia dla SQL Database](https://social.technet.microsoft.com/wiki/contents/articles/2951.windows-azure-sql-database-connection-security.aspx#best) |
...
| **Materiały źródłowe**              | [Włączanie szyfrowanych połączeń z aparatem bazy danych](https://msdn.microsoft.com/library/ms191192)  |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Szyfrowanie na poziomie transportu usługi Azure Storage — używanie protokołu HTTPS](https://azure.microsoft.com/documentation/articles/storage-security-guide/#_encryption-in-transit) |
...
| **Materiały źródłowe**              | [Windows Azure Blob MD5 — Omówienie](https://blogs.msdn.microsoft.com/windowsazurestorage/2011/02/17/windows-azure-blob-md5-overview/) |
...
| **Materiały źródłowe**              | [Azure File Storage](https://azure.microsoft.com/blog/azure-file-storage-now-generally-available/#comment-2529238931), [obsługa platformy Azure File Storage SMB dla klientów z systemem Windows](https://azure.microsoft.com/documentation/articles/storage-dotnet-how-to-use-files/#_mount-the-file-share) |
...
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Przypinanie certyfikatu i klucza publicznego](https://owasp.org/www-community/controls/Certificate_and_Public_Key_Pinning) |
...
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx), [wzmacnianie Królestwa](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_transport_security_enabled) |
...
| **Odpowiednie technologie** | .NET Framework 3 |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [MSDN](https://msdn.microsoft.com/library/ff650862.aspx) |
...
| **Odpowiednie technologie** | .NET Framework 3 |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [MSDN](https://msdn.microsoft.com/library/ff648826.aspx ) |
...
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Wymuszanie protokołu SSL w kontrolerze internetowego interfejsu API](https://www.asp.net/web-api/overview/security/working-with-ssl-in-web-api) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Obsługa protokołu TLS w usłudze Azure Redis](https://azure.microsoft.com/documentation/articles/cache-faq/#when-should-i-enable-the-non-ssl-port-for-connecting-to-redis) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Wybieranie protokołu komunikacyjnego](https://azure.microsoft.com/documentation/articles/iot-hub-devguide/#messaging) |
