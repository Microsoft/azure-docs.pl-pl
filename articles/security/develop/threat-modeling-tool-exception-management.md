...
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx), [wzmacnianie Królestwa](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_debug_information) |
...
| **Materiały źródłowe**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx), [wzmacnianie Królestwa](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_service_enumeration) |
...
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Obsługa wyjątków w interfejsie API sieci web ASP.NET](https://www.asp.net/web-api/overview/error-handling/exception-handling), [Walidacja modelu w interfejsie api sieci Web ASP.NET](https://www.asp.net/web-api/overview/formats-and-model-binding/model-validation-in-aspnet-web-api) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Okno dialogowe Edytowanie ustawień stron błędów ASP.NET](https://technet.microsoft.com/library/dd569096(WS.10).aspx) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Element wdrożenia (Schemat ustawień ASP.NET)](https://msdn.microsoft.com/library/ms228298(VS.80).aspx) |
...
| **Odpowiednie technologie** | Ogólny |
| **Atrybuty**              | Brak  |
| **Materiały źródłowe**              | [Bezpieczne niepowodzenie](https://owasp.org/www-community/Fail_securely) |
