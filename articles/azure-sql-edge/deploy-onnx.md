...
Przechowuj model w usłudze Azure SQL Edge lub wystąpieniu zarządzanym Azure SQL w `models` tabeli w bazie danych `onnx` . W parametrach połączenia Określ wartość _ * adres serwera * *, **username** i **Password**.
