...
W tym artykule przedstawiono sposób włączania i konfigurowania wystąpienia serwera konfiguracji chmury wiosennej. Aby dowiedzieć się więcej o zarządzaniu aplikacją, zobacz [skalowanie aplikacji w chmurze Azure wiosennej](spring-cloud-howto-scale-manual.md).
