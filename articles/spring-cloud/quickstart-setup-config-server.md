...
> [!TIP]
> Jeśli używasz prywatnego repozytorium dla serwera konfiguracji, zapoznaj się z naszym [samouczkiem dotyczącym konfigurowania uwierzytelniania](./spring-cloud-howto-config-server.md).
