...
3. W okienku nawigacji po lewej stronie wybierz opcję **serwer konfiguracji** .

4. W sekcji **repozytorium domyślne** Ustaw **Identyfikator URI** na " https://github.com/Azure-Samples/piggymetrics-config ".

5. Kliknij przycisk **Weryfikuj**.

    ![Przejdź do serwera konfiguracji](media/spring-cloud-quickstart-launch-app-portal/portal-config.png)

6. Po zakończeniu walidacji kliknij pozycję **Zastosuj** , aby zapisać zmiany.

    ![Sprawdzanie poprawności serwera konfiguracji](media/spring-cloud-quickstart-launch-app-portal/validate-complete.png)

7. Aktualizacja konfiguracji może potrwać kilka minut.
 
    ![Aktualizowanie serwera konfiguracji](media/spring-cloud-quickstart-launch-app-portal/updating-config.png) 

8. Po zakończeniu konfiguracji należy otrzymać powiadomienie.
