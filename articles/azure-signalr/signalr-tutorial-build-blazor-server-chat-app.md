...
1. Dodaj zależność usługi Azure Signal
   ...
   * Aktualizuj [`HostingStartupAssembly`](/aspnet/core/fundamentals/host/platform-specific-configuration) , aby korzystać z usługi Azure Signal Service.
...
1. Konfigurowanie usługi Azure Signal `ConnectionString` w programie `appsetting.json` lub za pomocą narzędzia do [zarządzania kluczami tajnymi](/aspnet/core/security/app-secrets?tabs=visual-studio#secret-manager)

> [!NOTE]
> Krok 2 można zastąpić za pomocą programu [`HostingStartupAssembly`](/aspnet/core/fundamentals/host/platform-specific-configuration) do zestawu sygnałów SDK.
> 
