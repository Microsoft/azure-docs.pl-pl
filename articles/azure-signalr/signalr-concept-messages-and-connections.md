...
- [Aggregation types in Azure Monitor (Typy agregacji w usłudze Azure Monitor)](../azure-monitor/platform/metrics-supported.md#microsoftsignalrservicesignalr )
