---
title: Usługi komunikacyjne platformy Azure jako źródło Event Grid
description: W tym artykule opisano, jak używać usług Azure Communications Services jako źródła zdarzeń Event Grid.
ms.topic: conceptual
ms.date: 02/11/2021
ms.author: mikben
...
> [!NOTE]
> Aby dowiedzieć się więcej o tym, jak zapamiętasz dane względem obsługi zdarzeń, zapoznaj się z [dokumentacją dotyczącą pojęć zamieszkania](../communication-services/concepts/privacy.md)
...
Możesz użyć Azure Portal lub interfejsu wiersza polecenia platformy Azure, aby subskrybować zdarzenia emitowane przez zasób usług komunikacyjnych. Rozpocznij pracę z obsługą zdarzeń, analizując [sposób obsługi zdarzeń programu SMS w usługach komunikacyjnych](../communication-services/quickstarts/telephony-sms/handle-sms-events.md)
...
| Tytuł | Opis |
| --- | --- |
| [Jak obsługiwać zdarzenia programu SMS w usługach komunikacyjnych](../communication-services/quickstarts/telephony-sms/handle-sms-events.md) | Obsługa wszystkich zdarzeń programu SMS odebranych przez usługę komunikacyjną przy użyciu elementu webhook. |
...
| Tytuł | Opis |
|---------|---------|
| [Szybki Start: obsługa zdarzeń programu SMS](../communication-services/quickstarts/telephony-sms/handle-sms-events.md) | Pokazuje, jak subskrybować zdarzenia programu SMS przy użyciu Event Grid.   |
