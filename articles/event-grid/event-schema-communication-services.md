...
> [!IMPORTANT]
> Usługi komunikacyjne platformy Azure są obecnie dostępne w publicznej wersji zapoznawczej.
...
Ten artykuł zawiera właściwości i schemat zdarzeń usług Azure Communications Services. Aby zapoznać się z wprowadzeniem do schematów zdarzeń, zobacz [Azure Event Grid schemacie zdarzeń](event-schema.md).
...
| Microsoft. Communications. ChatMessageReceived *                | Opublikowano po odebraniu komunikatu dla użytkownika w wątku rozmowy, do którego należy użytkownik.        |
...
Po wyzwoleniu zdarzenia usługa Event Grid wysyła dane dotyczące tego zdarzenia w celu subskrybowania punktów końcowych. Ta sekcja zawiera przykład sposobu, w jaki będą wyglądały dane dla każdego zdarzenia.
