...
Zgłoś wszelkie problemy związane z używaniem Event Grid w [https://github.com/Azure/event-grid-iot-edge/issues](https://github.com/Azure/event-grid-iot-edge/issues)IoT Edge.
