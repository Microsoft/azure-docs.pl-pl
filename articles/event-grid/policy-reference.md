...
ms.locfileid: "105037579"
---
# <a name="azure-policy-built-in-definitions-for-azure-event-grid"></a>Azure Policy wbudowane definicje Azure Event Grid

Ta strona jest indeksem [Azure Policy](../governance/policy/overview.md) wbudowanych definicji zasad dla Azure Event Grid. Aby uzyskać dodatkowe Azure Policy wbudowane dla innych usług, zobacz [Azure Policy wbudowane definicje](../governance/policy/samples/built-in-policies.md).
