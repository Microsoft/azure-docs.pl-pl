...
Aby utworzyć konto laboratorium, musisz mieć dostęp do subskrypcji platformy Azure, która została skonfigurowana dla Twojej szkoły. Twoja szkoła może mieć co najmniej jedną subskrypcję. Za pomocą subskrypcji można zarządzać rozliczeniami i zabezpieczeniami dla wszystkich zasobów i usług platformy Azure, w tym kont laboratorium.  Subskrypcje platformy Azure są zwykle zarządzane przez dział IT.  Aby uzyskać więcej informacji, przeczytaj następujący temat:
 - [Podręcznik administratora — subskrypcja](./administrator-guide.md#subscription)
...
- [Przewodnik administratora — laboratorium](./administrator-guide.md)
...
- [Podręcznik administratora — Grupa zasobów](./administrator-guide.md#resource-group)
- [Przewodnik administratora — konto laboratorium](./administrator-guide.md#lab-account) 
...
### <a name="who-should-be-owners-and-contributors-of-the-lab-account"></a>Kto powinna być właścicielami i współautorami konta laboratorium?
   ...
   -  [Przewodnik administratora — Zarządzanie tożsamościami](./administrator-guide.md#manage-identity).
...
- [Przewodnik administratora — Galeria obrazów udostępnionych](./administrator-guide.md#shared-image-gallery)
- [Przewodnik administratora — ceny udostępnionej galerii obrazów](./administrator-guide.md#shared-image-gallery-2)
...
- [Określanie obrazów w portalu Marketplace dostępnych dla twórców laboratorium](./specify-marketplace-images.md)
...
- [Podstawy architektury — Virtual Network](./classroom-labs-fundamentals.md#virtual-network)
- [Jak nawiązać połączenie z siecią wirtualną](./how-to-connect-peer-virtual-network.md)
- [Jak utworzyć laboratorium z udostępnionym zasobem w Azure Lab Services](./how-to-create-a-lab-with-shared-resource.md)

## <a name="set-up-your-lab-account"></a>Konfigurowanie konta laboratorium

Po zakończeniu planowania możesz przystąpić do konfigurowania konta laboratorium.  Te same kroki dotyczą konfigurowania Azure Lab Services laboratoryjnych [za pomocą zespołów](./lab-services-within-teams-overview.md).

1. **Utwórz konto laboratorium.** Aby uzyskać instrukcje, zapoznaj się z samouczkiem dotyczącym [tworzenia konta laboratorium](./tutorial-setup-lab-account.md#create-a-lab-account) .
   
    Aby uzyskać więcej wskazówek dotyczących nazewnictwa, zapoznaj się z następującym artykułem:

   - [Wskazówki dotyczące nazewnictwa dla zasobów](./administrator-guide.md#naming)

2. **Dodaj użytkowników do roli twórca laboratorium.** Aby uzyskać instrukcje, zobacz [Dodawanie użytkowników do roli twórca laboratorium](./tutorial-setup-lab-account.md#add-a-user-to-the-lab-creator-role).


3. **Nawiąż połączenie z równorzędną siecią wirtualną.** Aby uzyskać instrukcje, zobacz [łączenie sieci laboratorium z równorzędną siecią wirtualną](./how-to-connect-peer-virtual-network.md).
...
4. **Włącz i przejrzyj obrazy.** Aby uzyskać instrukcje, zobacz artykuł [Włączanie obrazów w portalu Azure Marketplace dla twórców laboratorium](./specify-marketplace-images.md).
