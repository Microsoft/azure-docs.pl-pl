...
1. Skonfiguruj zadanie w następujący sposób:
   ...
   |**Source Lab VM** > **Identyfikator maszyny wirtualnej laboratorium źródłowego** dla laboratorium źródłowego|Jeśli zmieniono nazwę domyślną zmiennej LabVMId, wprowadź ją w tym miejscu. Wartość domyślna to **$ (labVMId)**.|
   |**Output Variables** > **Identyfikator obrazu niestandardowego** dla zmiennych wyjściowych|W razie potrzeby można edytować domyślną nazwę zmiennej.|
