...
1. W oknie **wysyłanie zaproszenia** pocztą e-mail wprowadź opcjonalny komunikat, a następnie wybierz pozycję **Wyślij**. 
    ...
    Kolumna **zaproszenie** na liście **Użytkownicy** wyświetla stan zaproszenia dla każdego dodanego użytkownika. Stan powinien zostać zmieniony na **wysłanie** , a następnie do ** \<daty wysłania>**. 
...
1. W oknie **przydział dla użytkownika** Określ liczbę godzin, które chcesz nadać każdemu uczniowi poza zaplanowanym czasem klasy, a następnie wybierz pozycję **Zapisz**.
    ...
    Zmienione wartości są teraz wyświetlane w obszarze **przydziały na użytkownika \<: liczba godzin>** na pasku narzędzi i na liście Użytkownicy, jak pokazano poniżej:
...
1. W polu **Dostosuj limit przydziału \<dla wybranych użytkowników lub adresów e-mail>** wprowadź liczbę dodatkowych godzin laboratorium, które chcesz przyznać wybranym uczniom lub uczniom, a następnie wybierz pozycję **Zastosuj**. 
