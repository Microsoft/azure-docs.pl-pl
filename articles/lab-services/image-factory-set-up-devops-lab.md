...
1. Odwiedź projekt DevOps platformy Azure, który został utworzony w poprzednim kroku (adres URL wygląda podobnie do **protokołu https:\//\<AccountName>. VisualStudio.com/MyFirstProject**).
