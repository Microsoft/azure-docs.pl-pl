...
## <a name="prerequisites"></a>Wymagania wstępne
  ...
  - **Obszar roboczy usługi Azure Databricks** . [Utwórz obszar roboczy usługi Databricks](/azure/databricks/scenarios/quickstart-create-databricks-workspace-portal) lub użyj istniejącego. Najpierw utworzysz notes Python w obszarze roboczym usługi Azure Databricks. Następnie wykonasz notes i przekażesz do niego parametry przy użyciu usługi Azure Data Factory.
...
1.  W oknie **Nowa połączona usługa** wykonaj następujące czynności:
    ...
    1.  W obszarze **Nazwa** wpisz * *_AzureDatabricks \_ LinkedService_* _
    
    1.  Wybierz *obszar roboczy _ datakostkiing* *, który będzie uruchamiany w notesie
