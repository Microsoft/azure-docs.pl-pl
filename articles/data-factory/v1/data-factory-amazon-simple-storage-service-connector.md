...
| Wersja |Wersja obiektu S3, jeśli włączono obsługę wersji S3. |String |Nie |
...
Poprzedni przykład korzysta z ustalonych wartości właściwości **Key** i **bucketName** w zestawie danych Amazon S3.
