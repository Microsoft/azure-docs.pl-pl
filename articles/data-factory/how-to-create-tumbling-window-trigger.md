...
| **Rozpoczęcia**| Pierwsze wystąpienie, które może znajdować się w przeszłości. Pierwszy interwał wyzwalacza to (**StartTime**,   +  **Interwał** StartTime). | Data/godzina | Wartość daty i godziny. | Tak |
| **endTime**| Ostatnie wystąpienie, które może znajdować się w przeszłości. | Data/godzina | Wartość daty i godziny. | Tak |
