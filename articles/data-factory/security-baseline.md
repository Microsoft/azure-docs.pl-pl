...
* [Jak utworzyć Azure-SSIS IR](https://docs.microsoft.com/azure/data-factory/create-azure-ssis-integration-runtime)

* [Jak utworzyć i skonfigurować samoobsługowe środowisko IR](https://docs.microsoft.com/azure/data-factory/create-self-hosted-integration-runtime)
...
* [Przyłączanie Azure-SSIS IR do sieci wirtualnej](https://docs.microsoft.com/azure/data-factory/join-azure-ssis-integration-runtime-virtual-network#virtual-network-configuration)
...
* [Przyłączanie Azure-SSIS Integration Runtime do sieci wirtualnej](https://docs.microsoft.com/azure/data-factory/join-azure-ssis-integration-runtime-virtual-network)
...
* [Opis Azure Data Factory określonych tagów usługi](https://docs.microsoft.com/azure/data-factory/join-azure-ssis-integration-runtime-virtual-network)
...
* [Informacje o dziennikach diagnostycznych Azure Data Factory](https://docs.microsoft.com/azure/data-factory/monitor-using-azure-monitor)
...
* [Jak zbierać dane z usługi Azure Virtual Machines w programie Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/learn/quick-collect-azurevm)
...
* [Jak włączyć dzienniki diagnostyczne w Azure Data Factory](https://docs.microsoft.com/azure/data-factory/monitor-using-azure-monitor#set-up-diagnostic-logs)
...
* [Jak zbierać dane z maszyny wirtualnej platformy Azure za pomocą Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/learn/quick-collect-azurevm)
...
* [Wszystkie obsługiwane strony metryk](https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported)
...
* [Informacje na temat interfejsu API REST dla Azure Data Factory](https://docs.microsoft.com/rest/api/datafactory/)
...
* [Jakie są zarządzane tożsamości dla zasobów platformy Azure?](https://docs.microsoft.com/azure/active-directory/managed-identities-azure-resources/overview)

* [Kopiowanie i Przekształcanie danych w Azure SQL Database przy użyciu Azure Data Factory](https://docs.microsoft.com/azure/data-factory/connector-azure-sql-database#using-service-principal-authentication)

* [Jak skonfigurować uwierzytelnianie Azure Active Directory i zarządzać nim za pomocą Azure SQL Database](https://docs.microsoft.com/azure/sql-database/sql-database-aad-authentication-configure)
...
* [Configure and manage Azure Active Directory authentication with SQL (Konfigurowanie uwierzytelniania w usłudze Azure Active Directory i zarządzanie nim przy użyciu języka SQL)](https://docs.microsoft.com/azure/sql-database/sql-database-aad-authentication-configure?tabs=azure-powershell)

* [Enable Azure Active Directory authentication for Azure-SSIS Integration Runtime (Włączanie uwierzytelniania usługi Azure Active Directory dla środowiska Azure-SSIS Integration Runtime)](https://docs.microsoft.com/azure/data-factory/enable-aad-authentication-azure-ssis-ir)
...
* [Opis linku prywatnego](https://docs.microsoft.com/azure/private-link/private-endpoint-overview)
...
* [Informacje o szyfrowaniu w Azure Data Factory](https://docs.microsoft.com/azure/data-factory/data-movement-security-considerations)
...
* [Jak używać Azure Key Vault wpisów tajnych w działaniach potoku](https://docs.microsoft.com/azure/data-factory/how-to-use-azure-key-vault-secrets-pipeline-activities)

* [Jak poświadczenia w Azure Key Vault](https://docs.microsoft.com/azure/data-factory/store-credentials-in-key-vault)
...
* [Opis skanera zintegrowanej luki w zabezpieczeniach dla maszyn wirtualnych](https://docs.microsoft.com/azure/security-center/built-in-vulnerability-assessment)
...
* [Zintegrowany skaner luk w zabezpieczeniach dla maszyn wirtualnych](https://docs.microsoft.com/azure/security-center/built-in-vulnerability-assessment)
...
* [Usuwanie nietrwałe w Azure Key Vault](https://docs.microsoft.com/azure/key-vault/key-vault-ovw-soft-delete)
...
* [Tożsamość zarządzana dla Azure Data Factory](https://docs.microsoft.com/azure/data-factory/data-factory-service-identity)
...
* [Tworzenie kopii zapasowej maszyny wirtualnej platformy Azure z ustawień maszyny wirtualnej](https://docs.microsoft.com/azure/backup/backup-azure-vms-first-look-arm)
...
* [Azure Key Vault — omówienie usuwania nietrwałego](https://docs.microsoft.com/azure/key-vault/key-vault-ovw-soft-delete)
