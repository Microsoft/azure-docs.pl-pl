...
___
### <code>like</code>
<code><b>like(<i>&lt;string&gt;</i> : string, <i>&lt;pattern match&gt;</i> : string) => boolean</b></kod><br/><br/> wzorzec jest ciągiem, który jest dopasowany dosłownie. Wyjątki są następującymi specjalnymi symbolami: _ pasuje do dowolnego znaku w danych wejściowych w "" "regu" "POSIX" "" " (similar to  . l ar wyrażenie"% dopasowuje zero lub więcej znaków w danych wejściowych ( similar to . * w a wyrażeniach reguł "" POSIX "" r .
...
___
### <code>soundex</code>
<code><b>soundex(<i>&lt;value1&gt;</i> : string) => string</b></kod><br /><br/>
Gets t h e "" "SOUNDEX" ""for the string.  
* ``soundex('genius') -> 'G520'``  
___
### <code>split</code>
...
<code><b>varianceSampleIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => double</b></kod><br/><br/> na podstawie kryteriów pobiera nieobciążone zmiennce of a column.  
...
Funkcje konwersji służą do konwertowania danych i typów danych
