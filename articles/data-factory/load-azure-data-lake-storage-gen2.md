...
4. Na stronie **Nowa połączona usługa (Amazon S3)** wykonaj następujące czynności:
   ...
   4. Zostanie wyświetlone nowe połączenie usługi AmazonS3. Wybierz pozycję **Next** (Dalej). 
...
6. Określ zachowanie kopiowania, sprawdzając **cyklicznie** i binarne opcje **kopiowania** . Wybierz pozycję **Next** (Dalej).
