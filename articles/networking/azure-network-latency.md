...
## <a name="june-2020-round-trip-latency-figures"></a>Czerwiec 2020 — liczba opóźnień w trakcie podróży

Poniżej przedstawiono średni miesięczny czas błądzenia między regionami platformy Azure w ciągu ostatnich 30 dni (kończąc 30 czerwca 2020). Następujące pomiary są obsługiwane przez [ThousandEyes](https://thousandeyes.com).
