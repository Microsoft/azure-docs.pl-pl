...
ms.locfileid: "105037397"
---
# <a name="azure-policy-built-in-definitions-for-azure-data-box"></a>Azure Policy wbudowane definicje Azure Data Box

Ta strona jest indeksem [Azure Policy](../governance/policy/overview.md) wbudowanych definicji zasad dla Azure Data Box. Aby uzyskać dodatkowe Azure Policy wbudowane dla innych usług, zobacz [Azure Policy wbudowane definicje](../governance/policy/samples/built-in-policies.md).
