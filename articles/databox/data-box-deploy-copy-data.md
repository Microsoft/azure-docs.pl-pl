...
description: W tym samouczku dowiesz się, jak nawiązać połączenie z urządzeniem Azure Data Box i skopiować na nie dane z komputera-hosta za pomocą protokołu SMB z lokalnym internetowym interfejsem użytkownika.
services: databox
author: alkohli
ms.service: databox
ms.subservice: pod
...
![Łączenie i kopiowanie, Pobierz listę problemów](media/data-box-deploy-copy-data/view-errors-2.png)
...
![Łączenie i kopiowanie, pobieranie i wyświetlanie błędów](media/data-box-deploy-copy-data/view-errors-3.png)
