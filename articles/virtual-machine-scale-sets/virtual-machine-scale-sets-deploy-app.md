...
## <a name="install-an-app-with-the-custom-script-extension"></a><a name="already-provisioned"></a>Instalowanie aplikacji z rozszerzeniem niestandardowego skryptu
