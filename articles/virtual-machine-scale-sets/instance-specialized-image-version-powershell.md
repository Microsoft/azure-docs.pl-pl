...
Utwórz maszynę wirtualną na podstawie wyspecjalizowanej wersji obrazu zapisanej w [galerii obrazów udostępnionych](../virtual-machines/shared-image-galleries.md) przy użyciu Azure PowerShell. Jeśli chcesz utworzyć zestaw skalowania przy użyciu uogólnionej wersji obrazu, zobacz [Tworzenie wystąpień zestawu skalowania na podstawie uogólnionej wersji obrazu](instance-generalized-image-version-powershell.md).
