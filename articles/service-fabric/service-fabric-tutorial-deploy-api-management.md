...
Możesz również użyć [Azure Portal](../api-management/how-to-configure-service-fabric-backend.md) do tworzenia Service Fabric frontonu dla API Management i zarządzania nimi.
