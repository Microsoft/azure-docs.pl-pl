---
title: Opisy schematu XML modelu usługi Service Fabric platformy Azure
description: Opis schematu XML modelu usługi Service Fabric, w tym lokalizacji i podsumowania składników.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "75639194"
---
<!-- The schema reference articles were generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>Dokumentacja schematu XML modelu usług
W tym artykule opisano plik schematu ServiceFabricServiceModel. xsd, który jest instalowany z zestawem SDK Service Fabric.  Domyślnie plik schematu jest instalowany w *folderze C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Powiązania przestrzeni nazw

|Prefiks|Identyfikator URI przestrzeni nazw|
|---|---|
|XS|`https://www.w3.org/2001/XMLSchema`|

## <a name="component-summary"></a>Podsumowanie składników 
Poniższe składniki są zdefiniowane w ServiceFabricServiceModel. xsd:
- [257 elementów](service-fabric-service-model-schema-elements.md)
...
- [3 grupy elementów](service-fabric-service-model-schema-element-groups.md)
- [16 grup atrybutów](service-fabric-service-model-schema-attribute-groups.md)
