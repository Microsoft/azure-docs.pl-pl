...
>[!NOTE]
> Inicjowanie obsługi oparte na ścieżce względnej magazynu obrazów nie obsługuje `sfpkg` obecnie plików. W `sfpkg` związku z tym nie należy kopiować do magazynu obrazów.
