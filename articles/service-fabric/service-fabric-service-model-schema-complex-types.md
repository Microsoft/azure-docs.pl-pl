...
|typ|[Servicetemplates](#servicetemplatestype-complextype)|
...
|Atrybut|Wartość|
|---|---|
|zawartość|9 elementów, liczba atrybutów: 0|
|zdefiniowane|globalnie|
...
|---|---|
|name|Diagnostyka|
|typ|[Diagnostykatype](#diagnosticstype-complextype)|
|minOccurs|0|
...
|Atrybut|Wartość|
|---|---|
|zawartość|0 elementów, 8 atrybutów|
|zdefiniowane|globalnie|
...
#### <a name="restartcontaineronunhealthydockerhealthstatus"></a>Wartość restartcontaineronunhealthydockerhealthstatus
...
|Atrybut|Wartość|
|---|---|
|name|Wartość restartcontaineronunhealthydockerhealthstatus|
|typ|XS: wartość logiczna|
|używanie|optional|
|default|fałsz|
...
Gniazdo sieciowe. Obecnie obsługiwane typy to "Open" i "izolowane".
...
#### <a name="destination"></a>Miejsce docelowe
...
#### <a name="entrypointtype"></a>Punkt wejścia
...
#### <a name="servicegroup"></a>Stosowną
...
Ta wartość definiuje ochronę wartości atrybutu. Może być SecretsStoreRef/szyfrowany/zwykły tekst.
W przypadku wybrania wartości SecretsStoreRef wartość odwołuje się do wpisu tajnego zapisanego w SecureStore klastra, który jest odwołuje się i odszyfrowany podczas aktywacji.
...
#### <a name="port"></a>Port
Port zostanie zamieniony na port określony przez Microsoft Azure Service Fabric po zarejestrowaniu za pomocą Http.sys lub BFE.
...
Typ zmiennej środowiskowej. Może to być zwykły tekst/szyfrowany/SecretsStoreRef.
...
|Atrybut|Wartość|
|---|---|
|zawartość|21 elementów, liczba atrybutów: 0|
|zdefiniowane|globalnie|
...
|Atrybut|Wartość|
|---|---|
|zawartość|dwa elementy:, 7 atrybutów:|
|zdefiniowane|globalnie|
...
|---|---|
|name|Certyfikaty|
|typ|[Certificates](#certificatestype-complextype)|
|minOccurs|0|
...
Ta wartość określa typ hasła określonego w atrybucie "Password" (hasło). Może być SecretsStoreRef/szyfrowany/zwykły tekst.
W przypadku wybrania opcji SecretsStoreRef pobieramy wartość referencyjną z SecretStore.
W przypadku wybrania opcji zaszyfrowany programista aplikacji jest odpowiedzialny za utworzenie certyfikatu i użycie polecenia cmdlet Invoke-ServiceFabricEncryptSecret w celu zaszyfrowania poufnych informacji.
...
|Atrybut|Wartość|
|---|---|
|zawartość|0 elementów, 12 atrybutów|
|zdefiniowane|globalnie|
...
|Atrybut|Wartość|
|---|---|
|zawartość|4 elementy:, dwa atrybuty:|
|zdefiniowane|globalnie|
...
|Atrybut|Wartość|
|---|---|
|zawartość|11 elementów, liczba atrybutów: 0|
|zdefiniowane|globalnie|
...
|---|---|
|name|Zasoby|
|typ|[ResourceType](#resourcestype-complextype)|
|minOccurs|0|
...
|Atrybut|Wartość|
|---|---|
|zawartość|5 elementów, dwa atrybuty:|
|zdefiniowane|globalnie|
|name|ServiceType|
