...
Po skonfigurowaniu `Servicemanifest.xml` pliku należy wprowadzić pewne zmiany w `ApplicationManifest.xml` pliku, aby upewnić się, że jest używany poprawny typ usługi i nazwa.
