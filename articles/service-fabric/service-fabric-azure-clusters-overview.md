...
Aby uzyskać więcej informacji, Przeczytaj [Service Fabric Role-Based Access Control (RBAC)](service-fabric-cluster-security.md#role-based-access-control-rbac).
