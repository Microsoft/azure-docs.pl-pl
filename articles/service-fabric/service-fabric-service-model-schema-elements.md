...
|Atrybut|Wartość|
|---|---|
|type|[Diagnostykatype](service-fabric-service-model-schema-complex-types.md#diagnosticstype-complextype)|
|content|0 elementów, liczba atrybutów: 0|
...
|---|---|
|type|Anonimowy complexType|
|content|6 elementów:, dwa atrybuty:|
...
|---|---|
|name|Endpoint|
|type|[Punkt końcowy](service-fabric-service-model-schema-complex-types.md#endpointtype-complextype)|
...
|---|---|
|name|ServiceTypes|
|type|[Typ ServiceTypes](service-fabric-service-model-schema-complex-types.md#servicetypestype-complextype)|
...
|---|---|
|type|Anonimowy complexType|
|content|6 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ClusterManifestType complexType](service-fabric-service-model-schema-complex-types.md#clustermanifesttype-complextype)|
|name|Infrastruktura|
...
|Atrybut|Wartość|
|---|---|
|type|[Parametrytype](service-fabric-service-model-schema-complex-types.md#parameterstype-complextype)|
|content|0 elementów, liczba atrybutów: 0|
|zdefiniowane|globalnie|
|name|Parametry|
...
|Atrybut|Wartość|
|---|---|
|type|[ResourceType](service-fabric-service-model-schema-complex-types.md#resourcestype-complextype)|
|content|0 elementów, liczba atrybutów: 0|
...
|---|---|
|type|Anonimowy complexType|
|content|dwa elementy:, 4 atrybuty:|
...
|---|---|
|type|Anonimowy complexType|
|content|5 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ApplicationManifestType complexType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype)|
...
|Atrybut|Wartość|
|---|---|
|type|[Servicetemplates](service-fabric-service-model-schema-complex-types.md#servicetemplatestype-complextype)|
|content|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ApplicationManifestType complexType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype), [ApplicationInstanceType complexType](service-fabric-service-model-schema-complex-types.md#applicationinstancetype-complextype)|
...
|---|---|
|type|Anonimowy complexType|
|content|dwa elementy:, 5 atrybutów:|
