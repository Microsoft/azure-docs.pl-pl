...
W przypadku wartości true wartość tego parametru jest zaszyfrowana. Deweloper aplikacji jest odpowiedzialny za utworzenie certyfikatu i użycie polecenia cmdlet Invoke-ServiceFabricEncryptSecret w celu szyfrowania poufnych informacji. Informacje o certyfikacie, które będą używane do zaszyfrowania wartości, są określone w sekcji certyfikaty. Ten atrybut jest przestarzały. Użyj atrybutu typu.
...
W przypadku wybrania opcji zaszyfrowany programista aplikacji jest odpowiedzialny za utworzenie certyfikatu i użycie polecenia cmdlet Invoke-ServiceFabricEncryptSecret w celu zaszyfrowania poufnych informacji.
