---
title: Elementy schematu XML modelu usługi Service Fabric platformy Azure
...
|typ|Anonimowy complexType|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ApplicationInstanceType complexType](service-fabric-service-model-schema-complex-types.md#applicationinstancetype-complextype)|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie Destinations|
|name|AzureBlob|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie Destinations, element Destinations|
|name|AzureBlob|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|typ|[KeyValuePairType](service-fabric-service-model-schema-complex-types.md#keyvaluepairtype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie pojemności|
|name|Pojemność|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|Atrybut|Wartość|
|---|---|
|typ|[Certificates](service-fabric-service-model-schema-complex-types.md#certificatestype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
...
|zdefiniowane|lokalnie w [ApplicationManifestType complexType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype)|
|name|Certyfikaty|
|minOccurs|0|
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), atrybuty: 0|
|zdefiniowane|lokalnie w [ClusterManifestType complexType](service-fabric-service-model-schema-complex-types.md#clustermanifesttype-complextype)|
|name|Certyfikaty|
|minOccurs|0|
...
|typ|[FabricCertificateType](service-fabric-service-model-schema-complex-types.md#fabriccertificatetype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie [Certificates complexType](service-fabric-service-model-schema-complex-types.md#certificatestype-complextype)|
|name|Kolekcja|
|minOccurs|0|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie [Servicemanifesttype complexType](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype), DigestedCodePackage|
|name|CodePackage|
|maxOccurs|Unbounded|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie ConfigOverrides, element DigestedConfigPackage|
|name|ConfigOverride|
|minOccurs|0|
|maxOccurs|Unbounded|
...
Deklaruje folder o nazwie i PackageRoot, który zawiera plik Settings.xml. Ten plik zawiera sekcje ustawień zdefiniowanych przez użytkownika, par klucz-wartość, które proces może odczytywać z powrotem w czasie wykonywania. W trakcie uaktualniania, jeśli tylko wersja ConfigPackage została zmieniona, uruchomiony proces nie zostanie ponownie uruchomiony. Zamiast tego wywołanie zwrotne powiadamia proces, że ustawienia konfiguracji zostały zmienione, aby można je było ponownie załadować dynamicznie.

|Atrybut|Wartość|
|---|---|
|typ|[ConfigPackageType](service-fabric-service-model-schema-complex-types.md#configpackagetype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie [Servicemanifesttype complexType](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype), DigestedConfigPackage|
|name|ConfigPackage|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype), element DigestedCodePackage|
...
|zdefiniowane|lokalnie w elemencie [diagnosticstype complexType](service-fabric-service-model-schema-complex-types.md#diagnosticstype-complextype)|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie [Servicemanifesttype complexType](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype), DigestedDataPackage|
|name|DataPackage|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie DigestedCodePackage, element DigestedConfigPackage, element DigestedDataPackage|
...
|zdefiniowane|lokalnie w [ApplicationPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#applicationpoliciestype-complextype)|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ApplicationHealthPolicyType complexType](service-fabric-service-model-schema-complex-types.md#applicationhealthpolicytype-complextype)|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ApplicationManifestType complexType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype), [ApplicationInstanceType complexType](service-fabric-service-model-schema-complex-types.md#applicationinstancetype-complextype)|
...
|typ|XS: ciąg|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ApplicationManifestType complexType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype), [servicemanifesttype complexType](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype), [servicepackagetype complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
|name|Opis|
|minOccurs|0|
...
|zdefiniowane|lokalnie w elemencie CrashDumpSource|
|name|Miejsca docelowe|
|minOccurs|0|
...
|typ|Anonimowy complexType|
|zawartość|3 elementy, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie FolderSource|
|name|Miejsca docelowe|
|minOccurs|0|
...
|Atrybut|Wartość|
|---|---|
|typ|[Diagnostykatype](service-fabric-service-model-schema-complex-types.md#diagnosticstype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ApplicationManifestType complexType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype), [EnvironmentType complexType](service-fabric-service-model-schema-complex-types.md#environmenttype-complextype)|
|name|Diagnostyka|
|minOccurs|0|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie [Servicemanifesttype complexType](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype), [Servicepackagetype complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
|name|Diagnostyka|
|minOccurs|0|
...
|typ|Anonimowy complexType|
|zawartość|dwa elementy:, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ApplicationPackageType complexType](service-fabric-service-model-schema-complex-types.md#applicationpackagetype-complextype)|
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), atrybuty: 0|
|zdefiniowane|lokalnie w elemencie DigestedResources|
|name|DigestedCertificates|
|minOccurs|0|
|maxOccurs|1|
...
|zdefiniowane|lokalnie w elemencie [Servicepackagetype complexType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
...
|zdefiniowane|lokalnie w elemencie DigestedEndpoints|
...
|---|---|
|name|Punkt końcowy|
|typ|[Punkt końcowy](service-fabric-service-model-schema-complex-types.md#endpointtype-complextype)|
...
|---|---|
|name|ServiceTypes|
|typ|[Typ ServiceTypes](service-fabric-service-model-schema-complex-types.md#servicetypestype-complextype)|
...
Nieobsługiwane, nie należy używać. Obsługa hostingu biblioteki DLL (punkt wejścia zestawu) jest zapewniana przez proces FWP.exe. Service Fabric uruchamia proces roboczy sieci szkieletowej (FWP.exe) i ładuje zestaw w ramach procesu aktywacji.
...
|typ|Anonimowy complexType|
|zawartość|0 elementów, 1 atrybutów|
|zdefiniowane|lokalnie w elemencie Membership|
|name|Domena|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|typ|Anonimowy complexType|
|zawartość|dwa elementy:, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie [Servicediagnosticstype complexType](service-fabric-service-model-schema-complex-types.md#servicediagnosticstype-complextype)|
|name|ETW|
|minOccurs|0|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie Endpoints|
|name|Punkt końcowy|
|maxOccurs|Unbounded|
...
|typ|[Punkt końcowy](service-fabric-service-model-schema-complex-types.md#endpointtype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie Endpoints, element DigestedEndpoint|
|name|Punkt końcowy|
|maxOccurs|Unbounded|
...
|typ|[EndpointBindingPolicyType](service-fabric-service-model-schema-complex-types.md#endpointbindingpolicytype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype), element DigestedEndpoint|
|name|EndpointBindingPolicy|
|minOccurs|0|
...
|typ|[EndpointCertificateType](service-fabric-service-model-schema-complex-types.md#endpointcertificatetype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie Certificates, element DigestedCertificates, element DigestedCertificates|
|name|EndpointCertificate|
|minOccurs|0|
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), atrybuty: 0|
|zdefiniowane|lokalnie w [ResourceOverridesType complexType](service-fabric-service-model-schema-complex-types.md#resourceoverridestype-complextype)|
|name|Punkty końcowe|
|minOccurs|0|
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), atrybuty: 0|
|zdefiniowane|lokalnie w [ResourceType complexType](service-fabric-service-model-schema-complex-types.md#resourcestype-complextype)|
|name|Punkty końcowe|
|minOccurs|0|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [CodePackageType complexType](service-fabric-service-model-schema-complex-types.md#codepackagetype-complextype)|
|name|EntryPoint|
|minOccurs|1|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [EnvironmentOverridesType complexType](service-fabric-service-model-schema-complex-types.md#environmentoverridestype-complextype)|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [EnvironmentVariablesType complexType](service-fabric-service-model-schema-complex-types.md#environmentvariablestype-complextype)|
|name|EnvironmentVariable|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|typ|Anonimowy complexType|
|zawartość|0 elementów, dwa atrybuty:|
|zdefiniowane|lokalnie w [rozszerzeniach complextypetype](service-fabric-service-model-schema-complex-types.md#extensionstype-complextype)|
|name|Wewnętrzny|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|Atrybut|Wartość|
|---|---|
|typ|[Rozszerzenia](service-fabric-service-model-schema-complex-types.md#extensionstype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|globalnie|
|name|Rozszerzenia|
...
|typ|Anonimowy complexType|
|zawartość|dwa elementy:, 1 — atrybuty:|
|zdefiniowane|lokalnie w grupach elementu|
|name|Group (Grupa)|
|maxOccurs|Unbounded|
...
|typ|Anonimowy complexType|
|zawartość|0 elementów, 1 atrybutów|
|zdefiniowane|lokalnie w elemencie MemberOf|
|name|Group (Grupa)|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ImageOverridesType complexType](service-fabric-service-model-schema-complex-types.md#imageoverridestype-complextype)|
|name|Obraz|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie LoadMetrics, element LoadMetrics, element LoadMetrics, element LoadMetrics, element LoadMetrics|
|name|LoadMetric|
|maxOccurs|Unbounded|
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), atrybuty: 0|
|zdefiniowane|lokalnie w [ServiceGroupMemberType complexType](service-fabric-service-model-schema-complex-types.md#servicegroupmembertype-complextype)|
|name|LoadMetrics|
|minOccurs|0|
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), atrybuty: 0|
|zdefiniowane|lokalnie w [ServiceGroupTypeType complexType](service-fabric-service-model-schema-complex-types.md#servicegrouptypetype-complextype)|
|name|LoadMetrics|
|minOccurs|0|
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), atrybuty: 0|
|zdefiniowane|lokalnie w elemencie [Servicetypetype complexType](service-fabric-service-model-schema-complex-types.md#servicetypetype-complextype)|
|name|LoadMetrics|
|minOccurs|0|
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), atrybuty: 0|
|zdefiniowane|lokalnie w polu [complextypetype](service-fabric-service-model-schema-complex-types.md#servicetype-complextype)|
|name|LoadMetrics|
|minOccurs|0|
...
|typ|Anonimowy complexType|
|zawartość|0 elementów, 1 atrybutów|
|zdefiniowane|lokalnie w elemencie LogCollectionPolicies|
|name|LogCollectionPolicy|
...
|typ|[LogicalDirectoryType](service-fabric-service-model-schema-complex-types.md#logicaldirectorytype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie LogicalDirectories|
|name|LogicalDirectory|
|maxOccurs|Unbounded|
...
|typ|[Datapackagetype](service-fabric-service-model-schema-complex-types.md#datapackagetype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie ManifestDataPackages|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie Members elementy członkowskie|
|name|Członek|
|minOccurs|1|
|maxOccurs|Unbounded|
...
|typ|Anonimowy complexType|
|zawartość|dwa elementy:, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie User|
|name|MemberOf|
|minOccurs|0|
...
#### <a name="systemgroup"></a>Systemowa
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), atrybuty: 0|
|zdefiniowane|lokalnie w [StatelessServiceGroupType complexType](service-fabric-service-model-schema-complex-types.md#statelessservicegrouptype-complextype)|
|name|Elementy członkowskie|
|minOccurs|1|
|maxOccurs|1|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie powstanie, element powstanie|
|name|Węzeł|
|maxOccurs|Unbounded|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie powstanie|
|name|Węzeł|
|maxOccurs|Unbounded|
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), atrybuty: 0|
|zdefiniowane|lokalnie w [WindowsInfrastructureType complexType](service-fabric-service-model-schema-complex-types.md#windowsinfrastructuretype-complextype)|
|name|Powstanie|
...
|zdefiniowane|lokalnie w elemencie elementów NodeType|
|name|NodeType|
|maxOccurs|Unbounded|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie na [complexType](service-fabric-service-model-schema-complex-types.md#parameterstype-complextype)|
|name|Parametr|
|minOccurs|1|
|maxOccurs|Unbounded|
...
|typ|Anonimowy complexType|
|zawartość|0 elementów, dwa atrybuty:|
|zdefiniowane|lokalnie w elemencie parametrów|
|name|Parametr|
|blokowanie||
|minOccurs|0|
|maxOccurs|Unbounded|
...
## <a name="parameter-element-defined-in-section"></a>Element Parameter zdefiniowany w sekcji
...
|typ|Anonimowy complexType|
|zawartość|0 elementów, dwa atrybuty:|
|zdefiniowane|lokalnie w elemencie Section|
|name|Parametr|
|minOccurs|0|
|maxOccurs|Unbounded|
...
W przypadku wartości true wartość tego parametru jest zaszyfrowana. Deweloper aplikacji jest odpowiedzialny za utworzenie certyfikatu i użycie polecenia cmdlet Invoke-ServiceFabricEncryptSecret do szyfrowania poufnych informacji. Informacje o certyfikacie, które będą używane do zaszyfrowania wartości, są określone w sekcji certyfikaty. Ten atrybut jest przestarzały. Użyj atrybutu typu.
...
Ta wartość definiuje typ wartości określonej w atrybucie "value". Może być SecretsStoreRef/szyfrowany/zwykły tekst.
W przypadku wybrania opcji SecretsStoreRef pobieramy wartość referencyjną z SecretStore.
W przypadku wybrania opcji zaszyfrowany programista aplikacji jest odpowiedzialny za utworzenie certyfikatu i użycie polecenia cmdlet Invoke-ServiceFabricEncryptSecret do szyfrowania poufnych informacji.
...
|Atrybut|Wartość|
|---|---|
|typ|[Parametrytype](service-fabric-service-model-schema-complex-types.md#parameterstype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|globalnie|
|name|Parametry|
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), atrybuty: 0|
|zdefiniowane|lokalnie w [AppInstanceDefinitionType complexType](service-fabric-service-model-schema-complex-types.md#appinstancedefinitiontype-complextype)|
|name|Parametry|
...
|typ|Anonimowy complexType|
|zawartość|0 elementów, 1 atrybutów|
|zdefiniowane|lokalnie w elemencie NamedPartition|
|name|Partycja|
...
|typ|XS: ciąg|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w obszarze [Typ elementu complexType](service-fabric-service-model-schema-complex-types.md#servicetype-complextype), [servicetypetype complexType](service-fabric-service-model-schema-complex-types.md#servicetypetype-complextype), [ServiceGroupTypeType complexType](service-fabric-service-model-schema-complex-types.md#servicegrouptypetype-complextype)|
...
|typ|[ServiceTypeExtensionPolicyPropertiesType](service-fabric-service-model-schema-complex-types.md#servicetypeextensionpolicypropertiestype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie PersistencePolicy, element EvictionPolicy|
|name|Właściwości|
|minOccurs|0|
...
|typ|[KeyValuePairType](service-fabric-service-model-schema-complex-types.md#keyvaluepairtype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie PlacementProperties|
|name|Właściwość|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|typ|Anonimowy complexType|
|zawartość|0 elementów, 1 atrybutów|
|zdefiniowane|lokalnie w elemencie ProviderGuids|
|name|ProviderGuid|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|typ|[ResourceGovernancePolicyType](service-fabric-service-model-schema-complex-types.md#resourcegovernancepolicytype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype), element DigestedCodePackage, element DigestedEndpoint|
|name|ResourceGovernancePolicy|
|minOccurs|0|
...
|Atrybut|Wartość|
|---|---|
|typ|[ResourceType](service-fabric-service-model-schema-complex-types.md#resourcestype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie [Servicemanifesttype complexType](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype)|
|name|Zasoby|
|minOccurs|0|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie Roles|
|name|Rola|
|maxOccurs|Unbounded|
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), atrybuty: 0|
|zdefiniowane|lokalnie w elemencie Blackbird|
|name|Role|
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), atrybuty: 0|
|zdefiniowane|lokalnie w elemencie PaaS|
|name|Role|
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), atrybuty: 0|
|zdefiniowane|lokalnie w elemencie WindowsAzure|
|name|Role|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie ServiceScalingPolicies|
|name|ScalingPolicy|
|maxOccurs|Unbounded|
...
|typ|[FabricCertificateType](service-fabric-service-model-schema-complex-types.md#fabriccertificatetype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie Certificates, element Certificates, element DigestedCertificates|
|name|SecretsCertificate|
|minOccurs|0|
...
|typ|Anonimowy complexType|
|zawartość|1 element (y), 1 atrybut (y)|
|zdefiniowane|lokalnie w elemencie [settingstype complexType](service-fabric-service-model-schema-complex-types.md#settingstype-complextype)|
|name|Sekcja|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|typ|[SecurityAccessPolicyType](service-fabric-service-model-schema-complex-types.md#securityaccesspolicytype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ServiceManifestImportPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype), element SecurityAccessPolicies, element DigestedEndpoint|
|name|SecurityAccessPolicy|
|minOccurs|0|
...
#### <a name="servicepackageactivationmode"></a>Korzystanie
...
|typ|Anonimowy complexType|
|zawartość|0 elementów, dwa atrybuty:|
|zdefiniowane|lokalnie w elemencie servicekorelacje|
|name|Servicekorelacja|
|maxOccurs|Unbounded|
...
#### <a name="servicecorrelation"></a>Servicekorelacja
Definiuje relację koligacji z inną usługą. Przydatne podczas dzielenia aplikacji wcześniej monolitycznej na mikrousługi.  Jedna usługa ma lokalną zależność od innej usługi i obie te usługi muszą działać w tym samym węźle, aby można było pracować.
...
#### <a name="servicetypename"></a>Typ ServiceTypeName
...
## <a name="serviceplacementpolicy-element-defined-in-serviceplacementpolicies"></a>Element ServicePlacementPolicy zdefiniowany w ServicePlacementPolicies
Definiuje zasady umieszczania usług, które określają, że usługa powinna lub nie powinna być uruchamiana w określonych domenach błędów klastra.  Przydatne, gdy klaster obejmuje odległości geograficzne lub regiony geopolityczne.
...
|typ|Anonimowy complexType|
|zawartość|0 elementów, dwa atrybuty:|
|zdefiniowane|lokalnie w elemencie ServicePlacementPolicies|
|name|ServicePlacementPolicy|
|maxOccurs|Unbounded|
...
|Atrybut|Wartość|
|---|---|
|typ|[Servicetemplates](service-fabric-service-model-schema-complex-types.md#servicetemplatestype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ApplicationManifestType complexType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype), [ApplicationInstanceType complexType](service-fabric-service-model-schema-complex-types.md#applicationinstancetype-complextype)|
...
|typ|[Typ ServiceTypes](service-fabric-service-model-schema-complex-types.md#servicetypestype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie DigestedServiceTypes|
|name|ServiceTypes|
...
|typ|[KeyValuePairType](service-fabric-service-model-schema-complex-types.md#keyvaluepairtype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie SfssRgPolicies|
|name|SfssRgPolicy|
|minOccurs|0|
|maxOccurs|Unbounded|
...
|typ|[StatefulServiceType](service-fabric-service-model-schema-complex-types.md#statefulservicetype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [servicetemplates complexType](service-fabric-service-model-schema-complex-types.md#servicetemplatestype-complextype), element usługi|
|name|Klasy statefulservice|
...
|typ|[StatefulServiceGroupType](service-fabric-service-model-schema-complex-types.md#statefulservicegrouptype-complextype)|
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [servicetemplates complexType](service-fabric-service-model-schema-complex-types.md#servicetemplatestype-complextype), element Service|
|name|StatefulServiceGroup|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ServiceAndServiceGroupTypesType complexType](service-fabric-service-model-schema-complex-types.md#serviceandservicegrouptypestype-complextype)|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w [ServiceAndServiceGroupTypesType complexType](service-fabric-service-model-schema-complex-types.md#serviceandservicegrouptypestype-complextype), [Servicetypestype complexType](service-fabric-service-model-schema-complex-types.md#servicetypestype-complextype)|
...
Nieobsługiwane, nie należy używać. Nazwa niezarządzanego zestawu (na przykład Queue.dll) do hostowania.
...
|zdefiniowane|lokalnie w elemencie users|
|name|Użytkownik|
|maxOccurs|Unbounded|
...
|zawartość|0 elementów, liczba atrybutów: 0|
|zdefiniowane|lokalnie w elemencie głosów|
|name|Głos|
|maxOccurs|Unbounded|
