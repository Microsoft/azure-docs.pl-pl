---
title: Azure Policy kontroli zgodności z przepisami dla Azure Arc z włączoną obsługą usługi (wersja zapoznawcza)
description: Wyświetla Azure Policy kontroli zgodności z przepisami dostępne dla Azure Arc z włączoną obsługą usługi (wersja zapoznawcza). Te wbudowane definicje zasad zapewniają typowe podejścia do zarządzania zgodnością zasobów platformy Azure.
ms.date: 04/14/2021
ms.topic: sample
