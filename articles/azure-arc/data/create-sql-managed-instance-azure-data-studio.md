...
- Z opcji wdrożenia wybierz pozycję **wystąpienie zarządzane Azure SQL — Azure Arc** 
  > [!NOTE]
  > Może zostać wyświetlony monit o zainstalowanie interfejsu wiersza polecenia azdata w tym miejscu, jeśli nie jest on aktualnie zainstalowany.
