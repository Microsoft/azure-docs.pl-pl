...
Jeśli używasz typu modułu równoważenia obciążenia, skopiuj zewnętrzny adres IP i numer portu 300080.  Jeśli używasz NodePort, użyj adresu IP serwera interfejsu API Kubernetes i numeru portu znajdującego się w kolumnie porty.
