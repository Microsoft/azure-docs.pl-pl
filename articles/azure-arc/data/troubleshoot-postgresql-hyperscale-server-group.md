...
ms.locfileid: "90939126"
---
# <a name="troubleshooting-postgresql-hyperscale-server-groups"></a>Rozwiązywanie problemów z grupami serwerów PostgreSQL

Notesy mogą udokumentować procedury, dołączając zawartość z promocji, aby opisać, co zrobić, i jak to zrobić. Może również dostarczyć kod wykonywalny służący do automatyzacji procedury.  Ten wzorzec jest przydatny w przypadku wszystkich standardowych procedur operacyjnych do rozwiązywania problemów z przewodnikami.
...
**TSG100 — Azure Data Studio Notes platformy Azure z włączonym narzędziem do rozwiązywania problemów z PostgreSQLem** :::image type="content" source="media/postgres-hyperscale/ads-controller-postgres-troubleshooting-notebook2.jpg" alt-text="Azure Data Studio - Use PostgreSQL troubleshooting notebook":::
