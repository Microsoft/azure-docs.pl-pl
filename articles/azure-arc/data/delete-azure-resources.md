...
Możesz również użyć interfejsu wiersza polecenia platformy Azure, aby [usunąć grupę zasobów](/azure-resource-manager/management/delete-resource-group).
