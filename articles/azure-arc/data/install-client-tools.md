...
ms.locfileid: "90940675"
---
# <a name="install-client-tools-for-deploying-and-managing-azure-arc-enabled-data-services"></a>Zainstaluj narzędzia klienckie do wdrażania usług danych z obsługą usługi Azure Arc i zarządzania nimi
...
| Azure Data Studio | Tak | Bogate środowisko narzędzia do łączenia się z różnymi bazami danych, w tym Azure SQL, SQL Server, PostrgreSQL i MySQL. Rozszerzenia do Azure Data Studio zapewniają środowisko administracyjne dla usług danych z obsługą usługi Azure Arc. | [Instalacja](https://aka.ms/getazuredatastudio) |
