...
Aby [zainstalować](https://velero.io/docs/master/basic-install/) program Velero w systemie, postępuj zgodnie z zalecanym procesem dla danego systemu operacyjnego.
