...
W poniższym artykule szczegółowo opisano sposób, w jaki Azure Policy wbudowana zgodność zgodności z przepisami, mapuje się do domen i **kontroli** **zgodności** usług CIS Microsoft Azure testów.
...
Następnie Znajdź i wybierz pozycję **Przeprowadź inspekcję usługi CIS Microsoft Azure fundacje w ramach testu porównawczego 1.1.0**
...
### <a name="ensure-that-net-framework-version-is-the-latest-if-used-as-a-part-of-the-web-app"></a>Upewnij się, że wersja ".NET Framework" jest najnowsza, jeśli jest używana jako część aplikacji sieci Web
...
### <a name="ensure-server-parameter-log_duration-is-set-to-on-for-postgresql-database-server"></a>Upewnij się, że parametr serwera "log_duration" jest ustawiony na wartość "ON" dla serwera bazy danych PostgreSQL

**Identyfikator**: microsoft Azure 4,16 **własność**: klient
...
### <a name="ensure-that-threat-detection-types-is-set-to-all"></a>Upewnij się, że ustawienie "typy wykrywania zagrożeń" ma wartość "All"
