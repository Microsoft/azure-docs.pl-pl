...
Następnie znajdź i wybierz wbudowaną definicję inicjatywy **CIS Microsoft Azure Foundations Benchmark w wersji 1.1.0** Zgodność z przepisami.
...
### <a name="ensure-asc-default-policy-setting-monitor-network-security-groups-is-not-disabled"></a>Upewnij się, że domyślne ustawienie zasad usługi ASC "Monitorowanie sieciowych grup zabezpieczeń" nie jest "wyłączone"
...
### <a name="ensure-asc-default-policy-setting-enable-next-generation-firewallngfw-monitoring-is-not-disabled"></a>Upewnij się, że ustawienie zasad usługi ASC "Włącz monitorowanie zapory nowej generacji" nie jest "Wyłączone"

**Identyfikator:** CIS Azure 2.9 **Własność**: Klient
...
**Identyfikator:** CIS Azure 2.13 **Ownership**: Customer (Własność platformy Azure CIS 2.13): Klient
...
### <a name="ensure-that-security-contact-emails-is-set"></a>Upewnij się, że ustawiono ustawienie "Wiadomości e-mail dotyczące kontaktu dla zabezpieczeń"
...
**Identyfikator:** CIS Azure 4.2 **Ownership**: Customer (Własność platformy Azure CIS 4.2): Klient
...
**Identyfikator:** CIS Azure 4.3 **Ownership**: Customer (Własność platformy Azure CIS 4.3): Klient
...
**Identyfikator:** CIS Azure 4.9 **Ownership**: Customer (Własność platformy Azure CIS 4.9): Klient
...
|Nazwa<br /><sub>(Azure Portal)</sub> |Opis |Efekty |Wersja<br /><sub>(GitHub)</sub> |
|---|---|---|---|
|[Połączenia dziennika powinny być włączone dla serwerów baz danych PostgreSQL](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Feb6f77b9-bd53-4e35-a23d-7f65d5f0e442) |Te zasady pomagają w inspekcji baz danych PostgreSQL w środowisku bez log_connections włączonego ustawienia. |AuditIfNotExists, Disabled |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/PostgreSQL_EnableLogConnections_Audit.json) |
...
**Identyfikator:** CIS Azure 5.1.1 **Ownership**: Customer (Własność platformy Azure CIS 5.1.1): Klient
...
**Identyfikator:** CIS Azure 5.1.2 **Ownership**: Customer (Własność platformy Azure CIS 5.1.2): Klient
...
**Identyfikator:** CIS Azure 5.1.6 **Ownership**: Customer (Własność platformy Azure CIS 5.1.6): Klient
...
**Identyfikator:** CIS Azure 5.1.7 **Ownership**: Customer (Własność platformy Azure CIS 5.1.7): Klient
...
### <a name="ensure-that-unattached-disks-are-encrypted"></a>Upewnij się, że "Niedołączene dyski" są szyfrowane
...
### <a name="ensure-that-register-with-azure-active-directory-is-enabled-on-app-service"></a>Upewnij się, że włączono Azure Active Directory u Azure Active Directory na App Service
...
|Nazwa<br /><sub>(Azure Portal)</sub> |Opis |Efekt(y) |Wersja<br /><sub>(GitHub)</sub> |
|---|---|---|---|
|[Upewnij się, że "wersja języka Python" jest najnowsza, jeśli jest używana jako część aplikacji interfejsu API](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F74c3584d-afae-46f7-a20a-6f8adba71a16) |Okresowo nowsze wersje są wydane dla oprogramowania w języku Python ze względu na wady zabezpieczeń lub w celu dołączyć dodatkowe funkcje. Używanie najnowszej wersji języka Python dla aplikacji interfejsu API jest zalecane w celu skorzystania z poprawek zabezpieczeń, jeśli są dostępne, i/lub nowych funkcji najnowszej wersji. Obecnie te zasady dotyczą tylko aplikacji internetowych systemu Linux. |AuditIfNotExists, Disabled |[3.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/App%20Service/AppService_ApiApp_Audit_python_Latest.json) |
