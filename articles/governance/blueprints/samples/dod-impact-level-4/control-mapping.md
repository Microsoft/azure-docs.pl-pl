...
> Aby wyświetlić historię zmian, zobacz [historię zatwierdzeń usługi GitHub](https://github.com/MicrosoftDocs/azure-docs/commits/master/articles/governance/blueprints/samples/dod-impact-level-4/control-mapping.md).
...
Ten plan zawiera definicje zasad pomagające zapewnić prawidłowe włączenie powiadomień o zabezpieczeniach danych. Ponadto ten plan zapewnia, że Inspekcja i zaawansowane zabezpieczenia danych są skonfigurowane na serwerach SQL.
...
> poziomu[wpływu na 4. plan — etapy wdrażania](./deploy.md)
