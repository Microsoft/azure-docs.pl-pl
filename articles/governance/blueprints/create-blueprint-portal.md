...
1. Wybierz pozycję **definicje** strategii ze strony po lewej stronie, a następnie wybierz przycisk **+ Utwórz plan** w górnej części strony.
   ...
   :::image type="content" source="./media/create-blueprint-portal/create-blueprint-button.png" alt-text="Utwórz plan na stronie definicje strategii" border="false":::
...
1. Dodaj przypisanie roli na poziomie subskrypcji:
   ...
   :::image type="content" source="./media/create-blueprint-portal/add-role-assignment.png" alt-text="Przypisanie roli dla artefaktu planu" border="false":::
...
1. Dodaj szablon do grupy zasobów:
   ...
   :::image type="content" source="./media/create-blueprint-portal/add-resource-manager-template.png" alt-text="Menedżer zasobów szablon artefaktu planu" border="false":::
...
1. Dodaj przypisanie roli do grupy zasobów:
   ...
   :::image type="content" source="./media/create-blueprint-portal/add-role-assignment-2.png" alt-text="Przypisanie drugiej roli dla artefaktu planu" border="false":::
...
1. Na stronie **Przypisz plan** na liście rozwijanej **subskrypcja** wybierz subskrypcje, dla których chcesz wdrożyć ten plan.
   ...
   1. Wybierz pozycję **Utwórz** w dolnej części strony.
      ...
      :::image type="content" source="./media/create-blueprint-portal/assignment-create-subscription.png" alt-text="Tworzenie subskrypcji dla subskrypcji przydziału planu" border="false":::
...
1. Na liście planów kliknij prawym przyciskiem myszy wcześniej przypisane, a następnie wybierz pozycję **Wyświetl szczegóły przydziału**.
   ...
   :::image type="content" source="./media/create-blueprint-portal/view-assignment-details.png" alt-text="Wyświetl szczegóły przydziału ze strony przypisane plany" border="false":::
