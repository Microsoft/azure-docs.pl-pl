...
Element zostanie wstawiony do Azure Cosmos DB z [nieprawidłowym znakiem](/dotnet/api/microsoft.azure.documents.resource.id#remarks) w identyfikatorze elementu.
