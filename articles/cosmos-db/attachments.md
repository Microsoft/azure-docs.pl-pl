...
- Pobierz odwołania do korzystania z załączników za pomocą [zestawu .NET SDK w Azure Cosmos DB wersja 2](https://docs.microsoft.com/dotnet/api/microsoft.azure.documents.attachment?view=azure-dotnet)
- Pobierz odwołania do używania załączników za pomocą [zestawu Java SDK w Azure Cosmos DB wersja 2](https://docs.microsoft.com/java/api/com.microsoft.azure.documentdb.attachment?view=azure-java-stable)
