...
> - [Biblioteki zarządzania platformy Azure](https://azure.github.io/azure-sdk/releases/latest/index.html).
...
Lista definicji ról utworzonych w celu pobrania ich identyfikatorów:
...
Po utworzeniu definicji ról można je skojarzyć z tożsamościami w uciekierach. Podczas tworzenia przypisania roli należy podać:
...
> [!NOTE]
> Jeśli chcesz utworzyć przypisanie roli dla jednostki usługi,  upewnij się,  że używasz jego identyfikatora obiektu, który znajduje się w sekcji Aplikacje dla przedsiębiorstw w bloku **Azure Active Directory** portal.
...
Zestawy [SDK .NET W wersji 3](sql-api-sdk-dotnet-standard.md) [i Java w wersji 4](sql-api-sdk-java-v4.md) są obecnie obsługiwane.
