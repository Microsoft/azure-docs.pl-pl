...
> [!IMPORTANT]
> Łącznik Azure Cosmos DB Spark nie jest obecnie obsługiwany w przypadku kont [bezserwerowych](serverless.md) . Zostanie on rozkierowany jako oferta bezserwerowa będzie ogólnie dostępna.
