...
3. Dodajmy kilku nowych użytkowników. Wybierz pozycję **nowy wierzchołek** , aby dodać dane do grafu.
   ...
   :::image type="content" source="./media/create-graph-java/azure-cosmosdb-data-explorer-new-vertex.png" alt-text="Zrzut ekranu przedstawia nowy panel wierzchołka, w którym można wprowadzać wartości.":::
