---
title: Tworzenie bazy danych i kontenera podstawowego interfejsu API (SQL) przy użyciu autoskalowania na Azure Cosmos DB
description: Tworzenie bazy danych i kontenera podstawowego interfejsu API (SQL) przy użyciu autoskalowania na Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "107778791"
---
# <a name="create-an-azure-cosmos-core-sql-api-account-database-and-container-with-autoscale-using-azure-cli"></a>Tworzenie konta, bazy danych i kontenera interfejsu API usługi Azure Cosmos Core (SQL) przy użyciu autoskalowania przy użyciu interfejsu wiersza polecenia platformy Azure
[!INCLUDE[appliesto-sql-api](../../../includes/appliesto-sql-api.md)]

[!INCLUDE [azure-cli-prepare-your-environment.md](../../../../../includes/azure-cli-prepare-your-environment.md)]

- Ten artykuł wymaga interfejsu wiersza polecenia platformy Azure w wersji 2.0.73 lub nowszej. Jeśli używasz Azure Cloud Shell, najnowsza wersja jest już zainstalowana.
