---
title: Tworzenie tabeli interfejs API tabel dla Azure Cosmos DB
description: Tworzenie tabeli interfejs API tabel dla Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "107788992"
---
# <a name="create-an-azure-cosmos-table-api-account-and-table-using-azure-cli"></a>Tworzenie konta i tabeli usługi Azure Cosmos interfejs API tabel pomocą interfejsu wiersza polecenia platformy Azure
...
| [az cosmosdb table create](/cli/azure/cosmosdb/table#az_cosmosdb_table_create) | Tworzy tabelę usługi Azure Cosmos interfejs API tabel. |
