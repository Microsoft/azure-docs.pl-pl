...
|**Dokumentacja interfejsu API**|[Dokumentacja interfejsu API języka Python](/python/api/overview/azure/cosmosdb?preserve-view=true&view=azure-python)|
