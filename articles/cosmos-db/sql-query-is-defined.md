...
## <a name="examples"></a>Przykłady
  ...
  Poniższy przykład sprawdza obecność właściwości w określonym dokumencie JSON. Pierwsze zwraca wartość PRAWDA od "a", ale druga zwraca wartość false, ponieważ brak "b".  
