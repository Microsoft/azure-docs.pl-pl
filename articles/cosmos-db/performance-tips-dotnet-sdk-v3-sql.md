...
Domyślny tryb połączenia zestawu SDK platformy .NET V3 jest bezpośredni z protokołem TCP. Podczas tworzenia wystąpienia w programie należy skonfigurować tryb połączenia `CosmosClient` `CosmosClientOptions` .  Aby dowiedzieć się więcej o różnych opcjach łączności, zobacz artykuł dotyczący [trybów łączności](sql-sdk-connection-modes.md) .
