...
- Używanie [kluczy](database-security.md#primary-keys) Azure Cosmos DB lub [tokenów zasobów](secure-access-to-data.md#resource-tokens) podczas wystawiania wywołań z interfejsów API i zestawów SDK.
