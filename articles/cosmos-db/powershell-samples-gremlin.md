...
description: Pobierz przykłady Azure PowerShell, aby wykonywać różne typowe zadania w Azure Cosmos DB kontach interfejsu API Gremlin
author: markjbrown
...
|[Zablokuj zasoby przed usunięciem](scripts/powershell/gremlin/powershell-gremlin-lock.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Zapobiegaj usunięciu zasobów z blokadami zasobów. |
|||
