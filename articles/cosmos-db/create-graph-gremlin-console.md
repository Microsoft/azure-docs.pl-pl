...
:::image type="content" source="./media/create-graph-gremlin-console/gremlin-console.png" alt-text="Usługa Azure Cosmos DB w konsoli Apache Gremlin":::
