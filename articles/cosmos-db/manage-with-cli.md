...
Umieść blokadę usuwania w bazie danych. Aby dowiedzieć się więcej o tym, jak włączyć tę funkcję, zobacz, [uniemożliwiając zmiany z zestawów SDK](role-based-access-control.md#preventing-changes-from-cosmos-sdk).
...
Umieść blokadę usuwania dla kontenera. Aby dowiedzieć się więcej o tym, jak włączyć tę funkcję, zobacz, [uniemożliwiając zmiany z zestawów SDK](role-based-access-control.md#preventing-changes-from-cosmos-sdk).
