...
> [!NOTE]
> Ten artykuł dotyczy interfejsu API Azure Cosmos DB MongoDB 3,6. Aby uzyskać wersję MongoDB 4,0, zobacz [MongoDB 4,0 obsługiwane funkcje i składnia](mongodb-feature-support-40.md).
