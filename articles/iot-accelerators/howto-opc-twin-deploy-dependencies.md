...
1. Upewnij się, że zainstalowano rozszerzenia PowerShell i [AzureRM PowerShell](/powershell/azure/azurerm/install-azurerm-ps) .  Otwórz wiersz polecenia lub terminal i uruchom polecenie:
