...
1. Uruchom polecenie [AZ Group Delete](/cli/azure/group?preserve-view=true&view=azure-cli-latest#az-group-delete) . Spowoduje to usunięcie grupy zasobów, IoT Hub i utworzonej rejestracji urządzenia.
