...
|-----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| Zarządzanie urządzeniami               | <li>Subskrypcja Microsoft Azure</li><li>Interfejs API programu Graph usługi Azure Active Directory</li><li>Konto Microsoft Azure Storage</li>|<li>Włączone dla Azure Stack EDGE Pro/Data Box Gateway, uprawnienia współautora</li><li>Zapewnianie dostępu administratora lub użytkownika</li><li>Wymagane poświadczenia dostępu</li> |
