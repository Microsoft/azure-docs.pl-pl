...
- [Wdróż bezstanową aplikację na Azure Stack EDGE Pro za pośrednictwem polecenia kubectl](./azure-stack-edge-gpu-deploy-stateless-application-kubernetes.md).
