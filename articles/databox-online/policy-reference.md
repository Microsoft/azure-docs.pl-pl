...
ms.locfileid: "105037822"
---
# <a name="azure-policy-built-in-definitions-for-azure-stack-edge"></a>Azure Policy wbudowane definicje Azure Stack Edge

Ta strona jest indeksem [Azure Policy](../governance/policy/overview.md) wbudowanych definicji zasad dla Azure Stack Edge. Aby uzyskać dodatkowe Azure Policy wbudowane dla innych usług, zobacz [Azure Policy wbudowane definicje](../governance/policy/samples/built-in-policies.md).
