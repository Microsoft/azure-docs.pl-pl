---
title: Moduł IoT Edge C# dla Azure Data Box Edge | Microsoft Docs
description: Dowiedz się, jak opracowywać moduł IoT Edge C#, który można wdrożyć na Data Box Edge.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
---
# <a name="develop-a-c-iot-edge-module-to-move-files-on-data-box-edge"></a>Opracowywanie modułu IoT Edge C# w celu przenoszenia plików na Data Box Edge
