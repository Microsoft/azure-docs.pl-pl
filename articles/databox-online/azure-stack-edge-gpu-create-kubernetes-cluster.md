...
5. Masz punkt końcowy interfejsu API Kubernetes ze strony **urządzenie** w lokalnym interfejsie użytkownika sieci Web. Aby uzyskać więcej informacji, zobacz instrukcje w [punkcie końcowym interfejsu API funkcji Get Kubernetes](azure-stack-edge-gpu-deploy-configure-compute.md#get-kubernetes-api-endpoint)
