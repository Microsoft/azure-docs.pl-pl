...
description: Samouczek wdrażania Azure Stack Edge powoduje skonfigurowanie ustawień sieci, sieci obliczeniowej i serwera proxy sieci Web dla urządzenia fizycznego.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
