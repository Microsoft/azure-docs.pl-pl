---
title: Azure Stack Edge & Azure Data Box Gateway 1911 informacje o wersji | Microsoft Docs
description: Opisuje krytyczne problemy i rozwiązania dla Azure Stack Edge i Data Box Gateway, na których działa wersja 1911.
services: databox
author: alkohli
ms.service: databox
...
ms.locfileid: "90055898"
---
# <a name="azure-stack-edge-and-azure-data-box-gateway-1911-release-notes"></a>Informacje o wersji Azure Stack Edge i Azure Data Box Gateway 1911

Poniższe informacje o wersji dotyczą krytycznych problemów otwartych i rozwiązanych problemów dotyczących wydania 1911 dla Azure Stack Edge i Data Box Gateway.
...
> [!NOTE]
> Aktualizacja 1911 może zostać zastosowana tylko do wszystkich urządzeń z wersjami ogólne dostępności oprogramowania lub nowszych.

## <a name="whats-new"></a>Co nowego

W wersji 1911 nie ma nowych funkcji, tylko poprawki błędów.
