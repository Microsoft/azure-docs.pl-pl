...
ms.locfileid: "90985663"
---
# <a name="what-is-the-azure-stack-edge-pro-r"></a>Co to jest Azure Stack EDGE Pro R?

Azure Stack EDGE Pro R to rozwiązanie typu "sprzęt jako usługa". Firma Microsoft dostarcza na platformę Azure trwałe, niewytrzymałe i serwerowe klasy, które są przeznaczone do przesyłania danych przez sieć. Za pomocą procesora graficznego (GPU) te urządzenia są zoptymalizowane pod kątem obliczeniowych danych AI, analitycznych i bezserwerowych. Urządzenia porne są odpowiednie do użycia w środowiskach Harsh.
...
|Możliwość |Opis  |
|---------|---------|
|Sprzęt wzporny| Sprzęt klasy serwerów z założeniami przeznaczony dla środowisk Harsh. Urządzenie przenośne na 2-osobne przypadki. |
...
|Obsługiwane protokoły     |Obsługa standardowych protokołów SMB, NFS i REST na potrzeby pozyskiwania danych. <br> Aby uzyskać więcej informacji na temat obsługiwanych wersji, przejdź do pozycji [Azure Stack Edge system wymagania systemowe](azure-stack-edge-gpu-system-requirements.md).|
...
- **Azure Stack Edge urządzenie fizyczne Pro r** — Azure Stack EDGE Pro r to urządzenie z 1 węzłem, które można skonfigurować do wysyłania danych do platformy Azure. Urządzenie to serwer o rozmiarze 1U z wytrzymałą encasing dostarczanym przez firmę Microsoft. Opcjonalnie serwer jest dostępny z zasilaczem UPS (również 1U).
...
- **Azure Stack Edge lokalny interfejs użytkownika sieci Web w wersji Pro R** — Użyj lokalnego interfejsu użytkownika sieci Web do początkowej konfiguracji urządzenia, aby uruchomić diagnostykę, Zamknij i uruchom ponownie urządzenie Azure Stack EDGE Pro R, wyświetl dzienniki kopiowania i skontaktuj się z pomoc techniczna firmy Microsoft, aby wysłać żądanie obsługi.
