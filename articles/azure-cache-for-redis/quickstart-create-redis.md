---
title: 'Szybki Start: tworzenie pamięci podręcznej platformy Azure dla usługi Redis'
description: W tym przewodniku szybki start dowiesz się, jak utworzyć wystąpienie usługi Azure cache for Redis
author: yegu-ms
ms.author: yegu
ms.service: cache
ms.custom: mvc
...
ms.locfileid: "83204808"
---
# <a name="quickstart-create-an-azure-cache-for-redis-instance"></a>Szybki Start: tworzenie pamięci podręcznej platformy Azure dla wystąpienia Redis
