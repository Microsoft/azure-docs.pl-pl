...
* [Często zadawane pytania dotyczące planowania](cache-planning-faq.md)
* [Często zadawane pytania dotyczące programowania](cache-development-faq.md)
* [Często zadawane pytania dotyczące zarządzania](cache-management-faq.md)
* [Monitorowanie pytań i rozwiązywanie problemów](cache-monitor-troubleshoot-faq.md)

## <a name="deprecated-cache-services"></a>Przestarzałe usługi pamięci podręcznej
...
### <a name="in-role-cache"></a>Pamięć podręczna In-Role
...
Aby wyświetlić archiwalną dokumentację, zobacz [dokumentację archiwalnej In-Role pamięci podręcznej](/previous-versions/azure/azure-services/dn386103(v=azure.100)).
...
* Aby dotrzeć do szerszego grona odbiorców, możesz ogłosić pytanie na stronie pytań i odpowiedzi [firmy Microsoft dotyczącej usługi Azure cache&](/answers/topics/azure-cache-redis.html) i skontaktować się z zespołem usługi Azure cache i innymi członkami społeczności.
...
* Możesz również wysłać pytanie do nas [azurecache@microsoft.com](mailto:azurecache@microsoft.com) .