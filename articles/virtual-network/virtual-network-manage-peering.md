...
- W przypadku korzystania z portalu Otwórz https://portal.azure.comprogram i zaloguj się przy użyciu konta, które ma [niezbędne uprawnienia](#permissions) do pracy z komunikacjami równorzędnymi.
