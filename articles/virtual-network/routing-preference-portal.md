...
Funkcja preferencji routingu jest obecnie w wersji zapoznawczej. Zarejestruj funkcję subskrypcji za pomocą Azure PowerShell w następujący sposób:
```azurepowershell
