...
Zasady są stosowane do następującej hierarchii: grupy zarządzania, subskrypcji i grupy zasobów. Dowiedz się więcej na temat [Azure Policy](../governance/policy/overview.md?toc=%2fazure%2fvirtual-network%2ftoc.json) lub Wdróż niektóre [definicje Azure Policy](policy-samples.md)sieci wirtualnej.
