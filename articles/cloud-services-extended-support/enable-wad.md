...
```
Oto przykład pliku XML konfiguracji publicznej
```
...
```
Pobierz definicję schematu pliku konfiguracji prywatnej, wykonując następujące polecenie programu PowerShell:
...
```
Oto przykład pliku XML konfiguracji prywatnej
