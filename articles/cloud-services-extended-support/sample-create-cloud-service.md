...
## <a name="create-new-cloud-service-with-single-role-and-certificate-from-key-vault"></a>Utwórz nową usługę w chmurze z jedną rolą i certyfikatem z magazynu kluczy
