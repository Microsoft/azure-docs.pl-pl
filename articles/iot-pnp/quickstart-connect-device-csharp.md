---
title: Szybki Start — łączenie Plug and Play przykładowego kodu urządzenia w języku C# na platformie Azure IoT Hub | Microsoft Docs
description: Szybki Start — Kompilowanie i uruchamianie przykładowego kodu urządzenia Plug and Play IoT w systemie Windows, który nawiązuje połączenie z usługą IoT Hub. Użyj narzędzia Azure IoT Explorer, aby wyświetlić informacje wysyłane przez urządzenie do centrum.
author: ericmitt
ms.author: ericmitt
ms.date: 07/14/2020
ms.topic: quickstart
