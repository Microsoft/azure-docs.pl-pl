---
title: Przewodnik dla deweloperów urządzeń (Python) — IoT Plug and Play | Microsoft Docs
description: Opis Plug and Play IoT dla deweloperów urządzeń w języku Python
author: rido-min
ms.author: rmpablos
ms.date: 09/24/2020
ms.topic: conceptual
...
ms.locfileid: "91580489"
---
# <a name="iot-plug-and-play-device-developer-guide-python"></a>Przewodnik dla deweloperów urządzeń IoT Plug and Play (Python)
