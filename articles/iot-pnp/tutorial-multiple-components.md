---
title: Samouczek — łączenie przykładowego kodu urządzenia Plug and Play IoT z platformą Azure IoT Hub | Microsoft Docs
description: Samouczek — Kompilowanie i uruchamianie przykładowego kodu urządzenia Plug and Play IoT (C, C#, Java, JavaScript lub Python), który używa wielu składników i łączy się z usługą IoT Hub. Użyj narzędzia Azure IoT Explorer, aby wyświetlić informacje wysyłane przez urządzenie do centrum.
author: ericmitt
ms.author: ericmitt
ms.date: 07/22/2020
ms.topic: tutorial
...
ms.locfileid: "106061013"
---
# <a name="tutorial-connect-an-iot-plug-and-play-multiple-component-device-applications-running-on-linux-or-windows-to-iot-hub"></a>Samouczek: łączenie IoT Plug and Play aplikacji urządzeń ze składnikami uruchomionymi w systemie Linux lub Windows do IoT Hub
