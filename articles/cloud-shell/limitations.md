...
* W przypadku zainstalowanego magazynu utrwalane są tylko `$Home` modyfikacje znajdujące się w katalogu.
...
Nazwa `AzureAD` modułu jest obecnie `AzureAD.Standard.Preview`w tej samej funkcji.
