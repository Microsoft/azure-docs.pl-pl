...
- Obsługiwane maszyny wirtualne: 
    ...
    - ✘ Maszyny wirtualne chronione przez zapory platformy Azure kontrolowane przez [Menedżera zapory platformy Azure](https://docs.microsoft.com/azure/firewall-manager/overview).
- Połączeń 
    - ✔ Chmury komercyjne
...
![Konfigurowanie dostępu JIT VM w Azure Security Center](./media/security-center-just-in-time/jit-config-security-center.gif)
...
Dowiedz się więcej na temat [zasad dostępu do sieci JIT](https://docs.microsoft.com/rest/api/securitycenter/jitnetworkaccesspolicies).
...
## <a name="request-access-to-a-jit-enabled-vm"></a>Zażądaj dostępu do maszyny wirtualnej z obsługą JIT
...
![Żądanie dostępu JIT z Security Center](./media/security-center-just-in-time/jit-request-security-center.gif)
...
Więcej informacji znajduje się w [dokumentacji poleceń cmdlet programu PowerShell](https://docs.microsoft.com/powershell/scripting/developer/cmdlet/cmdlet-overview).
