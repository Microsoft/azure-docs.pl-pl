...
|Interfejs API REST|[Interfejs API cen](https://docs.microsoft.com/rest/api/securitycenter/pricings)|
|Interfejs wiersza polecenia platformy Azure|[AZ Security Cennik](https://docs.microsoft.com/cli/azure/security/pricing)|
