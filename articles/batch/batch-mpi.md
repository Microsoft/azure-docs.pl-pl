...
3. Wprowadź swoje poświadczenia usługi Batch i konta magazynu w `AccountSettings.settings` projekcie programu **Microsoft. Azure. Batch. Samples. Common** .
