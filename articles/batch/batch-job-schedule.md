...
Aby zarządzać zadaniem przy użyciu interfejsu wiersza polecenia platformy Azure, zobacz [AZ Batch Job-Schedule](/cli/azure/batch/job-schedule?view=azure-cli-latest).
