...
* Aby wyświetlić więcej Azure Functions wyzwalaczy, których można użyć do uruchamiania obciążeń wsadowych, zapoznaj [się z dokumentacją Azure Functions](../azure-functions/functions-triggers-bindings.md).
