...
* Wszystkie katalogi cyklicznie poniżej węzła `AZ_BATCH_NODE_ROOT_DIR` w węźle hosta (katalogu głównego katalogów Azure Batch) są mapowane do kontenera
