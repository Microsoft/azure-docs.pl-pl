...
1. W Azure Portal przejdź do zasobu Data Box Gateway, a następnie przejdź do pozycji **Przegląd**. Na pasku poleceń kliknij przycisk **+ Dodaj udział**.
...
7. Kliknij przycisk **Utwórz** , aby utworzyć udział. Zostanie wyświetlone powiadomienie, że trwa tworzenie udziału. Po utworzeniu udziału przy użyciu określonych ustawień blok **udziały** jest aktualizowany w celu odzwierciedlenia nowego udziału.
