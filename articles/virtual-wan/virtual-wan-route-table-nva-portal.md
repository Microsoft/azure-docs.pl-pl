...
## <a name="3-create-a-hub"></a><a name="hub"></a>3. Tworzenie centrum
...
## <a name="4-create-and-apply-a-hub-route-table"></a><a name="route"></a>4. Tworzenie i stosowanie tabeli tras centrum
