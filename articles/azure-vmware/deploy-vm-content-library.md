...
Jeśli planujesz używanie programu VMware HCX do migrowania obciążeń maszyn wirtualnych do chmury prywatnej, użyj procedury [Wdróż i skonfiguruj program VMware HCX](tutorial-deploy-vmware-hcx.md) .
