...
Sieci logiczne w chmurze prywatnej są dostarczane ze wstępnie zainicjowaną NSX-T. Bramy warstwy 0 i bramy warstwy 1 są wstępnie udostępniane. Można utworzyć segment i dołączyć go do istniejącej bramy warstwy 1 lub dołączyć do nowej zdefiniowanej bramy warstwy 1. Logiczne składniki sieci NSX zapewniają łączność południowo-zachodnią między obciążeniami i zapewniają łączność północ-południe z Internetem i usługami platformy Azure.
...
> [Samouczek: Tworzenie chmury prywatnej rozwiązania Azure VMware](tutorial-create-private-cloud.md)
