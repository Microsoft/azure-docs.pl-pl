...
1. Na stronie **Dodawanie połączenia** podaj wartości pól, a następnie wybierz **przycisk OK**. 
   ...
   :::image type="content" source="../media/expressroute-global-reach/open-cloud-shell.png" alt-text="Na stronie Dodawanie połączenia podaj wartości pól, a następnie wybierz przycisk OK." border="true":::
