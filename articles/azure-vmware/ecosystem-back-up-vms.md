...
Firmy CommVault, Veritas i Veeam mają wiodące rozwiązania do tworzenia kopii zapasowych i przywracania w środowiskach opartych na oprogramowaniu VMware. Klienci mają szeroko Roztwory te rozwiązania dla wdrożeń lokalnych. Teraz ci partnerzy rozrozszerzyły swoje rozwiązania na rozwiązanie VMware platformy Azure, korzystając z platformy Azure, aby zapewnić tworzenie kopii zapasowych i przechowywanie ich w celu długoterminowego przechowywania i archiwizowania.
...
Więcej informacji na temat tych rozwiązań dotyczących kopii zapasowych można znaleźć tutaj:
