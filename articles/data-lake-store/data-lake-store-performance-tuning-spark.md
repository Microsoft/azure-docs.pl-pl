---
title: Wskazówki dotyczące dostrajania wydajności Azure Data Lake Storage Gen1 Spark | Microsoft Docs
description: Wskazówki dotyczące dostrajania wydajności Azure Data Lake Storage Gen1 Spark
...
* **Uruchamianie klastra Spark na Data Lake Storage Gen1**.  Aby uzyskać więcej informacji, zobacz [Korzystanie z klastra usługi HDInsight Spark do analizowania danych w Data Lake Storage Gen1](https://docs.microsoft.com/azure/hdinsight/hdinsight-apache-spark-use-with-data-lake-store)
