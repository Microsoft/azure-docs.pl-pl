...
Można dodać wiele poświadczeń serwera w Menedżerze konfiguracji urządzenia, które mogą być poświadczeniami domeny, domenami nienależącymi do domeny (Windows lub Linux) lub SQL Server.
