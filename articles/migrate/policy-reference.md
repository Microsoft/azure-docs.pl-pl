---
title: Wbudowane definicje zasad dla Azure Migrate
description: Wyświetla listę wbudowanych definicji zasad Azure Policy dla Azure Migrate. Te wbudowane definicje zasad zapewniają typowe podejścia do zarządzania zasobami platformy Azure.
ms.date: 03/24/2021
ms.topic: reference
...
ms.locfileid: "105036853"
---
# <a name="azure-policy-built-in-definitions-for-azure-migrate"></a>Azure Policy wbudowane definicje Azure Migrate

Ta strona jest indeksem [Azure Policy](../governance/policy/overview.md) wbudowanych definicji zasad dla Azure Migrate. Aby uzyskać dodatkowe Azure Policy wbudowane dla innych usług, zobacz [Azure Policy wbudowane definicje](../governance/policy/samples/built-in-policies.md).
