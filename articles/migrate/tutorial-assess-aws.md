...
description: Dowiedz się, jak uzyskać dostęp do wystąpień AWS na potrzeby migracji na platformę Azure przy użyciu oceny serwera Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
