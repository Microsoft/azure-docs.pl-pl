...
* [Zakończenie obsługi](/sql/sql-server/end-of-support/sql-server-end-of-life-overview) & [rozszerzonych aktualizacji zabezpieczeń](/sql/sql-server/end-of-support/sql-server-extended-security-updates)