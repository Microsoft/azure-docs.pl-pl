---
title: Użyj Azure Portal, aby włączyć klucze zarządzane przez klienta za pomocą dysków zarządzanych przez funkcję SSE
description: Użyj Azure Portal, aby włączyć szyfrowanie po stronie serwera przy użyciu kluczy zarządzanych przez klienta na dyskach zarządzanych.
author: roygara
ms.date: 07/10/2020
ms.topic: how-to
ms.author: rogarana
