...
Azure Disk Encryption dla maszyn wirtualnych z systemem Windows używa funkcji BitLocker systemu Windows w celu zapewnienia pełnego szyfrowania dysków dysku systemu operacyjnego i dysku z danymi. Ponadto zapewnia szyfrowanie dysku zasobów tymczasowych, gdy parametr Volumetype ma wartość ALL.
