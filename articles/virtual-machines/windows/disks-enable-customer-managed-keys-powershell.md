...
### <a name="encrypt-an-existing-virtual-machine-scale-set-with-sse-and-customer-managed-keys"></a>Szyfruj istniejący zestaw skalowania maszyn wirtualnych za pomocą instrukcji SSE i kluczy zarządzanych przez klienta 
