...
[Maszyna wirtualna platformy Azure](overview.md) wymaga kilku dodatkowych zasobów platformy Azure. W tym artykule opisano tworzenie i usuwanie zasobów maszyn wirtualnych oraz zarządzanie nimi przy użyciu języka Python. Omawiane kwestie:
...
Maszyny wirtualne mogą mieć co najmniej jeden [dysk z danymi](../managed-disks-overview.md) , które są przechowywane jako wirtualne dyski twarde.
...
- Dowiedz się więcej o [bibliotece języka Python platformy Azure](/python/api/overview/azure/)
