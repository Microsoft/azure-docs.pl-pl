...
- SQL Server 2014: [Automatyczna kopia zapasowa dla SQL Server 2014 Virtual Machines (Menedżer zasobów)](https://docs.microsoft.com/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-automated-backup)
