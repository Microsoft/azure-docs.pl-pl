---
title: 'Samouczek: zabezpieczanie serwera internetowego przy użyciu certyfikatów TLS/SSL'
...
ms.locfileid: "107813168"
---
# <a name="tutorial-use-tlsssl-certificates-to-secure-a-web-server"></a>Samouczek: zabezpieczanie serwera internetowego przy użyciu certyfikatów TLS/SSL
Aby zabezpieczyć serwery internetowe, Transport Layer Security (TLS), wcześniej znany jako Secure Sockets Layer (SSL), można użyć certyfikatu do szyfrowania ruchu internetowego. Te certyfikaty protokołu TLS/SSL mogą być przechowywane w usłudze Azure Key Vault i umożliwiają bezpieczne wdrażanie certyfikatów na maszynach wirtualnych z systemem Linux na platformie Azure. Ten samouczek zawiera informacje na temat wykonywania następujących czynności:
