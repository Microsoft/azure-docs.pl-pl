...
* [W celu przechwycenia danych dziennika systemowego do monitorowania należy włączyć rozszerzenie Log Analytics](../../azure-monitor/vm/quick-collect-azurevm.md#enable-the-log-analytics-vm-extension)
...
* [Poniższy link zapewnia wskazówki dotyczące zabezpieczeń zalecanych przez firmę Microsoft, które mogą stanowić listę kryteriów dla wybranego oprogramowania.](../security-recommendations.md)
...
**Wskazówki**: Linux Virtual Machines i Azure Active Directory nie mają koncepcji domyślnych haseł. Klient odpowiedzialny za aplikacje innych firm i usługi w portalu Marketplace, które mogą korzystać z domyślnych haseł.
...
* [Zalecane wskazówki dotyczące zabezpieczeń firmy Microsoft](../security-recommendations.md)
...
* [Zarządzanie aktualizacjami i poprawkami dla maszyn wirtualnych](../../automation/update-management/manage-updates-for-vm.md)
...
* [Rozszerzenie diagnostyczne dla maszyn wirtualnych z systemem Linux](../extensions/diagnostics-linux.md?toc=/azure/azure-monitor/toc.json)
...
* [Jak przekazać niestandardowy wirtualny dysk twardy maszyny wirtualnej na platformę Azure](/azure-stack/operator/azure-stack-add-vm-image?view=azs-1910&preserve-view=true)
...
* [Jak skonfigurować oprogramowanie chroniące przed złośliwym oprogramowaniem firmy Microsoft dla Cloud Services i Virtual Machines](../security-recommendations.md)
