...
ms.locfileid: "86236155"
---
# <a name="azure-cli---enable-customer-managed-keys-with-server-side-encryption---managed-disks"></a>Interfejs wiersza polecenia platformy Azure — umożliwia zarządzanie kluczami zarządzanymi przez klienta za pomocą dysków zarządzanych przy użyciu szyfrowania po stronie serwera
