...
Użyj następującego żądania GET, aby zebrać [procentową metrykę procesora CPU](../../azure-monitor/platform/metrics-supported.md#microsoftcomputevirtualmachines) z maszyny wirtualnej
