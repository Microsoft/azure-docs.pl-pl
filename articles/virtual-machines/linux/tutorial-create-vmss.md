...
description: Dowiedz się, jak za pomocą interfejsu wiersza polecenia platformy Azure utworzyć i wdrożyć aplikację o wysokiej dostępie na maszynach wirtualnych z systemem Linux przy użyciu zestawu skalowania maszyn wirtualnych
author: ju-shim
ms.author: jushiman
ms.topic: tutorial
