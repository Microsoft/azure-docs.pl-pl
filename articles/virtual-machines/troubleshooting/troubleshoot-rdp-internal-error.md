...
2. Jeśli nie można zatrzymać aplikacji lub jeśli ta metoda nie dotyczy użytkownika, zmień port dla protokołu RDP:
    ...
    3. [Zaktualizuj grupę zabezpieczeń sieci dla nowego portu](../../virtual-network/network-security-groups-overview.md) w Azure Portal port RDP.
