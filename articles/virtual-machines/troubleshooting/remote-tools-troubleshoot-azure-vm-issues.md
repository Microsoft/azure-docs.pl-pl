...
- Aby uzyskać więcej informacji na temat polecenia cmdlet Enter-PSSession, zobacz [Enter-PSSession](/powershell/module/microsoft.powershell.core/enter-pssession).
