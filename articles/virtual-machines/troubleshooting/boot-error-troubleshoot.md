---
title: Rozwiązywanie problemów z błędami rozruchu na platformie Azure Virtual Machines | Microsoft Docs
description: Ten artykuł pomaga połączyć się z artykułami w celu rozwiązywania problemów z błędami rozruchowymi w usłudze Azure Virtual Machines.
...
* [Maszyna wirtualna nie jest uruchamiana po usłudze Windows Update](troubleshoot-stuck-updating-boot-error.md)
...
- [Konsola szeregowa VM](./serial-console-windows.md)
- [Rozwiązywanie problemów z maszyną wirtualną z systemem Windows przez dołączenie dysku systemu operacyjnego do maszyny wirtualnej odzyskiwania](./troubleshoot-recovery-disks-windows.md)
