...
- [Architektura i topologia maszyny wirtualnej](./workloads/hpc/hbv2-series-overview.md),
- obsługiwany [stos oprogramowania](./workloads/hpc/hbv2-series-overview.md#software-specifications) , w tym obsługiwane systemy operacyjne, i
