...
- [Architektura architektury i topologii maszyn wirtualnych](./workloads/hpc/hbv2-series-overview.md)
- Obsługiwany [stos oprogramowania](./workloads/hpc/hbv2-series-overview.md#software-specifications) , w tym obsługiwane systemy operacyjne
- Oczekiwana [wydajność](./workloads/hpc/hbv2-performance.md) maszyny wirtualnej z serii HBv2
