...
| [Set-AzVMOperatingSystem](/powershell/module/az.compute/set-azvmoperatingsystem) | Ustawia właściwości systemu operacyjnego dla maszyny wirtualnej. |
