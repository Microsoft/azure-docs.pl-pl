...
**Wskazówki**: Użyj Azure Active Directory (AD) kontroli dostępu opartej na ROLACH (RBAC), aby kontrolować dostęp do płaszczyzny kontroli Application Gateway platformy Azure (Azure Portal).
