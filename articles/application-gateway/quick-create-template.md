...
description: Dowiedz się, jak za pomocą szablonu Menedżer zasobów utworzyć Application Gateway platformy Azure, która kieruje ruch internetowy do maszyn wirtualnych w puli zaplecza.
