...
* [`Horizontal Pod Autoscaler`](../aks/concepts-scale.md#horizontal-pod-autoscaler) -Będziemy używać usługi HPA do używania metryk Application Gateway i określania celu skalowania.
...
Gdy będziemy mogli uwidocznić `appgw-request-count-metric` serwer metryk, jesteśmy gotowi do [`Horizontal Pod Autoscaler`](../aks/concepts-scale.md#horizontal-pod-autoscaler) skalowania wdrożenia docelowego.
