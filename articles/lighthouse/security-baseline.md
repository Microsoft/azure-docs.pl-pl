...
- [Test porównawczy zabezpieczeń platformy Azure — zarządzanie elementami zawartości](/azure/security/benchmarks/security-controls-v2-incident-response)
...
-   /Azure/Security/benchmarks/Security-Controls-v2-Logging-Threat-Protection strategii Internetu i ruchu przychodzącego i wychodzącego
...
- [Test porównawczy zabezpieczeń platformy Azure — zabezpieczenia sieci](/azure/security/benchmarks/security-controls-v2-logging-threat-detection)
